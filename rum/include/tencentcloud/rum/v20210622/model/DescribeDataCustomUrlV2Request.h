...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATACUSTOMURLV2REQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATACUSTOMURLV2REQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataCustomUrlV2Request : public AbstractModel
                {
                public:
                    DescribeDataCustomUrlV2Request();
                    ~DescribeDataCustomUrlV2Request() = default;
                    ...
                    /**
                     * 设置top: top resource view. allcount: performance view. day: 14-day data. condition: condition list. pagepv: performance view. area: request speed distribution. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
                    ...
                    /**
                     * 获取Value of the custom speed test key.
                    ...
                    /**
                     * 设置Value of the custom speed test key.
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATACUSTOMURLV2REQUEST_H_
