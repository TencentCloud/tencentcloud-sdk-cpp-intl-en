...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAFETCHURLV2REQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAFETCHURLV2REQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataFetchUrlV2Request : public AbstractModel
                {
                public:
                    DescribeDataFetchUrlV2Request();
                    ~DescribeDataFetchUrlV2Request() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAFETCHURLV2REQUEST_H_
