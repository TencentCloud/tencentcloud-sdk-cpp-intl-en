...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAEVENTURLV2REQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAEVENTURLV2REQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataEventUrlV2Request : public AbstractModel
                {
                public:
                    DescribeDataEventUrlV2Request();
                    ~DescribeDataEventUrlV2Request() = default;
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATAEVENTURLV2REQUEST_H_
