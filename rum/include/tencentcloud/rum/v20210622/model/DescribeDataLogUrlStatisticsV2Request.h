...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATALOGURLSTATISTICSV2REQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATALOGURLSTATISTICSV2REQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataLogUrlStatisticsV2Request : public AbstractModel
                {
                public:
                    DescribeDataLogUrlStatisticsV2Request();
                    ~DescribeDataLogUrlStatisticsV2Request() = default;
                    ...
                    /**
                     * 设置analysis: exception analysis. compare: exception list comparison. allcount: performance view. condition: condition list. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
                    ...
                    /**
                     * 获取JavaScript exception message.
                    ...
                    /**
                     * 设置JavaScript exception message.
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATALOGURLSTATISTICSV2REQUEST_H_
