...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASTATICRESOURCEV2REQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASTATICRESOURCEV2REQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataStaticResourceV2Request : public AbstractModel
                {
                public:
                    DescribeDataStaticResourceV2Request();
                    ~DescribeDataStaticResourceV2Request() = default;
                    ...
                    /**
                     * 获取top: top resource view. count40x: 40X view. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
                    ...
                    /**
                     * 设置top: top resource view. count40x: 40X view. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASTATICRESOURCEV2REQUEST_H_
