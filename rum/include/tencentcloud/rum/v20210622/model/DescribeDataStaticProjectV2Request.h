...
#ifndef TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASTATICPROJECTV2REQUEST_H_
#define TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASTATICPROJECTV2REQUEST_H_
    ...
    namespace Rum
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeDataStaticProjectV2Request : public AbstractModel
                {
                public:
                    DescribeDataStaticProjectV2Request();
                    ~DescribeDataStaticProjectV2Request() = default;
                    ...
                    /**
                     * 获取allcount: performance view. day: 14-day data. condition: condition list. area: request speed distribution. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
                    ...
                    /**
                     * 设置allcount: performance view. day: 14-day data. condition: condition list. area: request speed distribution. nettype/version/platform/isp/region/device/browser/ext1/ext2/ext3/ret/status/from/url/env/: network platform view, version view, device view, ISP view, region view, browser view, ext1 view, and so on.
                    ...
                    /**
                     * 设置Log level (1 indicates allowlist log. 2 indicates general log. 4 indicates error log. 8 indicates Promise error. 16 indicates AJAX request exception. 32 indicates JavaScript loading exception. 64 indicates image loading exception. 128 indicates CSS loading exception. 256 indicates console.error. 512 indicates audio or video resource exception. 1024 indicates retcode exception. 2048 indicates Aegis report. 4096 indicates PV log. 8192 indicates custom event. 16384 indicates mini program page does not exist. 32768 indicates WebSocket error. 65536 indicates JavaScript bridge error).
...
#endif // !TENCENTCLOUD_RUM_V20210622_MODEL_DESCRIBEDATASTATICPROJECTV2REQUEST_H_
