...
CoreInternalOutcome DeleteOfflineLogRecordResponse::Deserialize(const string &payload)
{
...
string DeleteOfflineLogRecordResponse::ToJsonString() const
{
...
string DeleteOfflineLogRecordResponse::GetMsg() const
{
    return m_msg;
}

bool DeleteOfflineLogRecordResponse::MsgHasBeenSet() const
{
