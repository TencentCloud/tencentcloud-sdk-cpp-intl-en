...
string DescribeOfflineLogConfigsRequest::ToJsonString() const
{
...
string DescribeOfflineLogConfigsRequest::GetProjectKey() const
{
    return m_projectKey;
}

void DescribeOfflineLogConfigsRequest::SetProjectKey(const string& _projectKey)
{
    m_projectKey = _projectKey;
    m_projectKeyHasBeenSet = true;
}

bool DescribeOfflineLogConfigsRequest::ProjectKeyHasBeenSet() const
{
