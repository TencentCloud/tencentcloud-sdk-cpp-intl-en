...
CoreInternalOutcome CreateOfflineLogConfigResponse::Deserialize(const string &payload)
{
...
string CreateOfflineLogConfigResponse::ToJsonString() const
{
...
string CreateOfflineLogConfigResponse::GetMsg() const
{
    return m_msg;
}

bool CreateOfflineLogConfigResponse::MsgHasBeenSet() const
{
