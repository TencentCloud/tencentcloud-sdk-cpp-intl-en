...
CoreInternalOutcome DescribeLogListResponse::Deserialize(const string &payload)
{
...
string DescribeLogListResponse::ToJsonString() const
{
...
string DescribeLogListResponse::GetResult() const
{
    return m_result;
}

bool DescribeLogListResponse::ResultHasBeenSet() const
{
