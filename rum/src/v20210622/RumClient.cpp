...
{
    using Req = const CreateOfflineLogConfigRequest&;
    using Resp = CreateOfflineLogConfigResponse;

    DoRequestAsync<Req, Resp>(
        "CreateOfflineLogConfig", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<CreateOfflineLogConfigOutcome>>();
    CreateOfflineLogConfigAsync(
    request,
    [prom](
        const RumClient*,
        const CreateOfflineLogConfigRequest&,
        CreateOfflineLogConfigOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DeleteOfflineLogConfigRequest&;
    using Resp = DeleteOfflineLogConfigResponse;

    DoRequestAsync<Req, Resp>(
        "DeleteOfflineLogConfig", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DeleteOfflineLogConfigOutcome>>();
    DeleteOfflineLogConfigAsync(
    request,
    [prom](
        const RumClient*,
        const DeleteOfflineLogConfigRequest&,
        DeleteOfflineLogConfigOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DeleteOfflineLogRecordRequest&;
    using Resp = DeleteOfflineLogRecordResponse;

    DoRequestAsync<Req, Resp>(
        "DeleteOfflineLogRecord", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DeleteOfflineLogRecordOutcome>>();
    DeleteOfflineLogRecordAsync(
    request,
    [prom](
        const RumClient*,
        const DeleteOfflineLogRecordRequest&,
        DeleteOfflineLogRecordOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeDataPerformanceProjectRequest&;
    using Resp = DescribeDataPerformanceProjectResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeDataPerformanceProject", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeDataPerformanceProjectOutcome>>();
    DescribeDataPerformanceProjectAsync(
    request,
    [prom](
        const RumClient*,
        const DescribeDataPerformanceProjectRequest&,
        DescribeDataPerformanceProjectOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeLogListRequest&;
    using Resp = DescribeLogListResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeLogList", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeLogListOutcome>>();
    DescribeLogListAsync(
    request,
    [prom](
        const RumClient*,
        const DescribeLogListRequest&,
        DescribeLogListOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeOfflineLogConfigsRequest&;
    using Resp = DescribeOfflineLogConfigsResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeOfflineLogConfigs", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeOfflineLogConfigsOutcome>>();
    DescribeOfflineLogConfigsAsync(
    request,
    [prom](
        const RumClient*,
        const DescribeOfflineLogConfigsRequest&,
        DescribeOfflineLogConfigsOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeOfflineLogRecordsRequest&;
    using Resp = DescribeOfflineLogRecordsResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeOfflineLogRecords", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeOfflineLogRecordsOutcome>>();
    DescribeOfflineLogRecordsAsync(
    request,
    [prom](
        const RumClient*,
        const DescribeOfflineLogRecordsRequest&,
        DescribeOfflineLogRecordsOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeOfflineLogsRequest&;
    using Resp = DescribeOfflineLogsResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeOfflineLogs", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeOfflineLogsOutcome>>();
    DescribeOfflineLogsAsync(
    request,
    [prom](
        const RumClient*,
        const DescribeOfflineLogsRequest&,
        DescribeOfflineLogsOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
