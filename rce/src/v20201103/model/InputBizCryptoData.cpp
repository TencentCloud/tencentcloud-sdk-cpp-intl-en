...
CoreInternalOutcome InputBizCryptoData::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("IsAuthorized") && !value["IsAuthorized"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InputBizCryptoData.IsAuthorized` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CryptoType") && !value["CryptoType"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InputBizCryptoData.CryptoType` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CryptoContent") && !value["CryptoContent"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `InputBizCryptoData.CryptoContent` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void InputBizCryptoData::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string InputBizCryptoData::GetIsAuthorized() const
{
    return m_isAuthorized;
}

void InputBizCryptoData::SetIsAuthorized(const string& _isAuthorized)
{
    m_isAuthorized = _isAuthorized;
    m_isAuthorizedHasBeenSet = true;
}

bool InputBizCryptoData::IsAuthorizedHasBeenSet() const
{
    return m_isAuthorizedHasBeenSet;
}

string InputBizCryptoData::GetCryptoType() const
{
    return m_cryptoType;
}

void InputBizCryptoData::SetCryptoType(const string& _cryptoType)
{
    m_cryptoType = _cryptoType;
    m_cryptoTypeHasBeenSet = true;
}

bool InputBizCryptoData::CryptoTypeHasBeenSet() const
{
    return m_cryptoTypeHasBeenSet;
}

string InputBizCryptoData::GetCryptoContent() const
{
    return m_cryptoContent;
}

void InputBizCryptoData::SetCryptoContent(const string& _cryptoContent)
{
    m_cryptoContent = _cryptoContent;
    m_cryptoContentHasBeenSet = true;
}

bool InputBizCryptoData::CryptoContentHasBeenSet() const
{
