            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>The ID of the red packet</p>
                    ...
                    /**
                     * 设置<p>The ID of the red packet</p>
                    ...
                    /**
                     * 获取<p>The type of red packet, for example, random amount, passcode, standard</p>
                    ...
                    /**
                     * 设置<p>The type of red packet, for example, random amount, passcode, standard</p>
                    ...
                    /**
                     * 获取<p>The amount  in the red packet</p>
                    ...
                    /**
                     * 设置<p>The amount  in the red packet</p>
