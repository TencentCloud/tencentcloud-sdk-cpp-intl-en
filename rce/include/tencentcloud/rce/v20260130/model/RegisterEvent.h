...
#ifndef TENCENTCLOUD_RCE_V20260130_MODEL_REGISTEREVENT_H_
#define TENCENTCLOUD_RCE_V20260130_MODEL_REGISTEREVENT_H_
    ...
    namespace Rce
    {
        namespace V20260130
        {
            namespace Model
            {
                ...
                */
                class RegisterEvent : public AbstractModel
                {
                public:
                    RegisterEvent();
                    ...
                    /**
                     * 获取<p>The result of the register</p>
                     * @return RegisterResult <p>The result of the register</p>
                     * 
                     */
                    Result GetRegisterResult() const;

                    /**
                     * 设置<p>The result of the register</p>
                     * @param _registerResult <p>The result of the register</p>
                     * 
                     */
                    void SetRegisterResult(const Result& _registerResult);

                    /**
                     * 判断参数 RegisterResult 是否已赋值
                     * @return RegisterResult 是否已赋值
                     * 
                     */
                    bool RegisterResultHasBeenSet() const;
                    ...
                    /**
                     * 获取<p>The detail information of the inviter who invited the user to your business</p>
                     * @return Inviter <p>The detail information of the inviter who invited the user to your business</p>
                     * 
                     */
                    Inviter GetInviter() const;

                    /**
                     * 设置<p>The detail information of the inviter who invited the user to your business</p>
                     * @param _inviter <p>The detail information of the inviter who invited the user to your business</p>
                     * 
                     */
                    void SetInviter(const Inviter& _inviter);

                    /**
                     * 判断参数 Inviter 是否已赋值
                     * @return Inviter 是否已赋值
                     * 
                     */
                    bool InviterHasBeenSet() const;
                ...
                private:
                     ...
                     */
                    Result m_registerResult;
                    bool m_registerResultHasBeenSet;
...
#endif // !TENCENTCLOUD_RCE_V20260130_MODEL_REGISTEREVENT_H_
