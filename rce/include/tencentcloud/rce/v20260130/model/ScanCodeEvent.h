...
#ifndef TENCENTCLOUD_RCE_V20260130_MODEL_SCANCODEEVENT_H_
#define TENCENTCLOUD_RCE_V20260130_MODEL_SCANCODEEVENT_H_
    ...
    namespace Rce
    {
        namespace V20260130
        {
            namespace Model
            {
                ...
                */
                class ScanCodeEvent : public AbstractModel
                {
                public:
                    ScanCodeEvent();
                    ~ScanCodeEvent() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取<p>Promotion code information</p>
                     * @return PromotionCode <p>Promotion code information</p>
                     * 
                     */
                    PromotionCode GetPromotionCode() const;

                    /**
                     * 设置<p>Promotion code information</p>
                     * @param _promotionCode <p>Promotion code information</p>
                     * 
                     */
                    void SetPromotionCode(const PromotionCode& _promotionCode);

                    /**
                     * 判断参数 PromotionCode 是否已赋值
                     * @return PromotionCode 是否已赋值
                     * 
                     */
                    bool PromotionCodeHasBeenSet() const;
                ...
                private:
                     ...
                     */
                    PromotionCode m_promotionCode;
                    bool m_promotionCodeHasBeenSet;
...
#endif // !TENCENTCLOUD_RCE_V20260130_MODEL_SCANCODEEVENT_H_
