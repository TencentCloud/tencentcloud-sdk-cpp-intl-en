...
#ifndef TENCENTCLOUD_RCE_V20260130_MODEL_ADDPROMOTIONEVENT_H_
#define TENCENTCLOUD_RCE_V20260130_MODEL_ADDPROMOTIONEVENT_H_
    ...
    namespace Rce
    {
        namespace V20260130
        {
            namespace Model
            {
                ...
                */
                class AddPromotionEvent : public AbstractModel
                {
                public:
                    AddPromotionEvent();
                    ~AddPromotionEvent() = default;
                    ...
                    /**
                     * 获取<p>The coupon associated with the promotion</p>
                    ...
                    /**
                     * 设置<p>The coupon associated with the promotion</p>
                    ...
                    /**
                     * 获取<p>The point associated with the promotion</p>
                     * @return Point <p>The point associated with the promotion</p>
                     * 
                     */
                    CreditPoint GetPoint() const;

                    /**
                     * 设置<p>The point associated with the promotion</p>
                     * @param _point <p>The point associated with the promotion</p>
                     * 
                     */
                    void SetPoint(const CreditPoint& _point);
                    ...
                    /**
                     * 获取<p>The result of participating the promotion</p>
                    ...
                    /**
                     * 设置<p>The result of participating the promotion</p>
                    ...
                    /**
                     * 获取<p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p>
                    ...
                    /**
                     * 设置<p>The custom parameters agreed with RCE. An array of objects in K:V format. e.g.[{"Key": "ApproverName", "Value": "bob"},{"Key":"ApproverPhone","Value": "+86131***85678"}]</p>
...
#endif // !TENCENTCLOUD_RCE_V20260130_MODEL_ADDPROMOTIONEVENT_H_
