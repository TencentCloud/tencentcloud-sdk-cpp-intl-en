...
#ifndef TENCENTCLOUD_RCE_V20260130_MODEL_ASSESSDEVICERISKPREMIUMPROREQUEST_H_
#define TENCENTCLOUD_RCE_V20260130_MODEL_ASSESSDEVICERISKPREMIUMPROREQUEST_H_
    ...
    namespace Rce
    {
        namespace V20260130
        {
            namespace Model
            {
                ...
                */
                class AssessDeviceRiskPremiumProRequest : public AbstractModel
                {
                public:
                    AssessDeviceRiskPremiumProRequest();
                    ~AssessDeviceRiskPremiumProRequest() = default;
...
#endif // !TENCENTCLOUD_RCE_V20260130_MODEL_ASSESSDEVICERISKPREMIUMPROREQUEST_H_
