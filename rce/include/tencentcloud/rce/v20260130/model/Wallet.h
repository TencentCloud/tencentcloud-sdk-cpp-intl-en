            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Wallet type</p><p>Enumeration value:</p><ul><li>crypto: Crypto currency</li><li>digital: Digital currency</li><li>fiat: Fiat currency</li></ul>
                    ...
                    /**
                     * 设置<p>Wallet type</p><p>Enumeration value:</p><ul><li>crypto: Crypto currency</li><li>digital: Digital currency</li><li>fiat: Fiat currency</li></ul>
                    ...
                    /**
                     * 获取<p>The address of the wallet.Usually it is the ID of the wallet.</p>
                    ...
                    /**
                     * 设置<p>The address of the wallet.Usually it is the ID of the wallet.</p>
                    ...
                    /**
                     * 获取<p>The full name of the person who holds  the wallet</p>
                    ...
                    /**
                     * 设置<p>The full name of the person who holds  the wallet</p>
                    ...
                    /**
                     * 获取<p>The provider of the wallet, such as wechat, alipay, paypal</p>
                    ...
                    /**
                     * 设置<p>The provider of the wallet, such as wechat, alipay, paypal</p>
