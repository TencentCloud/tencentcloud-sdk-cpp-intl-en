            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>The token provided by the SDK integrated in your web site or application</p>
                    ...
                    /**
                     * 设置<p>The token provided by the SDK integrated in your web site or application</p>
                    ...
                    /**
                     * 获取<p>User client IP address (IPv4 or IPv6)</p>
                    ...
                    /**
                     * 设置<p>User client IP address (IPv4 or IPv6)</p>
                    ...
                    /**
                     * 获取<p>Event details, import corresponding event information based on the event code you input</p>
                    ...
                    /**
                     * 设置<p>Event details, import corresponding event information based on the event code you input</p>
