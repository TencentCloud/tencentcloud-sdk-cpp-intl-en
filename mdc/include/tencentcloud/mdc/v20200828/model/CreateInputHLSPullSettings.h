...
#ifndef TENCENTCLOUD_MDC_V20200828_MODEL_CREATEINPUTHLSPULLSETTINGS_H_
#define TENCENTCLOUD_MDC_V20200828_MODEL_CREATEINPUTHLSPULLSETTINGS_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取The origin server address for the HLS origin server. There can be only one.
                    ...
                    /**
                     * 设置The origin server address for the HLS origin server. There can be only one.
...
#endif // !TENCENTCLOUD_MDC_V20200828_MODEL_CREATEINPUTHLSPULLSETTINGS_H_
