...
CoreInternalOutcome CreateStreamLinkFlowResponse::Deserialize(const string &payload)
{
...
string CreateStreamLinkFlowResponse::ToJsonString() const
{
...
DescribeFlow CreateStreamLinkFlowResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamLinkFlowResponse::InfoHasBeenSet() const
{
