...
CoreInternalOutcome CreateStreamLinkOutputInfoResponse::Deserialize(const string &payload)
{
...
string CreateStreamLinkOutputInfoResponse::ToJsonString() const
{
...
DescribeOutput CreateStreamLinkOutputInfoResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamLinkOutputInfoResponse::InfoHasBeenSet() const
{
