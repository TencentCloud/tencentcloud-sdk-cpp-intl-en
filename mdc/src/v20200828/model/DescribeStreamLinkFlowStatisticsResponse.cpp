...
CoreInternalOutcome DescribeStreamLinkFlowStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkFlowStatisticsResponse::ToJsonString() const
{
...
vector<FlowStatisticsArray> DescribeStreamLinkFlowStatisticsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLinkFlowStatisticsResponse::InfosHasBeenSet() const
{
