...
CoreInternalOutcome ModifyStreamLinkInputResponse::Deserialize(const string &payload)
{
...
string ModifyStreamLinkInputResponse::ToJsonString() const
{
...
DescribeInput ModifyStreamLinkInputResponse::GetInfo() const
{
    return m_info;
}

bool ModifyStreamLinkInputResponse::InfoHasBeenSet() const
{
