            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取List of groups to be searched in. Up to 100 groups are supported.
                     * @return GroupIds List of groups to be searched in. Up to 100 groups are supported.
                     */
                    std::vector<std::string> GetGroupIds() const;

                    /**
                     * 设置List of groups to be searched in. Up to 100 groups are supported.
...
For example, if the input image in `Image` or `Url` contains multiple faces and `MaxFaceNum` is 5, top 5 faces with the largest size in the image will be recognized.
                    ...
                    /**
                     * 获取Minimum height and width of face in px. Default value: 34. Face images whose value is below 34 cannot be recognized. You are recommended to set this parameter to 80.
                    ...
                    /**
                     * 设置Minimum height and width of face in px. Default value: 34. Face images whose value is below 34 cannot be recognized. You are recommended to set this parameter to 80.
                    ...
                    /**
                     * 获取Number of the most similar persons returned for faces recognized in one single image. Default value: 5. Maximum value: 100. 
...
The greater the value, the longer the processing time. You are recommended to set a value below 10.
                    ...
                    /**
                     * 设置Number of the most similar persons returned for faces recognized in one single image. Default value: 5. Maximum value: 100. 
For example, if `MaxFaceNum` is 1 and `MaxPersonNum` is 8, information of the top 8 most similar persons will be returned.
The greater the value, the longer the processing time. You are recommended to set a value below 10.
