...
#ifndef TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBERASPEVENTTCSSREQUEST_H_
#define TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBERASPEVENTTCSSREQUEST_H_
    ...
    namespace Cwp
    {
        namespace V20180228
        {
            namespace Model
            {
                ...
                */
                class DescribeRaspEventTCSSRequest : public AbstractModel
                {
                public:
                    DescribeRaspEventTCSSRequest();
                    ~DescribeRaspEventTCSSRequest() = default;
...
#endif // !TENCENTCLOUD_CWP_V20180228_MODEL_DESCRIBERASPEVENTTCSSREQUEST_H_
