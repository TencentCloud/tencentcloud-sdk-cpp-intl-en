...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Order ID: The order number for purchase in the annual and monthly billing mode
                    ...
                    /**
                     * 设置Order ID: The order number for purchase in the annual and monthly billing mode
                    ...
                    /**
                     * 获取Transaction ID: The settlement and deduction number
                    ...
                    /**
                     * 设置Transaction ID: The settlement and deduction number
                    ...
                    /**
                     * 获取Split item usage/duration ratio: Split item usage (duration) ratio, Split Item Usage (Duration) /Total Usage Before Splitting (Duration)
                    ...
                    /**
                     * 设置Split item usage/duration ratio: Split item usage (duration) ratio, Split Item Usage (Duration) /Total Usage Before Splitting (Duration)
                    ...
                    /**
                     * 获取Associated document ID: Document ID associated with this transaction, such as the original new purchase order corresponding to a refund order
                    ...
                    /**
                     * 设置Associated document ID: Document ID associated with this transaction, such as the original new purchase order corresponding to a refund order
