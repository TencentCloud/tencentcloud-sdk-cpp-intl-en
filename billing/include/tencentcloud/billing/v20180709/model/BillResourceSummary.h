            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Subproduct name: The subcategory of a Tencent Cloud product purchased by the user, such as CVM Computing C5t.
                    ...
                    /**
                     * 设置Subproduct name: The subcategory of a Tencent Cloud product purchased by the user, such as CVM Computing C5t.
                    ...
                    /**
                     * 获取Transaction type, which can be yearly/monthly subscription purchase, yearly/monthly subscription renewal, or pay-as-you-go deduction.
                    ...
                    /**
                     * 设置Transaction type, which can be yearly/monthly subscription purchase, yearly/monthly subscription renewal, or pay-as-you-go deduction.
                    ...
                    /**
                     * 获取Order ID: The order number for a yearly/monthly subscription purchase
                    ...
                    /**
                     * 设置Order ID: The order number for a yearly/monthly subscription purchase
                    ...
                    /**
                     * 获取Original cost: The original cost of a resource, which is "List price x Usage x Usage duration". If a customer has applied for a fixed preferential price or contract price or applied for a refund, this parameter will not be displayed by default.
                    ...
                    /**
                     * 设置Original cost: The original cost of a resource, which is "List price x Usage x Usage duration". If a customer has applied for a fixed preferential price or contract price or applied for a refund, this parameter will not be displayed by default.
                    ...
                    /**
                     * 获取Discount multiplier: The discount multiplier applied to the cost of the resource. If a customer has applied for a fixed preferential price or contract price or applied for a refund, this parameter will not be displayed by default.
                    ...
                    /**
                     * 设置Discount multiplier: The discount multiplier applied to the cost of the resource. If a customer has applied for a fixed preferential price or contract price or applied for a refund, this parameter will not be displayed by default.
                    ...
                    /**
                     * 获取Total amount after discount (Including Tax):  = Total Amount After Discount (Excluding Tax) + TaxAmount
                    ...
                    /**
                     * 设置Total amount after discount (Including Tax):  = Total Amount After Discount (Excluding Tax) + TaxAmount
