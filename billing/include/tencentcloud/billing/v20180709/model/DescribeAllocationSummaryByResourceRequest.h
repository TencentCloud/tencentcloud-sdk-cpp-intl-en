...
desc - Descending
                    ...
                    /**
                     * 获取Availability zone (AZ) ID, used for filtering
                    ...
                    /**
                     * 设置Availability zone (AZ) ID, used for filtering
                    ...
                    /**
                     * 获取Cost collection type, with the enumerated values as follows:
0 - Allocation 
1 - Collection 
-1 - Unallocated
...
-1 - Unallocated
                    ...
                    /**
                     * 设置Cost collection type, with the enumerated values as follows:
0 - Allocation 
1 - Collection 
-1 - Unallocated
