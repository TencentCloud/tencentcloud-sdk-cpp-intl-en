...
CoreInternalOutcome AllocationDetail::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("CostBeforeTax") && !value["CostBeforeTax"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationDetail.CostBeforeTax` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Tax") && !value["Tax"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationDetail.Tax` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AmountBeforeTax") && !value["AmountBeforeTax"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationDetail.AmountBeforeTax` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Currency") && !value["Currency"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationDetail.Currency` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TaxRate") && !value["TaxRate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationDetail.TaxRate` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string AllocationDetail::GetCostBeforeTax() const
{
    return m_costBeforeTax;
}

void AllocationDetail::SetCostBeforeTax(const string& _costBeforeTax)
{
    m_costBeforeTax = _costBeforeTax;
    m_costBeforeTaxHasBeenSet = true;
}

bool AllocationDetail::CostBeforeTaxHasBeenSet() const
{
    return m_costBeforeTaxHasBeenSet;
}

string AllocationDetail::GetTax() const
{
    return m_tax;
}

void AllocationDetail::SetTax(const string& _tax)
{
    m_tax = _tax;
    m_taxHasBeenSet = true;
}

bool AllocationDetail::TaxHasBeenSet() const
{
    return m_taxHasBeenSet;
}

string AllocationDetail::GetAmountBeforeTax() const
{
    return m_amountBeforeTax;
}

void AllocationDetail::SetAmountBeforeTax(const string& _amountBeforeTax)
{
    m_amountBeforeTax = _amountBeforeTax;
    m_amountBeforeTaxHasBeenSet = true;
}

bool AllocationDetail::AmountBeforeTaxHasBeenSet() const
{
...
string AllocationDetail::GetCurrency() const
{
    return m_currency;
}

void AllocationDetail::SetCurrency(const string& _currency)
{
    m_currency = _currency;
    m_currencyHasBeenSet = true;
}

bool AllocationDetail::CurrencyHasBeenSet() const
{
...
string AllocationDetail::GetTaxRate() const
{
    return m_taxRate;
}

void AllocationDetail::SetTaxRate(const string& _taxRate)
{
    m_taxRate = _taxRate;
    m_taxRateHasBeenSet = true;
}

bool AllocationDetail::TaxRateHasBeenSet() const
{
