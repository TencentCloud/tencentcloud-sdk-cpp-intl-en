...
CoreInternalOutcome AllocationSummaryByResource::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Currency") && !value["Currency"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByResource.Currency` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Tax") && !value["Tax"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByResource.Tax` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TaxRate") && !value["TaxRate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByResource.TaxRate` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CostBeforeTax") && !value["CostBeforeTax"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByResource.CostBeforeTax` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AmountBeforeTax") && !value["AmountBeforeTax"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByResource.AmountBeforeTax` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string AllocationSummaryByResource::GetCurrency() const
{
    return m_currency;
}

void AllocationSummaryByResource::SetCurrency(const string& _currency)
{
    m_currency = _currency;
    m_currencyHasBeenSet = true;
}

bool AllocationSummaryByResource::CurrencyHasBeenSet() const
{
    return m_currencyHasBeenSet;
}

string AllocationSummaryByResource::GetTax() const
{
    return m_tax;
}

void AllocationSummaryByResource::SetTax(const string& _tax)
{
    m_tax = _tax;
    m_taxHasBeenSet = true;
}

bool AllocationSummaryByResource::TaxHasBeenSet() const
{
    return m_taxHasBeenSet;
}

string AllocationSummaryByResource::GetTaxRate() const
{
    return m_taxRate;
}

void AllocationSummaryByResource::SetTaxRate(const string& _taxRate)
{
    m_taxRate = _taxRate;
    m_taxRateHasBeenSet = true;
}

bool AllocationSummaryByResource::TaxRateHasBeenSet() const
{
    return m_taxRateHasBeenSet;
}

string AllocationSummaryByResource::GetCostBeforeTax() const
{
    return m_costBeforeTax;
}

void AllocationSummaryByResource::SetCostBeforeTax(const string& _costBeforeTax)
{
    m_costBeforeTax = _costBeforeTax;
    m_costBeforeTaxHasBeenSet = true;
}

bool AllocationSummaryByResource::CostBeforeTaxHasBeenSet() const
{
    return m_costBeforeTaxHasBeenSet;
}

string AllocationSummaryByResource::GetAmountBeforeTax() const
{
    return m_amountBeforeTax;
}

void AllocationSummaryByResource::SetAmountBeforeTax(const string& _amountBeforeTax)
{
    m_amountBeforeTax = _amountBeforeTax;
    m_amountBeforeTaxHasBeenSet = true;
}

bool AllocationSummaryByResource::AmountBeforeTaxHasBeenSet() const
{
