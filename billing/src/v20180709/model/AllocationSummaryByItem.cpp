...
CoreInternalOutcome AllocationSummaryByItem::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("Currency") && !value["Currency"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByItem.Currency` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Tax") && !value["Tax"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByItem.Tax` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TaxRate") && !value["TaxRate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByItem.TaxRate` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("CostBeforeTax") && !value["CostBeforeTax"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByItem.CostBeforeTax` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("AmountBeforeTax") && !value["AmountBeforeTax"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `AllocationSummaryByItem.AmountBeforeTax` IsString=false incorrectly").SetRequestId(requestId));
        }
...
string AllocationSummaryByItem::GetCurrency() const
{
    return m_currency;
}

void AllocationSummaryByItem::SetCurrency(const string& _currency)
{
    m_currency = _currency;
    m_currencyHasBeenSet = true;
}

bool AllocationSummaryByItem::CurrencyHasBeenSet() const
{
    return m_currencyHasBeenSet;
}

string AllocationSummaryByItem::GetTax() const
{
    return m_tax;
}

void AllocationSummaryByItem::SetTax(const string& _tax)
{
    m_tax = _tax;
    m_taxHasBeenSet = true;
}

bool AllocationSummaryByItem::TaxHasBeenSet() const
{
    return m_taxHasBeenSet;
}

string AllocationSummaryByItem::GetTaxRate() const
{
    return m_taxRate;
}

void AllocationSummaryByItem::SetTaxRate(const string& _taxRate)
{
    m_taxRate = _taxRate;
    m_taxRateHasBeenSet = true;
}

bool AllocationSummaryByItem::TaxRateHasBeenSet() const
{
    return m_taxRateHasBeenSet;
}

string AllocationSummaryByItem::GetCostBeforeTax() const
{
    return m_costBeforeTax;
}

void AllocationSummaryByItem::SetCostBeforeTax(const string& _costBeforeTax)
{
    m_costBeforeTax = _costBeforeTax;
    m_costBeforeTaxHasBeenSet = true;
}

bool AllocationSummaryByItem::CostBeforeTaxHasBeenSet() const
{
    return m_costBeforeTaxHasBeenSet;
}

string AllocationSummaryByItem::GetAmountBeforeTax() const
{
    return m_amountBeforeTax;
}

void AllocationSummaryByItem::SetAmountBeforeTax(const string& _amountBeforeTax)
{
    m_amountBeforeTax = _amountBeforeTax;
    m_amountBeforeTaxHasBeenSet = true;
}

bool AllocationSummaryByItem::AmountBeforeTaxHasBeenSet() const
{
