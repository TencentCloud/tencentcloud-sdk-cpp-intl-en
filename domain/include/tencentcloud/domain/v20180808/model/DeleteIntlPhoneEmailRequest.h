...
#ifndef TENCENTCLOUD_DOMAIN_V20180808_MODEL_DELETEINTLPHONEEMAILREQUEST_H_
#define TENCENTCLOUD_DOMAIN_V20180808_MODEL_DELETEINTLPHONEEMAILREQUEST_H_
    ...
    namespace Domain
    {
        namespace V20180808
        {
            namespace Model
            {
                ...
                */
                class DeleteIntlPhoneEmailRequest : public AbstractModel
                {
                public:
                    DeleteIntlPhoneEmailRequest();
                    ~DeleteIntlPhoneEmailRequest() = default;
...
#endif // !TENCENTCLOUD_DOMAIN_V20180808_MODEL_DELETEINTLPHONEEMAILREQUEST_H_
