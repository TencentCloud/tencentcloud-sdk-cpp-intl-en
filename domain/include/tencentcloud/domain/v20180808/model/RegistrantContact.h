...
#ifndef TENCENTCLOUD_DOMAIN_V20180808_MODEL_REGISTRANTCONTACT_H_
#define TENCENTCLOUD_DOMAIN_V20180808_MODEL_REGISTRANTCONTACT_H_
    ...
    namespace Domain
    {
        namespace V20180808
        {
            namespace Model
            {
                ...
                */
                class RegistrantContact : public AbstractModel
                {
                public:
                    RegistrantContact();
                    ~RegistrantContact() = default;
                    ...
                    /**
                     * 获取The mobile number, such as `+86.1360000000`.
                    ...
                    /**
                     * 设置The mobile number, such as `+86.1360000000`.
...
#endif // !TENCENTCLOUD_DOMAIN_V20180808_MODEL_REGISTRANTCONTACT_H_
