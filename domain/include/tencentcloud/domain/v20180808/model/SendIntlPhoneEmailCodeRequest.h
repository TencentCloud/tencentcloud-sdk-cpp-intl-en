...
#ifndef TENCENTCLOUD_DOMAIN_V20180808_MODEL_SENDINTLPHONEEMAILCODEREQUEST_H_
#define TENCENTCLOUD_DOMAIN_V20180808_MODEL_SENDINTLPHONEEMAILCODEREQUEST_H_
    ...
    namespace Domain
    {
        namespace V20180808
        {
            namespace Model
            {
                ...
                */
                class SendIntlPhoneEmailCodeRequest : public AbstractModel
                {
                public:
                    SendIntlPhoneEmailCodeRequest();
                    ~SendIntlPhoneEmailCodeRequest() = default;
...
#endif // !TENCENTCLOUD_DOMAIN_V20180808_MODEL_SENDINTLPHONEEMAILCODEREQUEST_H_
