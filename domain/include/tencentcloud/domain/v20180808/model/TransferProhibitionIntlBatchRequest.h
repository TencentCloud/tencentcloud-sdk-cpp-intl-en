...
#ifndef TENCENTCLOUD_DOMAIN_V20180808_MODEL_TRANSFERPROHIBITIONINTLBATCHREQUEST_H_
#define TENCENTCLOUD_DOMAIN_V20180808_MODEL_TRANSFERPROHIBITIONINTLBATCHREQUEST_H_
    ...
    namespace Domain
    {
        namespace V20180808
        {
            namespace Model
            {
                ...
                */
                class TransferProhibitionIntlBatchRequest : public AbstractModel
                {
                public:
                    TransferProhibitionIntlBatchRequest();
                    ~TransferProhibitionIntlBatchRequest() = default;
...
#endif // !TENCENTCLOUD_DOMAIN_V20180808_MODEL_TRANSFERPROHIBITIONINTLBATCHREQUEST_H_
