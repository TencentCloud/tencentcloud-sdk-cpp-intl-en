...
#ifndef TENCENTCLOUD_DOMAIN_V20180808_MODEL_ADMINCONTACT_H_
#define TENCENTCLOUD_DOMAIN_V20180808_MODEL_ADMINCONTACT_H_
    ...
    namespace Domain
    {
        namespace V20180808
        {
            namespace Model
            {
                ...
                * The admin contact.
                */
                class AdminContact : public AbstractModel
                {
                public:
                    AdminContact();
                    ~AdminContact() = default;
...
#endif // !TENCENTCLOUD_DOMAIN_V20180808_MODEL_ADMINCONTACT_H_
