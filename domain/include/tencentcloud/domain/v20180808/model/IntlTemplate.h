...
#ifndef TENCENTCLOUD_DOMAIN_V20180808_MODEL_INTLTEMPLATE_H_
#define TENCENTCLOUD_DOMAIN_V20180808_MODEL_INTLTEMPLATE_H_
    ...
    namespace Domain
    {
        namespace V20180808
        {
            namespace Model
            {
                ...
                */
                class IntlTemplate : public AbstractModel
                {
                public:
                    IntlTemplate();
                    ~IntlTemplate() = default;
...
#endif // !TENCENTCLOUD_DOMAIN_V20180808_MODEL_INTLTEMPLATE_H_
