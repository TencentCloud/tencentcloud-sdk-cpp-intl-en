...
CoreInternalOutcome CreateIntlTemplateResponse::Deserialize(const string &payload)
{
...
string CreateIntlTemplateResponse::ToJsonString() const
{
...
string CreateIntlTemplateResponse::GetTemplateId() const
{
    return m_templateId;
}

bool CreateIntlTemplateResponse::TemplateIdHasBeenSet() const
{
