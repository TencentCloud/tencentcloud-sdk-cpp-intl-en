...
CoreInternalOutcome RenewIntlDomainBatchResponse::Deserialize(const string &payload)
{
...
string RenewIntlDomainBatchResponse::ToJsonString() const
{
...
int64_t RenewIntlDomainBatchResponse::GetLogId() const
{
    return m_logId;
}

bool RenewIntlDomainBatchResponse::LogIdHasBeenSet() const
{
