...
CoreInternalOutcome ModifyOwnerIntlBatchResponse::Deserialize(const string &payload)
{
...
string ModifyOwnerIntlBatchResponse::ToJsonString() const
{
...
int64_t ModifyOwnerIntlBatchResponse::GetLogId() const
{
    return m_logId;
}

bool ModifyOwnerIntlBatchResponse::LogIdHasBeenSet() const
{
