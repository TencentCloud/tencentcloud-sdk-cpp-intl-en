...
string DescribeIntlBatchDetailStatusRequest::ToJsonString() const
{
...
vector<int64_t> DescribeIntlBatchDetailStatusRequest::GetLogIds() const
{
    return m_logIds;
}

void DescribeIntlBatchDetailStatusRequest::SetLogIds(const vector<int64_t>& _logIds)
{
    m_logIds = _logIds;
    m_logIdsHasBeenSet = true;
}

bool DescribeIntlBatchDetailStatusRequest::LogIdsHasBeenSet() const
{
