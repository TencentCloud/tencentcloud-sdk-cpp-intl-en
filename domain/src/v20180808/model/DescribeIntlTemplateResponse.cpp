...
CoreInternalOutcome DescribeIntlTemplateResponse::Deserialize(const string &payload)
{
...
string DescribeIntlTemplateResponse::ToJsonString() const
{
...
IntlTemplateInfo DescribeIntlTemplateResponse::GetTemplate() const
{
    return m_template;
}

bool DescribeIntlTemplateResponse::TemplateHasBeenSet() const
{
