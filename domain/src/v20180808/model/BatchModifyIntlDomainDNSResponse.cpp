...
CoreInternalOutcome BatchModifyIntlDomainDNSResponse::Deserialize(const string &payload)
{
...
string BatchModifyIntlDomainDNSResponse::ToJsonString() const
{
...
uint64_t BatchModifyIntlDomainDNSResponse::GetLogId() const
{
    return m_logId;
}

bool BatchModifyIntlDomainDNSResponse::LogIdHasBeenSet() const
{
