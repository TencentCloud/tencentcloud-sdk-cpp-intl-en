...
CoreInternalOutcome CreateIntlDomainBatchResponse::Deserialize(const string &payload)
{
...
string CreateIntlDomainBatchResponse::ToJsonString() const
{
...
int64_t CreateIntlDomainBatchResponse::GetLogId() const
{
    return m_logId;
}

bool CreateIntlDomainBatchResponse::LogIdHasBeenSet() const
{
