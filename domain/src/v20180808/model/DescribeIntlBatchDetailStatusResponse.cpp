...
CoreInternalOutcome DescribeIntlBatchDetailStatusResponse::Deserialize(const string &payload)
{
...
string DescribeIntlBatchDetailStatusResponse::ToJsonString() const
{
...
vector<IntlBatchDetails> DescribeIntlBatchDetailStatusResponse::GetDetails() const
{
    return m_details;
}

bool DescribeIntlBatchDetailStatusResponse::DetailsHasBeenSet() const
{
