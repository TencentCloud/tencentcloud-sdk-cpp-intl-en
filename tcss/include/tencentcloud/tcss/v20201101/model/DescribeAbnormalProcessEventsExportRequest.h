...
#ifndef TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEABNORMALPROCESSEVENTSEXPORTREQUEST_H_
#define TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEABNORMALPROCESSEVENTSEXPORTREQUEST_H_
    ...
    namespace Tcss
    {
        namespace V20201101
        {
            namespace Model
            {
                ...
                */
                class DescribeAbnormalProcessEventsExportRequest : public AbstractModel
                {
                public:
                    DescribeAbnormalProcessEventsExportRequest();
                    ~DescribeAbnormalProcessEventsExportRequest() = default;
...
#endif // !TENCENTCLOUD_TCSS_V20201101_MODEL_DESCRIBEABNORMALPROCESSEVENTSEXPORTREQUEST_H_
