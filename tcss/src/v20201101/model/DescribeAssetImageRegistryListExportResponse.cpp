...
CoreInternalOutcome DescribeAssetImageRegistryListExportResponse::Deserialize(const string &payload)
{
...
string DescribeAssetImageRegistryListExportResponse::ToJsonString() const
{
...
string DescribeAssetImageRegistryListExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAssetImageRegistryListExportResponse::DownloadUrlHasBeenSet() const
{
