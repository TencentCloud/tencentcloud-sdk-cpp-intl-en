...
CoreInternalOutcome DescribeAssetImageRegistryVulListExportResponse::Deserialize(const string &payload)
{
...
string DescribeAssetImageRegistryVulListExportResponse::ToJsonString() const
{
...
string DescribeAssetImageRegistryVulListExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAssetImageRegistryVulListExportResponse::DownloadUrlHasBeenSet() const
{
