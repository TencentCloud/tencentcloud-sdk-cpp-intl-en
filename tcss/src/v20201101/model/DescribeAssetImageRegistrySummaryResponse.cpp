...
CoreInternalOutcome DescribeAssetImageRegistrySummaryResponse::Deserialize(const string &payload)
{
...
string DescribeAssetImageRegistrySummaryResponse::ToJsonString() const
{
