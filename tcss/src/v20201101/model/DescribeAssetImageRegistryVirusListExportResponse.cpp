...
CoreInternalOutcome DescribeAssetImageRegistryVirusListExportResponse::Deserialize(const string &payload)
{
...
string DescribeAssetImageRegistryVirusListExportResponse::ToJsonString() const
{
...
string DescribeAssetImageRegistryVirusListExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAssetImageRegistryVirusListExportResponse::DownloadUrlHasBeenSet() const
{
