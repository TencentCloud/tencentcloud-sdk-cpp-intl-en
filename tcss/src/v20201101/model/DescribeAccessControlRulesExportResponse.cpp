...
CoreInternalOutcome DescribeAccessControlRulesExportResponse::Deserialize(const string &payload)
{
...
string DescribeAccessControlRulesExportResponse::ToJsonString() const
{
...
string DescribeAccessControlRulesExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAccessControlRulesExportResponse::DownloadUrlHasBeenSet() const
{
