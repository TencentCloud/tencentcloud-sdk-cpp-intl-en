...
CoreInternalOutcome DescribeEscapeEventsExportResponse::Deserialize(const string &payload)
{
...
string DescribeEscapeEventsExportResponse::ToJsonString() const
{
...
string DescribeEscapeEventsExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeEscapeEventsExportResponse::DownloadUrlHasBeenSet() const
{
