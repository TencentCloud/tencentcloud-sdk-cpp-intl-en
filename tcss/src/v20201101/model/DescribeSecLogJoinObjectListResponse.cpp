...
CoreInternalOutcome DescribeSecLogJoinObjectListResponse::Deserialize(const string &payload)
{
...
string DescribeSecLogJoinObjectListResponse::ToJsonString() const
{
...
uint64_t DescribeSecLogJoinObjectListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeSecLogJoinObjectListResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<SecLogJoinObjectInfo> DescribeSecLogJoinObjectListResponse::GetList() const
{
    return m_list;
}
