...
CoreInternalOutcome DescribeAssetImageListExportResponse::Deserialize(const string &payload)
{
...
string DescribeAssetImageListExportResponse::ToJsonString() const
{
...
string DescribeAssetImageListExportResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeAssetImageListExportResponse::DownloadUrlHasBeenSet() const
{
