            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Whether all logs meeting the retrieval criteria have been returned. If not, use Context parameter to retrieve more logs.<br>  <br>Note: This is only valid when the search and analysis statement (Query) does not contain SQL.</p>
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取<p>Log statistics and analysis results<br>This parameter is valid only when UseNewAnalysis is false.</p>
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取<p>Column attribute of the statistical analysis result<br>This parameter is valid only when UseNewAnalysis is true.</p>
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取<p>Sampling rate used for this statistical analysis</p>
Note: This field may return null, indicating that no valid values can be obtained.
