...
CoreInternalOutcome DescribeBlockIgnoreListResponse::Deserialize(const string &payload)
{
...
string DescribeBlockIgnoreListResponse::ToJsonString() const
{
...
vector<BlockIgnoreRule> DescribeBlockIgnoreListResponse::GetData() const
{
    return m_data;
}

bool DescribeBlockIgnoreListResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeBlockIgnoreListResponse::GetTotal() const
{
    return m_total;
}

bool DescribeBlockIgnoreListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

int64_t DescribeBlockIgnoreListResponse::GetReturnCode() const
{
    return m_returnCode;
}

bool DescribeBlockIgnoreListResponse::ReturnCodeHasBeenSet() const
{
    return m_returnCodeHasBeenSet;
}

string DescribeBlockIgnoreListResponse::GetReturnMsg() const
{
    return m_returnMsg;
}
