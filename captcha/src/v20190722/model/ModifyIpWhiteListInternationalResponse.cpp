...
CoreInternalOutcome ModifyIpWhiteListInternationalResponse::Deserialize(const string &payload)
{
...
string ModifyIpWhiteListInternationalResponse::ToJsonString() const
{
...
int64_t ModifyIpWhiteListInternationalResponse::GetData() const
{
    return m_data;
}

bool ModifyIpWhiteListInternationalResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t ModifyIpWhiteListInternationalResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool ModifyIpWhiteListInternationalResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string ModifyIpWhiteListInternationalResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool ModifyIpWhiteListInternationalResponse::CaptchaMsgHasBeenSet() const
{
