...
CoreInternalOutcome CreateCaptchaInfoInternationalResponse::Deserialize(const string &payload)
{
...
string CreateCaptchaInfoInternationalResponse::ToJsonString() const
{
...
int64_t CreateCaptchaInfoInternationalResponse::GetData() const
{
    return m_data;
}

bool CreateCaptchaInfoInternationalResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t CreateCaptchaInfoInternationalResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool CreateCaptchaInfoInternationalResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string CreateCaptchaInfoInternationalResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool CreateCaptchaInfoInternationalResponse::CaptchaMsgHasBeenSet() const
{
