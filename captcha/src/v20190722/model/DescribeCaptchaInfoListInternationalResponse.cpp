...
CoreInternalOutcome DescribeCaptchaInfoListInternationalResponse::Deserialize(const string &payload)
{
...
string DescribeCaptchaInfoListInternationalResponse::ToJsonString() const
{
...
DescribeCaptchaConsoleDataInternational DescribeCaptchaInfoListInternationalResponse::GetData() const
{
    return m_data;
}

bool DescribeCaptchaInfoListInternationalResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeCaptchaInfoListInternationalResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool DescribeCaptchaInfoListInternationalResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string DescribeCaptchaInfoListInternationalResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool DescribeCaptchaInfoListInternationalResponse::CaptchaMsgHasBeenSet() const
{
