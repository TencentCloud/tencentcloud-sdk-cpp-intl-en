...
CoreInternalOutcome DeleteIpWhiteListInternationalResponse::Deserialize(const string &payload)
{
...
string DeleteIpWhiteListInternationalResponse::ToJsonString() const
{
...
int64_t DeleteIpWhiteListInternationalResponse::GetData() const
{
    return m_data;
}

bool DeleteIpWhiteListInternationalResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DeleteIpWhiteListInternationalResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool DeleteIpWhiteListInternationalResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string DeleteIpWhiteListInternationalResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool DeleteIpWhiteListInternationalResponse::CaptchaMsgHasBeenSet() const
{
