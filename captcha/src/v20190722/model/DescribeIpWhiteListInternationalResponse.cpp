...
CoreInternalOutcome DescribeIpWhiteListInternationalResponse::Deserialize(const string &payload)
{
...
string DescribeIpWhiteListInternationalResponse::ToJsonString() const
{
...
DescribeCaptchaIpWhiteListDataNew DescribeIpWhiteListInternationalResponse::GetData() const
{
    return m_data;
}

bool DescribeIpWhiteListInternationalResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeIpWhiteListInternationalResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool DescribeIpWhiteListInternationalResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string DescribeIpWhiteListInternationalResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool DescribeIpWhiteListInternationalResponse::CaptchaMsgHasBeenSet() const
{
