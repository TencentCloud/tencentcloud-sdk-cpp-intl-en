...
CoreInternalOutcome ModifyCaptchaInfoInternationalResponse::Deserialize(const string &payload)
{
...
string ModifyCaptchaInfoInternationalResponse::ToJsonString() const
{
...
int64_t ModifyCaptchaInfoInternationalResponse::GetData() const
{
    return m_data;
}

bool ModifyCaptchaInfoInternationalResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t ModifyCaptchaInfoInternationalResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool ModifyCaptchaInfoInternationalResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string ModifyCaptchaInfoInternationalResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool ModifyCaptchaInfoInternationalResponse::CaptchaMsgHasBeenSet() const
{
