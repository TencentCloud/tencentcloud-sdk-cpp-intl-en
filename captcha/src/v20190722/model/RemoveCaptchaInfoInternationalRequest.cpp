...
string RemoveCaptchaInfoInternationalRequest::ToJsonString() const
{
...
string RemoveCaptchaInfoInternationalRequest::GetCaptchaAppId() const
{
    return m_captchaAppId;
}

void RemoveCaptchaInfoInternationalRequest::SetCaptchaAppId(const string& _captchaAppId)
{
    m_captchaAppId = _captchaAppId;
    m_captchaAppIdHasBeenSet = true;
}

bool RemoveCaptchaInfoInternationalRequest::CaptchaAppIdHasBeenSet() const
{
