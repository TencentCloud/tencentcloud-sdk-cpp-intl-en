...
CoreInternalOutcome RemoveCaptchaInfoInternationalResponse::Deserialize(const string &payload)
{
...
string RemoveCaptchaInfoInternationalResponse::ToJsonString() const
{
...
int64_t RemoveCaptchaInfoInternationalResponse::GetData() const
{
    return m_data;
}

bool RemoveCaptchaInfoInternationalResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t RemoveCaptchaInfoInternationalResponse::GetCaptchaCode() const
{
    return m_captchaCode;
}

bool RemoveCaptchaInfoInternationalResponse::CaptchaCodeHasBeenSet() const
{
    return m_captchaCodeHasBeenSet;
}

string RemoveCaptchaInfoInternationalResponse::GetCaptchaMsg() const
{
    return m_captchaMsg;
}

bool RemoveCaptchaInfoInternationalResponse::CaptchaMsgHasBeenSet() const
{
