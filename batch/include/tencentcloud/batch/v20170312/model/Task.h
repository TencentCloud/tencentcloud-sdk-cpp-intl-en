            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Job name, which should be unique within instance
                     * @return TaskName Job name, which should be unique within instance
                     */
                    std::string GetTaskName() const;

                    /**
                     * 设置Job name, which should be unique within instance
                    ...
                    /**
                     * 获取The maximum number of retries after the task fails. Default value: 0
                     * @return MaxRetryCount The maximum number of retries after the task fails. Default value: 0
                     */
                    uint64_t GetMaxRetryCount() const;

                    /**
                     * 设置The maximum number of retries after the task fails. Default value: 0
                    ...
                    /**
                     * 获取Timeout period in seconds after the task starts. Defaults value: 86,400
                     * @return Timeout Timeout period in seconds after the task starts. Defaults value: 86,400
                     */
                    uint64_t GetTimeout() const;

                    /**
                     * 设置Timeout period in seconds after the task starts. Defaults value: 86,400
                    ...
                    /**
                     * 获取The maximum number of concurrent tasks. There is no limit by default.
                    ...
                    /**
                     * 设置The maximum number of concurrent tasks. There is no limit by default.
                    ...
                    /**
                     * 获取Maximum number of retry attempts after failing to create computing resources such as the CVM in the task launch process. Default value: 0.
                    ...
                    /**
                     * 设置Maximum number of retry attempts after failing to create computing resources such as the CVM in the task launch process. Default value: 0.
