            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Tag list. By setting this parameter, you can bind tags to a job. Each job supports up to 10 tags.
                     * @return Tags Tag list. By setting this parameter, you can bind tags to a job. Each job supports up to 10 tags.
                     */
                    std::vector<Tag> GetTags() const;

                    /**
                     * 设置Tag list. By setting this parameter, you can bind tags to a job. Each job supports up to 10 tags.
