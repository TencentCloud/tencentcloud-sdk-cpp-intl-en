            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取API type. Valid values: NORMAL (general API), TSF (microservice API). Default value: NORMAL.
                    ...
                    /**
                     * 设置API type. Valid values: NORMAL (general API), TSF (microservice API). Default value: NORMAL.
                    ...
                    /**
                     * 获取`target` type backend resource information (in beta test).
                    ...
                    /**
                     * 设置`target` type backend resource information (in beta test).
                    ...
                    /**
                     * 获取TSF Serverless namespace ID (in beta test).
                    ...
                    /**
                     * 设置TSF Serverless namespace ID (in beta test).
