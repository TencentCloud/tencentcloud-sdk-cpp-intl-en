...
CoreInternalOutcome DescribePrometheusConfigResponse::Deserialize(const string &payload)
{
...
string DescribePrometheusConfigResponse::ToJsonString() const
{
...
vector<PrometheusConfigItem> DescribePrometheusConfigResponse::GetProbes() const
{
    return m_probes;
}
