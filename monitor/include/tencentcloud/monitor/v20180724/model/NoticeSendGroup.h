            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Send group type</p><p>Enumeration value:</p><ul><li>USER: User</li><li>GROUP: User group</li><li>OnCallForm: Duty schedule</li></ul>
                    ...
                    /**
                     * 设置<p>Send group type</p><p>Enumeration value:</p><ul><li>USER: User</li><li>GROUP: User group</li><li>OnCallForm: Duty schedule</li></ul>
                     * @param _receiverType <p>Send group type</p><p>Enumeration value:</p><ul><li>USER: User</li><li>GROUP: User group</li><li>OnCallForm: Duty schedule</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 设置<p>Notifier info</p>
                     * @param _users <p>Notifier info</p>
                     * 
                     */
