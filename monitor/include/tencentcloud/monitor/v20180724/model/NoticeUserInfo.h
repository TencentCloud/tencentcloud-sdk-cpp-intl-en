            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Tencent Cloud user id, <strong>not account uin</strong></p>
                    ...
                    /**
                     * 设置<p>Tencent Cloud user id, <strong>not account uin</strong></p>
                     * @param _userId <p>Tencent Cloud user id, <strong>not account uin</strong></p>
                     * 
                     */
