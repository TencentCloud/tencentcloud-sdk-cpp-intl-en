...
#ifndef TENCENTCLOUD_MONITOR_V20180724_MODEL_DESCRIBEPROMETHEUSRECORDRULEYAMLREQUEST_H_
#define TENCENTCLOUD_MONITOR_V20180724_MODEL_DESCRIBEPROMETHEUSRECORDRULEYAMLREQUEST_H_
    ...
    namespace Monitor
    {
        namespace V20180724
        {
            namespace Model
            {
                ...
                */
                class DescribePrometheusRecordRuleYamlRequest : public AbstractModel
                {
                public:
                    DescribePrometheusRecordRuleYamlRequest();
                    ~DescribePrometheusRecordRuleYamlRequest() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20180724_MODEL_DESCRIBEPROMETHEUSRECORDRULEYAMLREQUEST_H_
