...
#ifndef TENCENTCLOUD_MONITOR_V20230616_MODEL_LISTAIWORKBENCHSESSIONSRESPONSE_H_
#define TENCENTCLOUD_MONITOR_V20230616_MODEL_LISTAIWORKBENCHSESSIONSRESPONSE_H_
    ...
    namespace Monitor
    {
        namespace V20230616
        {
            namespace Model
            {
                ...
                */
                class ListAIWorkbenchSessionsResponse : public AbstractModel
                {
                public:
                    ListAIWorkbenchSessionsResponse();
                    ~ListAIWorkbenchSessionsResponse() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20230616_MODEL_LISTAIWORKBENCHSESSIONSRESPONSE_H_
