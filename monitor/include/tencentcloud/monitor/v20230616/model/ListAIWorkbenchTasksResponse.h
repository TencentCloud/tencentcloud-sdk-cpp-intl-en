...
#ifndef TENCENTCLOUD_MONITOR_V20230616_MODEL_LISTAIWORKBENCHTASKSRESPONSE_H_
#define TENCENTCLOUD_MONITOR_V20230616_MODEL_LISTAIWORKBENCHTASKSRESPONSE_H_
    ...
    namespace Monitor
    {
        namespace V20230616
        {
            namespace Model
            {
                ...
                */
                class ListAIWorkbenchTasksResponse : public AbstractModel
                {
                public:
                    ListAIWorkbenchTasksResponse();
                    ~ListAIWorkbenchTasksResponse() = default;
...
#endif // !TENCENTCLOUD_MONITOR_V20230616_MODEL_LISTAIWORKBENCHTASKSRESPONSE_H_
