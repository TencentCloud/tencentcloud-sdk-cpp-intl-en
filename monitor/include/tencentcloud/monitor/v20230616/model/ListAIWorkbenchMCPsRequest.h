            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Filter by transmission protocol</p>
                    ...
                    /**
                     * 设置<p>Filter by transmission protocol</p>
                    ...
                    /**
                     * 获取<p>MCP type (built-in/private)</p><p>Enumeration values:</p><ul><li>builtin: platform built-in</li><li>private: user-customized</li></ul>
                    ...
                    /**
                     * 设置<p>MCP type (built-in/private)</p><p>Enumeration values:</p><ul><li>builtin: platform built-in</li><li>private: user-customized</li></ul>
