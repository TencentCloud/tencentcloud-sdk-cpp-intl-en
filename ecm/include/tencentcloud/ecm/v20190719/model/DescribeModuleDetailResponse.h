            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Module details. For more information, see `ModuleInfo` in the data structure.
...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Module statistics. For more information, see `ModuleCounterInfo` in the data structure.
Note: this field may return null, indicating that no valid values can be obtained.
