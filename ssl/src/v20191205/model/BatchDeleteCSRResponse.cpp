...
CoreInternalOutcome BatchDeleteCSRResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Success") && !rsp["Success"].IsNull())
    {
        ...
        {
            m_success.push_back((*itr).GetInt64());
        }
...
string BatchDeleteCSRResponse::ToJsonString() const
{
...
vector<int64_t> BatchDeleteCSRResponse::GetSuccess() const
{
    return m_success;
}

bool BatchDeleteCSRResponse::SuccessHasBeenSet() const
{
