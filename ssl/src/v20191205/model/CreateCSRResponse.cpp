...
CoreInternalOutcome CreateCSRResponse::Deserialize(const string &payload)
{
...
string CreateCSRResponse::ToJsonString() const
{
...
int64_t CreateCSRResponse::GetId() const
{
    return m_id;
}

bool CreateCSRResponse::IdHasBeenSet() const
{
