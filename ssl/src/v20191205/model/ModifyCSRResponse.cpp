...
CoreInternalOutcome ModifyCSRResponse::Deserialize(const string &payload)
{
...
string ModifyCSRResponse::ToJsonString() const
{
...
int64_t ModifyCSRResponse::GetId() const
{
    return m_id;
}

bool ModifyCSRResponse::IdHasBeenSet() const
{
