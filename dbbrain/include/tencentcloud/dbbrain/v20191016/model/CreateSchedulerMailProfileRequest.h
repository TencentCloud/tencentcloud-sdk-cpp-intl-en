            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Configuration name, which needs to be unique. For scheduled task reports, the name should be in the format of "scheduler_" + {instanceId}, such as "schduler_cdb-test".
                    ...
                    /**
                     * 设置Configuration name, which needs to be unique. For scheduled task reports, the name should be in the format of "scheduler_" + {instanceId}, such as "schduler_cdb-test".
                    ...
                    /**
                     * 获取Configure the instance ID that you need to generate the health report.
                    ...
                    /**
                     * 设置Configure the instance ID that you need to generate the health report.
