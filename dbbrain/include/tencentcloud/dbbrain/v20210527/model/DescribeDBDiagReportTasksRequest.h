            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Array of instance IDs, which is used to filter the task list of a specified instance.
                     * @return InstanceIds Array of instance IDs, which is used to filter the task list of a specified instance.
                     */
                    std::vector<std::string> GetInstanceIds() const;

                    /**
                     * 设置Array of instance IDs, which is used to filter the task list of a specified instance.
