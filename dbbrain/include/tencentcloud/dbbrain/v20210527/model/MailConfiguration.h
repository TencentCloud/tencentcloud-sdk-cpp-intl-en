            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Contact ID. Either `ContactPerson` or `ContactGroup` should be passed in.
                    ...
                    /**
                     * 设置Contact ID. Either `ContactPerson` or `ContactGroup` should be passed in.
                    ...
                    /**
                     * 获取Contact group ID. Either `ContactPerson` or `ContactGroup` should be passed in.
                    ...
                    /**
                     * 设置Contact group ID. Either `ContactPerson` or `ContactGroup` should be passed in.
