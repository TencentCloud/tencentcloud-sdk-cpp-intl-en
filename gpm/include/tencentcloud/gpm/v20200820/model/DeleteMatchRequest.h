...
#ifndef TENCENTCLOUD_GPM_V20200820_MODEL_DELETEMATCHREQUEST_H_
#define TENCENTCLOUD_GPM_V20200820_MODEL_DELETEMATCHREQUEST_H_
    ...
    namespace Gpm
    {
        namespace V20200820
        {
            namespace Model
            {
                ...
                */
                class DeleteMatchRequest : public AbstractModel
                {
                public:
                    DeleteMatchRequest();
                    ~DeleteMatchRequest() = default;
...
#endif // !TENCENTCLOUD_GPM_V20200820_MODEL_DELETEMATCHREQUEST_H_
