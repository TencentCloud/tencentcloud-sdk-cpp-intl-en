...
#ifndef TENCENTCLOUD_GPM_V20200820_MODEL_DESCRIBEMATCHREQUEST_H_
#define TENCENTCLOUD_GPM_V20200820_MODEL_DESCRIBEMATCHREQUEST_H_
    ...
    namespace Gpm
    {
        namespace V20200820
        {
            namespace Model
            {
                ...
                */
                class DescribeMatchRequest : public AbstractModel
                {
                public:
                    DescribeMatchRequest();
                    ~DescribeMatchRequest() = default;
...
#endif // !TENCENTCLOUD_GPM_V20200820_MODEL_DESCRIBEMATCHREQUEST_H_
