...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEKOREANIDCARDOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEKOREANIDCARDOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizeKoreanIDCardOCRRequest : public AbstractModel
                {
                public:
                    RecognizeKoreanIDCardOCRRequest();
                    ~RecognizeKoreanIDCardOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEKOREANIDCARDOCRREQUEST_H_
