...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEPHILIPPINESTINIDOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEPHILIPPINESTINIDOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizePhilippinesTinIDOCRRequest : public AbstractModel
                {
                public:
                    RecognizePhilippinesTinIDOCRRequest();
                    ~RecognizePhilippinesTinIDOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEPHILIPPINESTINIDOCRREQUEST_H_
