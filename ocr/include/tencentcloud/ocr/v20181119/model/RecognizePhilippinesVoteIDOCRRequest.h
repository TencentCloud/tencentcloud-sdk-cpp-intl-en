...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEPHILIPPINESVOTEIDOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEPHILIPPINESVOTEIDOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizePhilippinesVoteIDOCRRequest : public AbstractModel
                {
                public:
                    RecognizePhilippinesVoteIDOCRRequest();
                    ~RecognizePhilippinesVoteIDOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEPHILIPPINESVOTEIDOCRREQUEST_H_
