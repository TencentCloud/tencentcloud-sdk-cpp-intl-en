...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEBRAZILIDCARDOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEBRAZILIDCARDOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizeBrazilIDCardOCRRequest : public AbstractModel
                {
                public:
                    RecognizeBrazilIDCardOCRRequest();
                    ~RecognizeBrazilIDCardOCRRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取Base64 value of the image. Supported image formats: PNG, JPG, JPEG, GIF format is not supported yet. Supported image size: The downloaded image does not exceed 7M after Base64 encoding. Image download time does not exceed 3 seconds.
                    ...
                    /**
                     * 设置Base64 value of the image. Supported image formats: PNG, JPG, JPEG, GIF format is not supported yet. Supported image size: The downloaded image does not exceed 7M after Base64 encoding. Image download time does not exceed 3 seconds.
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEBRAZILIDCARDOCRREQUEST_H_
