        ...
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                ...
                public:
                    ImageCoordinates();
                    ~ImageCoordinates() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取<p>Top-left horizontal coordinate of the avatar</p>
                    ...
                    /**
                     * 设置<p>Top-left horizontal coordinate of the avatar</p>
                    ...
                    /**
                     * 获取<p>Top-left vertical coordinate of the avatar</p>
                    ...
                    /**
                     * 设置<p>Top-left vertical coordinate of the avatar</p>
                    ...
                    /**
                     * 获取<p>Avatar frame width.</p><p>Unit: px.</p>
                    ...
                    /**
                     * 设置<p>Avatar frame width.</p><p>Unit: px.</p>
                    ...
                    /**
                     * 获取<p>Avatar frame height.</p><p>Unit: px.</p>
                    ...
                    /**
                     * 设置<p>Avatar frame height.</p><p>Unit: px.</p>
