...
#ifndef TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEBRAZILRNEOCRREQUEST_H_
#define TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEBRAZILRNEOCRREQUEST_H_
    ...
    namespace Ocr
    {
        namespace V20181119
        {
            namespace Model
            {
                ...
                */
                class RecognizeBrazilRNEOCRRequest : public AbstractModel
                {
                public:
                    RecognizeBrazilRNEOCRRequest();
                    ~RecognizeBrazilRNEOCRRequest() = default;
...
#endif // !TENCENTCLOUD_OCR_V20181119_MODEL_RECOGNIZEBRAZILRNEOCRREQUEST_H_
