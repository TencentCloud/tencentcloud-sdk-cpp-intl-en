...
CoreInternalOutcome GetCardVerificationExternalResultResponse::Deserialize(const string &payload)
{
...
string GetCardVerificationExternalResultResponse::ToJsonString() const
{
...
string GetCardVerificationExternalResultResponse::GetStatus() const
{
    return m_status;
}

bool GetCardVerificationExternalResultResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

vector<string> GetCardVerificationExternalResultResponse::GetWarnInfo() const
{
    return m_warnInfo;
}

bool GetCardVerificationExternalResultResponse::WarnInfoHasBeenSet() const
{
    return m_warnInfoHasBeenSet;
}

string GetCardVerificationExternalResultResponse::GetNationality() const
{
    return m_nationality;
}

bool GetCardVerificationExternalResultResponse::NationalityHasBeenSet() const
{
    return m_nationalityHasBeenSet;
}

GeneralCard GetCardVerificationExternalResultResponse::GetCardInfo() const
{
    return m_cardInfo;
}
