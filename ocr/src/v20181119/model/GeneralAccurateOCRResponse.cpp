...
CoreInternalOutcome GeneralAccurateOCRResponse::Deserialize(const string &payload)
{
...
string GeneralAccurateOCRResponse::ToJsonString() const
{
...
vector<TextDetection> GeneralAccurateOCRResponse::GetTextDetections() const
{
    return m_textDetections;
}

bool GeneralAccurateOCRResponse::TextDetectionsHasBeenSet() const
{
    return m_textDetectionsHasBeenSet;
}

double GeneralAccurateOCRResponse::GetAngel() const
{
    return m_angel;
}
