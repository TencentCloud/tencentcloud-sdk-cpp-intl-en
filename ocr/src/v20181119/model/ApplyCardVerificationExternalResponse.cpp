...
CoreInternalOutcome ApplyCardVerificationExternalResponse::Deserialize(const string &payload)
{
...
string ApplyCardVerificationExternalResponse::ToJsonString() const
{
...
string ApplyCardVerificationExternalResponse::GetCardVerificationToken() const
{
    return m_cardVerificationToken;
}

bool ApplyCardVerificationExternalResponse::CardVerificationTokenHasBeenSet() const
{
