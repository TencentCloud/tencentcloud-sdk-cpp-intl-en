...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_CREATEHOSTMETRICCONFIGREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_CREATEHOSTMETRICCONFIGREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class CreateHostMetricConfigRequest : public AbstractModel
                {
                public:
                    CreateHostMetricConfigRequest();
                    ~CreateHostMetricConfigRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_CREATEHOSTMETRICCONFIGREQUEST_H_
