...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEASYNCSEARCHTASKSREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEASYNCSEARCHTASKSREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DescribeAsyncSearchTasksRequest : public AbstractModel
                {
                public:
                    DescribeAsyncSearchTasksRequest();
                    ~DescribeAsyncSearchTasksRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEASYNCSEARCHTASKSREQUEST_H_
