...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEESRECHARGESREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEESRECHARGESREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DescribeEsRechargesRequest : public AbstractModel
                {
                public:
                    DescribeEsRechargesRequest();
                    ~DescribeEsRechargesRequest() = default;
...
- Obtain the log topic Id through [Create Log Topic](https://www.tencentcloud.com/document/product/614/56456?from_cn_redirect=1).
                    ...
                    /**
                     * 获取-taskId is filtered by [configuration id]. Type: String. Required: No.
...
-Each request can have up to 10 Filters. The upper limit of Filter.Values is 100.
                    ...
                    /**
                     * 设置-taskId is filtered by [configuration id]. Type: String. Required: No.
-Name is filtered by [configuration name]. Type: String. Required: No.
- statusFlag: Filter by [Configuration Status Marking]. Type: String. Optional: No
-Each request can have up to 10 Filters. The upper limit of Filter.Values is 100.
                     * @param _filters -taskId is filtered by [configuration id]. Type: String. Required: No.
-Name is filtered by [configuration name]. Type: String. Required: No.
- statusFlag: Filter by [Configuration Status Marking]. Type: String. Optional: No
-Each request can have up to 10 Filters. The upper limit of Filter.Values is 100.
                     * 
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEESRECHARGESREQUEST_H_
