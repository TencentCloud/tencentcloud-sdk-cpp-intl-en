            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>DataSight Console ConsoleId</p>
                    ...
                    /**
                     * 设置<p>DataSight Console ConsoleId</p>
                     * @param _consoleId <p>DataSight Console ConsoleId</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Login methods</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul>
                    ...
                    /**
                     * 设置<p>Login methods</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul>
                     * @param _loginMode <p>Login methods</p><p>Enumeration value:</p><ul><li>0: Account password authentication</li><li>1: Anonymous login</li><li>2: Third-party authentication login</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>User account information</p><p>"Account password authentication" is required for login methods.</p>
                    ...
                    /**
                     * 设置<p>User account information</p><p>"Account password authentication" is required for login methods.</p>
                     * @param _accounts <p>User account information</p><p>"Account password authentication" is required for login methods.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Anonymous login account information</p><p>"Anonymous login" is required for the login method.</p>
                    ...
                    /**
                     * 设置<p>Anonymous login account information</p><p>"Anonymous login" is required for the login method.</p>
                     * @param _anonymousLogin <p>Anonymous login account information</p><p>"Anonymous login" is required for the login method.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Auth user role information</p><p>"Third-party authentication login" is required for the login method.</p>
                    ...
                    /**
                     * 设置<p>Auth user role information</p><p>"Third-party authentication login" is required for the login method.</p>
                     * @param _authRoles <p>Auth user role information</p><p>"Third-party authentication login" is required for the login method.</p>
                     * 
                     */
                    ...
                    /**
                     * 设置<p>Custom display menu</p>
                     * @param _menus <p>Custom display menu</p>
                     * 
                     */
