            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Offset of the query start time from the current time. The value cannot be positive. Value range: -1440–0.
                    ...
                    /**
                     * 设置Offset of the query start time from the current time. The value cannot be positive. Value range: -1440–0.
                    ...
                    /**
                     * 获取Offset of the query end time from the current time. The value cannot be positive and must be greater than `StartTimeOffset`. Value range: -1440–0.
                    ...
                    /**
                     * 设置Offset of the query end time from the current time. The value cannot be positive and must be greater than `StartTimeOffset`. Value range: -1440–0.
