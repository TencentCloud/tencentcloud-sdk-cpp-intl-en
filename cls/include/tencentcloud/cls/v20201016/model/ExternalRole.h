            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Cross-account delivery - User role RoleArn</p>
                    ...
                    /**
                     * 设置<p>Cross-account delivery - User role RoleArn</p>
                     * @param _roleArn <p>Cross-account delivery - User role RoleArn</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Cross-account delivery - User role name</p>
                    ...
                    /**
                     * 设置<p>Cross-account delivery - User role name</p>
                     * @param _externalId <p>Cross-account delivery - User role name</p>
                     * 
                     */
