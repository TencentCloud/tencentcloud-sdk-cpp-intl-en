...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEHOSTMETRICCONFIGSREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEHOSTMETRICCONFIGSREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DescribeHostMetricConfigsRequest : public AbstractModel
                {
                public:
                    DescribeHostMetricConfigsRequest();
                    ~DescribeHostMetricConfigsRequest() = default;
...
- Obtain the log topic Id through [Create Log Topic](https://www.tencentcloud.com/document/product/614/56456?from_cn_redirect=1). Note that BizType 0: log topic (default value), 1: metric topic.
                    ...
                    /**
                     * 获取-configId - String - required: no - filter by [configId].
...
Each request can have up to 10 Filters. The upper limit of Filter.Values is 10.
                    ...
                    /**
                     * 设置-configId - String - required: no - filter by [configId].
-Filter the name by [configuration name]. Type: String. Required: No.

Each request can have up to 10 Filters. The upper limit of Filter.Values is 10.
                     * @param _filters -configId - String - required: no - filter by [configId].
-Filter the name by [configuration name]. Type: String. Required: No.
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEHOSTMETRICCONFIGSREQUEST_H_
