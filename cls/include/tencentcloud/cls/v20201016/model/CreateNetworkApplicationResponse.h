...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_CREATENETWORKAPPLICATIONRESPONSE_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_CREATENETWORKAPPLICATIONRESPONSE_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class CreateNetworkApplicationResponse : public AbstractModel
                {
                public:
                    CreateNetworkApplicationResponse();
                    ~CreateNetworkApplicationResponse() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_CREATENETWORKAPPLICATIONRESPONSE_H_
