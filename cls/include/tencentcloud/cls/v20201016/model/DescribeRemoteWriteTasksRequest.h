...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEREMOTEWRITETASKSREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEREMOTEWRITETASKSREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DescribeRemoteWriteTasksRequest : public AbstractModel
                {
                public:
                    DescribeRemoteWriteTasksRequest();
                    ~DescribeRemoteWriteTasksRequest() = default;
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEREMOTEWRITETASKSREQUEST_H_
