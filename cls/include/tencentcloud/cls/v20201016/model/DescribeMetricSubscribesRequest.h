...
#ifndef TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEMETRICSUBSCRIBESREQUEST_H_
#define TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEMETRICSUBSCRIBESREQUEST_H_
    ...
    namespace Cls
    {
        namespace V20201016
        {
            namespace Model
            {
                ...
                */
                class DescribeMetricSubscribesRequest : public AbstractModel
                {
                public:
                    DescribeMetricSubscribesRequest();
                    ~DescribeMetricSubscribesRequest() = default;
                    ...
                    /**
                     * 获取<br><li> Filter taskId by [configuration id]. Type: String. Required: No</li>
...
<br><li>Each request can have up to 10 Filters. The maximum number of Filter.Values is 100.</li>
                    ...
                    /**
                     * 设置<br><li> Filter taskId by [configuration id]. Type: String. Required: No</li>
<br><li> Name is filtered by [configuration name]. Type: String Required: No</li>
<br><li> Filter status by [configuration status tag]. Type: String Required: No</li>
<br><li>Each request can have up to 10 Filters. The maximum number of Filter.Values is 100.</li>
                     * @param _filters <br><li> Filter taskId by [configuration id]. Type: String. Required: No</li>
<br><li> Name is filtered by [configuration name]. Type: String Required: No</li>
<br><li> Filter status by [configuration status tag]. Type: String Required: No</li>
<br><li>Each request can have up to 10 Filters. The maximum number of Filter.Values is 100.</li>
                     * 
...
#endif // !TENCENTCLOUD_CLS_V20201016_MODEL_DESCRIBEMETRICSUBSCRIBESREQUEST_H_
