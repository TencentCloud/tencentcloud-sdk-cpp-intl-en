            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取`Context` for loading subsequent content. It will expire after 1 hour.
                    ...
                    /**
                     * 获取Whether to return all raw log query results. This parameter is meaningless if the query statement (Query) contains an SQL query.
