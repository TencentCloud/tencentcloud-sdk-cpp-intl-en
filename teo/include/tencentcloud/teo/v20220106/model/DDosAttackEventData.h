...
#ifndef TENCENTCLOUD_TEO_V20220106_MODEL_DDOSATTACKEVENTDATA_H_
#define TENCENTCLOUD_TEO_V20220106_MODEL_DDOSATTACKEVENTDATA_H_
    ...
    namespace Teo
    {
        namespace V20220106
        {
            namespace Model
            {
                ...
                */
                class DDosAttackEventData : public AbstractModel
                {
                public:
                    DDosAttackEventData();
                    ~DDosAttackEventData() = default;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     */
                    std::vector<DDosAttackEvent> GetList() const;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     */
                    void SetList(const std::vector<DDosAttackEvent>& _list);
...
Note: This field may return null, indicating that no valid values can be obtained.
                     */
                    std::vector<DDosAttackEvent> m_list;
...
#endif // !TENCENTCLOUD_TEO_V20220106_MODEL_DDOSATTACKEVENTDATA_H_
