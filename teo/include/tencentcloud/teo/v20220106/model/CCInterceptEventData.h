...
#ifndef TENCENTCLOUD_TEO_V20220106_MODEL_CCINTERCEPTEVENTDATA_H_
#define TENCENTCLOUD_TEO_V20220106_MODEL_CCINTERCEPTEVENTDATA_H_
    ...
    namespace Teo
    {
        namespace V20220106
        {
            namespace Model
            {
                ...
                * CC block event data
                */
                class CCInterceptEventData : public AbstractModel
                {
                public:
                    CCInterceptEventData();
                    ~CCInterceptEventData() = default;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     */
                    std::vector<CCInterceptEvent> GetList() const;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     */
                    void SetList(const std::vector<CCInterceptEvent>& _list);
...
Note: This field may return null, indicating that no valid values can be obtained.
                     */
                    std::vector<CCInterceptEvent> m_list;
...
#endif // !TENCENTCLOUD_TEO_V20220106_MODEL_CCINTERCEPTEVENTDATA_H_
