...
#ifndef TENCENTCLOUD_TEO_V20220106_MODEL_WEBLOGDATA_H_
#define TENCENTCLOUD_TEO_V20220106_MODEL_WEBLOGDATA_H_
    ...
    namespace Teo
    {
        namespace V20220106
        {
            namespace Model
            {
                ...
                * Web attack log data
                */
                class WebLogData : public AbstractModel
                {
                public:
                    WebLogData();
                    ~WebLogData() = default;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     * 
                     */
                    std::vector<WebLogs> GetList() const;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     * 
                     */
                    void SetList(const std::vector<WebLogs>& _list);
...
#endif // !TENCENTCLOUD_TEO_V20220106_MODEL_WEBLOGDATA_H_
