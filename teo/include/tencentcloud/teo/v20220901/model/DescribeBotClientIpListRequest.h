...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEBOTCLIENTIPLISTREQUEST_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEBOTCLIENTIPLISTREQUEST_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class DescribeBotClientIpListRequest : public AbstractModel
                {
                public:
                    DescribeBotClientIpListRequest();
                    ~DescribeBotClientIpListRequest() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEBOTCLIENTIPLISTREQUEST_H_
