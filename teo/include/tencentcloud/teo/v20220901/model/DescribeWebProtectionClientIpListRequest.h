...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEWEBPROTECTIONCLIENTIPLISTREQUEST_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEWEBPROTECTIONCLIENTIPLISTREQUEST_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class DescribeWebProtectionClientIpListRequest : public AbstractModel
                {
                public:
                    DescribeWebProtectionClientIpListRequest();
                    ~DescribeWebProtectionClientIpListRequest() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEWEBPROTECTIONCLIENTIPLISTREQUEST_H_
