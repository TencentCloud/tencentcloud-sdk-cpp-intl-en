...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_EDGEKVDELETEREQUEST_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_EDGEKVDELETEREQUEST_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class EdgeKVDeleteRequest : public AbstractModel
                {
                public:
                    EdgeKVDeleteRequest();
                    ~EdgeKVDeleteRequest() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_EDGEKVDELETEREQUEST_H_
