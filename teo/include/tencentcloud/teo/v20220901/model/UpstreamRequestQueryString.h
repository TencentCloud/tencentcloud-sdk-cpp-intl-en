            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    ~UpstreamRequestQueryString() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取Whether to enable origin-pull request parameter query string. values:.
<Li>`On`: enable;</li>
.
<Li>Off: disable.</li>.
...
<Li>Off: disable.</li>.
                    ...
                    /**
                     * 设置Whether to enable origin-pull request parameter query string. values:.
<Li>`On`: enable;</li>
.
<Li>Off: disable.</li>.
...
<Li>Off: disable.</li>.
                    ...
                    /**
                     * 获取Query string mode. this parameter is required when switch is on. values:.
...
<Li>ExcludeCustom: ignore partial parameters.</li>.
                    ...
                    /**
                     * 设置Query string mode. this parameter is required when switch is on. values:.
<Li>`Full`: retain all</li>.
<Li>`Ignore`: ignore all;</li>.
<Li>IncludeCustom: retain partial parameters.</li>.
<Li>ExcludeCustom: ignore partial parameters.</li>.
