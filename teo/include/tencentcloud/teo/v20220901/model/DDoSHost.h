...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_DDOSHOST_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_DDOSHOST_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class DDoSHost : public AbstractModel
                {
                public:
                    DDoSHost();
                    ~DDoSHost() = default;
                    ...
                    /**
                     * 获取The second-level domain name
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 设置The second-level domain name
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Status of the domain name. Values:
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 设置Status of the domain name. Values:
`init`: NS to be switched
`offline`: Site acceleration not enabled with DNS
`process`: Deployment in progress
`online`: Normal
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_DDOSHOST_H_
