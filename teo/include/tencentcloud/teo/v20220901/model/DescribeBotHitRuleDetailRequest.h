...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEBOTHITRULEDETAILREQUEST_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEBOTHITRULEDETAILREQUEST_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class DescribeBotHitRuleDetailRequest : public AbstractModel
                {
                public:
                    DescribeBotHitRuleDetailRequest();
                    ~DescribeBotHitRuleDetailRequest() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEBOTHITRULEDETAILREQUEST_H_
