...
#ifndef TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEBOTDATARESPONSE_H_
#define TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEBOTDATARESPONSE_H_
    ...
    namespace Teo
    {
        namespace V20220901
        {
            namespace Model
            {
                ...
                */
                class DescribeBotDataResponse : public AbstractModel
                {
                public:
                    DescribeBotDataResponse();
                    ~DescribeBotDataResponse() = default;
...
#endif // !TENCENTCLOUD_TEO_V20220901_MODEL_DESCRIBEBOTDATARESPONSE_H_
