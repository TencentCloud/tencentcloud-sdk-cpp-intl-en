...
CoreInternalOutcome DescribeWebManagedRulesAttackEventsResponse::Deserialize(const string &payload)
{
...
string DescribeWebManagedRulesAttackEventsResponse::ToJsonString() const
{
...
WebEventData DescribeWebManagedRulesAttackEventsResponse::GetData() const
{
    return m_data;
}

bool DescribeWebManagedRulesAttackEventsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeWebManagedRulesAttackEventsResponse::GetStatus() const
{
    return m_status;
}

bool DescribeWebManagedRulesAttackEventsResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeWebManagedRulesAttackEventsResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeWebManagedRulesAttackEventsResponse::MsgHasBeenSet() const
{
