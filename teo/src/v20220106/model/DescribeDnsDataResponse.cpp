...
vector<DataItem> DescribeDnsDataResponse::GetData() const
{
    return m_data;
}
...
string DescribeDnsDataResponse::GetInterval() const
{
    return m_interval;
}

bool DescribeDnsDataResponse::IntervalHasBeenSet() const
{
