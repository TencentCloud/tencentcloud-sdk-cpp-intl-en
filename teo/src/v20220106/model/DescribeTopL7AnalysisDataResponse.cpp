...
string DescribeTopL7AnalysisDataResponse::GetType() const
{
    return m_type;
}

bool DescribeTopL7AnalysisDataResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string DescribeTopL7AnalysisDataResponse::GetMetricName() const
{
    return m_metricName;
}

bool DescribeTopL7AnalysisDataResponse::MetricNameHasBeenSet() const
{
