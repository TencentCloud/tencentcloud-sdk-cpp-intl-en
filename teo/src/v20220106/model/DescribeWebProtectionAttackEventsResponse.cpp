...
CoreInternalOutcome DescribeWebProtectionAttackEventsResponse::Deserialize(const string &payload)
{
...
string DescribeWebProtectionAttackEventsResponse::ToJsonString() const
{
...
CCInterceptEventData DescribeWebProtectionAttackEventsResponse::GetData() const
{
    return m_data;
}

bool DescribeWebProtectionAttackEventsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeWebProtectionAttackEventsResponse::GetStatus() const
{
    return m_status;
}

bool DescribeWebProtectionAttackEventsResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeWebProtectionAttackEventsResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeWebProtectionAttackEventsResponse::MsgHasBeenSet() const
{
