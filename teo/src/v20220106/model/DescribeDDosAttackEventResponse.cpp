...
CoreInternalOutcome DescribeDDosAttackEventResponse::Deserialize(const string &payload)
{
...
string DescribeDDosAttackEventResponse::ToJsonString() const
{
...
DDosAttackEventData DescribeDDosAttackEventResponse::GetData() const
{
    return m_data;
}

bool DescribeDDosAttackEventResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeDDosAttackEventResponse::GetStatus() const
{
    return m_status;
}

bool DescribeDDosAttackEventResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeDDosAttackEventResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeDDosAttackEventResponse::MsgHasBeenSet() const
{
