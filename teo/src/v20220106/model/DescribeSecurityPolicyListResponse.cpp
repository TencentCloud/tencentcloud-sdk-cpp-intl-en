...
CoreInternalOutcome DescribeSecurityPolicyListResponse::Deserialize(const string &payload)
{
...
string DescribeSecurityPolicyListResponse::ToJsonString() const
{
...
vector<SecurityEntity> DescribeSecurityPolicyListResponse::GetEntities() const
{
    return m_entities;
}

bool DescribeSecurityPolicyListResponse::EntitiesHasBeenSet() const
{
