...
DDosAttackSourceEventData DescribeDDosAttackSourceEventResponse::GetData() const
{
    return m_data;
}
...
int64_t DescribeDDosAttackSourceEventResponse::GetStatus() const
{
    return m_status;
}

bool DescribeDDosAttackSourceEventResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeDDosAttackSourceEventResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeDDosAttackSourceEventResponse::MsgHasBeenSet() const
{
