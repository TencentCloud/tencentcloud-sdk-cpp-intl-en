...
CacheConfigCache CacheConfig::GetCache() const
{
    return m_cache;
}

void CacheConfig::SetCache(const CacheConfigCache& _cache)
{
    m_cache = _cache;
    m_cacheHasBeenSet = true;
}
...
CacheConfigNoCache CacheConfig::GetNoCache() const
{
    return m_noCache;
}

void CacheConfig::SetNoCache(const CacheConfigNoCache& _noCache)
{
    m_noCache = _noCache;
    m_noCacheHasBeenSet = true;
}
...
CacheConfigFollowOrigin CacheConfig::GetFollowOrigin() const
{
    return m_followOrigin;
}

void CacheConfig::SetFollowOrigin(const CacheConfigFollowOrigin& _followOrigin)
{
