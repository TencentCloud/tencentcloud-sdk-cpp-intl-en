...
CoreInternalOutcome DescribeIdentificationResponse::Deserialize(const string &payload)
{
...
string DescribeIdentificationResponse::ToJsonString() const
{
...
string DescribeIdentificationResponse::GetName() const
{
    return m_name;
}

bool DescribeIdentificationResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

string DescribeIdentificationResponse::GetStatus() const
{
    return m_status;
}

bool DescribeIdentificationResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeIdentificationResponse::GetSubdomain() const
{
    return m_subdomain;
}

bool DescribeIdentificationResponse::SubdomainHasBeenSet() const
{
    return m_subdomainHasBeenSet;
}

string DescribeIdentificationResponse::GetRecordType() const
{
    return m_recordType;
}

bool DescribeIdentificationResponse::RecordTypeHasBeenSet() const
{
    return m_recordTypeHasBeenSet;
}

string DescribeIdentificationResponse::GetRecordValue() const
{
    return m_recordValue;
}

bool DescribeIdentificationResponse::RecordValueHasBeenSet() const
{
    return m_recordValueHasBeenSet;
}

vector<string> DescribeIdentificationResponse::GetOriginalNameServers() const
{
    return m_originalNameServers;
}

bool DescribeIdentificationResponse::OriginalNameServersHasBeenSet() const
{
