...
string DescribeTimingL7CacheDataResponse::GetType() const
{
    return m_type;
}

bool DescribeTimingL7CacheDataResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

string DescribeTimingL7CacheDataResponse::GetInterval() const
{
    return m_interval;
}

bool DescribeTimingL7CacheDataResponse::IntervalHasBeenSet() const
{
