...
CoreInternalOutcome DescribeDnsRecordsResponse::Deserialize(const string &payload)
{
...
string DescribeDnsRecordsResponse::ToJsonString() const
{
...
int64_t DescribeDnsRecordsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeDnsRecordsResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<DnsRecord> DescribeDnsRecordsResponse::GetRecords() const
{
    return m_records;
}

bool DescribeDnsRecordsResponse::RecordsHasBeenSet() const
{
