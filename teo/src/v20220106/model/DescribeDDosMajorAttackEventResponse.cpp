...
DDosMajorAttackEventData DescribeDDosMajorAttackEventResponse::GetData() const
{
    return m_data;
}
...
int64_t DescribeDDosMajorAttackEventResponse::GetStatus() const
{
    return m_status;
}

bool DescribeDDosMajorAttackEventResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeDDosMajorAttackEventResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeDDosMajorAttackEventResponse::MsgHasBeenSet() const
{
