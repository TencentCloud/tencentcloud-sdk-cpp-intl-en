...
CoreInternalOutcome DescribeWebProtectionLogResponse::Deserialize(const string &payload)
{
...
string DescribeWebProtectionLogResponse::ToJsonString() const
{
...
CCLogData DescribeWebProtectionLogResponse::GetData() const
{
    return m_data;
}

bool DescribeWebProtectionLogResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeWebProtectionLogResponse::GetStatus() const
{
    return m_status;
}

bool DescribeWebProtectionLogResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeWebProtectionLogResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeWebProtectionLogResponse::MsgHasBeenSet() const
{
