...
CoreInternalOutcome ImportDnsRecordsResponse::Deserialize(const string &payload)
{
...
string ImportDnsRecordsResponse::ToJsonString() const
{
...
vector<string> ImportDnsRecordsResponse::GetIds() const
{
    return m_ids;
}

bool ImportDnsRecordsResponse::IdsHasBeenSet() const
{
