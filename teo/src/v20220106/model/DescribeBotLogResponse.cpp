...
BotLogData DescribeBotLogResponse::GetData() const
{
    return m_data;
}
...
int64_t DescribeBotLogResponse::GetStatus() const
{
    return m_status;
}

bool DescribeBotLogResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeBotLogResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeBotLogResponse::MsgHasBeenSet() const
{
