...
CoreInternalOutcome ModifyZoneSettingResponse::Deserialize(const string &payload)
{
...
string ModifyZoneSettingResponse::ToJsonString() const
{
...
string ModifyZoneSettingResponse::GetZoneId() const
{
    return m_zoneId;
}

bool ModifyZoneSettingResponse::ZoneIdHasBeenSet() const
{
