...
vector<string> DeleteDnsRecordsRequest::GetIds() const
{
    return m_ids;
}

void DeleteDnsRecordsRequest::SetIds(const vector<string>& _ids)
{
    m_ids = _ids;
    m_idsHasBeenSet = true;
}

bool DeleteDnsRecordsRequest::IdsHasBeenSet() const
{
