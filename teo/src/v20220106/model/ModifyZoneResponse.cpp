...
string ModifyZoneResponse::GetId() const
{
    return m_id;
}

bool ModifyZoneResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string ModifyZoneResponse::GetName() const
{
    return m_name;
}

bool ModifyZoneResponse::NameHasBeenSet() const
{
    return m_nameHasBeenSet;
}

vector<string> ModifyZoneResponse::GetOriginalNameServers() const
{
    return m_originalNameServers;
}

bool ModifyZoneResponse::OriginalNameServersHasBeenSet() const
{
    return m_originalNameServersHasBeenSet;
}

string ModifyZoneResponse::GetStatus() const
{
    return m_status;
}

bool ModifyZoneResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string ModifyZoneResponse::GetType() const
{
    return m_type;
}

bool ModifyZoneResponse::TypeHasBeenSet() const
{
    return m_typeHasBeenSet;
}

vector<string> ModifyZoneResponse::GetNameServers() const
{
    return m_nameServers;
}

bool ModifyZoneResponse::NameServersHasBeenSet() const
{
    return m_nameServersHasBeenSet;
}

string ModifyZoneResponse::GetCreatedOn() const
{
    return m_createdOn;
}

bool ModifyZoneResponse::CreatedOnHasBeenSet() const
{
    return m_createdOnHasBeenSet;
}

string ModifyZoneResponse::GetModifiedOn() const
{
    return m_modifiedOn;
}

bool ModifyZoneResponse::ModifiedOnHasBeenSet() const
{
    return m_modifiedOnHasBeenSet;
}

string ModifyZoneResponse::GetCnameStatus() const
{
    return m_cnameStatus;
}

bool ModifyZoneResponse::CnameStatusHasBeenSet() const
{
