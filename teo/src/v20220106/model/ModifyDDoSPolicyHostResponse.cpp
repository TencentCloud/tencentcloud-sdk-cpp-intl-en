...
CoreInternalOutcome ModifyDDoSPolicyHostResponse::Deserialize(const string &payload)
{
...
string ModifyDDoSPolicyHostResponse::ToJsonString() const
{
...
string ModifyDDoSPolicyHostResponse::GetHost() const
{
    return m_host;
}

bool ModifyDDoSPolicyHostResponse::HostHasBeenSet() const
{
