...
CoreInternalOutcome DeleteApplicationProxyRuleResponse::Deserialize(const string &payload)
{
...
string DeleteApplicationProxyRuleResponse::ToJsonString() const
{
...
string DeleteApplicationProxyRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool DeleteApplicationProxyRuleResponse::RuleIdHasBeenSet() const
{
