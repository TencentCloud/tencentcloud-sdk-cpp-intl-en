...
WebLogData DescribeWebManagedRulesLogResponse::GetData() const
{
    return m_data;
}
...
int64_t DescribeWebManagedRulesLogResponse::GetStatus() const
{
    return m_status;
}

bool DescribeWebManagedRulesLogResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeWebManagedRulesLogResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeWebManagedRulesLogResponse::MsgHasBeenSet() const
{
