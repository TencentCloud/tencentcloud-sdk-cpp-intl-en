...
CoreInternalOutcome ModifyApplicationProxyRuleStatusResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationProxyRuleStatusResponse::ToJsonString() const
{
...
string ModifyApplicationProxyRuleStatusResponse::GetRuleId() const
{
    return m_ruleId;
}

bool ModifyApplicationProxyRuleStatusResponse::RuleIdHasBeenSet() const
{
