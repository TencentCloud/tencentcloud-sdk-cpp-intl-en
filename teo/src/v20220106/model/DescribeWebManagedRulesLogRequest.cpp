...
int64_t DescribeWebManagedRulesLogRequest::GetPageSize() const
{
    return m_pageSize;
}

void DescribeWebManagedRulesLogRequest::SetPageSize(const int64_t& _pageSize)
{
    m_pageSize = _pageSize;
    m_pageSizeHasBeenSet = true;
}

bool DescribeWebManagedRulesLogRequest::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t DescribeWebManagedRulesLogRequest::GetPageNo() const
{
    return m_pageNo;
}

void DescribeWebManagedRulesLogRequest::SetPageNo(const int64_t& _pageNo)
{
    m_pageNo = _pageNo;
    m_pageNoHasBeenSet = true;
}

bool DescribeWebManagedRulesLogRequest::PageNoHasBeenSet() const
{
