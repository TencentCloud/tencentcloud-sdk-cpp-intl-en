...
CoreInternalOutcome DescribeWebProtectionDataResponse::Deserialize(const string &payload)
{
...
string DescribeWebProtectionDataResponse::ToJsonString() const
{
...
vector<SecEntry> DescribeWebProtectionDataResponse::GetData() const
{
    return m_data;
}

bool DescribeWebProtectionDataResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeWebProtectionDataResponse::GetStatus() const
{
    return m_status;
}

bool DescribeWebProtectionDataResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeWebProtectionDataResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeWebProtectionDataResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string DescribeWebProtectionDataResponse::GetInterval() const
{
    return m_interval;
}

bool DescribeWebProtectionDataResponse::IntervalHasBeenSet() const
{
