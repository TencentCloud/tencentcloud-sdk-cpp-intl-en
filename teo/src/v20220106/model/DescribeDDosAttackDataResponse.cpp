...
int64_t DescribeDDosAttackDataResponse::GetStatus() const
{
    return m_status;
}

bool DescribeDDosAttackDataResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeDDosAttackDataResponse::GetMsg() const
{
    return m_msg;
}

bool DescribeDDosAttackDataResponse::MsgHasBeenSet() const
{
    return m_msgHasBeenSet;
}

string DescribeDDosAttackDataResponse::GetInterval() const
{
    return m_interval;
}

bool DescribeDDosAttackDataResponse::IntervalHasBeenSet() const
{
