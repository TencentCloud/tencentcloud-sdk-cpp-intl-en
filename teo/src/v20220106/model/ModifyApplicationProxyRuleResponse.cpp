...
CoreInternalOutcome ModifyApplicationProxyRuleResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationProxyRuleResponse::ToJsonString() const
{
...
string ModifyApplicationProxyRuleResponse::GetRuleId() const
{
    return m_ruleId;
}

bool ModifyApplicationProxyRuleResponse::RuleIdHasBeenSet() const
{
