...
namespace
{
    ...
    const string ENDPOINT = "cvm.intl.tencentcloudapi.com";
}
...
{
    using Req = const DescribeReservedInstancesConfigInfosRequest&;
    using Resp = DescribeReservedInstancesConfigInfosResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeReservedInstancesConfigInfos", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeReservedInstancesConfigInfosOutcome>>();
    DescribeReservedInstancesConfigInfosAsync(
    request,
    [prom](
        const CvmClient*,
        const DescribeReservedInstancesConfigInfosRequest&,
        DescribeReservedInstancesConfigInfosOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeReservedInstancesOfferingsRequest&;
    using Resp = DescribeReservedInstancesOfferingsResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeReservedInstancesOfferings", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeReservedInstancesOfferingsOutcome>>();
    DescribeReservedInstancesOfferingsAsync(
    request,
    [prom](
        const CvmClient*,
        const DescribeReservedInstancesOfferingsRequest&,
        DescribeReservedInstancesOfferingsOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const InquirePricePurchaseReservedInstancesOfferingRequest&;
    using Resp = InquirePricePurchaseReservedInstancesOfferingResponse;

    DoRequestAsync<Req, Resp>(
        "InquirePricePurchaseReservedInstancesOffering", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<InquirePricePurchaseReservedInstancesOfferingOutcome>>();
    InquirePricePurchaseReservedInstancesOfferingAsync(
    request,
    [prom](
        const CvmClient*,
        const InquirePricePurchaseReservedInstancesOfferingRequest&,
        InquirePricePurchaseReservedInstancesOfferingOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const PurchaseReservedInstancesOfferingRequest&;
    using Resp = PurchaseReservedInstancesOfferingResponse;

    DoRequestAsync<Req, Resp>(
        "PurchaseReservedInstancesOffering", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<PurchaseReservedInstancesOfferingOutcome>>();
    PurchaseReservedInstancesOfferingAsync(
    request,
    [prom](
        const CvmClient*,
        const PurchaseReservedInstancesOfferingRequest&,
        PurchaseReservedInstancesOfferingOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
