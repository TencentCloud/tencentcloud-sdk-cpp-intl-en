...
string EnableAlarmRequest::ToJsonString() const
{
...
int64_t EnableAlarmRequest::GetId() const
{
    return m_id;
}

void EnableAlarmRequest::SetId(const int64_t& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}

bool EnableAlarmRequest::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

int64_t EnableAlarmRequest::GetMemberUin() const
{
    return m_memberUin;
}

void EnableAlarmRequest::SetMemberUin(const int64_t& _memberUin)
{
    m_memberUin = _memberUin;
    m_memberUinHasBeenSet = true;
}

bool EnableAlarmRequest::MemberUinHasBeenSet() const
{
