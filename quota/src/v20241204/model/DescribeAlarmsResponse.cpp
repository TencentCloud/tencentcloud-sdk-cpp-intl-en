...
CoreInternalOutcome DescribeAlarmsResponse::Deserialize(const string &payload)
{
...
string DescribeAlarmsResponse::ToJsonString() const
{
...
int64_t DescribeAlarmsResponse::GetCount() const
{
    return m_count;
}

bool DescribeAlarmsResponse::CountHasBeenSet() const
{
    return m_countHasBeenSet;
}

vector<Alarm> DescribeAlarmsResponse::GetData() const
{
    return m_data;
}

bool DescribeAlarmsResponse::DataHasBeenSet() const
{
