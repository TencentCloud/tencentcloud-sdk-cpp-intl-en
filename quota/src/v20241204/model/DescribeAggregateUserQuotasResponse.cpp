...
CoreInternalOutcome DescribeAggregateUserQuotasResponse::Deserialize(const string &payload)
{
...
string DescribeAggregateUserQuotasResponse::ToJsonString() const
{
...
int64_t DescribeAggregateUserQuotasResponse::GetOwnerUin() const
{
    return m_ownerUin;
}

bool DescribeAggregateUserQuotasResponse::OwnerUinHasBeenSet() const
{
    return m_ownerUinHasBeenSet;
}

int64_t DescribeAggregateUserQuotasResponse::GetCount() const
{
    return m_count;
}

bool DescribeAggregateUserQuotasResponse::CountHasBeenSet() const
{
    return m_countHasBeenSet;
}

vector<UserQuota> DescribeAggregateUserQuotasResponse::GetData() const
{
    return m_data;
}

bool DescribeAggregateUserQuotasResponse::DataHasBeenSet() const
{
