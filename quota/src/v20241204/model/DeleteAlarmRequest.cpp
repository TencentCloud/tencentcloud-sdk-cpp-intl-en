...
int64_t DeleteAlarmRequest::GetId() const
{
    return m_id;
}

void DeleteAlarmRequest::SetId(const int64_t& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}

bool DeleteAlarmRequest::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

int64_t DeleteAlarmRequest::GetMemberUin() const
{
    return m_memberUin;
}

void DeleteAlarmRequest::SetMemberUin(const int64_t& _memberUin)
{
    m_memberUin = _memberUin;
    m_memberUinHasBeenSet = true;
}

bool DeleteAlarmRequest::MemberUinHasBeenSet() const
{
