...
CoreInternalOutcome DescribeCustomizedConfigListResponse::Deserialize(const string &payload)
{
...
string DescribeCustomizedConfigListResponse::ToJsonString() const
{
...
vector<ConfigListItem> DescribeCustomizedConfigListResponse::GetConfigList() const
{
    return m_configList;
}

bool DescribeCustomizedConfigListResponse::ConfigListHasBeenSet() const
{
    return m_configListHasBeenSet;
}

int64_t DescribeCustomizedConfigListResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeCustomizedConfigListResponse::TotalCountHasBeenSet() const
{
