...
string DescribeCustomizedConfigAssociateListRequest::GetConfigId() const
{
    return m_configId;
}

void DescribeCustomizedConfigAssociateListRequest::SetConfigId(const string& _configId)
{
    m_configId = _configId;
    m_configIdHasBeenSet = true;
}

bool DescribeCustomizedConfigAssociateListRequest::ConfigIdHasBeenSet() const
{
