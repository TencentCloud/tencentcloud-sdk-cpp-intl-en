...
string SetCustomizedConfigForLoadBalancerRequest::GetConfigId() const
{
    return m_configId;
}

void SetCustomizedConfigForLoadBalancerRequest::SetConfigId(const string& _configId)
{
    m_configId = _configId;
    m_configIdHasBeenSet = true;
}

bool SetCustomizedConfigForLoadBalancerRequest::ConfigIdHasBeenSet() const
{
