...
vector<string> DescribeCustomizedConfigListRequest::GetConfigIds() const
{
    return m_configIds;
}

void DescribeCustomizedConfigListRequest::SetConfigIds(const vector<string>& _configIds)
{
    m_configIds = _configIds;
    m_configIdsHasBeenSet = true;
}

bool DescribeCustomizedConfigListRequest::ConfigIdsHasBeenSet() const
{
