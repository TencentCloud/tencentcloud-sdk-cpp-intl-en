...
InternetAccessible::InternetAccessible() :
    ...
    m_bandwidthPackageSubTypeHasBeenSet(false)
{
}
...
CoreInternalOutcome InternetAccessible::Deserialize(const rapidjson::Value &value)
{
    ...
    if (value.HasMember("BandwidthPackageSubType") && !value["BandwidthPackageSubType"].IsNull())
    {
        if (!value["BandwidthPackageSubType"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `InternetAccessible.BandwidthPackageSubType` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_bandwidthPackageSubType = string(value["BandwidthPackageSubType"].GetString());
        m_bandwidthPackageSubTypeHasBeenSet = true;
    }
...
void InternetAccessible::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
    ...
    if (m_bandwidthPackageSubTypeHasBeenSet)
    {
        rapidjson::Value iKey(rapidjson::kStringType);
        string key = "BandwidthPackageSubType";
        iKey.SetString(key.c_str(), allocator);
        value.AddMember(iKey, rapidjson::Value(m_bandwidthPackageSubType.c_str(), allocator).Move(), allocator);
    }
...
string InternetAccessible::GetBandwidthPackageSubType() const
{
    return m_bandwidthPackageSubType;
}

void InternetAccessible::SetBandwidthPackageSubType(const string& _bandwidthPackageSubType)
{
    m_bandwidthPackageSubType = _bandwidthPackageSubType;
    m_bandwidthPackageSubTypeHasBeenSet = true;
}

bool InternetAccessible::BandwidthPackageSubTypeHasBeenSet() const
{
    return m_bandwidthPackageSubTypeHasBeenSet;
}
