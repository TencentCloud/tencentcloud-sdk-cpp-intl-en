...
#ifndef TENCENTCLOUD_CLB_V20230417_MODEL_RULEHEALTH_H_
#define TENCENTCLOUD_CLB_V20230417_MODEL_RULEHEALTH_H_
...
#include <tencentcloud/clb/v20230417/model/TargetHealth.h>
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Health check status of the backend service bound to this rule
                    ...
                    /**
                     * 设置Health check status of the backend service bound to this rule
...
#endif // !TENCENTCLOUD_CLB_V20230417_MODEL_RULEHEALTH_H_
