...
#ifndef TENCENTCLOUD_CLB_V20230417_MODEL_CREATELOADBALANCERRESPONSE_H_
#define TENCENTCLOUD_CLB_V20230417_MODEL_CREATELOADBALANCERRESPONSE_H_
            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>An array of unique IDs of Cloud Load Balancer instances.<br>In certain scenarios, such as a delay in creation, this field may return null. At this point, you can query the created resource ID through the DescribeTaskStatus API using the RequestId or DealName parameter returned by the API.</p>
...
#endif // !TENCENTCLOUD_CLB_V20230417_MODEL_CREATELOADBALANCERRESPONSE_H_
