...
#ifndef TENCENTCLOUD_CDWDORIS_V20211228_MODEL_EXECUTEPARAMETRIZEDQUERYRESPONSE_H_
#define TENCENTCLOUD_CDWDORIS_V20211228_MODEL_EXECUTEPARAMETRIZEDQUERYRESPONSE_H_
    ...
    namespace Cdwdoris
    {
        namespace V20211228
        {
            namespace Model
            {
                ...
                */
                class ExecuteParametrizedQueryResponse : public AbstractModel
                {
                public:
                    ExecuteParametrizedQueryResponse();
                    ~ExecuteParametrizedQueryResponse() = default;
...
#endif // !TENCENTCLOUD_CDWDORIS_V20211228_MODEL_EXECUTEPARAMETRIZEDQUERYRESPONSE_H_
