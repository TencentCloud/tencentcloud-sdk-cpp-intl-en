...
#ifndef TENCENTCLOUD_CDWDORIS_V20211228_MODEL_DESCRIBEINSTANCEOPERATIONHISTORYREQUEST_H_
#define TENCENTCLOUD_CDWDORIS_V20211228_MODEL_DESCRIBEINSTANCEOPERATIONHISTORYREQUEST_H_
    ...
    namespace Cdwdoris
    {
        namespace V20211228
        {
            namespace Model
            {
                ...
                */
                class DescribeInstanceOperationHistoryRequest : public AbstractModel
                {
                public:
                    DescribeInstanceOperationHistoryRequest();
                    ~DescribeInstanceOperationHistoryRequest() = default;
...
#endif // !TENCENTCLOUD_CDWDORIS_V20211228_MODEL_DESCRIBEINSTANCEOPERATIONHISTORYREQUEST_H_
