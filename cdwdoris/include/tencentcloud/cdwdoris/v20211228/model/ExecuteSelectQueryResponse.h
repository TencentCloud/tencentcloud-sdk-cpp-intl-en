...
#ifndef TENCENTCLOUD_CDWDORIS_V20211228_MODEL_EXECUTESELECTQUERYRESPONSE_H_
#define TENCENTCLOUD_CDWDORIS_V20211228_MODEL_EXECUTESELECTQUERYRESPONSE_H_
    ...
    namespace Cdwdoris
    {
        namespace V20211228
        {
            namespace Model
            {
                ...
                */
                class ExecuteSelectQueryResponse : public AbstractModel
                {
                public:
                    ExecuteSelectQueryResponse();
                    ~ExecuteSelectQueryResponse() = default;
...
#endif // !TENCENTCLOUD_CDWDORIS_V20211228_MODEL_EXECUTESELECTQUERYRESPONSE_H_
