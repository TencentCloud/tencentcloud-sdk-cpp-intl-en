...
CoreInternalOutcome ExecuteParametrizedQueryResponse::Deserialize(const string &payload)
{
...
string ExecuteParametrizedQueryResponse::ToJsonString() const
{
...
uint64_t ExecuteParametrizedQueryResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ExecuteParametrizedQueryResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<string> ExecuteParametrizedQueryResponse::GetFields() const
{
    return m_fields;
}

bool ExecuteParametrizedQueryResponse::FieldsHasBeenSet() const
{
    return m_fieldsHasBeenSet;
}

vector<string> ExecuteParametrizedQueryResponse::GetFieldTypes() const
{
    return m_fieldTypes;
}

bool ExecuteParametrizedQueryResponse::FieldTypesHasBeenSet() const
{
    return m_fieldTypesHasBeenSet;
}

vector<Rows> ExecuteParametrizedQueryResponse::GetRows() const
{
    return m_rows;
}
