...
CoreInternalOutcome ExecuteSelectQueryResponse::Deserialize(const string &payload)
{
...
string ExecuteSelectQueryResponse::ToJsonString() const
{
...
uint64_t ExecuteSelectQueryResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool ExecuteSelectQueryResponse::TotalCountHasBeenSet() const
{
    return m_totalCountHasBeenSet;
}

vector<string> ExecuteSelectQueryResponse::GetFields() const
{
    return m_fields;
}

bool ExecuteSelectQueryResponse::FieldsHasBeenSet() const
{
    return m_fieldsHasBeenSet;
}

vector<string> ExecuteSelectQueryResponse::GetFieldTypes() const
{
    return m_fieldTypes;
}

bool ExecuteSelectQueryResponse::FieldTypesHasBeenSet() const
{
    return m_fieldTypesHasBeenSet;
}

vector<Rows> ExecuteSelectQueryResponse::GetRows() const
{
    return m_rows;
}

bool ExecuteSelectQueryResponse::RowsHasBeenSet() const
{
    return m_rowsHasBeenSet;
}

string ExecuteSelectQueryResponse::GetMessage() const
{
    return m_message;
}

bool ExecuteSelectQueryResponse::MessageHasBeenSet() const
{
