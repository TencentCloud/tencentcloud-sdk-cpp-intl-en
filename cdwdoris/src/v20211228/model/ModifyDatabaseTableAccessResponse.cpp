...
CoreInternalOutcome ModifyDatabaseTableAccessResponse::Deserialize(const string &payload)
{
...
string ModifyDatabaseTableAccessResponse::ToJsonString() const
{
...
bool ModifyDatabaseTableAccessResponse::GetSuccess() const
{
    return m_success;
}

bool ModifyDatabaseTableAccessResponse::SuccessHasBeenSet() const
{
    return m_successHasBeenSet;
}

string ModifyDatabaseTableAccessResponse::GetMessage() const
{
    return m_message;
}

bool ModifyDatabaseTableAccessResponse::MessageHasBeenSet() const
{
