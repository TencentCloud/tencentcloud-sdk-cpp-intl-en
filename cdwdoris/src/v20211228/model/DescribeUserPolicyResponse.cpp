...
CoreInternalOutcome DescribeUserPolicyResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("AccountInfo") && !rsp["AccountInfo"].IsNull())
    {
        if (!rsp["AccountInfo"].IsObject())
        {
            return CoreInternalOutcome(Core::Error("response `AccountInfo` is not object type").SetRequestId(requestId));
        }

        CoreInternalOutcome outcome = m_accountInfo.Deserialize(rsp["AccountInfo"]);
...
string DescribeUserPolicyResponse::ToJsonString() const
{
...
AccountDetailInfo DescribeUserPolicyResponse::GetAccountInfo() const
{
    return m_accountInfo;
}

bool DescribeUserPolicyResponse::AccountInfoHasBeenSet() const
{
...
bool DescribeUserPolicyResponse::PermissionsHasBeenSet() const
{
