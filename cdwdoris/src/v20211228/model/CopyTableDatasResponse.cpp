...
CoreInternalOutcome CopyTableDatasResponse::Deserialize(const string &payload)
{
...
string CopyTableDatasResponse::ToJsonString() const
{
...
string CopyTableDatasResponse::GetMessage() const
{
    return m_message;
}

bool CopyTableDatasResponse::MessageHasBeenSet() const
{
