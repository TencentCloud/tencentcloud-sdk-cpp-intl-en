...
CoreInternalOutcome CreateDatabaseResponse::Deserialize(const string &payload)
{
...
string CreateDatabaseResponse::ToJsonString() const
{
...
string CreateDatabaseResponse::GetMessage() const
{
    return m_message;
}

bool CreateDatabaseResponse::MessageHasBeenSet() const
{
