...
CoreInternalOutcome UpdateDatabaseResponse::Deserialize(const string &payload)
{
...
string UpdateDatabaseResponse::ToJsonString() const
{
...
bool UpdateDatabaseResponse::GetSuccess() const
{
    return m_success;
}

bool UpdateDatabaseResponse::SuccessHasBeenSet() const
{
    return m_successHasBeenSet;
}

string UpdateDatabaseResponse::GetMessage() const
{
    return m_message;
}

bool UpdateDatabaseResponse::MessageHasBeenSet() const
{
