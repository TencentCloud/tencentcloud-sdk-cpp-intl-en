...
{
    using Req = const CopyTableDatasRequest&;
    using Resp = CopyTableDatasResponse;

    DoRequestAsync<Req, Resp>(
        "CopyTableDatas", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<CopyTableDatasOutcome>>();
    CopyTableDatasAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const CopyTableDatasRequest&,
        CopyTableDatasOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeCreateTablesDDLRequest&;
    using Resp = DescribeCreateTablesDDLResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeCreateTablesDDL", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeCreateTablesDDLOutcome>>();
    DescribeCreateTablesDDLAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const DescribeCreateTablesDDLRequest&,
        DescribeCreateTablesDDLOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeInstanceOperationHistoryRequest&;
    using Resp = DescribeInstanceOperationHistoryResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeInstanceOperationHistory", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeInstanceOperationHistoryOutcome>>();
    DescribeInstanceOperationHistoryAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const DescribeInstanceOperationHistoryRequest&,
        DescribeInstanceOperationHistoryOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeQueryAnalyseRequest&;
    using Resp = DescribeQueryAnalyseResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeQueryAnalyse", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeQueryAnalyseOutcome>>();
    DescribeQueryAnalyseAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const DescribeQueryAnalyseRequest&,
        DescribeQueryAnalyseOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const DescribeUserPolicyRequest&;
    using Resp = DescribeUserPolicyResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeUserPolicy", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<DescribeUserPolicyOutcome>>();
    DescribeUserPolicyAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const DescribeUserPolicyRequest&,
        DescribeUserPolicyOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const ExecuteParametrizedQueryRequest&;
    using Resp = ExecuteParametrizedQueryResponse;

    DoRequestAsync<Req, Resp>(
        "ExecuteParametrizedQuery", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<ExecuteParametrizedQueryOutcome>>();
    ExecuteParametrizedQueryAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const ExecuteParametrizedQueryRequest&,
        ExecuteParametrizedQueryOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const ExecuteSelectQueryRequest&;
    using Resp = ExecuteSelectQueryResponse;

    DoRequestAsync<Req, Resp>(
        "ExecuteSelectQuery", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<ExecuteSelectQueryOutcome>>();
    ExecuteSelectQueryAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const ExecuteSelectQueryRequest&,
        ExecuteSelectQueryOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const InsertDatasToTableRequest&;
    using Resp = InsertDatasToTableResponse;

    DoRequestAsync<Req, Resp>(
        "InsertDatasToTable", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<InsertDatasToTableOutcome>>();
    InsertDatasToTableAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const InsertDatasToTableRequest&,
        InsertDatasToTableOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const ModifyDatabaseTableAccessRequest&;
    using Resp = ModifyDatabaseTableAccessResponse;

    DoRequestAsync<Req, Resp>(
        "ModifyDatabaseTableAccess", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<ModifyDatabaseTableAccessOutcome>>();
    ModifyDatabaseTableAccessAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const ModifyDatabaseTableAccessRequest&,
        ModifyDatabaseTableAccessOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const QueryTableDataRequest&;
    using Resp = QueryTableDataResponse;

    DoRequestAsync<Req, Resp>(
        "QueryTableData", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<QueryTableDataOutcome>>();
    QueryTableDataAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const QueryTableDataRequest&,
        QueryTableDataOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const UpdateDatabaseRequest&;
    using Resp = UpdateDatabaseResponse;

    DoRequestAsync<Req, Resp>(
        "UpdateDatabase", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<UpdateDatabaseOutcome>>();
    UpdateDatabaseAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const UpdateDatabaseRequest&,
        UpdateDatabaseOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
{
    using Req = const UpdateTableSchemaRequest&;
    using Resp = UpdateTableSchemaResponse;

    DoRequestAsync<Req, Resp>(
        "UpdateTableSchema", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
{
    const auto prom = std::make_shared<std::promise<UpdateTableSchemaOutcome>>();
    UpdateTableSchemaAsync(
    request,
    [prom](
        const CdwdorisClient*,
        const UpdateTableSchemaRequest&,
        UpdateTableSchemaOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
