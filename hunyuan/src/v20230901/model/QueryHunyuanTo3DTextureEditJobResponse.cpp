...
CoreInternalOutcome QueryHunyuanTo3DTextureEditJobResponse::Deserialize(const string &payload)
{
...
string QueryHunyuanTo3DTextureEditJobResponse::ToJsonString() const
{
...
string QueryHunyuanTo3DTextureEditJobResponse::GetStatus() const
{
    return m_status;
}

bool QueryHunyuanTo3DTextureEditJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string QueryHunyuanTo3DTextureEditJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool QueryHunyuanTo3DTextureEditJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string QueryHunyuanTo3DTextureEditJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool QueryHunyuanTo3DTextureEditJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> QueryHunyuanTo3DTextureEditJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool QueryHunyuanTo3DTextureEditJobResponse::ResultFile3DsHasBeenSet() const
{
