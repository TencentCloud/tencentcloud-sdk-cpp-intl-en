...
CoreInternalOutcome QueryHunyuan3DPartJobResponse::Deserialize(const string &payload)
{
...
string QueryHunyuan3DPartJobResponse::ToJsonString() const
{
...
string QueryHunyuan3DPartJobResponse::GetStatus() const
{
    return m_status;
}

bool QueryHunyuan3DPartJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string QueryHunyuan3DPartJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool QueryHunyuan3DPartJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string QueryHunyuan3DPartJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool QueryHunyuan3DPartJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> QueryHunyuan3DPartJobResponse::GetResultFile3Ds() const
{
