...
CoreInternalOutcome SubmitHunyuan3DPartJobResponse::Deserialize(const string &payload)
{
...
string SubmitHunyuan3DPartJobResponse::ToJsonString() const
{
...
string SubmitHunyuan3DPartJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitHunyuan3DPartJobResponse::JobIdHasBeenSet() const
{
