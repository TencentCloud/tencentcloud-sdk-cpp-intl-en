...
CoreInternalOutcome QueryHunyuanTo3DProJobResponse::Deserialize(const string &payload)
{
...
string QueryHunyuanTo3DProJobResponse::ToJsonString() const
{
...
string QueryHunyuanTo3DProJobResponse::GetStatus() const
{
    return m_status;
}

bool QueryHunyuanTo3DProJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string QueryHunyuanTo3DProJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool QueryHunyuanTo3DProJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string QueryHunyuanTo3DProJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool QueryHunyuanTo3DProJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> QueryHunyuanTo3DProJobResponse::GetResultFile3Ds() const
{
