...
CoreInternalOutcome SubmitHunyuanTo3DTextureEditJobResponse::Deserialize(const string &payload)
{
...
string SubmitHunyuanTo3DTextureEditJobResponse::ToJsonString() const
{
...
string SubmitHunyuanTo3DTextureEditJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitHunyuanTo3DTextureEditJobResponse::JobIdHasBeenSet() const
{
