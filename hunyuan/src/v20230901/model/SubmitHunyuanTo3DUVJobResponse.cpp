...
CoreInternalOutcome SubmitHunyuanTo3DUVJobResponse::Deserialize(const string &payload)
{
...
string SubmitHunyuanTo3DUVJobResponse::ToJsonString() const
{
...
string SubmitHunyuanTo3DUVJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitHunyuanTo3DUVJobResponse::JobIdHasBeenSet() const
{
