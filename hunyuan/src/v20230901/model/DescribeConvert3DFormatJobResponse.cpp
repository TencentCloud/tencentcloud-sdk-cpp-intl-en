...
CoreInternalOutcome DescribeConvert3DFormatJobResponse::Deserialize(const string &payload)
{
...
string DescribeConvert3DFormatJobResponse::ToJsonString() const
{
...
string DescribeConvert3DFormatJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeConvert3DFormatJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeConvert3DFormatJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeConvert3DFormatJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeConvert3DFormatJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeConvert3DFormatJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> DescribeConvert3DFormatJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool DescribeConvert3DFormatJobResponse::ResultFile3DsHasBeenSet() const
{
