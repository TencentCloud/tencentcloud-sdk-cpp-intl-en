...
CoreInternalOutcome SubmitConvert3DFormatJobResponse::Deserialize(const string &payload)
{
...
string SubmitConvert3DFormatJobResponse::ToJsonString() const
{
...
string SubmitConvert3DFormatJobResponse::GetJobId() const
{
    return m_jobId;
}

bool SubmitConvert3DFormatJobResponse::JobIdHasBeenSet() const
{
