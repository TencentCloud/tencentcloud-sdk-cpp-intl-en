...
CoreInternalOutcome DescribeHunyuanTo3DUVJobResponse::Deserialize(const string &payload)
{
...
string DescribeHunyuanTo3DUVJobResponse::ToJsonString() const
{
...
string DescribeHunyuanTo3DUVJobResponse::GetStatus() const
{
    return m_status;
}

bool DescribeHunyuanTo3DUVJobResponse::StatusHasBeenSet() const
{
    return m_statusHasBeenSet;
}

string DescribeHunyuanTo3DUVJobResponse::GetErrorCode() const
{
    return m_errorCode;
}

bool DescribeHunyuanTo3DUVJobResponse::ErrorCodeHasBeenSet() const
{
    return m_errorCodeHasBeenSet;
}

string DescribeHunyuanTo3DUVJobResponse::GetErrorMessage() const
{
    return m_errorMessage;
}

bool DescribeHunyuanTo3DUVJobResponse::ErrorMessageHasBeenSet() const
{
    return m_errorMessageHasBeenSet;
}

vector<File3D> DescribeHunyuanTo3DUVJobResponse::GetResultFile3Ds() const
{
    return m_resultFile3Ds;
}

bool DescribeHunyuanTo3DUVJobResponse::ResultFile3DsHasBeenSet() const
{
