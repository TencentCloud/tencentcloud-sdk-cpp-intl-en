...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_DESCRIBE3DSMARTTOPOLOGYJOBRESPONSE_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_DESCRIBE3DSMARTTOPOLOGYJOBRESPONSE_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                */
                class Describe3DSmartTopologyJobResponse : public AbstractModel
                {
                public:
                    Describe3DSmartTopologyJobResponse();
                    ~Describe3DSmartTopologyJobResponse() = default;
                    ...
                    /**
                     * 获取File generation URL address, with a valid period of 1 day.	
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_DESCRIBE3DSMARTTOPOLOGYJOBRESPONSE_H_
