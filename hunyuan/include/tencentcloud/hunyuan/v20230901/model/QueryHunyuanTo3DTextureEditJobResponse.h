...
#ifndef TENCENTCLOUD_HUNYUAN_V20230901_MODEL_QUERYHUNYUANTO3DTEXTUREEDITJOBRESPONSE_H_
#define TENCENTCLOUD_HUNYUAN_V20230901_MODEL_QUERYHUNYUANTO3DTEXTUREEDITJOBRESPONSE_H_
    ...
    namespace Hunyuan
    {
        namespace V20230901
        {
            namespace Model
            {
                ...
                */
                class QueryHunyuanTo3DTextureEditJobResponse : public AbstractModel
                {
                public:
                    QueryHunyuanTo3DTextureEditJobResponse();
                    ~QueryHunyuanTo3DTextureEditJobResponse() = default;
...
#endif // !TENCENTCLOUD_HUNYUAN_V20230901_MODEL_QUERYHUNYUANTO3DTEXTUREEDITJOBRESPONSE_H_
