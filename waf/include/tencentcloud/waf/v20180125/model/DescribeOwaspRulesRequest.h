            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Specifies the field used to sort. valid values: RuleId, UpdateTime.
                    ...
                    /**
                     * 设置Specifies the field used to sort. valid values: RuleId, UpdateTime.
                    ...
                    /**
                     * 获取Specifies the criteria, support rule ID, rule type, rule description, CVE ID, rule Status, and threat level.
                    ...
                    /**
                     * 设置Specifies the criteria, support rule ID, rule type, rule description, CVE ID, rule Status, and threat level.
