            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Payment type: payment mode: PREPAID (prepayment) POSTPAID_BY_MONTH (pay-as-you-go).
                    ...
                    /**
                     * 设置Payment type: payment mode: PREPAID (prepayment) POSTPAID_BY_MONTH (pay-as-you-go).
                    ...
                    /**
                     * 获取High-Protection package type: specifies the high-protection package type. valid values: Enterprise (Enterprise edition), Standard (Standard version), StandardPlus (Standard version 2.0).
                    ...
                    /**
                     * 设置High-Protection package type: specifies the high-protection package type. valid values: Enterprise (Enterprise edition), Standard (Standard version), StandardPlus (Standard version 2.0).
                    ...
                    /**
                     * 获取Specifies the number of anti-ddos packages to purchase. valid values: one-time purchase of no more than 10.
                    ...
                    /**
                     * 设置Specifies the number of anti-ddos packages to purchase. valid values: one-time purchase of no more than 10.
                    ...
                    /**
                     * 获取false by default. true indicates to perform parameter validation only without actual purchase.
                    ...
                    /**
                     * 设置false by default. true indicates to perform parameter validation only without actual purchase.
