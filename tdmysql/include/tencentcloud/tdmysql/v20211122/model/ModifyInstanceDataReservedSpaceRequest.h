            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Target reserved space size to modify</p><p>Unit: GB</p>
                    ...
                    /**
                     * 设置<p>Target reserved space size to modify</p><p>Unit: GB</p>
                     * @param _reservedSpaceGB <p>Target reserved space size to modify</p><p>Unit: GB</p>
                     * 
                     */
