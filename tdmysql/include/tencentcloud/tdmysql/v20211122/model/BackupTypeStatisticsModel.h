...
#ifndef TENCENTCLOUD_TDMYSQL_V20211122_MODEL_BACKUPTYPESTATISTICSMODEL_H_
#define TENCENTCLOUD_TDMYSQL_V20211122_MODEL_BACKUPTYPESTATISTICSMODEL_H_
    ...
    namespace Tdmysql
    {
        namespace V20211122
        {
            namespace Model
            {
                ...
                */
                class BackupTypeStatisticsModel : public AbstractModel
                {
                public:
                    BackupTypeStatisticsModel();
                    ~BackupTypeStatisticsModel() = default;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     * 
                     */
                    std::vector<int64_t> GetDataBackupSize() const;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     * 
                     */
                    void SetDataBackupSize(const std::vector<int64_t>& _dataBackupSize);
...
Note: This field may return null, indicating that no valid values can be obtained.
                     * 
                     */
                    std::vector<int64_t> GetLogBackupSize() const;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     * 
                     */
                    void SetLogBackupSize(const std::vector<int64_t>& _logBackupSize);
...
Note: This field may return null, indicating that no valid values can be obtained.
                     */
                    std::vector<int64_t> m_dataBackupSize;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     */
                    std::vector<int64_t> m_logBackupSize;
...
#endif // !TENCENTCLOUD_TDMYSQL_V20211122_MODEL_BACKUPTYPESTATISTICSMODEL_H_
