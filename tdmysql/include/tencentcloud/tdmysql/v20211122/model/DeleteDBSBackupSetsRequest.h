            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Backup set list. the value comes from the DescribeDBSBackupSets api response.</p>
                    ...
                    /**
                     * 设置<p>Backup set list. the value comes from the DescribeDBSBackupSets api response.</p>
