            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Six-Segment resource format. tencent cloud uses the six-segment resource format to describe a resource.
...
For example: qcs::${ServiceType}:${Region}:${Account}:${ResourcePreifx}/${ResourceId}.
                    ...
                    /**
                     * 设置Six-Segment resource format. tencent cloud uses the six-segment resource format to describe a resource.
For example: qcs::${ServiceType}:${Region}:${Account}:${ResourcePreifx}/${ResourceId}.
