            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Type of the user. Manual: manually created; Synchronized: imported from external sources.
                    ...
                    /**
                     * 设置Type of the user. Manual: manually created; Synchronized: imported from external sources.
