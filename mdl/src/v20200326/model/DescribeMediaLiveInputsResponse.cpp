...
CoreInternalOutcome DescribeMediaLiveInputsResponse::Deserialize(const string &payload)
{
    Document d;
...
vector<InputInfo> DescribeMediaLiveInputsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeMediaLiveInputsResponse::InfosHasBeenSet() const
{
