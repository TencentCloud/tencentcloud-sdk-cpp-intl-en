...
CoreInternalOutcome QueryInputStreamStateResponse::Deserialize(const string &payload)
{
...
string QueryInputStreamStateResponse::ToJsonString() const
{
...
QueryDispatchInputInfo QueryInputStreamStateResponse::GetInfo() const
{
    return m_info;
}

bool QueryInputStreamStateResponse::InfoHasBeenSet() const
{
