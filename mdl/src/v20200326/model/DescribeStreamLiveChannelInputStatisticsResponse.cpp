...
CoreInternalOutcome DescribeStreamLiveChannelInputStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveChannelInputStatisticsResponse::ToJsonString() const
{
...
vector<ChannelInputStatistics> DescribeStreamLiveChannelInputStatisticsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLiveChannelInputStatisticsResponse::InfosHasBeenSet() const
{
