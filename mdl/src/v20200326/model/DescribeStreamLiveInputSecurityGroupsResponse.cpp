...
CoreInternalOutcome DescribeStreamLiveInputSecurityGroupsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveInputSecurityGroupsResponse::ToJsonString() const
{
...
vector<InputSecurityGroupInfo> DescribeStreamLiveInputSecurityGroupsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLiveInputSecurityGroupsResponse::InfosHasBeenSet() const
{
