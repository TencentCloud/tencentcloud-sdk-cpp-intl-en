...
CoreInternalOutcome CreateMediaLiveChannelResponse::Deserialize(const string &payload)
{
    Document d;
...
string CreateMediaLiveChannelResponse::GetId() const
{
    return m_id;
}

bool CreateMediaLiveChannelResponse::IdHasBeenSet() const
{
