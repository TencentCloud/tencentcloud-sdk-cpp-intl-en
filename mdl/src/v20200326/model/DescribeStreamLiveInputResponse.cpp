...
CoreInternalOutcome DescribeStreamLiveInputResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveInputResponse::ToJsonString() const
{
...
InputInfo DescribeStreamLiveInputResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamLiveInputResponse::InfoHasBeenSet() const
{
