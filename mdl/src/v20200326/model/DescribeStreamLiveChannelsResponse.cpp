...
CoreInternalOutcome DescribeStreamLiveChannelsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveChannelsResponse::ToJsonString() const
{
...
vector<StreamLiveChannelInfo> DescribeStreamLiveChannelsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLiveChannelsResponse::InfosHasBeenSet() const
{
