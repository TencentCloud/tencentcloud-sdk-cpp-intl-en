...
CoreInternalOutcome DeleteStreamLiveInputSecurityGroupResponse::Deserialize(const string &payload)
{
...
string DeleteStreamLiveInputSecurityGroupResponse::ToJsonString() const
{
