...
#include <tencentcloud/mdl/v20200326/model/PlanResp.h>
...
CoreInternalOutcome PlanResp::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("EventName") && !value["EventName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PlanResp.EventName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TimingSettings") && !value["TimingSettings"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PlanResp.TimingSettings` is not object type").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("EventSettings") && !value["EventSettings"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PlanResp.EventSettings` is not object type").SetRequestId(requestId));
        }
...
void PlanResp::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string PlanResp::GetEventName() const
{
    return m_eventName;
}

void PlanResp::SetEventName(const string& _eventName)
{
    m_eventName = _eventName;
    m_eventNameHasBeenSet = true;
}

bool PlanResp::EventNameHasBeenSet() const
{
    return m_eventNameHasBeenSet;
}

TimingSettingsResp PlanResp::GetTimingSettings() const
{
    return m_timingSettings;
}

void PlanResp::SetTimingSettings(const TimingSettingsResp& _timingSettings)
{
    m_timingSettings = _timingSettings;
    m_timingSettingsHasBeenSet = true;
}

bool PlanResp::TimingSettingsHasBeenSet() const
{
    return m_timingSettingsHasBeenSet;
}

EventSettingsResp PlanResp::GetEventSettings() const
{
    return m_eventSettings;
}

void PlanResp::SetEventSettings(const EventSettingsResp& _eventSettings)
{
    m_eventSettings = _eventSettings;
    m_eventSettingsHasBeenSet = true;
}

bool PlanResp::EventSettingsHasBeenSet() const
{
