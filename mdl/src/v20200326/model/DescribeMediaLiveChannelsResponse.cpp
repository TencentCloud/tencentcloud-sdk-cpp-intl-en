...
CoreInternalOutcome DescribeMediaLiveChannelsResponse::Deserialize(const string &payload)
{
    Document d;
...
vector<ChannelInfo> DescribeMediaLiveChannelsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeMediaLiveChannelsResponse::InfosHasBeenSet() const
{
