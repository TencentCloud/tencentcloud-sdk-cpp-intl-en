...
CoreInternalOutcome DescribeStreamLiveChannelOutputStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveChannelOutputStatisticsResponse::ToJsonString() const
{
...
vector<ChannelOutputsStatistics> DescribeStreamLiveChannelOutputStatisticsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLiveChannelOutputStatisticsResponse::InfosHasBeenSet() const
{
