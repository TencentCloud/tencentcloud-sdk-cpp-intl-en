...
CoreInternalOutcome CreateMediaLiveInputSecurityGroupResponse::Deserialize(const string &payload)
{
    Document d;
...
string CreateMediaLiveInputSecurityGroupResponse::GetId() const
{
    return m_id;
}

bool CreateMediaLiveInputSecurityGroupResponse::IdHasBeenSet() const
{
