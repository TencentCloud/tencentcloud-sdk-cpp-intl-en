...
CoreInternalOutcome DescribeStreamLiveChannelResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveChannelResponse::ToJsonString() const
{
...
StreamLiveChannelInfo DescribeStreamLiveChannelResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamLiveChannelResponse::InfoHasBeenSet() const
{
