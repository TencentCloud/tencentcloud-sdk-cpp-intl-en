...
CoreInternalOutcome VideoPipelineInputStatistics::Deserialize(const Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("Fps") && !value["Fps"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VideoPipelineInputStatistics.Fps` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Rate") && !value["Rate"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VideoPipelineInputStatistics.Rate` IsUint64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("Pid") && !value["Pid"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Error("response `VideoPipelineInputStatistics.Pid` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void VideoPipelineInputStatistics::ToJsonObject(Value &value, Document::AllocatorType& allocator) const
{
