...
CoreInternalOutcome DescribeStreamLiveWatermarkResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveWatermarkResponse::ToJsonString() const
{
...
DescribeWatermarkInfo DescribeStreamLiveWatermarkResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamLiveWatermarkResponse::InfoHasBeenSet() const
{
