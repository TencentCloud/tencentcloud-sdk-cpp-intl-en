...
CoreInternalOutcome CreateStreamLiveChannelResponse::Deserialize(const string &payload)
{
...
string CreateStreamLiveChannelResponse::ToJsonString() const
{
...
string CreateStreamLiveChannelResponse::GetId() const
{
    return m_id;
}

bool CreateStreamLiveChannelResponse::IdHasBeenSet() const
{
    return m_idHasBeenSet;
}

string CreateStreamLiveChannelResponse::GetTagMsg() const
{
    return m_tagMsg;
}

bool CreateStreamLiveChannelResponse::TagMsgHasBeenSet() const
{
