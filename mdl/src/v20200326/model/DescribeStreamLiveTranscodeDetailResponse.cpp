...
CoreInternalOutcome DescribeStreamLiveTranscodeDetailResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Infos") && !rsp["Infos"].IsNull())
    {
        ...
        {
            DescribeTranscodeDetailInfo item;
...
string DescribeStreamLiveTranscodeDetailResponse::ToJsonString() const
{
...
vector<DescribeTranscodeDetailInfo> DescribeStreamLiveTranscodeDetailResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLiveTranscodeDetailResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

int64_t DescribeStreamLiveTranscodeDetailResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamLiveTranscodeDetailResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

int64_t DescribeStreamLiveTranscodeDetailResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamLiveTranscodeDetailResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

int64_t DescribeStreamLiveTranscodeDetailResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamLiveTranscodeDetailResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

int64_t DescribeStreamLiveTranscodeDetailResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamLiveTranscodeDetailResponse::TotalPageHasBeenSet() const
{
