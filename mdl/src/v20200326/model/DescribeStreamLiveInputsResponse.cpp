...
CoreInternalOutcome DescribeStreamLiveInputsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveInputsResponse::ToJsonString() const
{
...
vector<InputInfo> DescribeStreamLiveInputsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLiveInputsResponse::InfosHasBeenSet() const
{
