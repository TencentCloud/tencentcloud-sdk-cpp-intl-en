...
CoreInternalOutcome GetAbWatermarkPlayUrlResponse::Deserialize(const string &payload)
{
...
string GetAbWatermarkPlayUrlResponse::ToJsonString() const
{
...
string GetAbWatermarkPlayUrlResponse::GetUrl() const
{
    return m_url;
}

bool GetAbWatermarkPlayUrlResponse::UrlHasBeenSet() const
{
