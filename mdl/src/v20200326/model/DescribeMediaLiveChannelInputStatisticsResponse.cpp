...
CoreInternalOutcome DescribeMediaLiveChannelInputStatisticsResponse::Deserialize(const string &payload)
{
    Document d;
...
vector<ChannelInputStatistics> DescribeMediaLiveChannelInputStatisticsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeMediaLiveChannelInputStatisticsResponse::InfosHasBeenSet() const
{
