...
CoreInternalOutcome DescribeWatermarkDetectionResponse::Deserialize(const string &payload)
{
...
string DescribeWatermarkDetectionResponse::ToJsonString() const
{
...
AbWatermarkDetectionInfo DescribeWatermarkDetectionResponse::GetTaskInfo() const
{
    return m_taskInfo;
}

bool DescribeWatermarkDetectionResponse::TaskInfoHasBeenSet() const
{
