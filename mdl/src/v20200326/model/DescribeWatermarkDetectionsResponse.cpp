...
CoreInternalOutcome DescribeWatermarkDetectionsResponse::Deserialize(const string &payload)
{
...
string DescribeWatermarkDetectionsResponse::ToJsonString() const
{
...
vector<AbWatermarkDetectionInfo> DescribeWatermarkDetectionsResponse::GetTaskInfos() const
{
    return m_taskInfos;
}

bool DescribeWatermarkDetectionsResponse::TaskInfosHasBeenSet() const
{
    return m_taskInfosHasBeenSet;
}

int64_t DescribeWatermarkDetectionsResponse::GetTotalCount() const
{
    return m_totalCount;
}

bool DescribeWatermarkDetectionsResponse::TotalCountHasBeenSet() const
{
