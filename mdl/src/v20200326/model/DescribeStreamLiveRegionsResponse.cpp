...
CoreInternalOutcome DescribeStreamLiveRegionsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveRegionsResponse::ToJsonString() const
{
...
StreamLiveRegionInfo DescribeStreamLiveRegionsResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamLiveRegionsResponse::InfoHasBeenSet() const
{
