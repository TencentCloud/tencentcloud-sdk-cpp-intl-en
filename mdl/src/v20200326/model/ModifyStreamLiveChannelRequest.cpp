...
vector<SubtitleConf> ModifyStreamLiveChannelRequest::GetCaptionTemplates() const
{
    return m_captionTemplates;
}

void ModifyStreamLiveChannelRequest::SetCaptionTemplates(const vector<SubtitleConf>& _captionTemplates)
{
    m_captionTemplates = _captionTemplates;
    m_captionTemplatesHasBeenSet = true;
}

bool ModifyStreamLiveChannelRequest::CaptionTemplatesHasBeenSet() const
{
...
EventNotifySetting ModifyStreamLiveChannelRequest::GetEventNotifySettings() const
{
    return m_eventNotifySettings;
}

void ModifyStreamLiveChannelRequest::SetEventNotifySettings(const EventNotifySetting& _eventNotifySettings)
{
    m_eventNotifySettings = _eventNotifySettings;
    m_eventNotifySettingsHasBeenSet = true;
}

bool ModifyStreamLiveChannelRequest::EventNotifySettingsHasBeenSet() const
{
    return m_eventNotifySettingsHasBeenSet;
}

InputLossBehaviorInfo ModifyStreamLiveChannelRequest::GetInputLossBehavior() const
{
    return m_inputLossBehavior;
}

void ModifyStreamLiveChannelRequest::SetInputLossBehavior(const InputLossBehaviorInfo& _inputLossBehavior)
{
...
InputAnalysisInfo ModifyStreamLiveChannelRequest::GetInputAnalysisSettings() const
{
    return m_inputAnalysisSettings;
}

void ModifyStreamLiveChannelRequest::SetInputAnalysisSettings(const InputAnalysisInfo& _inputAnalysisSettings)
{
    m_inputAnalysisSettings = _inputAnalysisSettings;
    m_inputAnalysisSettingsHasBeenSet = true;
}

bool ModifyStreamLiveChannelRequest::InputAnalysisSettingsHasBeenSet() const
{
    return m_inputAnalysisSettingsHasBeenSet;
}

vector<Tag> ModifyStreamLiveChannelRequest::GetTags() const
{
    return m_tags;
}

void ModifyStreamLiveChannelRequest::SetTags(const vector<Tag>& _tags)
{
    m_tags = _tags;
...
GeneralSetting ModifyStreamLiveChannelRequest::GetGeneralSettings() const
{
    return m_generalSettings;
}

void ModifyStreamLiveChannelRequest::SetGeneralSettings(const GeneralSetting& _generalSettings)
{
    m_generalSettings = _generalSettings;
    m_generalSettingsHasBeenSet = true;
}

bool ModifyStreamLiveChannelRequest::GeneralSettingsHasBeenSet() const
{
