...
CoreInternalOutcome DescribeStreamLiveWatermarksResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveWatermarksResponse::ToJsonString() const
{
...
vector<DescribeWatermarkInfo> DescribeStreamLiveWatermarksResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLiveWatermarksResponse::InfosHasBeenSet() const
{
