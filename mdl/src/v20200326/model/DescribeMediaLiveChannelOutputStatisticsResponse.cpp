...
CoreInternalOutcome DescribeMediaLiveChannelOutputStatisticsResponse::Deserialize(const string &payload)
{
    Document d;
...
vector<ChannelOutputsStatistics> DescribeMediaLiveChannelOutputStatisticsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeMediaLiveChannelOutputStatisticsResponse::InfosHasBeenSet() const
{
