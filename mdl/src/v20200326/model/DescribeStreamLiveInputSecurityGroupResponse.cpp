...
CoreInternalOutcome DescribeStreamLiveInputSecurityGroupResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLiveInputSecurityGroupResponse::ToJsonString() const
{
...
InputSecurityGroupInfo DescribeStreamLiveInputSecurityGroupResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamLiveInputSecurityGroupResponse::InfoHasBeenSet() const
{
