...
CoreInternalOutcome ModifyStreamLiveInputSecurityGroupResponse::Deserialize(const string &payload)
{
...
string ModifyStreamLiveInputSecurityGroupResponse::ToJsonString() const
{
