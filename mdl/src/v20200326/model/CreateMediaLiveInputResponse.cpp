...
CoreInternalOutcome CreateMediaLiveInputResponse::Deserialize(const string &payload)
{
    Document d;
...
string CreateMediaLiveInputResponse::GetId() const
{
    return m_id;
}

bool CreateMediaLiveInputResponse::IdHasBeenSet() const
{
