...
CoreInternalOutcome DescribeStreamLivePlansResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLivePlansResponse::ToJsonString() const
{
...
vector<PlanResp> DescribeStreamLivePlansResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamLivePlansResponse::InfosHasBeenSet() const
{
