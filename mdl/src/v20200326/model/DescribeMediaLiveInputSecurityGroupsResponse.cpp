...
CoreInternalOutcome DescribeMediaLiveInputSecurityGroupsResponse::Deserialize(const string &payload)
{
    Document d;
...
vector<InputSecurityGroupInfo> DescribeMediaLiveInputSecurityGroupsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeMediaLiveInputSecurityGroupsResponse::InfosHasBeenSet() const
{
