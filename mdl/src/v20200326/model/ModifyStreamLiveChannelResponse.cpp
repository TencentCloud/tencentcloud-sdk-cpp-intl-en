...
CoreInternalOutcome ModifyStreamLiveChannelResponse::Deserialize(const string &payload)
{
...
string ModifyStreamLiveChannelResponse::ToJsonString() const
{
...
string ModifyStreamLiveChannelResponse::GetTagMsg() const
{
    return m_tagMsg;
}

bool ModifyStreamLiveChannelResponse::TagMsgHasBeenSet() const
{
