...
#ifndef TENCENTCLOUD_MDL_V20200326_MODEL_MODIFYSTREAMLIVECHANNELREQUEST_H_
#define TENCENTCLOUD_MDL_V20200326_MODEL_MODIFYSTREAMLIVECHANNELREQUEST_H_
    ...
    namespace Mdl
    {
        namespace V20200326
        {
            namespace Model
            {
                ...
                */
                class ModifyStreamLiveChannelRequest : public AbstractModel
                {
                public:
                    ModifyStreamLiveChannelRequest();
                    ~ModifyStreamLiveChannelRequest() = default;
...
#endif // !TENCENTCLOUD_MDL_V20200326_MODEL_MODIFYSTREAMLIVECHANNELREQUEST_H_
