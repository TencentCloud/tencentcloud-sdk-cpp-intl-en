...
#ifndef TENCENTCLOUD_MDL_V20200326_MODEL_CREATESTREAMLIVECHANNELRESPONSE_H_
#define TENCENTCLOUD_MDL_V20200326_MODEL_CREATESTREAMLIVECHANNELRESPONSE_H_
    ...
    namespace Mdl
    {
        namespace V20200326
        {
            namespace Model
            {
                ...
                */
                class CreateStreamLiveChannelResponse : public AbstractModel
                {
                public:
                    CreateStreamLiveChannelResponse();
                    ~CreateStreamLiveChannelResponse() = default;
...
#endif // !TENCENTCLOUD_MDL_V20200326_MODEL_CREATESTREAMLIVECHANNELRESPONSE_H_
