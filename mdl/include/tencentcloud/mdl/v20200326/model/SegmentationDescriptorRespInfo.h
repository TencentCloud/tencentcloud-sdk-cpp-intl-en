...
#ifndef TENCENTCLOUD_MDL_V20200326_MODEL_SEGMENTATIONDESCRIPTORRESPINFO_H_
#define TENCENTCLOUD_MDL_V20200326_MODEL_SEGMENTATIONDESCRIPTORRESPINFO_H_
    ...
    namespace Mdl
    {
        namespace V20200326
        {
            namespace Model
            {
                ...
                */
                class SegmentationDescriptorRespInfo : public AbstractModel
                {
                public:
                    SegmentationDescriptorRespInfo();
                    ~SegmentationDescriptorRespInfo() = default;
...
#endif // !TENCENTCLOUD_MDL_V20200326_MODEL_SEGMENTATIONDESCRIPTORRESPINFO_H_
