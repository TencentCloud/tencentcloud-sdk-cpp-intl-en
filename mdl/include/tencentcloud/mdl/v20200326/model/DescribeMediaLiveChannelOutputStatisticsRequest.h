...
#ifndef TENCENTCLOUD_MDL_V20200326_MODEL_DESCRIBEMEDIALIVECHANNELOUTPUTSTATISTICSREQUEST_H_
#define TENCENTCLOUD_MDL_V20200326_MODEL_DESCRIBEMEDIALIVECHANNELOUTPUTSTATISTICSREQUEST_H_
    ...
    namespace Mdl
    {
        namespace V20200326
        {
            namespace Model
            {
                ...
                */
                class DescribeMediaLiveChannelOutputStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeMediaLiveChannelOutputStatisticsRequest();
                    ~DescribeMediaLiveChannelOutputStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_MDL_V20200326_MODEL_DESCRIBEMEDIALIVECHANNELOUTPUTSTATISTICSREQUEST_H_
