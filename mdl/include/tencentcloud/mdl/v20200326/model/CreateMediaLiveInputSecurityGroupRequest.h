...
#ifndef TENCENTCLOUD_MDL_V20200326_MODEL_CREATEMEDIALIVEINPUTSECURITYGROUPREQUEST_H_
#define TENCENTCLOUD_MDL_V20200326_MODEL_CREATEMEDIALIVEINPUTSECURITYGROUPREQUEST_H_
    ...
    namespace Mdl
    {
        namespace V20200326
        {
            namespace Model
            {
                ...
                */
                class CreateMediaLiveInputSecurityGroupRequest : public AbstractModel
                {
                public:
                    ...
                    /**
                     * 获取Input security group name, which can contain letters, digits, and underscores and must be unique at the region level.
                    ...
                    /**
                     * 设置Input security group name, which can contain letters, digits, and underscores and must be unique at the region level.
...
#endif // !TENCENTCLOUD_MDL_V20200326_MODEL_CREATEMEDIALIVEINPUTSECURITYGROUPREQUEST_H_
