...
#ifndef TENCENTCLOUD_MDL_V20200326_MODEL_EVENTSETTINGSDESTINATIONRESP_H_
#define TENCENTCLOUD_MDL_V20200326_MODEL_EVENTSETTINGSDESTINATIONRESP_H_
    ...
    namespace Mdl
    {
        namespace V20200326
        {
            namespace Model
            {
                ...
                */
                class EventSettingsDestinationResp : public AbstractModel
                {
                public:
                    EventSettingsDestinationResp();
                    ~EventSettingsDestinationResp() = default;
...
#endif // !TENCENTCLOUD_MDL_V20200326_MODEL_EVENTSETTINGSDESTINATIONRESP_H_
