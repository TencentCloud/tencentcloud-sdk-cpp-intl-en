...
#ifndef TENCENTCLOUD_MDL_V20200326_MODEL_PLANREQ_H_
#define TENCENTCLOUD_MDL_V20200326_MODEL_PLANREQ_H_
    ...
    namespace Mdl
    {
        namespace V20200326
        {
            namespace Model
            {
                ...
                */
                class PlanReq : public AbstractModel
                {
                public:
                    PlanReq();
                    ~PlanReq() = default;
                ...
                private:
                     ...
                     */
                    TimingSettingsReq m_timingSettings;
                    bool m_timingSettingsHasBeenSet;

                    /**
                     * Event configuration
                     */
                    EventSettingsReq m_eventSettings;
...
#endif // !TENCENTCLOUD_MDL_V20200326_MODEL_PLANREQ_H_
