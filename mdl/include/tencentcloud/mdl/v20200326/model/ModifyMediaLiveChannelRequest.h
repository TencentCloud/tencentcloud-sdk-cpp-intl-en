...
#ifndef TENCENTCLOUD_MDL_V20200326_MODEL_MODIFYMEDIALIVECHANNELREQUEST_H_
#define TENCENTCLOUD_MDL_V20200326_MODEL_MODIFYMEDIALIVECHANNELREQUEST_H_
    ...
    namespace Mdl
    {
        namespace V20200326
        {
            namespace Model
            {
                ...
                */
                class ModifyMediaLiveChannelRequest : public AbstractModel
                {
                public:
                    ModifyMediaLiveChannelRequest();
                    ~ModifyMediaLiveChannelRequest() = default;
...
#endif // !TENCENTCLOUD_MDL_V20200326_MODEL_MODIFYMEDIALIVECHANNELREQUEST_H_
