...
#ifndef TENCENTCLOUD_MDL_V20200326_MODEL_DESCRIBESTREAMLIVECHANNELOUTPUTSTATISTICSREQUEST_H_
#define TENCENTCLOUD_MDL_V20200326_MODEL_DESCRIBESTREAMLIVECHANNELOUTPUTSTATISTICSREQUEST_H_
    ...
    namespace Mdl
    {
        namespace V20200326
        {
            namespace Model
            {
                ...
                */
                class DescribeStreamLiveChannelOutputStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeStreamLiveChannelOutputStatisticsRequest();
                    ~DescribeStreamLiveChannelOutputStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_MDL_V20200326_MODEL_DESCRIBESTREAMLIVECHANNELOUTPUTSTATISTICSREQUEST_H_
