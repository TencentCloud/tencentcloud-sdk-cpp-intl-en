...
#ifndef TENCENTCLOUD_LIVE_V20180801_MODEL_DELETELIVECERTREQUEST_H_
#define TENCENTCLOUD_LIVE_V20180801_MODEL_DELETELIVECERTREQUEST_H_
    ...
    namespace Live
    {
        namespace V20180801
        {
            namespace Model
            {
                ...
                */
                class DeleteLiveCertRequest : public AbstractModel
                {
                public:
                    DeleteLiveCertRequest();
                    ~DeleteLiveCertRequest() = default;
...
#endif // !TENCENTCLOUD_LIVE_V20180801_MODEL_DELETELIVECERTREQUEST_H_
