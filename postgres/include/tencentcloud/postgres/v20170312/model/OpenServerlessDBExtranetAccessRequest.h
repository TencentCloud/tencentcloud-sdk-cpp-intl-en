...
#ifndef TENCENTCLOUD_POSTGRES_V20170312_MODEL_OPENSERVERLESSDBEXTRANETACCESSREQUEST_H_
#define TENCENTCLOUD_POSTGRES_V20170312_MODEL_OPENSERVERLESSDBEXTRANETACCESSREQUEST_H_
    ...
    namespace Postgres
    {
        namespace V20170312
        {
            namespace Model
            {
                ...
                */
                class OpenServerlessDBExtranetAccessRequest : public AbstractModel
                {
                public:
                    OpenServerlessDBExtranetAccessRequest();
                    ~OpenServerlessDBExtranetAccessRequest() = default;
...
#endif // !TENCENTCLOUD_POSTGRES_V20170312_MODEL_OPENSERVERLESSDBEXTRANETACCESSREQUEST_H_
