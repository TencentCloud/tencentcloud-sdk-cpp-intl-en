            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Cloud dedicated zone local time this monday date.
                     * @return ThisMondayLocalDate Cloud dedicated zone local time this monday date.
                     * 
                     */
                    std::string GetThisMondayLocalDate() const;

                    /**
                     * 设置Cloud dedicated zone local time this monday date.
                    ...
                    /**
                     * 获取Cloud dedicated zone local time last monday date.
                     * @return LastMondayLocalDate Cloud dedicated zone local time last monday date.
                     * 
                     */
                    std::string GetLastMondayLocalDate() const;

                    /**
                     * 设置Cloud dedicated zone local time last monday date.
