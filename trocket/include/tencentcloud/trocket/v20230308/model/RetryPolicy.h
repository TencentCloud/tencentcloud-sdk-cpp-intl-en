            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Retry policy type. The enumeration values are as follows:
...
-CUSTOMIZED: Tier backoff
                    ...
                    /**
                     * 设置Retry policy type. The enumeration values are as follows:
...
-CUSTOMIZED: Tier backoff
                    ...
                    /**
                     * 获取Fixed retry interval. This parameter takes effect when a fixed interval-based retry policy is configured.
                    ...
                    /**
                     * 设置Fixed retry interval. This parameter takes effect when a fixed interval-based retry policy is configured.
