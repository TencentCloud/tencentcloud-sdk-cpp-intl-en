...
- PREPAID: monthly subscription.
                    ...
                    /**
                     * 获取Expiration timestamp. **It is a Unix timestamp (ms).**
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 设置Expiration timestamp. **It is a Unix timestamp (ms).**
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Whether automatic renewal is enabled. This parameter is valid only for prepaid clusters. 0: automatic renewal disabled; 1: automatic renewal enabled.
                    ...
                    /**
                     * 设置Whether automatic renewal is enabled. This parameter is valid only for prepaid clusters. 0: automatic renewal disabled; 1: automatic renewal enabled.
