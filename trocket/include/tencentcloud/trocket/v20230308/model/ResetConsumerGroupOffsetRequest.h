            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Timestamp (unit: millisecond) for resetting the offset. The value -1 indicates resetting to the latest offset.
                    ...
                    /**
                     * 设置Timestamp (unit: millisecond) for resetting the offset. The value -1 indicates resetting to the latest offset.
