...
string CloseWanServiceRequest::ToJsonString() const
{
...
string CloseWanServiceRequest::GetInstanceId() const
{
    return m_instanceId;
}

void CloseWanServiceRequest::SetInstanceId(const string& _instanceId)
{
