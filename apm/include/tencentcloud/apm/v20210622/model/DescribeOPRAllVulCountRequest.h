...
#ifndef TENCENTCLOUD_APM_V20210622_MODEL_DESCRIBEOPRALLVULCOUNTREQUEST_H_
#define TENCENTCLOUD_APM_V20210622_MODEL_DESCRIBEOPRALLVULCOUNTREQUEST_H_
    ...
    namespace Apm
    {
        namespace V20210622
        {
            namespace Model
            {
                ...
                */
                class DescribeOPRAllVulCountRequest : public AbstractModel
                {
                public:
                    DescribeOPRAllVulCountRequest();
                    ~DescribeOPRAllVulCountRequest() = default;
...
#endif // !TENCENTCLOUD_APM_V20210622_MODEL_DESCRIBEOPRALLVULCOUNTREQUEST_H_
