            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Input information of face recognition task.
                    ...
                    /**
                     * 设置Input information of face recognition task.
...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取The progress of a face recognition task. Value range: 0-100.
                    ...
                    /**
                     * 设置The progress of a face recognition task. Value range: 0-100.
                    ...
                    /**
                     * 获取The time when the face recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the face recognition task started, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 获取The time when the face recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the face recognition task was completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
