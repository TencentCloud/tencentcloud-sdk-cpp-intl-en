...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_CREATEAIGCAUDIOCLONETASK_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_CREATEAIGCAUDIOCLONETASK_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class CreateAigcAudioCloneTask : public AbstractModel
                {
                public:
                    CreateAigcAudioCloneTask();
                    ~CreateAigcAudioCloneTask() = default;
                    ...
                    /**
                     * 获取<p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
                    ...
                    /**
                     * 设置<p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
                     * @param _errCode <p>Error code. Returns a non-zero error code in case of a source error. Please use the ErrCode of each specific task when 0 is returned.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
                    ...
                    /**
                     * 设置<p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
                     * @param _errCodeExt <p>Error code expansion. A null string indicates success, while other values indicate failure.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Input information for the AIGC audio clone task.</p>
                     * @return Input <p>Input information for the AIGC audio clone task.</p>
                     * 
                     */
                    CreateAigcAudioCloneInput GetInput() const;

                    /**
                     * 设置<p>Input information for the AIGC audio clone task.</p>
                     * @param _input <p>Input information for the AIGC audio clone task.</p>
                     * 
                     */
                    void SetInput(const CreateAigcAudioCloneInput& _input);
                    ...
                    /**
                     * 获取<p>Output information for the AIGC audio clone task.</p>
                    ...
                    /**
                     * 设置<p>Output information for the AIGC audio clone task.</p>
                     * @param _output <p>Output information for the AIGC audio clone task.</p>
                     * 
                     */
                ...
                private:
                     ...
                     */
                    CreateAigcAudioCloneInput m_input;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_CREATEAIGCAUDIOCLONETASK_H_
