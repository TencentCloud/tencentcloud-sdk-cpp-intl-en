            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Intelligent frame-specific tagging task input.
                    ...
                    /**
                     * 设置Intelligent frame-specific tagging task input.
                     * @param _input Intelligent frame-specific tagging task input.
                     * 
                     */
                    ...
                    /**
                     * 获取Intelligent frame-specific tagging task output.
                    ...
                    /**
                     * 设置Intelligent frame-specific tagging task output.
                     * @param _output Intelligent frame-specific tagging task output.
                     * 
                     */
                    ...
                    /**
                     * 获取Intelligent frame-specific tagging task progress, in the range of [0,100].
                    ...
                    /**
                     * 设置Intelligent frame-specific tagging task progress, in the range of [0,100].
                     * @param _progress Intelligent frame-specific tagging task progress, in the range of [0,100].
                     * 
                     */
                    ...
                    /**
                     * 获取Intelligent frame-specific tagging task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                    ...
                    /**
                     * 设置Intelligent frame-specific tagging task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * @param _beginProcessTime Intelligent frame-specific tagging task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * 
                     */
                    ...
                    /**
                     * 获取Task completion time of intelligent frame tagging in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                    ...
                    /**
                     * 设置Task completion time of intelligent frame tagging in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * @param _finishTime Task completion time of intelligent frame tagging in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * 
                     */
