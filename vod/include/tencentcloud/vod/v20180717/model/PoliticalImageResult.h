            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取The confidence score for the politically sensitive content recognition result. Value range: 0-100.
                     * @return Confidence The confidence score for the politically sensitive content recognition result. Value range: 0-100.
                     */
                    double GetConfidence() const;

                    /**
                     * 设置The confidence score for the politically sensitive content recognition result. Value range: 0-100.
...
<li>block</li>
                    ...
                    /**
                     * 获取The coordinates (pixel) of the top-left and bottom-right corners of the frame where politically sensitive content or a banned icon appears. Format: [x1, y1, x2, y2].
                    ...
                    /**
                     * 设置The coordinates (pixel) of the top-left and bottom-right corners of the frame where politically sensitive content or a banned icon appears. Format: [x1, y1, x2, y2].
