            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Input for the intelligent tag task.
                    ...
                    /**
                     * 设置Input for the intelligent tag task.
                     * @param _input Input for the intelligent tag task.
                     * 
                     */
                    ...
                    /**
                     * 获取Progress of the intelligent tag task, with a value range of [0-100].
                    ...
                    /**
                     * 设置Progress of the intelligent tag task, with a value range of [0-100].
                     * @param _progress Progress of the intelligent tag task, with a value range of [0-100].
                     * 
                     */
                    ...
                    /**
                     * 获取Intelligent tag task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                    ...
                    /**
                     * 设置Intelligent tag task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * @param _beginProcessTime Intelligent tag task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * 
                     */
                    ...
                    /**
                     * 获取Task completion time of the intelligent tag in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                    ...
                    /**
                     * 设置Task completion time of the intelligent tag in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * @param _finishTime Task completion time of the intelligent tag in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * 
                     */
