            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Switch of porn detection in video image task. Valid values:
...
<li>OFF: disables porn detection in video image task.</li>
                    ...
                    /**
                     * 设置Switch of porn detection in video image task. Valid values:
<li>ON: enables porn detection in video image task;</li>
<li>OFF: disables porn detection in video image task.</li>
...
<li>OFF: disables porn detection in video image task.</li>
                    ...
                    /**
                     * 获取Filter tag for porn detection in video image. If an audit result contains the selected tag, it will be returned; if the filter tag is empty, all audit results will be returned. Valid values:
<li>porn: porn;</li>
...
<li>sexy: sexiness.</li>
                    ...
                    /**
                     * 设置Filter tag for porn detection in video image. If an audit result contains the selected tag, it will be returned; if the filter tag is empty, all audit results will be returned. Valid values:
<li>porn: porn;</li>
<li>vulgar: vulgarity;</li>
<li>intimacy: intimacy;</li>
<li>sexy: sexiness.</li>
