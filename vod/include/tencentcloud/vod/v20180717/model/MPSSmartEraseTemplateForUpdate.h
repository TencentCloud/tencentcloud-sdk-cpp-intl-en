...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_MPSSMARTERASETEMPLATEFORUPDATE_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_MPSSMARTERASETEMPLATEFORUPDATE_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class MPSSmartEraseTemplateForUpdate : public AbstractModel
                {
                public:
                    MPSSmartEraseTemplateForUpdate();
                    ~MPSSmartEraseTemplateForUpdate() = default;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_MPSSMARTERASETEMPLATEFORUPDATE_H_
