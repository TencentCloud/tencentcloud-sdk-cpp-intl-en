            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Category ID, used to categorize and manage media. You can call the [Create Category](https://www.tencentcloud.com/document/product/266/7812?from_cn_redirect=1) API to create a category and obtain the category ID.
...
<li>Default value: 0, indicate other categories.</li>
                    ...
                    /**
                     * 设置Category ID, used to categorize and manage media. You can call the [Create Category](https://www.tencentcloud.com/document/product/266/7812?from_cn_redirect=1) API to create a category and obtain the category ID.
<li>Default value: 0, indicate other categories.</li>
                     * @param _classId Category ID, used to categorize and manage media. You can call the [Create Category](https://www.tencentcloud.com/document/product/266/7812?from_cn_redirect=1) API to create a category and obtain the category ID.
<li>Default value: 0, indicate other categories.</li>
                     * 
                     */
