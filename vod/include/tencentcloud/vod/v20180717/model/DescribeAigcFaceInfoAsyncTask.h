            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Asynchronously fetch the input information of AIGC face information tasks.</p>
                    ...
                    /**
                     * 设置<p>Asynchronously fetch the input information of AIGC face information tasks.</p>
                     * @param _input <p>Asynchronously fetch the input information of AIGC face information tasks.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Asynchronously fetch the output information of the AIGC human face information task.</p>
                    ...
                    /**
                     * 设置<p>Asynchronously fetch the output information of the AIGC human face information task.</p>
                     * @param _output <p>Asynchronously fetch the output information of the AIGC human face information task.</p>
                     * 
                     */
