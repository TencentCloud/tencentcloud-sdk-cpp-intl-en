            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Unique ID filter of video content recognition templates. Array length limit: 100.
                     * @return Definitions Unique ID filter of video content recognition templates. Array length limit: 100.
                     */
                    std::vector<int64_t> GetDefinitions() const;

                    /**
                     * 设置Unique ID filter of video content recognition templates. Array length limit: 100.
