...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_CLONEVOICEASYNCTASK_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_CLONEVOICEASYNCTASK_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                * Voice cloning task.
                */
                class CloneVoiceAsyncTask : public AbstractModel
                {
                public:
                    CloneVoiceAsyncTask();
                    ~CloneVoiceAsyncTask() = default;
                    ...
                    /**
                     * 获取<p>Error code. 0 indicates success, and other values indicate failure:</p><li>40000: Invalid parameters. Check the input parameters.</li><li>60000: Source file error (for example, video data corruption). Confirm whether the source file is normal.</li><li>70000: Internal service error. Retry is recommended.</li>
                    ...
                    /**
                     * 设置<p>Error code. 0 indicates success, and other values indicate failure:</p><li>40000: Invalid parameters. Check the input parameters.</li><li>60000: Source file error (for example, video data corruption). Confirm whether the source file is normal.</li><li>70000: Internal service error. Retry is recommended.</li>
                    ...
                    /**
                     * 设置<p>Error code. An empty string indicates that the task is successful, while other values indicate that the task has failed. For valid values, see the list of <a href="https://www.tencentcloud.com/document/product/266/50368?from_cn_redirect=1#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">video processing error codes</a>.</p>
                     * @param _errCodeExt <p>Error code. An empty string indicates that the task is successful, while other values indicate that the task has failed. For valid values, see the list of <a href="https://www.tencentcloud.com/document/product/266/50368?from_cn_redirect=1#.E8.A7.86.E9.A2.91.E5.A4.84.E7.90.86.E7.B1.BB.E9.94.99.E8.AF.AF.E7.A0.81">video processing error codes</a>.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Voice type clone task input information.</p>
                     * @return Input <p>Voice type clone task input information.</p>
                     * 
                     */
                    CloneVoiceAsyncInput GetInput() const;

                    /**
                     * 设置<p>Voice type clone task input information.</p>
                     * @param _input <p>Voice type clone task input information.</p>
                     * 
                     */
                    void SetInput(const CloneVoiceAsyncInput& _input);
                    ...
                    /**
                     * 获取<p>Voice type clone task output information.</p>
                     * @return Output <p>Voice type clone task output information.</p>
                     * 
                     */
                    CloneVoiceAsyncOutput GetOutput() const;

                    /**
                     * 设置<p>Voice type clone task output information.</p>
                     * @param _output <p>Voice type clone task output information.</p>
                     * 
                     */
                    void SetOutput(const CloneVoiceAsyncOutput& _output);
                ...
                private:
                     ...
                     */
                    CloneVoiceAsyncInput m_input;
                    bool m_inputHasBeenSet;

                    /**
                     * <p>Voice type clone task output information.</p>
                     */
                    CloneVoiceAsyncOutput m_output;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_CLONEVOICEASYNCTASK_H_
