...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_DELETEPROCESSIMAGEASYNCTEMPLATEREQUEST_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_DELETEPROCESSIMAGEASYNCTEMPLATEREQUEST_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class DeleteProcessImageAsyncTemplateRequest : public AbstractModel
                {
                public:
                    DeleteProcessImageAsyncTemplateRequest();
                    ~DeleteProcessImageAsyncTemplateRequest() = default;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_DELETEPROCESSIMAGEASYNCTEMPLATEREQUEST_H_
