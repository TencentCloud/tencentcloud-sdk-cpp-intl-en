            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Name of the image asynchronous processing template. The length cannot exceed 64 characters.
                    ...
                    /**
                     * 设置Name of the image asynchronous processing template. The length cannot exceed 64 characters.
                     * @param _name Name of the image asynchronous processing template. The length cannot exceed 64 characters.
                     * 
                     */
                    ...
                    /**
                     * 获取Asynchronous image processing configuration.
                    ...
                    /**
                     * 设置Asynchronous image processing configuration.
                     * @param _processImageConfigure Asynchronous image processing configuration.
                     * 
                     */
