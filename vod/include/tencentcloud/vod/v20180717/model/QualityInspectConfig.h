            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Sampling interval time</p><p>Measurement unit: ms.</p>
                    ...
                    /**
                     * 设置<p>Sampling interval time</p><p>Measurement unit: ms.</p>
                     * @param _intervalTime <p>Sampling interval time</p><p>Measurement unit: ms.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Duration of abnormality.</p><p>Measurement unit: millisecond.</p>
                    ...
                    /**
                     * 设置<p>Duration of abnormality.</p><p>Measurement unit: millisecond.</p>
                     * @param _duration <p>Duration of abnormality.</p><p>Measurement unit: millisecond.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Threshold of a detection item. Different detection items have different thresholds.</p>
                    ...
                    /**
                     * 设置<p>Threshold of a detection item. Different detection items have different thresholds.</p>
                     * @param _threshold <p>Threshold of a detection item. Different detection items have different thresholds.</p>
                     * 
                     */
