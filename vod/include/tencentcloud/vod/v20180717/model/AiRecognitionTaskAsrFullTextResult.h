            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Input information on the full speech recognition task.
                    ...
                    /**
                     * 设置Input information on the full speech recognition task.
                    ...
                    /**
                     * 获取Speech full-text recognition task progress, in the range of [0,100].
                    ...
                    /**
                     * 设置Speech full-text recognition task progress, in the range of [0,100].
                     * @param _progress Speech full-text recognition task progress, in the range of [0,100].
                     * 
                     */
                    ...
                    /**
                     * 获取Speech full-text recognition task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                    ...
                    /**
                     * 设置Speech full-text recognition task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * @param _beginProcessTime Speech full-text recognition task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * 
                     */
                    ...
                    /**
                     * 获取Task completion time of full text speech recognition in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                    ...
                    /**
                     * 设置Task completion time of full text speech recognition in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * @param _finishTime Task completion time of full text speech recognition in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * 
                     */
