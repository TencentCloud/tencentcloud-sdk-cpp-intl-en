...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Input of OCR-based porn information detection in text task in content audit.
                    ...
                    /**
                     * 设置Input of OCR-based porn information detection in text task in content audit.
                    ...
                    /**
                     * 获取Output of OCR-based porn information detection in text task in content audit.
Note: this field may return null, indicating that no valid values can be obtained.
...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 设置Output of OCR-based porn information detection in text task in content audit.
Note: this field may return null, indicating that no valid values can be obtained.
