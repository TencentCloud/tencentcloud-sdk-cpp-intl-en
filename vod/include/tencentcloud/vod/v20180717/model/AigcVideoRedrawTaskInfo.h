            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>For description of the style. Limited to 50 characters.</p>
                    ...
                    /**
                     * 设置<p>For description of the style. Limited to 50 characters.</p>
                     * @param _style <p>For description of the style. Limited to 50 characters.</p>
                     * 
                     */
