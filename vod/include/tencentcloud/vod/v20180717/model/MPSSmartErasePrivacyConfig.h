            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Privacy protection removal method.</p><p>Enumeration values:</p><ul><li>blur: Blurry</li><li>mosaic: Mosaic</li></ul>
                    ...
                    /**
                     * 设置<p>Privacy protection removal method.</p><p>Enumeration values:</p><ul><li>blur: Blurry</li><li>mosaic: Mosaic</li></ul>
                     * @param _privacyModel <p>Privacy protection removal method.</p><p>Enumeration values:</p><ul><li>blur: Blurry</li><li>mosaic: Mosaic</li></ul>
                     * 
                     */
