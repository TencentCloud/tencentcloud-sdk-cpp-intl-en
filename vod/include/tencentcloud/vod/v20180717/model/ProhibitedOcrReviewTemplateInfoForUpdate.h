...
<li>OFF: disables the text prohibition task.</li>
                    ...
                    /**
                     * 获取Threshold score for determining suspected violations. When the review score reaches this threshold or above, it is considered a suspected violation. Default value: 100. Value range: 0–100.
                    ...
                    /**
                     * 设置Threshold score for determining suspected violations. When the review score reaches this threshold or above, it is considered a suspected violation. Default value: 100. Value range: 0–100.
                     * @param _blockConfidence Threshold score for determining suspected violations. When the review score reaches this threshold or above, it is considered a suspected violation. Default value: 100. Value range: 0–100.
                     * 
                     */
