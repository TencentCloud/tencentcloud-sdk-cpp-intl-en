            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Subtitle file format. Default value is vtt. This parameter is valid only when OcrSwitch takes value "ON".</p><ul><li>srt srt format</li><li>vtt WebVTT format</li><li>When SubtitleEmbedId is filled, empty string can be taken to indicate no output subtitles.</li></ul>
                    ...
                    /**
                     * 设置<p>Subtitle file format. Default value is vtt. This parameter is valid only when OcrSwitch takes value "ON".</p><ul><li>srt srt format</li><li>vtt WebVTT format</li><li>When SubtitleEmbedId is filled, empty string can be taken to indicate no output subtitles.</li></ul>
                     * @param _subtitleFormat <p>Subtitle file format. Default value is vtt. This parameter is valid only when OcrSwitch takes value "ON".</p><ul><li>srt srt format</li><li>vtt WebVTT format</li><li>When SubtitleEmbedId is filled, empty string can be taken to indicate no output subtitles.</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Whether caption translation is enabled or not. The default value is OFF. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>ON Enable</li><li>OFF Disable</li></ul>
                    ...
                    /**
                     * 设置<p>Whether caption translation is enabled or not. The default value is OFF. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>ON Enable</li><li>OFF Disable</li></ul>
                     * @param _transSwitch <p>Whether caption translation is enabled or not. The default value is OFF. This parameter is valid only when OcrSwitch is set to "ON".</p><ul><li>ON Enable</li><li>OFF Disable</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 设置<p>The target language for subtitles, default value is en; this parameter is valid only when TransSwitch is set to "ON".<br>Currently support the following languages:<br>zh: Simplified Chinese<br>en: English<br>ja: Japanese<br>ko: Korean<br>fr: French<br>es: Spanish<br>it: Italian<br>de: German<br>tr: Turkish<br>ru: Russian<br>pt: Portuguese<br>vi: Vietnamese<br>id: Indonesian<br>ms: Malay<br>th: Thai<br>ar: Arabic<br>hi: Hindi</p>
                     * @param _transDstLang <p>The target language for subtitles, default value is en; this parameter is valid only when TransSwitch is set to "ON".<br>Currently support the following languages:<br>zh: Simplified Chinese<br>en: English<br>ja: Japanese<br>ko: Korean<br>fr: French<br>es: Spanish<br>it: Italian<br>de: German<br>tr: Turkish<br>ru: Russian<br>pt: Portuguese<br>vi: Vietnamese<br>id: Indonesian<br>ms: Malay<br>th: Thai<br>ar: Arabic<br>hi: Hindi</p>
                     * 
                     */
