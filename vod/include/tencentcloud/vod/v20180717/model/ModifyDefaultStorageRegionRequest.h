            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Default storage region. It must be an opened region (query via the DescribeStorageRegions API).
                    ...
                    /**
                     * 设置Default storage region. It must be an opened region (query via the DescribeStorageRegions API).
                     * @param _storageRegion Default storage region. It must be an opened region (query via the DescribeStorageRegions API).
                     * 
                     */
