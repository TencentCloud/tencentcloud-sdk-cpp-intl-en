...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_CREATEAIGCADVANCEDCUSTOMELEMENTTASK_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_CREATEAIGCADVANCEDCUSTOMELEMENTTASK_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class CreateAigcAdvancedCustomElementTask : public AbstractModel
                {
                public:
                    CreateAigcAdvancedCustomElementTask();
                    ~CreateAigcAdvancedCustomElementTask() = default;
                    ...
                    /**
                     * 获取<p>Task status.</p><p>Enumeration values: </p><ul><li>PROCESSING: Processing</li><li>FINISH: Completed</li></ul>
                    ...
                    /**
                     * 设置<p>Task status.</p><p>Enumeration values: </p><ul><li>PROCESSING: Processing</li><li>FINISH: Completed</li></ul>
                     * @param _status <p>Task status.</p><p>Enumeration values: </p><ul><li>PROCESSING: Processing</li><li>FINISH: Completed</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Create AIGC custom subject task output information.</p>
                     * @return Output <p>Create AIGC custom subject task output information.</p>
                     * 
                     */
                    CreateAigcAdvancedCustomElementOutput GetOutput() const;

                    /**
                     * 设置<p>Create AIGC custom subject task output information.</p>
                     * @param _output <p>Create AIGC custom subject task output information.</p>
                     * 
                     */
                    void SetOutput(const CreateAigcAdvancedCustomElementOutput& _output);
                ...
                private:
                     ...
                     */
                    CreateAigcAdvancedCustomElementOutput m_output;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_CREATEAIGCADVANCEDCUSTOMELEMENTTASK_H_
