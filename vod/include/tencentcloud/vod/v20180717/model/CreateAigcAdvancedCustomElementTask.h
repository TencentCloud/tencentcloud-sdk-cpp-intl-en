            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Input of the task to create a custom AIGC subject.</p>
                    ...
                    /**
                     * 设置<p>Input of the task to create a custom AIGC subject.</p>
                     * @param _input <p>Input of the task to create a custom AIGC subject.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Create custom AIGC task output information.</p>
                    ...
                    /**
                     * 设置<p>Create custom AIGC task output information.</p>
                     * @param _output <p>Create custom AIGC task output information.</p>
                     * 
                     */
