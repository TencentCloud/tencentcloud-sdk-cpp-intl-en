...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Input of sampled screencapturing task.
                    ...
                    /**
                     * 设置Input of sampled screencapturing task.
                    ...
                    /**
                     * 获取Output of sampled screencapturing task.
Note: this field may return null, indicating that no valid values can be obtained.
...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 设置Output of sampled screencapturing task.
Note: this field may return null, indicating that no valid values can be obtained.
...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取The progress of a sampled screenshot task. Value range: 0-100.
                    ...
                    /**
                     * 设置The progress of a sampled screenshot task. Value range: 0-100.
                    ...
                    /**
                     * 获取The time when the sampling screenshot task starts execution is in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the sampling screenshot task starts execution is in [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 获取The time when the sampling screenshot task is completed uses [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the sampling screenshot task is completed uses [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
