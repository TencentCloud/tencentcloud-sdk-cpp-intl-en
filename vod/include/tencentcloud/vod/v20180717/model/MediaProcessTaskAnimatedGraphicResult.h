...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取The time when the rotation graph task started to execute, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the rotation graph task started to execute, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 获取The time when the rotation graph task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the rotation graph task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
