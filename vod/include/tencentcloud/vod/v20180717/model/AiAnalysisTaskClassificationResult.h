            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Input of intelligent categorization task.
                    ...
                    /**
                     * 设置Input of intelligent categorization task.
                    ...
                    /**
                     * 获取Intelligent classification task output.
                    ...
                    /**
                     * 设置Intelligent classification task output.
                     * @param _output Intelligent classification task output.
                     * 
                     */
                    ...
                    /**
                     * 获取The progress of an intelligent categorization task. Value range: 0-100.
                    ...
                    /**
                     * 设置The progress of an intelligent categorization task. Value range: 0-100.
                    ...
                    /**
                     * 获取The time when the intelligent classification task started to be executed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the intelligent classification task started to be executed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 获取The time when the intelligent classification task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the intelligent classification task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
