            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Output of the intelligent classification task.
                    ...
                    /**
                     * 设置Output of the intelligent classification task.
                     * @param _output Output of the intelligent classification task.
                     * 
                     */
                    ...
                    /**
                     * 获取Intelligent categorization task progress, in the range of [0,100].
                    ...
                    /**
                     * 设置Intelligent categorization task progress, in the range of [0,100].
                     * @param _progress Intelligent categorization task progress, in the range of [0,100].
                     * 
                     */
                    ...
                    /**
                     * 获取Intelligent categorization task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                    ...
                    /**
                     * 设置Intelligent categorization task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * @param _beginProcessTime Intelligent categorization task start execution time in [ISO datetime format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * 
                     */
                    ...
                    /**
                     * 获取Task completion time of intelligent categorization in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                    ...
                    /**
                     * 设置Task completion time of intelligent categorization in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * @param _finishTime Task completion time of intelligent categorization in [ISO date format](https://www.tencentcloud.com/document/product/266/11732?from_cn_redirect=1#I).
                     * 
                     */
