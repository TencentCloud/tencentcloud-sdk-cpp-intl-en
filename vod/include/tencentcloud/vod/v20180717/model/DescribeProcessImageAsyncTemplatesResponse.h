...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEPROCESSIMAGEASYNCTEMPLATESRESPONSE_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEPROCESSIMAGEASYNCTEMPLATESRESPONSE_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                */
                class DescribeProcessImageAsyncTemplatesResponse : public AbstractModel
                {
                public:
                    DescribeProcessImageAsyncTemplatesResponse();
                    ~DescribeProcessImageAsyncTemplatesResponse() = default;
                    ...
                    /**
                     * 判断参数 ProcessImageAsyncTemplateSet 是否已赋值
                     * @return ProcessImageAsyncTemplateSet 是否已赋值
                     * 
                     */
                    bool ProcessImageAsyncTemplateSetHasBeenSet() const;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_DESCRIBEPROCESSIMAGEASYNCTEMPLATESRESPONSE_H_
