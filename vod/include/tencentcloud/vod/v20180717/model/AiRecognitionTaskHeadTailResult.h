            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Input information of video opening and ending credits recognition task.
                    ...
                    /**
                     * 设置Input information of video opening and ending credits recognition task.
...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取The progress of an opening/closing segment recognition task. Value range: 0-100.
                    ...
                    /**
                     * 设置The progress of an opening/closing segment recognition task. Value range: 0-100.
                    ...
                    /**
                     * 获取The time when the video start and end recognition task starts, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the video start and end recognition task starts, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 获取The time when the video start and end recognition task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the video start and end recognition task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
