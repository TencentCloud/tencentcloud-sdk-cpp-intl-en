            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>ID of the knowledge base to be deleted.</p>
                    ...
                    /**
                     * 设置<p>ID of the knowledge base to be deleted.</p>
                     * @param _knowledgeBaseId <p>ID of the knowledge base to be deleted.</p>
                     * 
                     */
