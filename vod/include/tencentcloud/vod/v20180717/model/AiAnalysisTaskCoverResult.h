            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Intelligent Cover Task output.
                    ...
                    /**
                     * 设置Intelligent Cover Task output.
                     * @param _output Intelligent Cover Task output.
                     * 
                     */
                    ...
                    /**
                     * 获取The progress of an intelligent thumbnail generation task. Value range: 0-100.
                    ...
                    /**
                     * 设置The progress of an intelligent thumbnail generation task. Value range: 0-100.
                    ...
                    /**
                     * 获取The time when the smart cover task started to be executed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the smart cover task started to be executed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 获取The time when the smart cover task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
                    ...
                    /**
                     * 设置The time when the smart cover task is completed, using [ISO date format](https://www.tencentcloud.com/document/product/266/11732#iso-date-format).
