...
#ifndef TENCENTCLOUD_VOD_V20180717_MODEL_MPSRAWSMARTSUBTITLEPARAMETER_H_
#define TENCENTCLOUD_VOD_V20180717_MODEL_MPSRAWSMARTSUBTITLEPARAMETER_H_
    ...
    namespace Vod
    {
        namespace V20180717
        {
            namespace Model
            {
                ...
                * 
                */
                class MPSRawSmartSubtitleParameter : public AbstractModel
                {
                public:
                    MPSRawSmartSubtitleParameter();
                    ~MPSRawSmartSubtitleParameter() = default;
...
#endif // !TENCENTCLOUD_VOD_V20180717_MODEL_MPSRAWSMARTSUBTITLEPARAMETER_H_
