            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取The confidence score for the OCR-based recognition result. Value range: 0-100.
                     * @return Confidence The confidence score for the OCR-based recognition result. Value range: 0-100.
                     */
                    double GetConfidence() const;

                    /**
                     * 设置The confidence score for the OCR-based recognition result. Value range: 0-100.
