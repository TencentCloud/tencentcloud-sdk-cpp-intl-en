            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Create AIGC custom timbre input.</p>
                    ...
                    /**
                     * 设置<p>Create AIGC custom timbre input.</p>
                     * @param _input <p>Create AIGC custom timbre input.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Create custom voice type output message for AIGC.</p>
                    ...
                    /**
                     * 设置<p>Create custom voice type output message for AIGC.</p>
                     * @param _output <p>Create custom voice type output message for AIGC.</p>
                     * 
                     */
