            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取User-defined speech audit task switch. Available values:
...
<li>OFF: Disable the custom voice moderation task.</li>
                    ...
                    /**
                     * 设置User-defined speech audit task switch. Available values:
<li>ON: enable custom voice moderation task;</li>
<li>OFF: Disable the custom voice moderation task.</li>
                     * @param _switch User-defined speech audit task switch. Available values:
<li>ON: enable custom voice moderation task;</li>
<li>OFF: Disable the custom voice moderation task.</li>
                     * 
                     */
                    ...
                    /**
                     * 获取User-customized voice filter tags. The review results including the selected tags are returned. If the filter tag is empty, all review results will be returned. To use the tag filtering feature, add the corresponding tag when adding custom voice keyword material.
...
The number of tags can be up to 10, and each tag can contain up to 16 characters.
                    ...
                    /**
                     * 设置User-customized voice filter tags. The review results including the selected tags are returned. If the filter tag is empty, all review results will be returned. To use the tag filtering feature, add the corresponding tag when adding custom voice keyword material.
The number of tags can be up to 10, and each tag can contain up to 16 characters.
                     * @param _labelSet User-customized voice filter tags. The review results including the selected tags are returned. If the filter tag is empty, all review results will be returned. To use the tag filtering feature, add the corresponding tag when adding custom voice keyword material.
The number of tags can be up to 10, and each tag can contain up to 16 characters.
                     * 
                     */
