...
md5hash: MD5 (custom key + file path + timestamp)
                */
                ...
                public:
                    ...
                    /**
                     * 获取Timestamp parameter name;Only upper and lower-case letters, digits, and underscores (_) are allowed. It cannot start with a digit. Length limit: 1-100 characters.
                    ...
                    /**
                     * 设置Timestamp parameter name;Only upper and lower-case letters, digits, and underscores (_) are allowed. It cannot start with a digit. Length limit: 1-100 characters.
                     * @param _timeParam Timestamp parameter name;Only upper and lower-case letters, digits, and underscores (_) are allowed. It cannot start with a digit. Length limit: 1-100 characters.
                     * 
                     */
                    ...
                    /**
                     * 获取Timestamp settings: <li>dec: Decimal</li> <li>hex: Hexadecimal</li>
                    ...
                    /**
                     * 设置Timestamp settings: <li>dec: Decimal</li> <li>hex: Hexadecimal</li>
                     * @param _timeFormat Timestamp settings: <li>dec: Decimal</li> <li>hex: Hexadecimal</li>
                     * 
                     */
