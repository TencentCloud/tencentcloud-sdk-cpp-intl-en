            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Switch of politically sensitive information detection in text task. Valid values:
...
<li>OFF: disables politically sensitive information detection in text task.</li>
                    ...
                    /**
                     * 设置Switch of politically sensitive information detection in text task. Valid values:
<li>ON: enables politically sensitive information detection in text task;</li>
<li>OFF: disables politically sensitive information detection in text task.</li>
