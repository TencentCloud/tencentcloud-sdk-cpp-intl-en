...
namespace TencentCloud
{
 ...
 - 0: parameter values not used during running.
                    ...
                    /**
                     * 获取Describes the type of the current values. Default value: multi.
                    ...
                    /**
                     * 设置Describes the type of the current values. Default value: multi.
