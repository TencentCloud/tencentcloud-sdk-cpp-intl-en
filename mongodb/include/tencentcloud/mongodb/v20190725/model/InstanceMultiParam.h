            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Whether the TencentDB for MongoDB console has pulled parameter information successfully
                     * @return Status Whether the TencentDB for MongoDB console has pulled parameter information successfully
                     */
                    uint64_t GetStatus() const;

                    /**
                     * 设置Whether the TencentDB for MongoDB console has pulled parameter information successfully
