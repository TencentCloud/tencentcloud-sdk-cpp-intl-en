            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Search keyword, supports fuzzy matching.  
                    ...
                    /**
                     * 设置Search keyword, supports fuzzy matching.  
                    ...
                    /**
                     * 获取Filters the exchange type. each element in the array is a selected filter type. only direct, fanout, topic, and header are supported.
                    ...
                    /**
                     * 设置Filters the exchange type. each element in the array is a selected filter type. only direct, fanout, topic, and header are supported.
                    ...
                    /**
                     * 获取Filter exchange creation source, "system": "system created", "user": "user created".
                    ...
                    /**
                     * 设置Filter exchange creation source, "system": "system created", "user": "user created".
                    ...
                    /**
                     * 获取Exchange name, used for exact matching.
                    ...
                    /**
                     * 设置Exchange name, used for exact matching.
