...
#ifndef TENCENTCLOUD_DLC_V20210125_MODEL_PERMISSIONRESPONSEINFO_H_
#define TENCENTCLOUD_DLC_V20210125_MODEL_PERMISSIONRESPONSEINFO_H_
    ...
    namespace Dlc
    {
        namespace V20210125
        {
            namespace Model
            {
                ...
                */
                class PermissionResponseInfo : public AbstractModel
                {
                public:
                    PermissionResponseInfo();
                    ~PermissionResponseInfo() = default;
...
#endif // !TENCENTCLOUD_DLC_V20210125_MODEL_PERMISSIONRESPONSEINFO_H_
