...
CoreInternalOutcome DescribeTaskStatisticsResponse::Deserialize(const string &payload)
{
...
string DescribeTaskStatisticsResponse::ToJsonString() const
{
...
StatisticInfo DescribeTaskStatisticsResponse::GetStatisticInfo() const
{
    return m_statisticInfo;
}

bool DescribeTaskStatisticsResponse::StatisticInfoHasBeenSet() const
{
