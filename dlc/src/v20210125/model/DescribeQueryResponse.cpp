...
CoreInternalOutcome DescribeQueryResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["DataSet"].IsString())
        {
            return CoreInternalOutcome(Core::Error("response `DataSet` IsString=false incorrectly").SetRequestId(requestId));
        }
        m_dataSet = string(rsp["DataSet"].GetString());
...
string DescribeQueryResponse::ToJsonString() const
{
...
string DescribeQueryResponse::GetTaskId() const
{
    return m_taskId;
}

bool DescribeQueryResponse::TaskIdHasBeenSet() const
{
    return m_taskIdHasBeenSet;
}

string DescribeQueryResponse::GetSQL() const
{
    return m_sQL;
}

bool DescribeQueryResponse::SQLHasBeenSet() const
{
    return m_sQLHasBeenSet;
}

string DescribeQueryResponse::GetSQLType() const
{
    return m_sQLType;
}

bool DescribeQueryResponse::SQLTypeHasBeenSet() const
{
    return m_sQLTypeHasBeenSet;
}

int64_t DescribeQueryResponse::GetState() const
{
    return m_state;
}

bool DescribeQueryResponse::StateHasBeenSet() const
{
    return m_stateHasBeenSet;
}

string DescribeQueryResponse::GetDataSet() const
{
    return m_dataSet;
}

bool DescribeQueryResponse::DataSetHasBeenSet() const
{
