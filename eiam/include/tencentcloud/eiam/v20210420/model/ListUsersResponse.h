            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取List of users returned for the query.
...
Note: this field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Total number of users returned for the query, which will be returned only when the `IncludeTotal` input parameter is set to `true`.
Note: this field may return null, indicating that no valid values can be obtained.
