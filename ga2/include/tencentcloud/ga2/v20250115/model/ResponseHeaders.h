...
#ifndef TENCENTCLOUD_GA2_V20250115_MODEL_RESPONSEHEADERS_H_
#define TENCENTCLOUD_GA2_V20250115_MODEL_RESPONSEHEADERS_H_
    ...
    namespace Ga2
    {
        namespace V20250115
        {
            namespace Model
            {
                ...
                * Header
                */
                class ResponseHeaders : public AbstractModel
                {
                public:
                    ResponseHeaders();
                    ...
                    /**
                     * 获取<p>key</p><p>Parameter format: 1. The string only contain printable ASCII characters. 2. Cannot contain these characters ()&lt;&gt;@,;:\&quot;/[ ]?={ }</p><p>Input limit: Length 1-40.</p>
                    ...
                    /**
                     * 设置<p>key</p><p>Parameter format: 1. The string only contain printable ASCII characters. 2. Cannot contain these characters ()&lt;&gt;@,;:\&quot;/[ ]?={ }</p><p>Input limit: Length 1-40.</p>
                    ...
                    /**
                     * 获取<p>value</p><p>Input limit: length cannot exceed 128</p><p>If the string contains $, you can only configure '$remote_addr' and '$remote_port'. Otherwise, it is not supported.</p>
                    ...
                    /**
                     * 设置<p>value</p><p>Input limit: length cannot exceed 128</p><p>If the string contains $, you can only configure '$remote_addr' and '$remote_port'. Otherwise, it is not supported.</p>
...
#endif // !TENCENTCLOUD_GA2_V20250115_MODEL_RESPONSEHEADERS_H_
