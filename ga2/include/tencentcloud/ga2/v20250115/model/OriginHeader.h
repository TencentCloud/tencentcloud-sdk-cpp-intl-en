...
#ifndef TENCENTCLOUD_GA2_V20250115_MODEL_ORIGINHEADER_H_
#define TENCENTCLOUD_GA2_V20250115_MODEL_ORIGINHEADER_H_
    ...
    namespace Ga2
    {
        namespace V20250115
        {
            namespace Model
            {
                ...
                */
                class OriginHeader : public AbstractModel
                {
                public:
                    OriginHeader();
                    ~OriginHeader() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取<p>Key.</p><p>Parameter format: 1. The string literal only contains printable ASCII characters. 2. Cannot contain these characters ()&lt;&gt;@,;:\&quot;/[ ]?={ }</p><p>Input parameter limitation: length 1-40.</p>
                    ...
                    /**
                     * 设置<p>Key.</p><p>Parameter format: 1. The string literal only contains printable ASCII characters. 2. Cannot contain these characters ()&lt;&gt;@,;:\&quot;/[ ]?={ }</p><p>Input parameter limitation: length 1-40.</p>
                    ...
                    /**
                     * 获取<p>Value.</p><p>Input parameter limit: length cannot exceed 128.</p><p>If the string contains $, you can only configure '$remote_addr', '$remote_port'; otherwise, it is not supported.</p>
                    ...
                    /**
                     * 设置<p>Value.</p><p>Input parameter limit: length cannot exceed 128.</p><p>If the string contains $, you can only configure '$remote_addr', '$remote_port'; otherwise, it is not supported.</p>
...
#endif // !TENCENTCLOUD_GA2_V20250115_MODEL_ORIGINHEADER_H_
