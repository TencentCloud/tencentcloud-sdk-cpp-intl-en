...
#ifndef TENCENTCLOUD_BI_V20220105_MODEL_MODIFYTAGTABLEREQUEST_H_
#define TENCENTCLOUD_BI_V20220105_MODEL_MODIFYTAGTABLEREQUEST_H_
    ...
    namespace Bi
    {
        namespace V20220105
        {
            namespace Model
            {
                ...
                */
                class ModifyTagTableRequest : public AbstractModel
                {
                public:
                    ModifyTagTableRequest();
                    ~ModifyTagTableRequest() = default;
...
#endif // !TENCENTCLOUD_BI_V20220105_MODEL_MODIFYTAGTABLEREQUEST_H_
