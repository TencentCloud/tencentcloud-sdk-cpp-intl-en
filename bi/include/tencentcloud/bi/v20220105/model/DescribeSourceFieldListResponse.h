...
#ifndef TENCENTCLOUD_BI_V20220105_MODEL_DESCRIBESOURCEFIELDLISTRESPONSE_H_
#define TENCENTCLOUD_BI_V20220105_MODEL_DESCRIBESOURCEFIELDLISTRESPONSE_H_
    ...
    namespace Bi
    {
        namespace V20220105
        {
            namespace Model
            {
                ...
                */
                class DescribeSourceFieldListResponse : public AbstractModel
                {
                public:
                    DescribeSourceFieldListResponse();
                    ~DescribeSourceFieldListResponse() = default;
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取List of fields in the table
                     * @return Data List of fields in the table
                     * 
                     */
                    TableColumnListData GetData() const;
...
#endif // !TENCENTCLOUD_BI_V20220105_MODEL_DESCRIBESOURCEFIELDLISTRESPONSE_H_
