...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_BINLOGREGIONINFO_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_BINLOGREGIONINFO_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class BinlogRegionInfo : public AbstractModel
                {
                public:
                    BinlogRegionInfo();
                    ~BinlogRegionInfo() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取<p>Backup region</p>
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_BINLOGREGIONINFO_H_
