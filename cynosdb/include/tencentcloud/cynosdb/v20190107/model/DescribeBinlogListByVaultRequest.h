            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Number of returned results, range (0,100], default 100
                    ...
                    /**
                     * 设置Number of returned results, range (0,100], default 100
                     * @param _limit Number of returned results, range (0,100], default 100
                     * 
                     */
