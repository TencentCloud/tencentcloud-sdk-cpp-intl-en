...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_TRANSFERCLUSTERPREPAYTOPOSTPAYRESPONSE_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_TRANSFERCLUSTERPREPAYTOPOSTPAYRESPONSE_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class TransferClusterPrepayToPostpayResponse : public AbstractModel
                {
                public:
                    TransferClusterPrepayToPostpayResponse();
                    ~TransferClusterPrepayToPostpayResponse() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_TRANSFERCLUSTERPREPAYTOPOSTPAYRESPONSE_H_
