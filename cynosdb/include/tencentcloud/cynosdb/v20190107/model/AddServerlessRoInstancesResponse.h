...
#ifndef TENCENTCLOUD_CYNOSDB_V20190107_MODEL_ADDSERVERLESSROINSTANCESRESPONSE_H_
#define TENCENTCLOUD_CYNOSDB_V20190107_MODEL_ADDSERVERLESSROINSTANCESRESPONSE_H_
    ...
    namespace Cynosdb
    {
        namespace V20190107
        {
            namespace Model
            {
                ...
                */
                class AddServerlessRoInstancesResponse : public AbstractModel
                {
                public:
                    AddServerlessRoInstancesResponse();
                    ~AddServerlessRoInstancesResponse() = default;
...
#endif // !TENCENTCLOUD_CYNOSDB_V20190107_MODEL_ADDSERVERLESSROINSTANCESRESPONSE_H_
