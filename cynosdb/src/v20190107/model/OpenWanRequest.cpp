...
string OpenWanRequest::ToJsonString() const
{
...
string OpenWanRequest::GetInstanceGrpId() const
{
    return m_instanceGrpId;
}

void OpenWanRequest::SetInstanceGrpId(const string& _instanceGrpId)
{
    m_instanceGrpId = _instanceGrpId;
    m_instanceGrpIdHasBeenSet = true;
}

bool OpenWanRequest::InstanceGrpIdHasBeenSet() const
{
