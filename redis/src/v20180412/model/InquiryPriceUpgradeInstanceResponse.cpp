...
CoreInternalOutcome InquiryPriceUpgradeInstanceResponse::Deserialize(const string &payload)
{
...
string InquiryPriceUpgradeInstanceResponse::ToJsonString() const
{
...
double InquiryPriceUpgradeInstanceResponse::GetPrice() const
{
    return m_price;
}
