...
string ClearQueueRequest::ToJsonString() const
{
...
string ClearQueueRequest::GetQueueName() const
{
    return m_queueName;
}

void ClearQueueRequest::SetQueueName(const string& _queueName)
{
    m_queueName = _queueName;
    m_queueNameHasBeenSet = true;
}

bool ClearQueueRequest::QueueNameHasBeenSet() const
{
