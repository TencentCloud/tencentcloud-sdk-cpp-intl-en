...
#ifndef TENCENTCLOUD_CMQ_V20190304_MODEL_CLEARQUEUEREQUEST_H_
#define TENCENTCLOUD_CMQ_V20190304_MODEL_CLEARQUEUEREQUEST_H_
    ...
    namespace Cmq
    {
        namespace V20190304
        {
            namespace Model
            {
                ...
                */
                class ClearQueueRequest : public AbstractModel
                {
                public:
                    ClearQueueRequest();
                    ~ClearQueueRequest() = default;
...
#endif // !TENCENTCLOUD_CMQ_V20190304_MODEL_CLEARQUEUEREQUEST_H_
