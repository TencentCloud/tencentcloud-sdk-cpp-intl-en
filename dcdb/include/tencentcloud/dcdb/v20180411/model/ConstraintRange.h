            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Minimum value when constraint type is `section`
                     * @return Min Minimum value when constraint type is `section`
                     */
                    std::string GetMin() const;

                    /**
                     * 设置Minimum value when constraint type is `section`
                    ...
                    /**
                     * 获取Maximum value when constraint type is `section`
                     * @return Max Maximum value when constraint type is `section`
                     */
                    std::string GetMax() const;

                    /**
                     * 设置Maximum value when constraint type is `section`
