            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Numeric ID of a shard (this field is obsolete and should not be depended on)
                     * @return ShardId Numeric ID of a shard (this field is obsolete and should not be depended on)
                     */
                    int64_t GetShardId() const;

                    /**
                     * 设置Numeric ID of a shard (this field is obsolete and should not be depended on)
