            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Number of returned results, defaults to 20, maximum value 100.
                    ...
                    /**
                     * 设置Number of returned results, defaults to 20, maximum value 100.
                    ...
                    /**
                     * 获取Filter condition list. Supported filter fields: apikeyId (API Key ID), apiKeyName (name), platform (platform type), status (status), bindType (binding type).
                    ...
                    /**
                     * 设置Filter condition list. Supported filter fields: apikeyId (API Key ID), apiKeyName (name), platform (platform type), status (status), bindType (binding type).
                    ...
                    /**
                     * 获取Sorting condition list. Supported sorting field: apiKeyName
                    ...
                    /**
                     * 设置Sorting condition list. Supported sorting field: apiKeyName
