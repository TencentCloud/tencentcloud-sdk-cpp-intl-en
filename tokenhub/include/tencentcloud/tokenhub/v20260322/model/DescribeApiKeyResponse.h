            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Platform type. Enumerate: maas.
                    ...
                    /**
                     * 获取Binding type. Value: all (all models and access points), model_all_endpoint_custom (all models + custom access point), model_custom_endpoint_all (custom model + all access points), model_custom_endpoint_custom (custom model + custom access point).
                    ...
                    /**
                     * 获取Multi-dimensional information of Token quota. This field is not returned when unconfigured.
