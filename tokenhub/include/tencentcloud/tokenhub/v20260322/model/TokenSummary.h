            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Package serial number of the current billing cycle
                    ...
                    /**
                     * 设置Package serial number of the current billing cycle
                    ...
                    /**
                     * 获取Package billing cycle start time (RFC3339)
                    ...
                    /**
                     * 设置Package billing cycle start time (RFC3339)
                    ...
                    /**
                     * 获取Package billing cycle end time (RFC3339)
                    ...
                    /**
                     * 设置Package billing cycle end time (RFC3339)
                    ...
                    /**
                     * 获取Summary list of tokens grouped by billing item
                    ...
                    /**
                     * 设置Summary list of tokens grouped by billing item
