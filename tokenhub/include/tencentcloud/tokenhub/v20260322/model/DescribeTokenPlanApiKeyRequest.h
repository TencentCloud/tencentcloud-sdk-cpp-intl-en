...
#ifndef TENCENTCLOUD_TOKENHUB_V20260322_MODEL_DESCRIBETOKENPLANAPIKEYREQUEST_H_
#define TENCENTCLOUD_TOKENHUB_V20260322_MODEL_DESCRIBETOKENPLANAPIKEYREQUEST_H_
    ...
    namespace Tokenhub
    {
        namespace V20260322
        {
            namespace Model
            {
                ...
                */
                class DescribeTokenPlanApiKeyRequest : public AbstractModel
                {
                public:
                    DescribeTokenPlanApiKeyRequest();
                    ~DescribeTokenPlanApiKeyRequest() = default;
...
#endif // !TENCENTCLOUD_TOKENHUB_V20260322_MODEL_DESCRIBETOKENPLANAPIKEYREQUEST_H_
