            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Instance ID of the routing strategy, such as rrp-azd4dt1c.
                    ...
                    /**
                     * 设置Instance ID of the routing strategy, such as rrp-azd4dt1c.
                    ...
                    /**
                     * 获取Rule list of the routing strategy. requires specifying the policy rule ID (RoutePolicyEntryId).
                    ...
                    /**
                     * 设置Rule list of the routing strategy. requires specifying the policy rule ID (RoutePolicyEntryId).
