            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Protocol port ID, such as `ppm-f5n1f8da`.
                     * @return ServiceId Protocol port ID, such as `ppm-f5n1f8da`.
                     */
                    std::string GetServiceId() const;

                    /**
                     * 设置Protocol port ID, such as `ppm-f5n1f8da`.
