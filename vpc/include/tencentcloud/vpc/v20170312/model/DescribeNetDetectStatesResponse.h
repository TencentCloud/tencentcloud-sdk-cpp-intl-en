            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取The array of network detection verification results that meet requirements.
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取The number of network detection verification results that meet requirements.
Note: This field may return null, indicating that no valid values can be obtained.
