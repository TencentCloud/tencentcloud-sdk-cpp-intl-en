...
string DeleteVpcEndPointServiceRequest::ToJsonString() const
{
...
string DeleteVpcEndPointServiceRequest::GetEndPointServiceId() const
{
    return m_endPointServiceId;
}

void DeleteVpcEndPointServiceRequest::SetEndPointServiceId(const string& _endPointServiceId)
{
