...
#ifndef TENCENTCLOUD_TCR_V20190924_MODEL_MODIFYCUSTOMACCOUNTREQUEST_H_
#define TENCENTCLOUD_TCR_V20190924_MODEL_MODIFYCUSTOMACCOUNTREQUEST_H_
    ...
    namespace Tcr
    {
        namespace V20190924
        {
            namespace Model
            {
                ...
                */
                class ModifyCustomAccountRequest : public AbstractModel
                {
                public:
                    ModifyCustomAccountRequest();
                    ~ModifyCustomAccountRequest() = default;
                    ...
                    /**
                     * 获取Expiry time of the custom account (timestamp)
                    ...
                    /**
                     * 设置Expiry time of the custom account (timestamp)
...
#endif // !TENCENTCLOUD_TCR_V20190924_MODEL_MODIFYCUSTOMACCOUNTREQUEST_H_
