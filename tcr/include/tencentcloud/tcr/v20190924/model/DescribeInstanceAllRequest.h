...
#ifndef TENCENTCLOUD_TCR_V20190924_MODEL_DESCRIBEINSTANCEALLREQUEST_H_
#define TENCENTCLOUD_TCR_V20190924_MODEL_DESCRIBEINSTANCEALLREQUEST_H_
    ...
    namespace Tcr
    {
        namespace V20190924
        {
            namespace Model
            {
                ...
                */
                class DescribeInstanceAllRequest : public AbstractModel
                {
                public:
                    DescribeInstanceAllRequest();
                    ~DescribeInstanceAllRequest() = default;
...
#endif // !TENCENTCLOUD_TCR_V20190924_MODEL_DESCRIBEINSTANCEALLREQUEST_H_
