            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Attribute name. If more than one filter exists, the logical relationship between these filters is `AND`.
                    ...
                    /**
                     * 设置Attribute name. If more than one filter exists, the logical relationship between these filters is `AND`.
