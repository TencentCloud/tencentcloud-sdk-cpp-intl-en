            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Whether to enable origin-pull authentication for other object storage origins. Values:
`on`: Enable
`off`: Disable
...
`off`: Disable
                    ...
                    /**
                     * 设置Whether to enable origin-pull authentication for other object storage origins. Values:
`on`: Enable
`off`: Disable
...
Note: This field may return `null`, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Key. specifies the field with masking back.
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 设置Key. specifies the field with masking back.
Note: This field may return null, indicating that no valid values can be obtained.
