...
#ifndef TENCENTCLOUD_FACEID_V20180301_MODEL_PAKISTANIDCARD_H_
#define TENCENTCLOUD_FACEID_V20180301_MODEL_PAKISTANIDCARD_H_
    ...
    namespace Faceid
    {
        namespace V20180301
        {
            namespace Model
            {
                ...
                */
                class PakistanIDCard : public AbstractModel
                {
                public:
                    PakistanIDCard();
                    ~PakistanIDCard() = default;
                    ...
                    /**
                     * 设置Issuing city
                     * @param _issuedCountry Issuing city
                     * 
                     */
...
#endif // !TENCENTCLOUD_FACEID_V20180301_MODEL_PAKISTANIDCARD_H_
