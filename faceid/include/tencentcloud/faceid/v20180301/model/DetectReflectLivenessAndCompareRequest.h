            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取URL of the liveness data package generated by the SDK
                     * @return LiveDataUrl URL of the liveness data package generated by the SDK
                     */
                    std::string GetLiveDataUrl() const;

                    /**
                     * 设置URL of the liveness data package generated by the SDK
                    ...
                    /**
                     * 获取MD5 hash value of the liveness data package generated by the SDK
                     * @return LiveDataMd5 MD5 hash value of the liveness data package generated by the SDK
                     */
                    std::string GetLiveDataMd5() const;

                    /**
                     * 设置MD5 hash value of the liveness data package generated by the SDK
                    ...
                    /**
                     * 获取MD5 hash value of the target image for comparison
                     * @return ImageMd5 MD5 hash value of the target image for comparison
                     */
                    std::string GetImageMd5() const;

                    /**
                     * 设置MD5 hash value of the target image for comparison
