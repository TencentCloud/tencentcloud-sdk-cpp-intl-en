...
#ifndef TENCENTCLOUD_FACEID_V20180301_MODEL_PHILIPPINESTINID_H_
#define TENCENTCLOUD_FACEID_V20180301_MODEL_PHILIPPINESTINID_H_
    ...
    namespace Faceid
    {
        namespace V20180301
        {
            namespace Model
            {
                ...
                * Philippines TinID
                */
                class PhilippinesTinID : public AbstractModel
                {
                public:
                    PhilippinesTinID();
                    ~PhilippinesTinID() = default;
...
#endif // !TENCENTCLOUD_FACEID_V20180301_MODEL_PHILIPPINESTINID_H_
