...
#ifndef TENCENTCLOUD_FACEID_V20180301_MODEL_GETAMLSCREENINGRESULTREQUEST_H_
#define TENCENTCLOUD_FACEID_V20180301_MODEL_GETAMLSCREENINGRESULTREQUEST_H_
    ...
    namespace Faceid
    {
        namespace V20180301
        {
            namespace Model
            {
                ...
                */
                class GetAMLScreeningResultRequest : public AbstractModel
                {
                public:
                    GetAMLScreeningResultRequest();
                    ~GetAMLScreeningResultRequest() = default;
...
#endif // !TENCENTCLOUD_FACEID_V20180301_MODEL_GETAMLSCREENINGRESULTREQUEST_H_
