...
#ifndef TENCENTCLOUD_FACEID_V20180301_MODEL_BANGLADESHIDCARD_H_
#define TENCENTCLOUD_FACEID_V20180301_MODEL_BANGLADESHIDCARD_H_
    ...
    namespace Faceid
    {
        namespace V20180301
        {
            namespace Model
            {
                ...
                * Bangladesh ID card
                */
                class BangladeshIDCard : public AbstractModel
                {
                public:
                    BangladeshIDCard();
                    ~BangladeshIDCard() = default;
...
#endif // !TENCENTCLOUD_FACEID_V20180301_MODEL_BANGLADESHIDCARD_H_
