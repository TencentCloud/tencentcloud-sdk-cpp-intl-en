...
#ifndef TENCENTCLOUD_FACEID_V20180301_MODEL_PAKISTANDRIVINGLICENSE_H_
#define TENCENTCLOUD_FACEID_V20180301_MODEL_PAKISTANDRIVINGLICENSE_H_
    ...
    namespace Faceid
    {
        namespace V20180301
        {
            namespace Model
            {
                ...
                */
                class PakistanDrivingLicense : public AbstractModel
                {
                public:
                    PakistanDrivingLicense();
                    ~PakistanDrivingLicense() = default;
...
#endif // !TENCENTCLOUD_FACEID_V20180301_MODEL_PAKISTANDRIVINGLICENSE_H_
