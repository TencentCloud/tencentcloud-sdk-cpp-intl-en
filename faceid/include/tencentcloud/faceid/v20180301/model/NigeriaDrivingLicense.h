...
#ifndef TENCENTCLOUD_FACEID_V20180301_MODEL_NIGERIADRIVINGLICENSE_H_
#define TENCENTCLOUD_FACEID_V20180301_MODEL_NIGERIADRIVINGLICENSE_H_
    ...
    namespace Faceid
    {
        namespace V20180301
        {
            namespace Model
            {
                ...
                */
                class NigeriaDrivingLicense : public AbstractModel
                {
                public:
                    NigeriaDrivingLicense();
                    ~NigeriaDrivingLicense() = default;
...
#endif // !TENCENTCLOUD_FACEID_V20180301_MODEL_NIGERIADRIVINGLICENSE_H_
