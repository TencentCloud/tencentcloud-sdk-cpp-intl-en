...
string ApplyLivenessTokenRequest::ToJsonString() const
{
...
string ApplyLivenessTokenRequest::GetSecureLevel() const
{
    return m_secureLevel;
}

void ApplyLivenessTokenRequest::SetSecureLevel(const string& _secureLevel)
{
    m_secureLevel = _secureLevel;
    m_secureLevelHasBeenSet = true;
}

bool ApplyLivenessTokenRequest::SecureLevelHasBeenSet() const
{
