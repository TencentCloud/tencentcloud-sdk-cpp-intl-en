...
string GetFaceIdResultIntlRequest::ToJsonString() const
{
...
string GetFaceIdResultIntlRequest::GetSdkToken() const
{
    return m_sdkToken;
}

void GetFaceIdResultIntlRequest::SetSdkToken(const string& _sdkToken)
{
    m_sdkToken = _sdkToken;
    m_sdkTokenHasBeenSet = true;
}

bool GetFaceIdResultIntlRequest::SdkTokenHasBeenSet() const
{
