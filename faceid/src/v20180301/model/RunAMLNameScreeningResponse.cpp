...
CoreInternalOutcome RunAMLNameScreeningResponse::Deserialize(const string &payload)
{
...
string RunAMLNameScreeningResponse::ToJsonString() const
{
...
string RunAMLNameScreeningResponse::GetScreeningResult() const
{
    return m_screeningResult;
}

bool RunAMLNameScreeningResponse::ScreeningResultHasBeenSet() const
{
    return m_screeningResultHasBeenSet;
}

vector<string> RunAMLNameScreeningResponse::GetAMLTypes() const
{
    return m_aMLTypes;
}

bool RunAMLNameScreeningResponse::AMLTypesHasBeenSet() const
{
    return m_aMLTypesHasBeenSet;
}

string RunAMLNameScreeningResponse::GetHitDetail() const
{
    return m_hitDetail;
}

bool RunAMLNameScreeningResponse::HitDetailHasBeenSet() const
{
    return m_hitDetailHasBeenSet;
}

string RunAMLNameScreeningResponse::GetResult() const
{
    return m_result;
}

bool RunAMLNameScreeningResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string RunAMLNameScreeningResponse::GetDescription() const
{
    return m_description;
}

bool RunAMLNameScreeningResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

string RunAMLNameScreeningResponse::GetScreeningId() const
{
    return m_screeningId;
}

bool RunAMLNameScreeningResponse::ScreeningIdHasBeenSet() const
{
    return m_screeningIdHasBeenSet;
}

bool RunAMLNameScreeningResponse::GetEnableOngoingScreening() const
{
    return m_enableOngoingScreening;
}

bool RunAMLNameScreeningResponse::EnableOngoingScreeningHasBeenSet() const
{
