...
CoreInternalOutcome VideoLivenessCompareResponse::Deserialize(const string &payload)
{
...
string VideoLivenessCompareResponse::ToJsonString() const
{
...
double VideoLivenessCompareResponse::GetSim() const
{
    return m_sim;
}

bool VideoLivenessCompareResponse::SimHasBeenSet() const
{
    return m_simHasBeenSet;
}

string VideoLivenessCompareResponse::GetResult() const
{
    return m_result;
}

bool VideoLivenessCompareResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string VideoLivenessCompareResponse::GetDescription() const
{
    return m_description;
}

bool VideoLivenessCompareResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

FileInfo VideoLivenessCompareResponse::GetBestFrame() const
{
    return m_bestFrame;
}

bool VideoLivenessCompareResponse::BestFrameHasBeenSet() const
{
