...
string GetAMLScreeningResultRequest::ToJsonString() const
{
...
string GetAMLScreeningResultRequest::GetUniqueCustomerID() const
{
    return m_uniqueCustomerID;
}

void GetAMLScreeningResultRequest::SetUniqueCustomerID(const string& _uniqueCustomerID)
{
    m_uniqueCustomerID = _uniqueCustomerID;
    m_uniqueCustomerIDHasBeenSet = true;
}

bool GetAMLScreeningResultRequest::UniqueCustomerIDHasBeenSet() const
{
