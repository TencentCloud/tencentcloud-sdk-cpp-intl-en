...
string GetSdkVerificationResultRequest::ToJsonString() const
{
...
string GetSdkVerificationResultRequest::GetSdkToken() const
{
    return m_sdkToken;
}

void GetSdkVerificationResultRequest::SetSdkToken(const string& _sdkToken)
{
    m_sdkToken = _sdkToken;
    m_sdkTokenHasBeenSet = true;
}

bool GetSdkVerificationResultRequest::SdkTokenHasBeenSet() const
{
