...
CoreInternalOutcome GetLivenessResultResponse::Deserialize(const string &payload)
{
    ...
    {
        if (!rsp["Video"].IsObject())
        {
            return CoreInternalOutcome(Core::Error("response `Video` is not object type").SetRequestId(requestId));
        }

        CoreInternalOutcome outcome = m_video.Deserialize(rsp["Video"]);
        if (!outcome.IsSuccess())
        {
            outcome.GetError().SetRequestId(requestId);
            return outcome;
...
string GetLivenessResultResponse::ToJsonString() const
{
...
string GetLivenessResultResponse::GetResult() const
{
    return m_result;
}

bool GetLivenessResultResponse::ResultHasBeenSet() const
{
    return m_resultHasBeenSet;
}

string GetLivenessResultResponse::GetDescription() const
{
    return m_description;
}

bool GetLivenessResultResponse::DescriptionHasBeenSet() const
{
    return m_descriptionHasBeenSet;
}

FileInfo GetLivenessResultResponse::GetBestFrame() const
{
    return m_bestFrame;
}

bool GetLivenessResultResponse::BestFrameHasBeenSet() const
{
    return m_bestFrameHasBeenSet;
}

FileInfo GetLivenessResultResponse::GetVideo() const
{
    return m_video;
}

bool GetLivenessResultResponse::VideoHasBeenSet() const
{
