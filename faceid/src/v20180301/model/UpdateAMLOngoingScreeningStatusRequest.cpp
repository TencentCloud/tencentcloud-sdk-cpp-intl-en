...
string UpdateAMLOngoingScreeningStatusRequest::ToJsonString() const
{
...
string UpdateAMLOngoingScreeningStatusRequest::GetUniqueCustomerID() const
{
    return m_uniqueCustomerID;
}

void UpdateAMLOngoingScreeningStatusRequest::SetUniqueCustomerID(const string& _uniqueCustomerID)
{
    m_uniqueCustomerID = _uniqueCustomerID;
    m_uniqueCustomerIDHasBeenSet = true;
}

bool UpdateAMLOngoingScreeningStatusRequest::UniqueCustomerIDHasBeenSet() const
{
    return m_uniqueCustomerIDHasBeenSet;
}

bool UpdateAMLOngoingScreeningStatusRequest::GetEnableOngoingScreening() const
{
    return m_enableOngoingScreening;
}

void UpdateAMLOngoingScreeningStatusRequest::SetEnableOngoingScreening(const bool& _enableOngoingScreening)
{
    m_enableOngoingScreening = _enableOngoingScreening;
    m_enableOngoingScreeningHasBeenSet = true;
}

bool UpdateAMLOngoingScreeningStatusRequest::EnableOngoingScreeningHasBeenSet() const
{
