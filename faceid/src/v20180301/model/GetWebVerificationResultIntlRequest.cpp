...
string GetWebVerificationResultIntlRequest::ToJsonString() const
{
...
string GetWebVerificationResultIntlRequest::GetBizToken() const
{
    return m_bizToken;
}

void GetWebVerificationResultIntlRequest::SetBizToken(const string& _bizToken)
{
    m_bizToken = _bizToken;
    m_bizTokenHasBeenSet = true;
}

bool GetWebVerificationResultIntlRequest::BizTokenHasBeenSet() const
{
