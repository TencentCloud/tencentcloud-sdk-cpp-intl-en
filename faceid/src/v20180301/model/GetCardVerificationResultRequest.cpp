...
string GetCardVerificationResultRequest::ToJsonString() const
{
...
string GetCardVerificationResultRequest::GetCardVerificationToken() const
{
    return m_cardVerificationToken;
}

void GetCardVerificationResultRequest::SetCardVerificationToken(const string& _cardVerificationToken)
{
    m_cardVerificationToken = _cardVerificationToken;
    m_cardVerificationTokenHasBeenSet = true;
}

bool GetCardVerificationResultRequest::CardVerificationTokenHasBeenSet() const
{
