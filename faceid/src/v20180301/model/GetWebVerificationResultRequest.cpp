...
string GetWebVerificationResultRequest::ToJsonString() const
{
...
string GetWebVerificationResultRequest::GetBizToken() const
{
    return m_bizToken;
}

void GetWebVerificationResultRequest::SetBizToken(const string& _bizToken)
{
    m_bizToken = _bizToken;
    m_bizTokenHasBeenSet = true;
}

bool GetWebVerificationResultRequest::BizTokenHasBeenSet() const
{
