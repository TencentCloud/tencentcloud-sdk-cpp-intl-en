...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGVERSIONAUDITDETAILRESP_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGVERSIONAUDITDETAILRESP_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGVersionAuditDetailResp : public AbstractModel
                {
                public:
                    DescribeMNGVersionAuditDetailResp();
                    ~DescribeMNGVersionAuditDetailResp() = default;
                     ...
                     * 
                     */
                    std::vector<DescribeMNGAuditDetailAppAuditInfo> GetAppAuditList() const;
                     ...
                     * 
                     */
                    void SetAppAuditList(const std::vector<DescribeMNGAuditDetailAppAuditInfo>& _appAuditList);
                ...
                private:
                     ...
                     */
                    std::vector<DescribeMNGAuditDetailAppAuditInfo> m_appAuditList;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGVERSIONAUDITDETAILRESP_H_
