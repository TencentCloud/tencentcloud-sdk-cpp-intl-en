...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNGSENSITIVEAPIPERMISSIONAPPROVALREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNGSENSITIVEAPIPERMISSIONAPPROVALREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class CreateMNGSensitiveAPIPermissionApprovalRequest : public AbstractModel
                {
                public:
                    CreateMNGSensitiveAPIPermissionApprovalRequest();
                    ~CreateMNGSensitiveAPIPermissionApprovalRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNGSENSITIVEAPIPERMISSIONAPPROVALREQUEST_H_
