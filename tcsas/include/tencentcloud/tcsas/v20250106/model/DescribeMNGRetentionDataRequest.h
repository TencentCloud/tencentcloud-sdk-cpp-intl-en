...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGRETENTIONDATAREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGRETENTIONDATAREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGRetentionDataRequest : public AbstractModel
                {
                public:
                    DescribeMNGRetentionDataRequest();
                    ~DescribeMNGRetentionDataRequest() = default;
                    ...
                    /**
                     * 获取Type: 1 Production data, 0 Non-production data
                    ...
                    /**
                     * 设置Type: 1 Production data, 0 Non-production data
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGRETENTIONDATAREQUEST_H_
