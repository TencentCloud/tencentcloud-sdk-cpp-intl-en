...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNPDOMAINACLREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNPDOMAINACLREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class CreateMNPDomainACLRequest : public AbstractModel
                {
                public:
                    CreateMNPDomainACLRequest();
                    ~CreateMNPDomainACLRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNPDOMAINACLREQUEST_H_
