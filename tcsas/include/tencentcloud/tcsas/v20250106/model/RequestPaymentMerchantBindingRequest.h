...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_REQUESTPAYMENTMERCHANTBINDINGREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_REQUESTPAYMENTMERCHANTBINDINGREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class RequestPaymentMerchantBindingRequest : public AbstractModel
                {
                public:
                    RequestPaymentMerchantBindingRequest();
                    ~RequestPaymentMerchantBindingRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_REQUESTPAYMENTMERCHANTBINDINGREQUEST_H_
