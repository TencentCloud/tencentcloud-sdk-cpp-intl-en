...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTLINECHARTREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTLINECHARTREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGPaymentLineChartRequest : public AbstractModel
                {
                public:
                    DescribeMNGPaymentLineChartRequest();
                    ~DescribeMNGPaymentLineChartRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTLINECHARTREQUEST_H_
