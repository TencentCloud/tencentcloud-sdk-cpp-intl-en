...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPRETENTIONDATAREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPRETENTIONDATAREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNPRetentionDataRequest : public AbstractModel
                {
                public:
                    DescribeMNPRetentionDataRequest();
                    ~DescribeMNPRetentionDataRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPRETENTIONDATAREQUEST_H_
