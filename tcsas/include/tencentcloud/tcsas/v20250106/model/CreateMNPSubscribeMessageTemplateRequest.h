...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNPSUBSCRIBEMESSAGETEMPLATEREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNPSUBSCRIBEMESSAGETEMPLATEREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class CreateMNPSubscribeMessageTemplateRequest : public AbstractModel
                {
                public:
                    CreateMNPSubscribeMessageTemplateRequest();
                    ~CreateMNPSubscribeMessageTemplateRequest() = default;
                    ...
                    /**
                     * 获取<p>Subscription message template keyword.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template keyword.</p>
                     * @param _keywords <p>Subscription message template keyword.</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNPSUBSCRIBEMESSAGETEMPLATEREQUEST_H_
