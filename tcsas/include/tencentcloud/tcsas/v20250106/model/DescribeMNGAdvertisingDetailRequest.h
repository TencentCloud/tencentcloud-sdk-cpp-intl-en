...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGADVERTISINGDETAILREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGADVERTISINGDETAILREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGAdvertisingDetailRequest : public AbstractModel
                {
                public:
                    DescribeMNGAdvertisingDetailRequest();
                    ~DescribeMNGAdvertisingDetailRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGADVERTISINGDETAILREQUEST_H_
