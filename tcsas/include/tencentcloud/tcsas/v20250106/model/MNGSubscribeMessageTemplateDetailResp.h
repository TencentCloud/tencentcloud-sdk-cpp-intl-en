...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_MNGSUBSCRIBEMESSAGETEMPLATEDETAILRESP_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_MNGSUBSCRIBEMESSAGETEMPLATEDETAILRESP_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class MNGSubscribeMessageTemplateDetailResp : public AbstractModel
                {
                public:
                    MNGSubscribeMessageTemplateDetailResp();
                    ~MNGSubscribeMessageTemplateDetailResp() = default;
                     ...
                     * 
                     */
                    std::vector<DescribeMNGSubscribeMessageTemplateLibraryKeywordData> GetKeywordList() const;
                     ...
                     * 
                     */
                    void SetKeywordList(const std::vector<DescribeMNGSubscribeMessageTemplateLibraryKeywordData>& _keywordList);
                ...
                private:
                     ...
                     */
                    std::vector<DescribeMNGSubscribeMessageTemplateLibraryKeywordData> m_keywordList;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_MNGSUBSCRIBEMESSAGETEMPLATEDETAILRESP_H_
