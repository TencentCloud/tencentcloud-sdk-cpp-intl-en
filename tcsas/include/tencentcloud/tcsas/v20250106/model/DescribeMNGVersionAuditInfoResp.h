...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGVERSIONAUDITINFORESP_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGVERSIONAUDITINFORESP_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGVersionAuditInfoResp : public AbstractModel
                {
                public:
                    DescribeMNGVersionAuditInfoResp();
                    ~DescribeMNGVersionAuditInfoResp() = default;
                     ...
                     * 
                     */
                    std::vector<DescribeMNGAuditListAppInfoResp> GetAuditAppList() const;
                     ...
                     * 
                     */
                    void SetAuditAppList(const std::vector<DescribeMNGAuditListAppInfoResp>& _auditAppList);
                ...
                private:
                     ...
                     */
                    std::vector<DescribeMNGAuditListAppInfoResp> m_auditAppList;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGVERSIONAUDITINFORESP_H_
