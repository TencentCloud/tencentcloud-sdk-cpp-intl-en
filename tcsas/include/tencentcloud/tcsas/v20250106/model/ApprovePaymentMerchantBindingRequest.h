...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_APPROVEPAYMENTMERCHANTBINDINGREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_APPROVEPAYMENTMERCHANTBINDINGREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class ApprovePaymentMerchantBindingRequest : public AbstractModel
                {
                public:
                    ApprovePaymentMerchantBindingRequest();
                    ~ApprovePaymentMerchantBindingRequest() = default;
                     ...
                     * 
                     */
                    uint64_t GetApprovalType() const;
                     ...
                     * 
                     */
                    void SetApprovalType(const uint64_t& _approvalType);
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_APPROVEPAYMENTMERCHANTBINDINGREQUEST_H_
