...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGSUBSCRIBEMESSAGETEMPLATELIBRARYINFORESP_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGSUBSCRIBEMESSAGETEMPLATELIBRARYINFORESP_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGSubscribeMessageTemplateLibraryInfoResp : public AbstractModel
                {
                public:
                    DescribeMNGSubscribeMessageTemplateLibraryInfoResp();
                    ~DescribeMNGSubscribeMessageTemplateLibraryInfoResp() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取<p>Subscription message template library title.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template library title.</p>
                     * @param _templateTitle <p>Subscription message template library title.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Subscription message template library title in multiple languages.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template library title in multiple languages.</p>
                     * @param _templateTitleI18nList <p>Subscription message template library title in multiple languages.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Subscription message template library default language.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template library default language.</p>
                     * @param _defaultLang <p>Subscription message template library default language.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Subscription message template library supported languages.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template library supported languages.</p>
                     * @param _supportLang <p>Subscription message template library supported languages.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Subscription message template library keywords.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template library keywords.</p>
                     * @param _keywords <p>Subscription message template library keywords.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Subscription message template library keyword in multiple languages.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template library keyword in multiple languages.</p>
                     * @param _keywordI18nList <p>Subscription message template library keyword in multiple languages.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Subscription message template library description.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template library description.</p>
                     * @param _description <p>Subscription message template library description.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Subscription message template library ID.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template library ID.</p>
                     * @param _templateLibraryId <p>Subscription message template library ID.</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGSUBSCRIBEMESSAGETEMPLATELIBRARYINFORESP_H_
