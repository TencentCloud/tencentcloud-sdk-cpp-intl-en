...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEPAYMENTDATAOVERVIEWREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEPAYMENTDATAOVERVIEWREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribePaymentDataOverviewRequest : public AbstractModel
                {
                public:
                    DescribePaymentDataOverviewRequest();
                    ~DescribePaymentDataOverviewRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEPAYMENTDATAOVERVIEWREQUEST_H_
