...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGAUDITDETAILAPPAUDITINFO_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGAUDITDETAILAPPAUDITINFO_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGAuditDetailAppAuditInfo : public AbstractModel
                {
                public:
                    DescribeMNGAuditDetailAppAuditInfo();
                    ~DescribeMNGAuditDetailAppAuditInfo() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGAUDITDETAILAPPAUDITINFO_H_
