            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Merchant ID information bound to the team to which this mini program belongs.</p>
                    ...
                    /**
                     * 设置<p>Merchant ID information bound to the team to which this mini program belongs.</p>
                     * @param _merchantId <p>Merchant ID information bound to the team to which this mini program belongs.</p>
                     * 
                     */
