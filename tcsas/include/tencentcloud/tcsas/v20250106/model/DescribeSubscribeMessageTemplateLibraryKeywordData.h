...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBESUBSCRIBEMESSAGETEMPLATELIBRARYKEYWORDDATA_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBESUBSCRIBEMESSAGETEMPLATELIBRARYKEYWORDDATA_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeSubscribeMessageTemplateLibraryKeywordData : public AbstractModel
                {
                public:
                    DescribeSubscribeMessageTemplateLibraryKeywordData();
                    ~DescribeSubscribeMessageTemplateLibraryKeywordData() = default;
                     ...
                     * @param _keyword <p>Subscription message template library keywords.</p>
                     * 
                     */
                     ...
                     * @param _keywordList <p>Subscription message template library keyword in multiple languages.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Subscription message template library keyword default value multilingual type.</p>
                    ...
                    /**
                     * 设置<p>Subscription message template library keyword default value multilingual type.</p>
                     * @param _defaultValueList <p>Subscription message template library keyword default value multilingual type.</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBESUBSCRIBEMESSAGETEMPLATELIBRARYKEYWORDDATA_H_
