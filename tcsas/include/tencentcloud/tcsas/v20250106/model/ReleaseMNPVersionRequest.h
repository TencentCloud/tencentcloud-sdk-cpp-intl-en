...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_RELEASEMNPVERSIONREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_RELEASEMNPVERSIONREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class ReleaseMNPVersionRequest : public AbstractModel
                {
                public:
                    ReleaseMNPVersionRequest();
                    ~ReleaseMNPVersionRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_RELEASEMNPVERSIONREQUEST_H_
