...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGVERSIONAUDITLISTREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGVERSIONAUDITLISTREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGVersionAuditListRequest : public AbstractModel
                {
                public:
                    DescribeMNGVersionAuditListRequest();
                    ~DescribeMNGVersionAuditListRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGVERSIONAUDITLISTREQUEST_H_
