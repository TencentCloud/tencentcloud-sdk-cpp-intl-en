...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPPREVIEWREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPPREVIEWREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNPPreviewRequest : public AbstractModel
                {
                public:
                    DescribeMNPPreviewRequest();
                    ~DescribeMNPPreviewRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPPREVIEWREQUEST_H_
