...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPACTIVEUSERREALTIMESTATISTICSREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPACTIVEUSERREALTIMESTATISTICSREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNPActiveUserRealTimeStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeMNPActiveUserRealTimeStatisticsRequest();
                    ~DescribeMNPActiveUserRealTimeStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPACTIVEUSERREALTIMESTATISTICSREQUEST_H_
