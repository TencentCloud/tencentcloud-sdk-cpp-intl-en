...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_AGERATINGITEM_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_AGERATINGITEM_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class AgeRatingItem : public AbstractModel
                {
                public:
                    AgeRatingItem();
                    ~AgeRatingItem() = default;
                    ...
                    /**
                     * 设置<p>Age rating label.</p>
                     * @param _label <p>Age rating label.</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_AGERATINGITEM_H_
