...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGMAUMONTHLYCOMPARISONMETRICCARDREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGMAUMONTHLYCOMPARISONMETRICCARDREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGMAUMonthlyComparisonMetricCardRequest : public AbstractModel
                {
                public:
                    DescribeMNGMAUMonthlyComparisonMetricCardRequest();
                    ~DescribeMNGMAUMonthlyComparisonMetricCardRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGMAUMONTHLYCOMPARISONMETRICCARDREQUEST_H_
