...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACTIVEUSERREALTIMESTATISTICSREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACTIVEUSERREALTIMESTATISTICSREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGActiveUserRealTimeStatisticsRequest : public AbstractModel
                {
                public:
                    DescribeMNGActiveUserRealTimeStatisticsRequest();
                    ~DescribeMNGActiveUserRealTimeStatisticsRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACTIVEUSERREALTIMESTATISTICSREQUEST_H_
