...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPPAGEANALYSISDETAILREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPPAGEANALYSISDETAILREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNPPageAnalysisDetailRequest : public AbstractModel
                {
                public:
                    DescribeMNPPageAnalysisDetailRequest();
                    ~DescribeMNPPageAnalysisDetailRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPPAGEANALYSISDETAILREQUEST_H_
