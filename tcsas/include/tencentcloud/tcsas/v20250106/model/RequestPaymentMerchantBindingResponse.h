...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_REQUESTPAYMENTMERCHANTBINDINGRESPONSE_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_REQUESTPAYMENTMERCHANTBINDINGRESPONSE_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class RequestPaymentMerchantBindingResponse : public AbstractModel
                {
                public:
                    RequestPaymentMerchantBindingResponse();
                    ~RequestPaymentMerchantBindingResponse() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_REQUESTPAYMENTMERCHANTBINDINGRESPONSE_H_
