...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNGDOMAINACLREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNGDOMAINACLREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class CreateMNGDomainACLRequest : public AbstractModel
                {
                public:
                    CreateMNGDomainACLRequest();
                    ~CreateMNGDomainACLRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNGDOMAINACLREQUEST_H_
