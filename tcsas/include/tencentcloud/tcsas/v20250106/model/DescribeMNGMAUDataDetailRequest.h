...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGMAUDATADETAILREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGMAUDATADETAILREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGMAUDataDetailRequest : public AbstractModel
                {
                public:
                    DescribeMNGMAUDataDetailRequest();
                    ~DescribeMNGMAUDataDetailRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGMAUDATADETAILREQUEST_H_
