...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPMAUDATADETAILREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPMAUDATADETAILREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNPMAUDataDetailRequest : public AbstractModel
                {
                public:
                    DescribeMNPMAUDataDetailRequest();
                    ~DescribeMNPMAUDataDetailRequest() = default;
                    ...
                    /**
                     * 获取Mini program team ID. Pass -1 to leave unspecified.
                    ...
                    /**
                     * 设置Mini program team ID. Pass -1 to leave unspecified.
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPMAUDATADETAILREQUEST_H_
