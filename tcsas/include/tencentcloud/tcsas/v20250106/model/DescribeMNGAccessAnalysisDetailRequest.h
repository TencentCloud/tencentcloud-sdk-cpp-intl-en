...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACCESSANALYSISDETAILREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACCESSANALYSISDETAILREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGAccessAnalysisDetailRequest : public AbstractModel
                {
                public:
                    DescribeMNGAccessAnalysisDetailRequest();
                    ~DescribeMNGAccessAnalysisDetailRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACCESSANALYSISDETAILREQUEST_H_
