...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTOVERVIEWREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTOVERVIEWREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGPaymentOverviewRequest : public AbstractModel
                {
                public:
                    DescribeMNGPaymentOverviewRequest();
                    ~DescribeMNGPaymentOverviewRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTOVERVIEWREQUEST_H_
