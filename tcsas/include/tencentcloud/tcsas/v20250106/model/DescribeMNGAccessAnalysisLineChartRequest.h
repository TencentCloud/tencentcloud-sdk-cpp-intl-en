...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACCESSANALYSISLINECHARTREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACCESSANALYSISLINECHARTREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGAccessAnalysisLineChartRequest : public AbstractModel
                {
                public:
                    DescribeMNGAccessAnalysisLineChartRequest();
                    ~DescribeMNGAccessAnalysisLineChartRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACCESSANALYSISLINECHARTREQUEST_H_
