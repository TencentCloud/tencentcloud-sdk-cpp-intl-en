...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNGREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNGREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class CreateMNGRequest : public AbstractModel
                {
                public:
                    CreateMNGRequest();
                    ~CreateMNGRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_CREATEMNGREQUEST_H_
