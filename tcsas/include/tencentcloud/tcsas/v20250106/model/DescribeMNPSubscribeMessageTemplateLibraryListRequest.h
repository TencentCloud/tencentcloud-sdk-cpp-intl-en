...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPSUBSCRIBEMESSAGETEMPLATELIBRARYLISTREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPSUBSCRIBEMESSAGETEMPLATELIBRARYLISTREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNPSubscribeMessageTemplateLibraryListRequest : public AbstractModel
                {
                public:
                    DescribeMNPSubscribeMessageTemplateLibraryListRequest();
                    ~DescribeMNPSubscribeMessageTemplateLibraryListRequest() = default;
                     ...
                     * @param _queryType <p>Subscription message template type. Valid values: 2: One-time message; 3: Long-term subscription message.</p>
                     * 
                     */
                     ...
                     * @param _queryStr <p>Search keyword.</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPSUBSCRIBEMESSAGETEMPLATELIBRARYLISTREQUEST_H_
