...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTRETENTIONANALYSISREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTRETENTIONANALYSISREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGPaymentRetentionAnalysisRequest : public AbstractModel
                {
                public:
                    DescribeMNGPaymentRetentionAnalysisRequest();
                    ~DescribeMNGPaymentRetentionAnalysisRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTRETENTIONANALYSISREQUEST_H_
