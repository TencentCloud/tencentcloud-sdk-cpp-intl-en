...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGLISTRESP_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGLISTRESP_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGListResp : public AbstractModel
                {
                public:
                    DescribeMNGListResp();
                    ~DescribeMNGListResp() = default;
                     ...
                     * 
                     */
                    std::vector<DescribeMNGListData> GetDataList() const;
                     ...
                     * 
                     */
                    void SetDataList(const std::vector<DescribeMNGListData>& _dataList);
                ...
                private:
                     ...
                     */
                    std::vector<DescribeMNGListData> m_dataList;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGLISTRESP_H_
