...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGAUDITLISTAPPINFORESP_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGAUDITLISTAPPINFORESP_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGAuditListAppInfoResp : public AbstractModel
                {
                public:
                    DescribeMNGAuditListAppInfoResp();
                    ~DescribeMNGAuditListAppInfoResp() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGAUDITLISTAPPINFORESP_H_
