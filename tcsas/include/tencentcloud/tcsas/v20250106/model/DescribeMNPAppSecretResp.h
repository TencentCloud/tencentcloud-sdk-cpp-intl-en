...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPAPPSECRETRESP_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPAPPSECRETRESP_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNPAppSecretResp : public AbstractModel
                {
                public:
                    DescribeMNPAppSecretResp();
                    ~DescribeMNPAppSecretResp() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取<p>Mini program secret key status. Valid values: 0: Not generated; 1: Active; 2: Frozen; 3: Reset.</p>
                    ...
                    /**
                     * 设置<p>Mini program secret key status. Valid values: 0: Not generated; 1: Active; 2: Frozen; 3: Reset.</p>
                     * @param _secretStatus <p>Mini program secret key status. Valid values: 0: Not generated; 1: Active; 2: Frozen; 3: Reset.</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPAPPSECRETRESP_H_
