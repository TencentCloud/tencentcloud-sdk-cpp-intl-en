...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_RELEASEMNGVERSIONREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_RELEASEMNGVERSIONREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class ReleaseMNGVersionRequest : public AbstractModel
                {
                public:
                    ReleaseMNGVersionRequest();
                    ~ReleaseMNGVersionRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_RELEASEMNGVERSIONREQUEST_H_
