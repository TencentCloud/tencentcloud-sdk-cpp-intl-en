...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEADVERTISINGOVERVIEWREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEADVERTISINGOVERVIEWREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeAdvertisingOverviewRequest : public AbstractModel
                {
                public:
                    DescribeAdvertisingOverviewRequest();
                    ~DescribeAdvertisingOverviewRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEADVERTISINGOVERVIEWREQUEST_H_
