...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTREPORTDETAILREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTREPORTDETAILREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGPaymentReportDetailRequest : public AbstractModel
                {
                public:
                    DescribeMNGPaymentReportDetailRequest();
                    ~DescribeMNGPaymentReportDetailRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGPAYMENTREPORTDETAILREQUEST_H_
