...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACCESSANALYSISOVERVIEWREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACCESSANALYSISOVERVIEWREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNGAccessAnalysisOverviewRequest : public AbstractModel
                {
                public:
                    DescribeMNGAccessAnalysisOverviewRequest();
                    ~DescribeMNGAccessAnalysisOverviewRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNGACCESSANALYSISOVERVIEWREQUEST_H_
