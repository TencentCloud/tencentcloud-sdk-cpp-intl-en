...
#ifndef TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPADVERTISINGDETAILREQUEST_H_
#define TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPADVERTISINGDETAILREQUEST_H_
    ...
    namespace Tcsas
    {
        namespace V20250106
        {
            namespace Model
            {
                ...
                */
                class DescribeMNPAdvertisingDetailRequest : public AbstractModel
                {
                public:
                    DescribeMNPAdvertisingDetailRequest();
                    ~DescribeMNPAdvertisingDetailRequest() = default;
...
#endif // !TENCENTCLOUD_TCSAS_V20250106_MODEL_DESCRIBEMNPADVERTISINGDETAILREQUEST_H_
