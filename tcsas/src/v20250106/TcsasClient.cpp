...
TcsasClient::ConfigureMNGPreviewOutcome TcsasClient::ConfigureMNGPreview(const ConfigureMNGPreviewRequest &request)
{
    ...
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ConfigureMNGPreviewResponse rsp = ConfigureMNGPreviewResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ConfigureMNGPreviewOutcome(rsp);
        else
            return ConfigureMNGPreviewOutcome(o.GetError());
    }
    else
    {
        return ConfigureMNGPreviewOutcome(outcome.GetError());
    }
}

void TcsasClient::ConfigureMNGPreviewAsync(const ConfigureMNGPreviewRequest& request, const ConfigureMNGPreviewAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const ConfigureMNGPreviewRequest&;
    using Resp = ConfigureMNGPreviewResponse;

    DoRequestAsync<Req, Resp>(
        "ConfigureMNGPreview", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::ConfigureMNGPreviewOutcomeCallable TcsasClient::ConfigureMNGPreviewCallable(const ConfigureMNGPreviewRequest &request)
{
    const auto prom = std::make_shared<std::promise<ConfigureMNGPreviewOutcome>>();
    ConfigureMNGPreviewAsync(
    request,
    [prom](
        const TcsasClient*,
        const ConfigureMNGPreviewRequest&,
        ConfigureMNGPreviewOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::CreateMNGOutcome TcsasClient::CreateMNG(const CreateMNGRequest &request)
{
    auto outcome = MakeRequest(request, "CreateMNG");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        CreateMNGResponse rsp = CreateMNGResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return CreateMNGOutcome(rsp);
        else
            return CreateMNGOutcome(o.GetError());
    }
    else
    {
        return CreateMNGOutcome(outcome.GetError());
    }
}

void TcsasClient::CreateMNGAsync(const CreateMNGRequest& request, const CreateMNGAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const CreateMNGRequest&;
    using Resp = CreateMNGResponse;

    DoRequestAsync<Req, Resp>(
        "CreateMNG", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::CreateMNGOutcomeCallable TcsasClient::CreateMNGCallable(const CreateMNGRequest &request)
{
    const auto prom = std::make_shared<std::promise<CreateMNGOutcome>>();
    CreateMNGAsync(
    request,
    [prom](
        const TcsasClient*,
        const CreateMNGRequest&,
        CreateMNGOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::CreateMNGApprovalOutcome TcsasClient::CreateMNGApproval(const CreateMNGApprovalRequest &request)
{
    ...
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        CreateMNGApprovalResponse rsp = CreateMNGApprovalResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return CreateMNGApprovalOutcome(rsp);
        else
            return CreateMNGApprovalOutcome(o.GetError());
    }
    else
    {
        return CreateMNGApprovalOutcome(outcome.GetError());
    }
}

void TcsasClient::CreateMNGApprovalAsync(const CreateMNGApprovalRequest& request, const CreateMNGApprovalAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const CreateMNGApprovalRequest&;
    using Resp = CreateMNGApprovalResponse;

    DoRequestAsync<Req, Resp>(
        "CreateMNGApproval", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::CreateMNGApprovalOutcomeCallable TcsasClient::CreateMNGApprovalCallable(const CreateMNGApprovalRequest &request)
{
    const auto prom = std::make_shared<std::promise<CreateMNGApprovalOutcome>>();
    CreateMNGApprovalAsync(
    request,
    [prom](
        const TcsasClient*,
        const CreateMNGApprovalRequest&,
        CreateMNGApprovalOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::CreateMNGDomainACLOutcome TcsasClient::CreateMNGDomainACL(const CreateMNGDomainACLRequest &request)
{
    auto outcome = MakeRequest(request, "CreateMNGDomainACL");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        CreateMNGDomainACLResponse rsp = CreateMNGDomainACLResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return CreateMNGDomainACLOutcome(rsp);
        else
            return CreateMNGDomainACLOutcome(o.GetError());
    }
    else
    {
        return CreateMNGDomainACLOutcome(outcome.GetError());
    }
}

void TcsasClient::CreateMNGDomainACLAsync(const CreateMNGDomainACLRequest& request, const CreateMNGDomainACLAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const CreateMNGDomainACLRequest&;
    using Resp = CreateMNGDomainACLResponse;

    DoRequestAsync<Req, Resp>(
        "CreateMNGDomainACL", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::CreateMNGDomainACLOutcomeCallable TcsasClient::CreateMNGDomainACLCallable(const CreateMNGDomainACLRequest &request)
{
    const auto prom = std::make_shared<std::promise<CreateMNGDomainACLOutcome>>();
    CreateMNGDomainACLAsync(
    request,
    [prom](
        const TcsasClient*,
        const CreateMNGDomainACLRequest&,
        CreateMNGDomainACLOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::CreateMNGSensitiveAPIPermissionApprovalOutcome TcsasClient::CreateMNGSensitiveAPIPermissionApproval(const CreateMNGSensitiveAPIPermissionApprovalRequest &request)
{
    auto outcome = MakeRequest(request, "CreateMNGSensitiveAPIPermissionApproval");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        CreateMNGSensitiveAPIPermissionApprovalResponse rsp = CreateMNGSensitiveAPIPermissionApprovalResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return CreateMNGSensitiveAPIPermissionApprovalOutcome(rsp);
        else
            return CreateMNGSensitiveAPIPermissionApprovalOutcome(o.GetError());
    }
    else
    {
        return CreateMNGSensitiveAPIPermissionApprovalOutcome(outcome.GetError());
    }
}

void TcsasClient::CreateMNGSensitiveAPIPermissionApprovalAsync(const CreateMNGSensitiveAPIPermissionApprovalRequest& request, const CreateMNGSensitiveAPIPermissionApprovalAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const CreateMNGSensitiveAPIPermissionApprovalRequest&;
    using Resp = CreateMNGSensitiveAPIPermissionApprovalResponse;

    DoRequestAsync<Req, Resp>(
        "CreateMNGSensitiveAPIPermissionApproval", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::CreateMNGSensitiveAPIPermissionApprovalOutcomeCallable TcsasClient::CreateMNGSensitiveAPIPermissionApprovalCallable(const CreateMNGSensitiveAPIPermissionApprovalRequest &request)
{
    const auto prom = std::make_shared<std::promise<CreateMNGSensitiveAPIPermissionApprovalOutcome>>();
    CreateMNGSensitiveAPIPermissionApprovalAsync(
    request,
    [prom](
        const TcsasClient*,
        const CreateMNGSensitiveAPIPermissionApprovalRequest&,
        CreateMNGSensitiveAPIPermissionApprovalOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::CreateMNGVersionOutcome TcsasClient::CreateMNGVersion(const CreateMNGVersionRequest &request)
{
    ...
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        CreateMNGVersionResponse rsp = CreateMNGVersionResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return CreateMNGVersionOutcome(rsp);
        else
            return CreateMNGVersionOutcome(o.GetError());
    }
    else
    {
        return CreateMNGVersionOutcome(outcome.GetError());
    }
}

void TcsasClient::CreateMNGVersionAsync(const CreateMNGVersionRequest& request, const CreateMNGVersionAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const CreateMNGVersionRequest&;
    using Resp = CreateMNGVersionResponse;

    DoRequestAsync<Req, Resp>(
        "CreateMNGVersion", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::CreateMNGVersionOutcomeCallable TcsasClient::CreateMNGVersionCallable(const CreateMNGVersionRequest &request)
{
    const auto prom = std::make_shared<std::promise<CreateMNGVersionOutcome>>();
    CreateMNGVersionAsync(
    request,
    [prom](
        const TcsasClient*,
        const CreateMNGVersionRequest&,
        CreateMNGVersionOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DeleteMNGOutcome TcsasClient::DeleteMNG(const DeleteMNGRequest &request)
{
    auto outcome = MakeRequest(request, "DeleteMNG");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DeleteMNGResponse rsp = DeleteMNGResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DeleteMNGOutcome(rsp);
        else
            return DeleteMNGOutcome(o.GetError());
    }
    else
    {
        return DeleteMNGOutcome(outcome.GetError());
    }
}

void TcsasClient::DeleteMNGAsync(const DeleteMNGRequest& request, const DeleteMNGAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DeleteMNGRequest&;
    using Resp = DeleteMNGResponse;

    DoRequestAsync<Req, Resp>(
        "DeleteMNG", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DeleteMNGOutcomeCallable TcsasClient::DeleteMNGCallable(const DeleteMNGRequest &request)
{
    const auto prom = std::make_shared<std::promise<DeleteMNGOutcome>>();
    DeleteMNGAsync(
    request,
    [prom](
        const TcsasClient*,
        const DeleteMNGRequest&,
        DeleteMNGOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeApplicationMNPListOutcome TcsasClient::DescribeApplicationMNPList(const DescribeApplicationMNPListRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeApplicationMNPList");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeApplicationMNPListResponse rsp = DescribeApplicationMNPListResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeApplicationMNPListOutcome(rsp);
        else
            return DescribeApplicationMNPListOutcome(o.GetError());
    }
    else
    {
        return DescribeApplicationMNPListOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeApplicationMNPListAsync(const DescribeApplicationMNPListRequest& request, const DescribeApplicationMNPListAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeApplicationMNPListRequest&;
    using Resp = DescribeApplicationMNPListResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeApplicationMNPList", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeApplicationMNPListOutcomeCallable TcsasClient::DescribeApplicationMNPListCallable(const DescribeApplicationMNPListRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeApplicationMNPListOutcome>>();
    DescribeApplicationMNPListAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeApplicationMNPListRequest&,
        DescribeApplicationMNPListOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGOutcome TcsasClient::DescribeMNG(const DescribeMNGRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeMNG");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGResponse rsp = DescribeMNGResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGOutcome(rsp);
        else
            return DescribeMNGOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGAsync(const DescribeMNGRequest& request, const DescribeMNGAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGRequest&;
    using Resp = DescribeMNGResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNG", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGOutcomeCallable TcsasClient::DescribeMNGCallable(const DescribeMNGRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGOutcome>>();
    DescribeMNGAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGRequest&,
        DescribeMNGOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGAllStageVersionsOutcome TcsasClient::DescribeMNGAllStageVersions(const DescribeMNGAllStageVersionsRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeMNGAllStageVersions");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGAllStageVersionsResponse rsp = DescribeMNGAllStageVersionsResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGAllStageVersionsOutcome(rsp);
        else
            return DescribeMNGAllStageVersionsOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGAllStageVersionsOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGAllStageVersionsAsync(const DescribeMNGAllStageVersionsRequest& request, const DescribeMNGAllStageVersionsAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGAllStageVersionsRequest&;
    using Resp = DescribeMNGAllStageVersionsResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGAllStageVersions", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGAllStageVersionsOutcomeCallable TcsasClient::DescribeMNGAllStageVersionsCallable(const DescribeMNGAllStageVersionsRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGAllStageVersionsOutcome>>();
    DescribeMNGAllStageVersionsAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGAllStageVersionsRequest&,
        DescribeMNGAllStageVersionsOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGCategoryOutcome TcsasClient::DescribeMNGCategory(const DescribeMNGCategoryRequest &request)
{
    ...
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGCategoryResponse rsp = DescribeMNGCategoryResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGCategoryOutcome(rsp);
        else
            return DescribeMNGCategoryOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGCategoryOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGCategoryAsync(const DescribeMNGCategoryRequest& request, const DescribeMNGCategoryAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGCategoryRequest&;
    using Resp = DescribeMNGCategoryResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGCategory", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGCategoryOutcomeCallable TcsasClient::DescribeMNGCategoryCallable(const DescribeMNGCategoryRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGCategoryOutcome>>();
    DescribeMNGCategoryAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGCategoryRequest&,
        DescribeMNGCategoryOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGDomainACLOutcome TcsasClient::DescribeMNGDomainACL(const DescribeMNGDomainACLRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeMNGDomainACL");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGDomainACLResponse rsp = DescribeMNGDomainACLResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGDomainACLOutcome(rsp);
        else
            return DescribeMNGDomainACLOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGDomainACLOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGDomainACLAsync(const DescribeMNGDomainACLRequest& request, const DescribeMNGDomainACLAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGDomainACLRequest&;
    using Resp = DescribeMNGDomainACLResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGDomainACL", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGDomainACLOutcomeCallable TcsasClient::DescribeMNGDomainACLCallable(const DescribeMNGDomainACLRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGDomainACLOutcome>>();
    DescribeMNGDomainACLAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGDomainACLRequest&,
        DescribeMNGDomainACLOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGListOutcome TcsasClient::DescribeMNGList(const DescribeMNGListRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeMNGList");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGListResponse rsp = DescribeMNGListResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGListOutcome(rsp);
        else
            return DescribeMNGListOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGListOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGListAsync(const DescribeMNGListRequest& request, const DescribeMNGListAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGListRequest&;
    using Resp = DescribeMNGListResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGList", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGListOutcomeCallable TcsasClient::DescribeMNGListCallable(const DescribeMNGListRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGListOutcome>>();
    DescribeMNGListAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGListRequest&,
        DescribeMNGListOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGOfflinePackageURLOutcome TcsasClient::DescribeMNGOfflinePackageURL(const DescribeMNGOfflinePackageURLRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeMNGOfflinePackageURL");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGOfflinePackageURLResponse rsp = DescribeMNGOfflinePackageURLResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGOfflinePackageURLOutcome(rsp);
        else
            return DescribeMNGOfflinePackageURLOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGOfflinePackageURLOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGOfflinePackageURLAsync(const DescribeMNGOfflinePackageURLRequest& request, const DescribeMNGOfflinePackageURLAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGOfflinePackageURLRequest&;
    using Resp = DescribeMNGOfflinePackageURLResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGOfflinePackageURL", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGOfflinePackageURLOutcomeCallable TcsasClient::DescribeMNGOfflinePackageURLCallable(const DescribeMNGOfflinePackageURLRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGOfflinePackageURLOutcome>>();
    DescribeMNGOfflinePackageURLAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGOfflinePackageURLRequest&,
        DescribeMNGOfflinePackageURLOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGPreviewOutcome TcsasClient::DescribeMNGPreview(const DescribeMNGPreviewRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeMNGPreview");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGPreviewResponse rsp = DescribeMNGPreviewResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGPreviewOutcome(rsp);
        else
            return DescribeMNGPreviewOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGPreviewOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGPreviewAsync(const DescribeMNGPreviewRequest& request, const DescribeMNGPreviewAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGPreviewRequest&;
    using Resp = DescribeMNGPreviewResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGPreview", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGPreviewOutcomeCallable TcsasClient::DescribeMNGPreviewCallable(const DescribeMNGPreviewRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGPreviewOutcome>>();
    DescribeMNGPreviewAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGPreviewRequest&,
        DescribeMNGPreviewOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGReleasedVersionHistoryOutcome TcsasClient::DescribeMNGReleasedVersionHistory(const DescribeMNGReleasedVersionHistoryRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeMNGReleasedVersionHistory");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGReleasedVersionHistoryResponse rsp = DescribeMNGReleasedVersionHistoryResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGReleasedVersionHistoryOutcome(rsp);
        else
            return DescribeMNGReleasedVersionHistoryOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGReleasedVersionHistoryOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGReleasedVersionHistoryAsync(const DescribeMNGReleasedVersionHistoryRequest& request, const DescribeMNGReleasedVersionHistoryAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGReleasedVersionHistoryRequest&;
    using Resp = DescribeMNGReleasedVersionHistoryResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGReleasedVersionHistory", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGReleasedVersionHistoryOutcomeCallable TcsasClient::DescribeMNGReleasedVersionHistoryCallable(const DescribeMNGReleasedVersionHistoryRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGReleasedVersionHistoryOutcome>>();
    DescribeMNGReleasedVersionHistoryAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGReleasedVersionHistoryRequest&,
        DescribeMNGReleasedVersionHistoryOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGSensitiveAPIPermissionApprovalOutcome TcsasClient::DescribeMNGSensitiveAPIPermissionApproval(const DescribeMNGSensitiveAPIPermissionApprovalRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeMNGSensitiveAPIPermissionApproval");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGSensitiveAPIPermissionApprovalResponse rsp = DescribeMNGSensitiveAPIPermissionApprovalResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGSensitiveAPIPermissionApprovalOutcome(rsp);
        else
            return DescribeMNGSensitiveAPIPermissionApprovalOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGSensitiveAPIPermissionApprovalOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGSensitiveAPIPermissionApprovalAsync(const DescribeMNGSensitiveAPIPermissionApprovalRequest& request, const DescribeMNGSensitiveAPIPermissionApprovalAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGSensitiveAPIPermissionApprovalRequest&;
    using Resp = DescribeMNGSensitiveAPIPermissionApprovalResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGSensitiveAPIPermissionApproval", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGSensitiveAPIPermissionApprovalOutcomeCallable TcsasClient::DescribeMNGSensitiveAPIPermissionApprovalCallable(const DescribeMNGSensitiveAPIPermissionApprovalRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGSensitiveAPIPermissionApprovalOutcome>>();
    DescribeMNGSensitiveAPIPermissionApprovalAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGSensitiveAPIPermissionApprovalRequest&,
        DescribeMNGSensitiveAPIPermissionApprovalOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGSensitiveAPIPermissionListOutcome TcsasClient::DescribeMNGSensitiveAPIPermissionList(const DescribeMNGSensitiveAPIPermissionListRequest &request)
{
    auto outcome = MakeRequest(request, "DescribeMNGSensitiveAPIPermissionList");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGSensitiveAPIPermissionListResponse rsp = DescribeMNGSensitiveAPIPermissionListResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGSensitiveAPIPermissionListOutcome(rsp);
        else
            return DescribeMNGSensitiveAPIPermissionListOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGSensitiveAPIPermissionListOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGSensitiveAPIPermissionListAsync(const DescribeMNGSensitiveAPIPermissionListRequest& request, const DescribeMNGSensitiveAPIPermissionListAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGSensitiveAPIPermissionListRequest&;
    using Resp = DescribeMNGSensitiveAPIPermissionListResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGSensitiveAPIPermissionList", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGSensitiveAPIPermissionListOutcomeCallable TcsasClient::DescribeMNGSensitiveAPIPermissionListCallable(const DescribeMNGSensitiveAPIPermissionListRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGSensitiveAPIPermissionListOutcome>>();
    DescribeMNGSensitiveAPIPermissionListAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGSensitiveAPIPermissionListRequest&,
        DescribeMNGSensitiveAPIPermissionListOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::DescribeMNGVersionOutcome TcsasClient::DescribeMNGVersion(const DescribeMNGVersionRequest &request)
{
    ...
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        DescribeMNGVersionResponse rsp = DescribeMNGVersionResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return DescribeMNGVersionOutcome(rsp);
        else
            return DescribeMNGVersionOutcome(o.GetError());
    }
    else
    {
        return DescribeMNGVersionOutcome(outcome.GetError());
    }
}

void TcsasClient::DescribeMNGVersionAsync(const DescribeMNGVersionRequest& request, const DescribeMNGVersionAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const DescribeMNGVersionRequest&;
    using Resp = DescribeMNGVersionResponse;

    DoRequestAsync<Req, Resp>(
        "DescribeMNGVersion", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::DescribeMNGVersionOutcomeCallable TcsasClient::DescribeMNGVersionCallable(const DescribeMNGVersionRequest &request)
{
    const auto prom = std::make_shared<std::promise<DescribeMNGVersionOutcome>>();
    DescribeMNGVersionAsync(
    request,
    [prom](
        const TcsasClient*,
        const DescribeMNGVersionRequest&,
        DescribeMNGVersionOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::ModifyMNGOutcome TcsasClient::ModifyMNG(const ModifyMNGRequest &request)
{
    auto outcome = MakeRequest(request, "ModifyMNG");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyMNGResponse rsp = ModifyMNGResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyMNGOutcome(rsp);
        else
            return ModifyMNGOutcome(o.GetError());
    }
    else
    {
        return ModifyMNGOutcome(outcome.GetError());
    }
}

void TcsasClient::ModifyMNGAsync(const ModifyMNGRequest& request, const ModifyMNGAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const ModifyMNGRequest&;
    using Resp = ModifyMNGResponse;

    DoRequestAsync<Req, Resp>(
        "ModifyMNG", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::ModifyMNGOutcomeCallable TcsasClient::ModifyMNGCallable(const ModifyMNGRequest &request)
{
    const auto prom = std::make_shared<std::promise<ModifyMNGOutcome>>();
    ModifyMNGAsync(
    request,
    [prom](
        const TcsasClient*,
        const ModifyMNGRequest&,
        ModifyMNGOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::ModifyMNGDomainOutcome TcsasClient::ModifyMNGDomain(const ModifyMNGDomainRequest &request)
{
    ...
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ModifyMNGDomainResponse rsp = ModifyMNGDomainResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ModifyMNGDomainOutcome(rsp);
        else
            return ModifyMNGDomainOutcome(o.GetError());
    }
    else
    {
        return ModifyMNGDomainOutcome(outcome.GetError());
    }
}

void TcsasClient::ModifyMNGDomainAsync(const ModifyMNGDomainRequest& request, const ModifyMNGDomainAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const ModifyMNGDomainRequest&;
    using Resp = ModifyMNGDomainResponse;

    DoRequestAsync<Req, Resp>(
        "ModifyMNGDomain", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::ModifyMNGDomainOutcomeCallable TcsasClient::ModifyMNGDomainCallable(const ModifyMNGDomainRequest &request)
{
    const auto prom = std::make_shared<std::promise<ModifyMNGDomainOutcome>>();
    ModifyMNGDomainAsync(
    request,
    [prom](
        const TcsasClient*,
        const ModifyMNGDomainRequest&,
        ModifyMNGDomainOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::ReleaseMNGVersionOutcome TcsasClient::ReleaseMNGVersion(const ReleaseMNGVersionRequest &request)
{
    ...
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        ReleaseMNGVersionResponse rsp = ReleaseMNGVersionResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return ReleaseMNGVersionOutcome(rsp);
        else
            return ReleaseMNGVersionOutcome(o.GetError());
    }
    else
    {
        return ReleaseMNGVersionOutcome(outcome.GetError());
    }
}

void TcsasClient::ReleaseMNGVersionAsync(const ReleaseMNGVersionRequest& request, const ReleaseMNGVersionAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const ReleaseMNGVersionRequest&;
    using Resp = ReleaseMNGVersionResponse;

    DoRequestAsync<Req, Resp>(
        "ReleaseMNGVersion", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::ReleaseMNGVersionOutcomeCallable TcsasClient::ReleaseMNGVersionCallable(const ReleaseMNGVersionRequest &request)
{
    const auto prom = std::make_shared<std::promise<ReleaseMNGVersionOutcome>>();
    ReleaseMNGVersionAsync(
    request,
    [prom](
        const TcsasClient*,
        const ReleaseMNGVersionRequest&,
        ReleaseMNGVersionOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::RemoveMNGOutcome TcsasClient::RemoveMNG(const RemoveMNGRequest &request)
{
    auto outcome = MakeRequest(request, "RemoveMNG");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        RemoveMNGResponse rsp = RemoveMNGResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return RemoveMNGOutcome(rsp);
        else
            return RemoveMNGOutcome(o.GetError());
    }
    else
    {
        return RemoveMNGOutcome(outcome.GetError());
    }
}

void TcsasClient::RemoveMNGAsync(const RemoveMNGRequest& request, const RemoveMNGAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const RemoveMNGRequest&;
    using Resp = RemoveMNGResponse;

    DoRequestAsync<Req, Resp>(
        "RemoveMNG", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::RemoveMNGOutcomeCallable TcsasClient::RemoveMNGCallable(const RemoveMNGRequest &request)
{
    const auto prom = std::make_shared<std::promise<RemoveMNGOutcome>>();
    RemoveMNGAsync(
    request,
    [prom](
        const TcsasClient*,
        const RemoveMNGRequest&,
        RemoveMNGOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
...
TcsasClient::RollbackMNGVersionOutcome TcsasClient::RollbackMNGVersion(const RollbackMNGVersionRequest &request)
{
    auto outcome = MakeRequest(request, "RollbackMNGVersion");
    if (outcome.IsSuccess())
    {
        auto r = outcome.GetResult();
        string payload = string(r.Body(), r.BodySize());
        RollbackMNGVersionResponse rsp = RollbackMNGVersionResponse();
        auto o = rsp.Deserialize(payload);
        if (o.IsSuccess())
            return RollbackMNGVersionOutcome(rsp);
        else
            return RollbackMNGVersionOutcome(o.GetError());
    }
    else
    {
        return RollbackMNGVersionOutcome(outcome.GetError());
    }
}

void TcsasClient::RollbackMNGVersionAsync(const RollbackMNGVersionRequest& request, const RollbackMNGVersionAsyncHandler& handler, const std::shared_ptr<const AsyncCallerContext>& context)
{
    using Req = const RollbackMNGVersionRequest&;
    using Resp = RollbackMNGVersionResponse;

    DoRequestAsync<Req, Resp>(
        "RollbackMNGVersion", request, {{{"Content-Type", "application/json"}}},
        [this, context, handler](Req req, Outcome<Core::Error, Resp> resp)
        {
            handler(this, req, std::move(resp), context);
        });
...
TcsasClient::RollbackMNGVersionOutcomeCallable TcsasClient::RollbackMNGVersionCallable(const RollbackMNGVersionRequest &request)
{
    const auto prom = std::make_shared<std::promise<RollbackMNGVersionOutcome>>();
    RollbackMNGVersionAsync(
    request,
    [prom](
        const TcsasClient*,
        const RollbackMNGVersionRequest&,
        RollbackMNGVersionOutcome resp,
        const std::shared_ptr<const AsyncCallerContext>&
    )
    {
        prom->set_value(resp);
