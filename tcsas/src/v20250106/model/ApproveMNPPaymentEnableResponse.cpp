...
CoreInternalOutcome ApproveMNPPaymentEnableResponse::Deserialize(const string &payload)
{
...
string ApproveMNPPaymentEnableResponse::ToJsonString() const
{
...
ApproveMNPPaymentOpenRes ApproveMNPPaymentEnableResponse::GetData() const
{
    return m_data;
}

bool ApproveMNPPaymentEnableResponse::DataHasBeenSet() const
{
