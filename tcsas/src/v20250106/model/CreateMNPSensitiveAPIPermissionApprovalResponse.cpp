...
CoreInternalOutcome CreateMNPSensitiveAPIPermissionApprovalResponse::Deserialize(const string &payload)
{
...
string CreateMNPSensitiveAPIPermissionApprovalResponse::ToJsonString() const
{
...
ResourceIdStringInfo CreateMNPSensitiveAPIPermissionApprovalResponse::GetData() const
{
    return m_data;
}

bool CreateMNPSensitiveAPIPermissionApprovalResponse::DataHasBeenSet() const
{
