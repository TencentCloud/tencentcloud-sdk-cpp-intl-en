...
CoreInternalOutcome DescribeMNGVersionAuditListResponse::Deserialize(const string &payload)
{
...
string DescribeMNGVersionAuditListResponse::ToJsonString() const
{
...
DescribeMNGVersionAuditListResp DescribeMNGVersionAuditListResponse::GetData() const
{
    return m_data;
}

bool DescribeMNGVersionAuditListResponse::DataHasBeenSet() const
{
