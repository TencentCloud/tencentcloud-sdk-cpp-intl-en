...
CoreInternalOutcome DescribeMNPAppSecretResponse::Deserialize(const string &payload)
{
...
string DescribeMNPAppSecretResponse::ToJsonString() const
{
...
DescribeMNPAppSecretResp DescribeMNPAppSecretResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPAppSecretResponse::DataHasBeenSet() const
{
