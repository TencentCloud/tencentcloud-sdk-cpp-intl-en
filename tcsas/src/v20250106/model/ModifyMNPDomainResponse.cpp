...
CoreInternalOutcome ModifyMNPDomainResponse::Deserialize(const string &payload)
{
...
string ModifyMNPDomainResponse::ToJsonString() const
{
...
BooleanInfo ModifyMNPDomainResponse::GetData() const
{
    return m_data;
}

bool ModifyMNPDomainResponse::DataHasBeenSet() const
{
