...
CoreInternalOutcome CreateMNPVersionResponse::Deserialize(const string &payload)
{
...
string CreateMNPVersionResponse::ToJsonString() const
{
...
CreateMNPVersionResp CreateMNPVersionResponse::GetData() const
{
    return m_data;
}

bool CreateMNPVersionResponse::DataHasBeenSet() const
{
