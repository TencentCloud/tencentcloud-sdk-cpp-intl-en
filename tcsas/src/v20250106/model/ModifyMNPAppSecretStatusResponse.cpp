...
CoreInternalOutcome ModifyMNPAppSecretStatusResponse::Deserialize(const string &payload)
{
...
string ModifyMNPAppSecretStatusResponse::ToJsonString() const
{
...
ModifyMNPAppSecretStatusResp ModifyMNPAppSecretStatusResponse::GetData() const
{
    return m_data;
}

bool ModifyMNPAppSecretStatusResponse::DataHasBeenSet() const
{
