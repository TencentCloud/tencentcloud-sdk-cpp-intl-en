...
CoreInternalOutcome DescribeMNPSensitiveAPIPermissionListResponse::Deserialize(const string &payload)
{
...
string DescribeMNPSensitiveAPIPermissionListResponse::ToJsonString() const
{
...
DescribeMNPSensitiveAPIPermissionListResp DescribeMNPSensitiveAPIPermissionListResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPSensitiveAPIPermissionListResponse::DataHasBeenSet() const
{
