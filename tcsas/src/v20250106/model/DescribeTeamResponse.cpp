...
CoreInternalOutcome DescribeTeamResponse::Deserialize(const string &payload)
{
...
string DescribeTeamResponse::ToJsonString() const
{
...
DescribeTeamDetailResp DescribeTeamResponse::GetData() const
{
    return m_data;
}

bool DescribeTeamResponse::DataHasBeenSet() const
{
