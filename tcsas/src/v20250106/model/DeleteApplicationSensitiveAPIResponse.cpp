...
CoreInternalOutcome DeleteApplicationSensitiveAPIResponse::Deserialize(const string &payload)
{
...
string DeleteApplicationSensitiveAPIResponse::ToJsonString() const
{
...
BooleanInfo DeleteApplicationSensitiveAPIResponse::GetData() const
{
    return m_data;
}

bool DeleteApplicationSensitiveAPIResponse::DataHasBeenSet() const
{
