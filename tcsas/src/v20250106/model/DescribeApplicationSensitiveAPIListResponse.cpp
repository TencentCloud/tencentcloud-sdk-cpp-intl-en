...
CoreInternalOutcome DescribeApplicationSensitiveAPIListResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationSensitiveAPIListResponse::ToJsonString() const
{
...
DescribeApplicationSensitiveAPIListResp DescribeApplicationSensitiveAPIListResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationSensitiveAPIListResponse::DataHasBeenSet() const
{
