...
CoreInternalOutcome CreateMNPSubscribeMessageTemplateResponse::Deserialize(const string &payload)
{
...
string CreateMNPSubscribeMessageTemplateResponse::ToJsonString() const
{
...
BooleanInfo CreateMNPSubscribeMessageTemplateResponse::GetData() const
{
    return m_data;
}

bool CreateMNPSubscribeMessageTemplateResponse::DataHasBeenSet() const
{
