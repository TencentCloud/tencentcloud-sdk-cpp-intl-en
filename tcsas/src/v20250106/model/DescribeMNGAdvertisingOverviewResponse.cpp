...
CoreInternalOutcome DescribeMNGAdvertisingOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeMNGAdvertisingOverviewResponse::ToJsonString() const
{
...
AnalysisAdvertOverview DescribeMNGAdvertisingOverviewResponse::GetData() const
{
    return m_data;
}

bool DescribeMNGAdvertisingOverviewResponse::DataHasBeenSet() const
{
