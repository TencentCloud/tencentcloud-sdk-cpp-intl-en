...
CoreInternalOutcome DeleteMNPSubscribeMessageTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteMNPSubscribeMessageTemplateResponse::ToJsonString() const
{
...
BooleanInfo DeleteMNPSubscribeMessageTemplateResponse::GetData() const
{
    return m_data;
}

bool DeleteMNPSubscribeMessageTemplateResponse::DataHasBeenSet() const
{
