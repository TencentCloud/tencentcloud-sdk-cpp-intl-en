...
CoreInternalOutcome DescribeMNPVersionResponse::Deserialize(const string &payload)
{
...
string DescribeMNPVersionResponse::ToJsonString() const
{
...
DescribeMNPVersionResp DescribeMNPVersionResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPVersionResponse::DataHasBeenSet() const
{
