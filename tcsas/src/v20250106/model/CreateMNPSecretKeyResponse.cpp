...
CoreInternalOutcome CreateMNPSecretKeyResponse::Deserialize(const string &payload)
{
...
string CreateMNPSecretKeyResponse::ToJsonString() const
{
...
CreateMNPSecretKeyResp CreateMNPSecretKeyResponse::GetData() const
{
    return m_data;
}

bool CreateMNPSecretKeyResponse::DataHasBeenSet() const
{
