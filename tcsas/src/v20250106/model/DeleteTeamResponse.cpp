...
CoreInternalOutcome DeleteTeamResponse::Deserialize(const string &payload)
{
...
string DeleteTeamResponse::ToJsonString() const
{
...
BooleanInfo DeleteTeamResponse::GetData() const
{
    return m_data;
}

bool DeleteTeamResponse::DataHasBeenSet() const
{
