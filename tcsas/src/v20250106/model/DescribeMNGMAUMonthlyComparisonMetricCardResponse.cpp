...
CoreInternalOutcome DescribeMNGMAUMonthlyComparisonMetricCardResponse::Deserialize(const string &payload)
{
...
string DescribeMNGMAUMonthlyComparisonMetricCardResponse::ToJsonString() const
{
...
MAUIndicatorCard DescribeMNGMAUMonthlyComparisonMetricCardResponse::GetData() const
{
    return m_data;
}

bool DescribeMNGMAUMonthlyComparisonMetricCardResponse::DataHasBeenSet() const
{
