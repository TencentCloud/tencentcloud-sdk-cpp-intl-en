...
CoreInternalOutcome DescribePaymentDataOverviewResponse::Deserialize(const string &payload)
{
...
string DescribePaymentDataOverviewResponse::ToJsonString() const
{
...
MNPPaymentOverview DescribePaymentDataOverviewResponse::GetData() const
{
    return m_data;
}

bool DescribePaymentDataOverviewResponse::DataHasBeenSet() const
{
