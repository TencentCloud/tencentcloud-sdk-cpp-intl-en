...
CoreInternalOutcome DescribeMNGSensitiveAPIPermissionListResponse::Deserialize(const string &payload)
{
...
string DescribeMNGSensitiveAPIPermissionListResponse::ToJsonString() const
{
...
DescribeMNGSensitiveAPIPermissionListResp DescribeMNGSensitiveAPIPermissionListResponse::GetData() const
{
    return m_data;
}

bool DescribeMNGSensitiveAPIPermissionListResponse::DataHasBeenSet() const
{
