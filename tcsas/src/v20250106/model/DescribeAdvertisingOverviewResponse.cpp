...
CoreInternalOutcome DescribeAdvertisingOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeAdvertisingOverviewResponse::ToJsonString() const
{
...
MNPAdvertisingOverview DescribeAdvertisingOverviewResponse::GetData() const
{
    return m_data;
}

bool DescribeAdvertisingOverviewResponse::DataHasBeenSet() const
{
