...
CoreInternalOutcome CreatePresetKeyResponse::Deserialize(const string &payload)
{
...
string CreatePresetKeyResponse::ToJsonString() const
{
...
PresetResp CreatePresetKeyResponse::GetData() const
{
    return m_data;
}

bool CreatePresetKeyResponse::DataHasBeenSet() const
{
