...
CoreInternalOutcome ChangePaymentBoundMerchantResponse::Deserialize(const string &payload)
{
...
string ChangePaymentBoundMerchantResponse::ToJsonString() const
{
...
ChangePaymentV2BindMerchantRes ChangePaymentBoundMerchantResponse::GetData() const
{
    return m_data;
}

bool ChangePaymentBoundMerchantResponse::DataHasBeenSet() const
{
