...
CoreInternalOutcome DescribeAdvertisingLineChartResponse::Deserialize(const string &payload)
{
...
string DescribeAdvertisingLineChartResponse::ToJsonString() const
{
...
AdTrendChart DescribeAdvertisingLineChartResponse::GetData() const
{
    return m_data;
}

bool DescribeAdvertisingLineChartResponse::DataHasBeenSet() const
{
