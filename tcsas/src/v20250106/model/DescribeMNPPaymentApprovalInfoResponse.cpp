...
CoreInternalOutcome DescribeMNPPaymentApprovalInfoResponse::Deserialize(const string &payload)
{
...
string DescribeMNPPaymentApprovalInfoResponse::ToJsonString() const
{
...
ApplyPaymentOpenDetailRes DescribeMNPPaymentApprovalInfoResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPPaymentApprovalInfoResponse::DataHasBeenSet() const
{
