...
CoreInternalOutcome QueryMNPMerchantInfoResponse::Deserialize(const string &payload)
{
...
string QueryMNPMerchantInfoResponse::ToJsonString() const
{
...
DescribeMNPTeamMerchantInfoRes QueryMNPMerchantInfoResponse::GetData() const
{
    return m_data;
}

bool QueryMNPMerchantInfoResponse::DataHasBeenSet() const
{
