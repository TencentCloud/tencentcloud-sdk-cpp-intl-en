...
CoreInternalOutcome ModifyMNGAppSecretStatusResponse::Deserialize(const string &payload)
{
...
string ModifyMNGAppSecretStatusResponse::ToJsonString() const
{
...
ModifyMNGAppSecretStatusResp ModifyMNGAppSecretStatusResponse::GetData() const
{
    return m_data;
}

bool ModifyMNGAppSecretStatusResponse::DataHasBeenSet() const
{
