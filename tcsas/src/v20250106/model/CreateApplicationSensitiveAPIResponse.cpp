...
CoreInternalOutcome CreateApplicationSensitiveAPIResponse::Deserialize(const string &payload)
{
...
string CreateApplicationSensitiveAPIResponse::ToJsonString() const
{
...
BooleanInfo CreateApplicationSensitiveAPIResponse::GetData() const
{
    return m_data;
}

bool CreateApplicationSensitiveAPIResponse::DataHasBeenSet() const
{
