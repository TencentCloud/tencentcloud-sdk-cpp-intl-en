...
CoreInternalOutcome RequestPaymentMerchantBindingResponse::Deserialize(const string &payload)
{
...
string RequestPaymentMerchantBindingResponse::ToJsonString() const
{
...
MerchantBindApprovalResp RequestPaymentMerchantBindingResponse::GetData() const
{
    return m_data;
}

bool RequestPaymentMerchantBindingResponse::DataHasBeenSet() const
{
