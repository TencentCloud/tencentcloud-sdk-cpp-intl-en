...
CoreInternalOutcome ReleaseMNGVersionResponse::Deserialize(const string &payload)
{
...
string ReleaseMNGVersionResponse::ToJsonString() const
{
...
BooleanInfo ReleaseMNGVersionResponse::GetData() const
{
    return m_data;
}

bool ReleaseMNGVersionResponse::DataHasBeenSet() const
{
