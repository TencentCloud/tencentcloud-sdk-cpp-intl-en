...
CoreInternalOutcome RequestPaymentEnableResponse::Deserialize(const string &payload)
{
...
string RequestPaymentEnableResponse::ToJsonString() const
{
...
ChangePaymentV2BindMerchantRes RequestPaymentEnableResponse::GetData() const
{
    return m_data;
}

bool RequestPaymentEnableResponse::DataHasBeenSet() const
{
