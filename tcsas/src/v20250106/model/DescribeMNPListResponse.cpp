...
CoreInternalOutcome DescribeMNPListResponse::Deserialize(const string &payload)
{
...
string DescribeMNPListResponse::ToJsonString() const
{
...
DescribeMNPListResp DescribeMNPListResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPListResponse::DataHasBeenSet() const
{
