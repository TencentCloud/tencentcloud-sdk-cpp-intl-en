...
CoreInternalOutcome DeleteTeamMemberResponse::Deserialize(const string &payload)
{
...
string DeleteTeamMemberResponse::ToJsonString() const
{
...
BooleanInfo DeleteTeamMemberResponse::GetData() const
{
    return m_data;
}

bool DeleteTeamMemberResponse::DataHasBeenSet() const
{
