...
CoreInternalOutcome DeleteMNPResponse::Deserialize(const string &payload)
{
...
string DeleteMNPResponse::ToJsonString() const
{
...
BooleanInfo DeleteMNPResponse::GetData() const
{
    return m_data;
}

bool DeleteMNPResponse::DataHasBeenSet() const
{
