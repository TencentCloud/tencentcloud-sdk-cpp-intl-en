...
CoreInternalOutcome DescribeAPPDataOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeAPPDataOverviewResponse::ToJsonString() const
{
...
APPOverview DescribeAPPDataOverviewResponse::GetData() const
{
    return m_data;
}

bool DescribeAPPDataOverviewResponse::DataHasBeenSet() const
{
