...
CoreInternalOutcome DescribeMNGAccessAnalysisOverviewResponse::Deserialize(const string &payload)
{
...
string DescribeMNGAccessAnalysisOverviewResponse::ToJsonString() const
{
...
AccessAnalysisOverview DescribeMNGAccessAnalysisOverviewResponse::GetData() const
{
    return m_data;
}

bool DescribeMNGAccessAnalysisOverviewResponse::DataHasBeenSet() const
{
