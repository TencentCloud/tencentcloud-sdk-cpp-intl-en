...
CoreInternalOutcome UnbindPaymentMerchantResponse::Deserialize(const string &payload)
{
...
string UnbindPaymentMerchantResponse::ToJsonString() const
{
...
BooleanInfo UnbindPaymentMerchantResponse::GetData() const
{
    return m_data;
}

bool UnbindPaymentMerchantResponse::DataHasBeenSet() const
{
