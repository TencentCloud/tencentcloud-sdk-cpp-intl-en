...
CoreInternalOutcome DescribeMNPVersionAuditDetailResponse::Deserialize(const string &payload)
{
...
string DescribeMNPVersionAuditDetailResponse::ToJsonString() const
{
...
DescribeMNPVersionAuditDetailResp DescribeMNPVersionAuditDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPVersionAuditDetailResponse::DataHasBeenSet() const
{
