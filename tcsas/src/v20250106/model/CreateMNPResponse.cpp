...
CoreInternalOutcome CreateMNPResponse::Deserialize(const string &payload)
{
...
string CreateMNPResponse::ToJsonString() const
{
...
ResourceIdStringInfo CreateMNPResponse::GetData() const
{
    return m_data;
}

bool CreateMNPResponse::DataHasBeenSet() const
{
