...
CoreInternalOutcome DescribeMNGVersionResponse::Deserialize(const string &payload)
{
...
string DescribeMNGVersionResponse::ToJsonString() const
{
...
DescribeMNGVersionResp DescribeMNGVersionResponse::GetData() const
{
    return m_data;
}

bool DescribeMNGVersionResponse::DataHasBeenSet() const
{
