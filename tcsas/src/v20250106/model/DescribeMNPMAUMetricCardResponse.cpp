...
CoreInternalOutcome DescribeMNPMAUMetricCardResponse::Deserialize(const string &payload)
{
...
string DescribeMNPMAUMetricCardResponse::ToJsonString() const
{
...
MAUIndicatorCard DescribeMNPMAUMetricCardResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPMAUMetricCardResponse::DataHasBeenSet() const
{
