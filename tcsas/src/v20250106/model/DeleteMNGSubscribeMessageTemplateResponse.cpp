...
CoreInternalOutcome DeleteMNGSubscribeMessageTemplateResponse::Deserialize(const string &payload)
{
...
string DeleteMNGSubscribeMessageTemplateResponse::ToJsonString() const
{
...
BooleanInfo DeleteMNGSubscribeMessageTemplateResponse::GetData() const
{
    return m_data;
}

bool DeleteMNGSubscribeMessageTemplateResponse::DataHasBeenSet() const
{
