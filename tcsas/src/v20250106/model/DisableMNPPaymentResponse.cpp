...
CoreInternalOutcome DisableMNPPaymentResponse::Deserialize(const string &payload)
{
...
string DisableMNPPaymentResponse::ToJsonString() const
{
...
BooleanInfo DisableMNPPaymentResponse::GetData() const
{
    return m_data;
}

bool DisableMNPPaymentResponse::DataHasBeenSet() const
{
