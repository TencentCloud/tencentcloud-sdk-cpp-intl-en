...
vector<AgeRatingItemReq> ModifyMNGRequest::GetAgeRatings() const
{
    return m_ageRatings;
}

void ModifyMNGRequest::SetAgeRatings(const vector<AgeRatingItemReq>& _ageRatings)
{
    m_ageRatings = _ageRatings;
    m_ageRatingsHasBeenSet = true;
}

bool ModifyMNGRequest::AgeRatingsHasBeenSet() const
{
