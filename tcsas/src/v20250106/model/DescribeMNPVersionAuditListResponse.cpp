...
CoreInternalOutcome DescribeMNPVersionAuditListResponse::Deserialize(const string &payload)
{
...
string DescribeMNPVersionAuditListResponse::ToJsonString() const
{
...
DescribeMNPVersionAuditListResp DescribeMNPVersionAuditListResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPVersionAuditListResponse::DataHasBeenSet() const
{
