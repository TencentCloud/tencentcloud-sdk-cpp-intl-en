...
CoreInternalOutcome ModifyMNPResponse::Deserialize(const string &payload)
{
...
string ModifyMNPResponse::ToJsonString() const
{
...
ResourceIdInfo ModifyMNPResponse::GetData() const
{
    return m_data;
}

bool ModifyMNPResponse::DataHasBeenSet() const
{
