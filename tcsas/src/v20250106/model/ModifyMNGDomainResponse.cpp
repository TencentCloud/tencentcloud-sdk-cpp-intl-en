...
CoreInternalOutcome ModifyMNGDomainResponse::Deserialize(const string &payload)
{
...
string ModifyMNGDomainResponse::ToJsonString() const
{
...
BooleanInfo ModifyMNGDomainResponse::GetData() const
{
    return m_data;
}

bool ModifyMNGDomainResponse::DataHasBeenSet() const
{
