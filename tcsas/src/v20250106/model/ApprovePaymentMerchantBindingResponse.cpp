...
CoreInternalOutcome ApprovePaymentMerchantBindingResponse::Deserialize(const string &payload)
{
...
string ApprovePaymentMerchantBindingResponse::ToJsonString() const
{
...
ApprovalPaymentV2MerchantBindRes ApprovePaymentMerchantBindingResponse::GetData() const
{
    return m_data;
}

bool ApprovePaymentMerchantBindingResponse::DataHasBeenSet() const
{
