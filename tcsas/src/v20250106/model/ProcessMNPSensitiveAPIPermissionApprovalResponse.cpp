...
CoreInternalOutcome ProcessMNPSensitiveAPIPermissionApprovalResponse::Deserialize(const string &payload)
{
...
string ProcessMNPSensitiveAPIPermissionApprovalResponse::ToJsonString() const
{
...
BooleanInfo ProcessMNPSensitiveAPIPermissionApprovalResponse::GetData() const
{
    return m_data;
}

bool ProcessMNPSensitiveAPIPermissionApprovalResponse::DataHasBeenSet() const
{
