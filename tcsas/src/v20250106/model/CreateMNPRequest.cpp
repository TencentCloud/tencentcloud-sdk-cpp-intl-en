...
vector<AgeRatingItemReq> CreateMNPRequest::GetAgeRatings() const
{
    return m_ageRatings;
}

void CreateMNPRequest::SetAgeRatings(const vector<AgeRatingItemReq>& _ageRatings)
{
    m_ageRatings = _ageRatings;
    m_ageRatingsHasBeenSet = true;
}

bool CreateMNPRequest::AgeRatingsHasBeenSet() const
{
