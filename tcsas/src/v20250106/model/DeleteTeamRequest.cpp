...
string DeleteTeamRequest::GetPlatformId() const
{
    return m_platformId;
}

void DeleteTeamRequest::SetPlatformId(const string& _platformId)
{
    m_platformId = _platformId;
    m_platformIdHasBeenSet = true;
}

bool DeleteTeamRequest::PlatformIdHasBeenSet() const
{
