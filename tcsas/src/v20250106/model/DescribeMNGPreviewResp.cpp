...
#include <tencentcloud/tcsas/v20250106/model/DescribeMNGPreviewResp.h>
...
CoreInternalOutcome DescribeMNGPreviewResp::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("MNPId") && !value["MNPId"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DescribeMNGPreviewResp.MNPId` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MNPName") && !value["MNPName"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DescribeMNGPreviewResp.MNPName` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MNPDesc") && !value["MNPDesc"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DescribeMNGPreviewResp.MNPDesc` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MNPVersion") && !value["MNPVersion"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DescribeMNGPreviewResp.MNPVersion` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("MNPVersionIntro") && !value["MNPVersionIntro"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DescribeMNGPreviewResp.MNPVersionIntro` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("QRCodeUrl") && !value["QRCodeUrl"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DescribeMNGPreviewResp.QRCodeUrl` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PreviewEntrancePath") && !value["PreviewEntrancePath"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DescribeMNGPreviewResp.PreviewEntrancePath` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("QRCodeContent") && !value["QRCodeContent"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `DescribeMNGPreviewResp.QRCodeContent` IsString=false incorrectly").SetRequestId(requestId));
        }
...
void DescribeMNGPreviewResp::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string DescribeMNGPreviewResp::GetMNPId() const
{
    return m_mNPId;
}

void DescribeMNGPreviewResp::SetMNPId(const string& _mNPId)
{
    m_mNPId = _mNPId;
    m_mNPIdHasBeenSet = true;
}

bool DescribeMNGPreviewResp::MNPIdHasBeenSet() const
{
    return m_mNPIdHasBeenSet;
}

string DescribeMNGPreviewResp::GetMNPName() const
{
    return m_mNPName;
}

void DescribeMNGPreviewResp::SetMNPName(const string& _mNPName)
{
    m_mNPName = _mNPName;
    m_mNPNameHasBeenSet = true;
}

bool DescribeMNGPreviewResp::MNPNameHasBeenSet() const
{
    return m_mNPNameHasBeenSet;
}

string DescribeMNGPreviewResp::GetMNPDesc() const
{
    return m_mNPDesc;
}

void DescribeMNGPreviewResp::SetMNPDesc(const string& _mNPDesc)
{
    m_mNPDesc = _mNPDesc;
    m_mNPDescHasBeenSet = true;
}

bool DescribeMNGPreviewResp::MNPDescHasBeenSet() const
{
    return m_mNPDescHasBeenSet;
}

string DescribeMNGPreviewResp::GetMNPVersion() const
{
    return m_mNPVersion;
}

void DescribeMNGPreviewResp::SetMNPVersion(const string& _mNPVersion)
{
    m_mNPVersion = _mNPVersion;
    m_mNPVersionHasBeenSet = true;
}

bool DescribeMNGPreviewResp::MNPVersionHasBeenSet() const
{
    return m_mNPVersionHasBeenSet;
}

string DescribeMNGPreviewResp::GetMNPVersionIntro() const
{
    return m_mNPVersionIntro;
}

void DescribeMNGPreviewResp::SetMNPVersionIntro(const string& _mNPVersionIntro)
{
    m_mNPVersionIntro = _mNPVersionIntro;
    m_mNPVersionIntroHasBeenSet = true;
}

bool DescribeMNGPreviewResp::MNPVersionIntroHasBeenSet() const
{
    return m_mNPVersionIntroHasBeenSet;
}

string DescribeMNGPreviewResp::GetQRCodeUrl() const
{
    return m_qRCodeUrl;
}

void DescribeMNGPreviewResp::SetQRCodeUrl(const string& _qRCodeUrl)
{
    m_qRCodeUrl = _qRCodeUrl;
    m_qRCodeUrlHasBeenSet = true;
}

bool DescribeMNGPreviewResp::QRCodeUrlHasBeenSet() const
{
    return m_qRCodeUrlHasBeenSet;
}

string DescribeMNGPreviewResp::GetPreviewEntrancePath() const
{
    return m_previewEntrancePath;
}

void DescribeMNGPreviewResp::SetPreviewEntrancePath(const string& _previewEntrancePath)
{
    m_previewEntrancePath = _previewEntrancePath;
    m_previewEntrancePathHasBeenSet = true;
}

bool DescribeMNGPreviewResp::PreviewEntrancePathHasBeenSet() const
{
    return m_previewEntrancePathHasBeenSet;
}

string DescribeMNGPreviewResp::GetQRCodeContent() const
{
    return m_qRCodeContent;
}

void DescribeMNGPreviewResp::SetQRCodeContent(const string& _qRCodeContent)
{
    m_qRCodeContent = _qRCodeContent;
    m_qRCodeContentHasBeenSet = true;
}

bool DescribeMNGPreviewResp::QRCodeContentHasBeenSet() const
{
