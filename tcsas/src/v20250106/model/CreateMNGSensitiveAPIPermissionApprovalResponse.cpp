...
CoreInternalOutcome CreateMNGSensitiveAPIPermissionApprovalResponse::Deserialize(const string &payload)
{
...
string CreateMNGSensitiveAPIPermissionApprovalResponse::ToJsonString() const
{
...
ResourceIdStringInfo CreateMNGSensitiveAPIPermissionApprovalResponse::GetData() const
{
    return m_data;
}

bool CreateMNGSensitiveAPIPermissionApprovalResponse::DataHasBeenSet() const
{
