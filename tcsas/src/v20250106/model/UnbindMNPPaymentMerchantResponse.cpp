...
CoreInternalOutcome UnbindMNPPaymentMerchantResponse::Deserialize(const string &payload)
{
...
string UnbindMNPPaymentMerchantResponse::ToJsonString() const
{
...
BooleanInfo UnbindMNPPaymentMerchantResponse::GetData() const
{
    return m_data;
}

bool UnbindMNPPaymentMerchantResponse::DataHasBeenSet() const
{
