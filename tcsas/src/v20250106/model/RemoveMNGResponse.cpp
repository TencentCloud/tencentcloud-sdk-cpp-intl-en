...
CoreInternalOutcome RemoveMNGResponse::Deserialize(const string &payload)
{
...
string RemoveMNGResponse::ToJsonString() const
{
...
BooleanInfo RemoveMNGResponse::GetData() const
{
    return m_data;
}

bool RemoveMNGResponse::DataHasBeenSet() const
{
