...
CoreInternalOutcome CreateMNGVersionResponse::Deserialize(const string &payload)
{
...
string CreateMNGVersionResponse::ToJsonString() const
{
...
CreateMNGVersionResp CreateMNGVersionResponse::GetData() const
{
    return m_data;
}

bool CreateMNGVersionResponse::DataHasBeenSet() const
{
