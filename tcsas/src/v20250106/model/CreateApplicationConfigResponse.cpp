...
CoreInternalOutcome CreateApplicationConfigResponse::Deserialize(const string &payload)
{
...
string CreateApplicationConfigResponse::ToJsonString() const
{
...
BooleanInfo CreateApplicationConfigResponse::GetData() const
{
    return m_data;
}

bool CreateApplicationConfigResponse::DataHasBeenSet() const
{
