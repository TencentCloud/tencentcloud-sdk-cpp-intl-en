...
CoreInternalOutcome DisableApplicationSensitiveAPIResponse::Deserialize(const string &payload)
{
...
string DisableApplicationSensitiveAPIResponse::ToJsonString() const
{
...
BooleanInfo DisableApplicationSensitiveAPIResponse::GetData() const
{
    return m_data;
}

bool DisableApplicationSensitiveAPIResponse::DataHasBeenSet() const
{
