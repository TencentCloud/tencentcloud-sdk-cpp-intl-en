...
CoreInternalOutcome CreateMNGDomainACLResponse::Deserialize(const string &payload)
{
...
string CreateMNGDomainACLResponse::ToJsonString() const
{
...
BooleanInfo CreateMNGDomainACLResponse::GetData() const
{
    return m_data;
}

bool CreateMNGDomainACLResponse::DataHasBeenSet() const
{
