...
CoreInternalOutcome DescribeMNGSubscribeMessageTemplateListResponse::Deserialize(const string &payload)
{
...
string DescribeMNGSubscribeMessageTemplateListResponse::ToJsonString() const
{
...
DescribeMNGSubscribeMessageTemplateListResp DescribeMNGSubscribeMessageTemplateListResponse::GetData() const
{
    return m_data;
}

bool DescribeMNGSubscribeMessageTemplateListResponse::DataHasBeenSet() const
{
