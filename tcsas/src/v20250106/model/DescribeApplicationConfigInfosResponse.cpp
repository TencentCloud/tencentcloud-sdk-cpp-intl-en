...
CoreInternalOutcome DescribeApplicationConfigInfosResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationConfigInfosResponse::ToJsonString() const
{
...
DescribeApplicationConfigInfo DescribeApplicationConfigInfosResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationConfigInfosResponse::DataHasBeenSet() const
{
