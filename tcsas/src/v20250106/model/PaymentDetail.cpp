...
#include <tencentcloud/tcsas/v20250106/model/PaymentDetail.h>
...
CoreInternalOutcome PaymentDetail::Deserialize(const rapidjson::Value &value)
{
    string requestId = "";
    ...
    if (value.HasMember("DataTime") && !value["DataTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.DataTime` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OrderMNPNum") && !value["OrderMNPNum"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.OrderMNPNum` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OrderNum") && !value["OrderNum"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.OrderNum` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OrderPaidNum") && !value["OrderPaidNum"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.OrderPaidNum` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OrderRefundNum") && !value["OrderRefundNum"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.OrderRefundNum` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OrderUnpaidNum") && !value["OrderUnpaidNum"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.OrderUnpaidNum` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("OrderUserNum") && !value["OrderUserNum"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.OrderUserNum` IsInt64=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("PaidAmount") && !value["PaidAmount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.PaidAmount` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("RefundAmount") && !value["RefundAmount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.RefundAmount` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("TotalAmount") && !value["TotalAmount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.TotalAmount` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UnpaidAmount") && !value["UnpaidAmount"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.UnpaidAmount` IsString=false incorrectly").SetRequestId(requestId));
        }
    ...
    if (value.HasMember("UpdateTime") && !value["UpdateTime"].IsNull())
    {
        ...
        {
            return CoreInternalOutcome(Core::Error("response `PaymentDetail.UpdateTime` IsInt64=false incorrectly").SetRequestId(requestId));
        }
...
void PaymentDetail::ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const
{
...
string PaymentDetail::GetDataTime() const
{
    return m_dataTime;
}

void PaymentDetail::SetDataTime(const string& _dataTime)
{
    m_dataTime = _dataTime;
    m_dataTimeHasBeenSet = true;
}

bool PaymentDetail::DataTimeHasBeenSet() const
{
    return m_dataTimeHasBeenSet;
}

int64_t PaymentDetail::GetOrderMNPNum() const
{
    return m_orderMNPNum;
}

void PaymentDetail::SetOrderMNPNum(const int64_t& _orderMNPNum)
{
    m_orderMNPNum = _orderMNPNum;
    m_orderMNPNumHasBeenSet = true;
}

bool PaymentDetail::OrderMNPNumHasBeenSet() const
{
    return m_orderMNPNumHasBeenSet;
}

int64_t PaymentDetail::GetOrderNum() const
{
    return m_orderNum;
}

void PaymentDetail::SetOrderNum(const int64_t& _orderNum)
{
    m_orderNum = _orderNum;
    m_orderNumHasBeenSet = true;
}

bool PaymentDetail::OrderNumHasBeenSet() const
{
    return m_orderNumHasBeenSet;
}

int64_t PaymentDetail::GetOrderPaidNum() const
{
    return m_orderPaidNum;
}

void PaymentDetail::SetOrderPaidNum(const int64_t& _orderPaidNum)
{
    m_orderPaidNum = _orderPaidNum;
    m_orderPaidNumHasBeenSet = true;
}

bool PaymentDetail::OrderPaidNumHasBeenSet() const
{
    return m_orderPaidNumHasBeenSet;
}

int64_t PaymentDetail::GetOrderRefundNum() const
{
    return m_orderRefundNum;
}

void PaymentDetail::SetOrderRefundNum(const int64_t& _orderRefundNum)
{
    m_orderRefundNum = _orderRefundNum;
    m_orderRefundNumHasBeenSet = true;
}

bool PaymentDetail::OrderRefundNumHasBeenSet() const
{
    return m_orderRefundNumHasBeenSet;
}

int64_t PaymentDetail::GetOrderUnpaidNum() const
{
    return m_orderUnpaidNum;
}

void PaymentDetail::SetOrderUnpaidNum(const int64_t& _orderUnpaidNum)
{
    m_orderUnpaidNum = _orderUnpaidNum;
    m_orderUnpaidNumHasBeenSet = true;
}

bool PaymentDetail::OrderUnpaidNumHasBeenSet() const
{
    return m_orderUnpaidNumHasBeenSet;
}

int64_t PaymentDetail::GetOrderUserNum() const
{
    return m_orderUserNum;
}

void PaymentDetail::SetOrderUserNum(const int64_t& _orderUserNum)
{
    m_orderUserNum = _orderUserNum;
    m_orderUserNumHasBeenSet = true;
}

bool PaymentDetail::OrderUserNumHasBeenSet() const
{
    return m_orderUserNumHasBeenSet;
}

string PaymentDetail::GetPaidAmount() const
{
    return m_paidAmount;
}

void PaymentDetail::SetPaidAmount(const string& _paidAmount)
{
    m_paidAmount = _paidAmount;
    m_paidAmountHasBeenSet = true;
}

bool PaymentDetail::PaidAmountHasBeenSet() const
{
    return m_paidAmountHasBeenSet;
}

string PaymentDetail::GetRefundAmount() const
{
    return m_refundAmount;
}

void PaymentDetail::SetRefundAmount(const string& _refundAmount)
{
    m_refundAmount = _refundAmount;
    m_refundAmountHasBeenSet = true;
}

bool PaymentDetail::RefundAmountHasBeenSet() const
{
    return m_refundAmountHasBeenSet;
}

string PaymentDetail::GetTotalAmount() const
{
    return m_totalAmount;
}

void PaymentDetail::SetTotalAmount(const string& _totalAmount)
{
    m_totalAmount = _totalAmount;
    m_totalAmountHasBeenSet = true;
}

bool PaymentDetail::TotalAmountHasBeenSet() const
{
    return m_totalAmountHasBeenSet;
}

string PaymentDetail::GetUnpaidAmount() const
{
    return m_unpaidAmount;
}

void PaymentDetail::SetUnpaidAmount(const string& _unpaidAmount)
{
    m_unpaidAmount = _unpaidAmount;
    m_unpaidAmountHasBeenSet = true;
}

bool PaymentDetail::UnpaidAmountHasBeenSet() const
{
    return m_unpaidAmountHasBeenSet;
}

int64_t PaymentDetail::GetUpdateTime() const
{
    return m_updateTime;
}

void PaymentDetail::SetUpdateTime(const int64_t& _updateTime)
{
    m_updateTime = _updateTime;
    m_updateTimeHasBeenSet = true;
}

bool PaymentDetail::UpdateTimeHasBeenSet() const
{
