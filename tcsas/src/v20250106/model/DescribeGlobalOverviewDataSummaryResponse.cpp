...
CoreInternalOutcome DescribeGlobalOverviewDataSummaryResponse::Deserialize(const string &payload)
{
...
string DescribeGlobalOverviewDataSummaryResponse::ToJsonString() const
{
...
AccessAnalysisOverview DescribeGlobalOverviewDataSummaryResponse::GetData() const
{
    return m_data;
}

bool DescribeGlobalOverviewDataSummaryResponse::DataHasBeenSet() const
{
