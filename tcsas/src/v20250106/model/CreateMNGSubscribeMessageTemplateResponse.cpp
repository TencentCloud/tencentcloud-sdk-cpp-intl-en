...
CoreInternalOutcome CreateMNGSubscribeMessageTemplateResponse::Deserialize(const string &payload)
{
...
string CreateMNGSubscribeMessageTemplateResponse::ToJsonString() const
{
...
BooleanInfo CreateMNGSubscribeMessageTemplateResponse::GetData() const
{
    return m_data;
}

bool CreateMNGSubscribeMessageTemplateResponse::DataHasBeenSet() const
{
