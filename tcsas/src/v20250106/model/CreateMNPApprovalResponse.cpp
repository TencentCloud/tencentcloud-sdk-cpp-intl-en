...
CoreInternalOutcome CreateMNPApprovalResponse::Deserialize(const string &payload)
{
...
string CreateMNPApprovalResponse::ToJsonString() const
{
...
bool CreateMNPApprovalResponse::DataHasBeenSet() const
{
