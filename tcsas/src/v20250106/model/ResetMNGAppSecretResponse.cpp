...
CoreInternalOutcome ResetMNGAppSecretResponse::Deserialize(const string &payload)
{
...
string ResetMNGAppSecretResponse::ToJsonString() const
{
...
ResetMNGAppSecretResp ResetMNGAppSecretResponse::GetData() const
{
    return m_data;
}

bool ResetMNGAppSecretResponse::DataHasBeenSet() const
{
