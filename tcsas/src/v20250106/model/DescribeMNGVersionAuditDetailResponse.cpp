...
CoreInternalOutcome DescribeMNGVersionAuditDetailResponse::Deserialize(const string &payload)
{
...
string DescribeMNGVersionAuditDetailResponse::ToJsonString() const
{
...
DescribeMNGVersionAuditDetailResp DescribeMNGVersionAuditDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeMNGVersionAuditDetailResponse::DataHasBeenSet() const
{
