...
CoreInternalOutcome DescribeMNGSensitiveAPIPermissionApprovalResponse::Deserialize(const string &payload)
{
...
string DescribeMNGSensitiveAPIPermissionApprovalResponse::ToJsonString() const
{
...
DescribeMNGSensitiveAPIPermissionApprovalData DescribeMNGSensitiveAPIPermissionApprovalResponse::GetData() const
{
    return m_data;
}

bool DescribeMNGSensitiveAPIPermissionApprovalResponse::DataHasBeenSet() const
{
