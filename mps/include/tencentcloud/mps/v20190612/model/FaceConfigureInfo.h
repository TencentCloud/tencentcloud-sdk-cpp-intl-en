...
<li>OFF: Disables the intelligent face recognition task.</li>
                    ...
                    /**
                     * 获取Face recognition filter score. Returns recognition result when the recognition result reaches or exceeds this score. Default is 95. Value ranges from 0 to 100.
                    ...
                    /**
                     * 设置Face recognition filter score. Returns recognition result when the recognition result reaches or exceeds this score. Default is 95. Value ranges from 0 to 100.
...
<li>politician: sensitive person.</li>
                    ...
                    /**
                     * 获取User-defined character filter tag. Specify the tag of the user-defined character to be returned. If left blank or empty, all customized figure results will be returned.
...
The number of tags is up to 100, and each tag can have up to 16 characters.
                    ...
                    /**
                     * 设置User-defined character filter tag. Specify the tag of the user-defined character to be returned. If left blank or empty, all customized figure results will be returned.
The number of tags is up to 100, and each tag can have up to 16 characters.
