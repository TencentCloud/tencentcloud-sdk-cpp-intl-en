            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>id of the suppressed subtitles.</p>
                    ...
                    /**
                     * 设置<p>id of the suppressed subtitles.</p>
                    ...
                    /**
                     * 获取<p>Continue to use the original subtitle position.</p><p>Default value: 1</p>
                    ...
                    /**
                     * 设置<p>Continue to use the original subtitle position.</p><p>Default value: 1</p>
                    ...
                    /**
                     * 获取<p>Continue to use the original subtitle font size.</p><p>Default value: 1</p>
                    ...
                    /**
                     * 设置<p>Continue to use the original subtitle font size.</p><p>Default value: 1</p>
