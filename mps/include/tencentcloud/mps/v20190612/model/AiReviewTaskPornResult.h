...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 获取Input for a porn information detection task during content audit.
                     * @return Input Input for a porn information detection task during content audit.
                     */
                    AiReviewPornTaskInput GetInput() const;

                    /**
                     * 设置Input for a porn information detection task during content audit.
                    ...
                    /**
                     * 获取Output of a porn information detection task during content audit.
Note: This field may return null, indicating that no valid values can be obtained.
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 设置Output of a porn information detection task during content audit.
Note: This field may return null, indicating that no valid values can be obtained.
