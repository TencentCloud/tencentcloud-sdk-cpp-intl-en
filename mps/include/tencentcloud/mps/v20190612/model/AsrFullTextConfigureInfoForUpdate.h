...
<li>OFF: Disables the intelligent voice full-text recognition task.</li>
                    ...
                    /**
                     * 获取Generated subtitle file format. Leaving it as an empty string means no subtitle file will be generated. Available values:
...
<li>vtt: Generate a WebVTT subtitle file.</li>
                    ...
                    /**
                     * 设置Generated subtitle file format. Leaving it as an empty string means no subtitle file will be generated. Available values:
<li>vtt: Generate a WebVTT subtitle file.</li>
