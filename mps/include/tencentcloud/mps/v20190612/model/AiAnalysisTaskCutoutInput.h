...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKCUTOUTINPUT_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKCUTOUTINPUT_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class AiAnalysisTaskCutoutInput : public AbstractModel
                {
                public:
                    AiAnalysisTaskCutoutInput();
                    ~AiAnalysisTaskCutoutInput() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取<p>ID of the intelligent video matting template.</p>
                    ...
                    /**
                     * 设置<p>ID of the intelligent video matting template.</p>
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_AIANALYSISTASKCUTOUTINPUT_H_
