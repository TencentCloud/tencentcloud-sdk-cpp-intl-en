...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_CHANGEVOICERESPONSE_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_CHANGEVOICERESPONSE_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class ChangeVoiceResponse : public AbstractModel
                {
                public:
                    ChangeVoiceResponse();
                    ~ChangeVoiceResponse() = default;
                    ...
                    /**
                     * 获取<p>base64-encoded result audio, default mp3 format</p>
                    ...
                    /**
                     * 获取<p>Result audio url, valid for 24 hours</p>
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_CHANGEVOICERESPONSE_H_
