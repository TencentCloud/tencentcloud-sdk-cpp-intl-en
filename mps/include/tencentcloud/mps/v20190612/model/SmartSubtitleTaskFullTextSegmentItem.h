...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_SMARTSUBTITLETASKFULLTEXTSEGMENTITEM_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_SMARTSUBTITLETASKFULLTEXTSEGMENTITEM_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class SmartSubtitleTaskFullTextSegmentItem : public AbstractModel
                {
                public:
                    SmartSubtitleTaskFullTextSegmentItem();
                    ~SmartSubtitleTaskFullTextSegmentItem() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_SMARTSUBTITLETASKFULLTEXTSEGMENTITEM_H_
