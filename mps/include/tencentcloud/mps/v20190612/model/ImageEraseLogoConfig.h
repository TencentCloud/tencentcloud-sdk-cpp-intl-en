...
Note: This field may return null, indicating that no valid value can be obtained.
                    ...
                    /**
                     * 获取Multiple box selection areas to be erased. Note: The value array of this parameter can contain up to 2 values.
Note: This field may return null, indicating that no valid value can be obtained.
...
Note: This field may return null, indicating that no valid value can be obtained.
                    ...
                    /**
                     * 设置Multiple box selection areas to be erased. Note: The value array of this parameter can contain up to 2 values.
Note: This field may return null, indicating that no valid value can be obtained.
