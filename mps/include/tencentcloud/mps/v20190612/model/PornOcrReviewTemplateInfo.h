            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    ~PornOcrReviewTemplateInfo() = default;
                    void ToJsonObject(rapidjson::Value &value, rapidjson::Document::AllocatorType& allocator) const;
                    CoreInternalOutcome Deserialize(const rapidjson::Value &value);


                    /**
                     * 获取Switch of a porn information detection in text task. Valid values:
...
<li>OFF: Disables a porn information detection in text task.</li>
                    ...
                    /**
                     * 设置Switch of a porn information detection in text task. Valid values:
<li>ON: Enables a porn information detection in text task;</li>
<li>OFF: Disables a porn information detection in text task.</li>
