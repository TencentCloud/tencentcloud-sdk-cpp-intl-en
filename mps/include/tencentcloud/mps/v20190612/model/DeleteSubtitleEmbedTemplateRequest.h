...
#ifndef TENCENTCLOUD_MPS_V20190612_MODEL_DELETESUBTITLEEMBEDTEMPLATEREQUEST_H_
#define TENCENTCLOUD_MPS_V20190612_MODEL_DELETESUBTITLEEMBEDTEMPLATEREQUEST_H_
    ...
    namespace Mps
    {
        namespace V20190612
        {
            namespace Model
            {
                ...
                */
                class DeleteSubtitleEmbedTemplateRequest : public AbstractModel
                {
                public:
                    DeleteSubtitleEmbedTemplateRequest();
                    ~DeleteSubtitleEmbedTemplateRequest() = default;
...
#endif // !TENCENTCLOUD_MPS_V20190612_MODEL_DELETESUBTITLEEMBEDTEMPLATEREQUEST_H_
