            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>base64-encoded audio to be converted.</p>
                    ...
                    /**
                     * 设置<p>base64-encoded audio to be converted.</p>
                    ...
                    /**
                     * 获取<p>Audio Url to be switched. Valid when AudioData is empty.</p>
                    ...
                    /**
                     * 设置<p>Audio Url to be switched. Valid when AudioData is empty.</p>
