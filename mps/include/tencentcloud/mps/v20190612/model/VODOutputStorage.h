            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Target <em>Bucket ID</em> for the output file generated by media processing</p>
                    ...
                    /**
                     * 设置<p>Target <em>Bucket ID</em> for the output file generated by media processing</p>
                    ...
                    /**
                     * 获取<p>Region of the target Bucket for the output file generated by media processing</p>
                    ...
                    /**
                     * 设置<p>Region of the target Bucket for the output file generated by media processing</p>
                    ...
                    /**
                     * 获取<p>Whether to use VOD Standard Edition.<br>Attention: If left empty, VOD Pro Edition is used.</p><p>Enumeration values: </p><ul><li>0: Do not use VOD Standard Edition</li><li>1: Use VOD Standard Edition</li></ul>
                    ...
                    /**
                     * 设置<p>Whether to use VOD Standard Edition.<br>Attention: If left empty, VOD Pro Edition is used.</p><p>Enumeration values: </p><ul><li>0: Do not use VOD Standard Edition</li><li>1: Use VOD Standard Edition</li></ul>
