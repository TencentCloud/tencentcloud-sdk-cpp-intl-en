...
CoreInternalOutcome DescribeStreamLinkSecurityGroupResponse::Deserialize(const string &payload)
{
...
string DescribeStreamLinkSecurityGroupResponse::ToJsonString() const
{
...
SecurityGroupInfo DescribeStreamLinkSecurityGroupResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamLinkSecurityGroupResponse::InfoHasBeenSet() const
{
