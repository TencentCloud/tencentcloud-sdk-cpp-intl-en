...
CoreInternalOutcome SendTemplatedEmailResponse::Deserialize(const string &payload)
{
...
string SendTemplatedEmailResponse::ToJsonString() const
{
...
bool SendTemplatedEmailResponse::GetResult() const
{
    return m_result;
}

bool SendTemplatedEmailResponse::ResultHasBeenSet() const
{
