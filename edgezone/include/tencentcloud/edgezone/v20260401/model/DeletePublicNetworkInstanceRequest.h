...
#ifndef TENCENTCLOUD_EDGEZONE_V20260401_MODEL_DELETEPUBLICNETWORKINSTANCEREQUEST_H_
#define TENCENTCLOUD_EDGEZONE_V20260401_MODEL_DELETEPUBLICNETWORKINSTANCEREQUEST_H_
    ...
    namespace Edgezone
    {
        namespace V20260401
        {
            namespace Model
            {
                ...
                */
                class DeletePublicNetworkInstanceRequest : public AbstractModel
                {
                public:
                    DeletePublicNetworkInstanceRequest();
                    ~DeletePublicNetworkInstanceRequest() = default;
...
#endif // !TENCENTCLOUD_EDGEZONE_V20260401_MODEL_DELETEPUBLICNETWORKINSTANCEREQUEST_H_
