...
CoreInternalOutcome DescribeConsoleMNPVersionCompileTaskResponse::Deserialize(const string &payload)
{
...
string DescribeConsoleMNPVersionCompileTaskResponse::ToJsonString() const
{
...
DescribeMNPVersionCompileTaskResp DescribeConsoleMNPVersionCompileTaskResponse::GetData() const
{
    return m_data;
}

bool DescribeConsoleMNPVersionCompileTaskResponse::DataHasBeenSet() const
{
