...
CoreInternalOutcome EnableApplicationSensitiveAPIResponse::Deserialize(const string &payload)
{
...
string EnableApplicationSensitiveAPIResponse::ToJsonString() const
{
...
BooleanInfo EnableApplicationSensitiveAPIResponse::GetData() const
{
    return m_data;
}

bool EnableApplicationSensitiveAPIResponse::DataHasBeenSet() const
{
