...
CoreInternalOutcome ModifyGlobalDomainResponse::Deserialize(const string &payload)
{
...
string ModifyGlobalDomainResponse::ToJsonString() const
{
...
GlobalDomainModifyRespResp ModifyGlobalDomainResponse::GetData() const
{
    return m_data;
}

bool ModifyGlobalDomainResponse::DataHasBeenSet() const
{
