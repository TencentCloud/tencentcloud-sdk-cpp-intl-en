...
CoreInternalOutcome CreateSensitiveApiApplyResponse::Deserialize(const string &payload)
{
...
string CreateSensitiveApiApplyResponse::ToJsonString() const
{
...
ResourceIdStringInfo CreateSensitiveApiApplyResponse::GetData() const
{
    return m_data;
}

bool CreateSensitiveApiApplyResponse::DataHasBeenSet() const
{
