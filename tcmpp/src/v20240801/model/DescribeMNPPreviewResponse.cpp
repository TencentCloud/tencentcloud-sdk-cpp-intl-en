...
CoreInternalOutcome DescribeMNPPreviewResponse::Deserialize(const string &payload)
{
...
string DescribeMNPPreviewResponse::ToJsonString() const
{
...
DescribeMNPPreviewResp DescribeMNPPreviewResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPPreviewResponse::DataHasBeenSet() const
{
