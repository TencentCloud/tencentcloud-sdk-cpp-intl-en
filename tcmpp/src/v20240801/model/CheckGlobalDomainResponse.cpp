...
CoreInternalOutcome CheckGlobalDomainResponse::Deserialize(const string &payload)
{
...
string CheckGlobalDomainResponse::ToJsonString() const
{
...
GlobalDomainCheckResp CheckGlobalDomainResponse::GetData() const
{
    return m_data;
}

bool CheckGlobalDomainResponse::DataHasBeenSet() const
{
