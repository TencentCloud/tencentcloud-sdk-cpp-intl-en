...
CoreInternalOutcome ModifyUserPasswordResponse::Deserialize(const string &payload)
{
...
string ModifyUserPasswordResponse::ToJsonString() const
{
...
BooleanInfo ModifyUserPasswordResponse::GetData() const
{
    return m_data;
}

bool ModifyUserPasswordResponse::DataHasBeenSet() const
{
