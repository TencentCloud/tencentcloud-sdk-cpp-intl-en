...
CoreInternalOutcome AddTeamMemberResponse::Deserialize(const string &payload)
{
...
string AddTeamMemberResponse::ToJsonString() const
{
...
BooleanInfo AddTeamMemberResponse::GetData() const
{
    return m_data;
}

bool AddTeamMemberResponse::DataHasBeenSet() const
{
