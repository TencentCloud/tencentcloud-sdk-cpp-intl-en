...
CoreInternalOutcome DescribeOnlineVersionResponse::Deserialize(const string &payload)
{
...
string DescribeOnlineVersionResponse::ToJsonString() const
{
...
DescribeRevertOnlineVersionPageResp DescribeOnlineVersionResponse::GetData() const
{
    return m_data;
}

bool DescribeOnlineVersionResponse::DataHasBeenSet() const
{
