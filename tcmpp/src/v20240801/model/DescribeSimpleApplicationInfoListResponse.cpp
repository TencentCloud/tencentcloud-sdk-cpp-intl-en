...
CoreInternalOutcome DescribeSimpleApplicationInfoListResponse::Deserialize(const string &payload)
{
...
string DescribeSimpleApplicationInfoListResponse::ToJsonString() const
{
...
ApplicationSimpleListInfoResp DescribeSimpleApplicationInfoListResponse::GetData() const
{
    return m_data;
}

bool DescribeSimpleApplicationInfoListResponse::DataHasBeenSet() const
{
