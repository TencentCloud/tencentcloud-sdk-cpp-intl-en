...
CoreInternalOutcome DescribeGlobalDomainListResponse::Deserialize(const string &payload)
{
...
string DescribeGlobalDomainListResponse::ToJsonString() const
{
...
GlobalDomainDescribeListPageResp DescribeGlobalDomainListResponse::GetData() const
{
    return m_data;
}

bool DescribeGlobalDomainListResponse::DataHasBeenSet() const
{
