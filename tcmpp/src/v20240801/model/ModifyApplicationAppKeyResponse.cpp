...
CoreInternalOutcome ModifyApplicationAppKeyResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationAppKeyResponse::ToJsonString() const
{
...
BooleanInfo ModifyApplicationAppKeyResponse::GetData() const
{
    return m_data;
}

bool ModifyApplicationAppKeyResponse::DataHasBeenSet() const
{
