...
CoreInternalOutcome ModifyMNPStatusOfflineResponse::Deserialize(const string &payload)
{
...
string ModifyMNPStatusOfflineResponse::ToJsonString() const
{
...
BooleanInfo ModifyMNPStatusOfflineResponse::GetData() const
{
    return m_data;
}

bool ModifyMNPStatusOfflineResponse::DataHasBeenSet() const
{
