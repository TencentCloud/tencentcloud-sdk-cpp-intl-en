...
CoreInternalOutcome DescribeMNPOfflinePackageURLResponse::Deserialize(const string &payload)
{
...
string DescribeMNPOfflinePackageURLResponse::ToJsonString() const
{
...
StringData DescribeMNPOfflinePackageURLResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPOfflinePackageURLResponse::DataHasBeenSet() const
{
