...
CoreInternalOutcome DescribeTeamListResponse::Deserialize(const string &payload)
{
...
string DescribeTeamListResponse::ToJsonString() const
{
...
DescribeTeamPageResp DescribeTeamListResponse::GetData() const
{
    return m_data;
}

bool DescribeTeamListResponse::DataHasBeenSet() const
{
