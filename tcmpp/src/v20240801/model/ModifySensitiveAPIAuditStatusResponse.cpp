...
CoreInternalOutcome ModifySensitiveAPIAuditStatusResponse::Deserialize(const string &payload)
{
...
string ModifySensitiveAPIAuditStatusResponse::ToJsonString() const
{
...
BooleanInfo ModifySensitiveAPIAuditStatusResponse::GetData() const
{
    return m_data;
}

bool ModifySensitiveAPIAuditStatusResponse::DataHasBeenSet() const
{
