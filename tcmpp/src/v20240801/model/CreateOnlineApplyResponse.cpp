...
CoreInternalOutcome CreateOnlineApplyResponse::Deserialize(const string &payload)
{
...
string CreateOnlineApplyResponse::ToJsonString() const
{
...
BooleanInfo CreateOnlineApplyResponse::GetData() const
{
    return m_data;
}

bool CreateOnlineApplyResponse::DataHasBeenSet() const
{
