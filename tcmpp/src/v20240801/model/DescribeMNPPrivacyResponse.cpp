...
CoreInternalOutcome DescribeMNPPrivacyResponse::Deserialize(const string &payload)
{
...
string DescribeMNPPrivacyResponse::ToJsonString() const
{
...
string DescribeMNPPrivacyResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPPrivacyResponse::DataHasBeenSet() const
{
