...
CoreInternalOutcome DescribeRoleDetailResponse::Deserialize(const string &payload)
{
...
string DescribeRoleDetailResponse::ToJsonString() const
{
...
DescribeRoleDetailResp DescribeRoleDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeRoleDetailResponse::DataHasBeenSet() const
{
