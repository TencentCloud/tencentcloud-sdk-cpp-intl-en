...
CoreInternalOutcome DescribeTempSecret4UploadFile2CosResponse::Deserialize(const string &payload)
{
...
string DescribeTempSecret4UploadFile2CosResponse::ToJsonString() const
{
...
UploadFileTempSecret DescribeTempSecret4UploadFile2CosResponse::GetData() const
{
    return m_data;
}

bool DescribeTempSecret4UploadFile2CosResponse::DataHasBeenSet() const
{
