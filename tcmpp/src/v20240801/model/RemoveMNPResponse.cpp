...
CoreInternalOutcome RemoveMNPResponse::Deserialize(const string &payload)
{
...
string RemoveMNPResponse::ToJsonString() const
{
...
BooleanInfo RemoveMNPResponse::GetData() const
{
    return m_data;
}

bool RemoveMNPResponse::DataHasBeenSet() const
{
