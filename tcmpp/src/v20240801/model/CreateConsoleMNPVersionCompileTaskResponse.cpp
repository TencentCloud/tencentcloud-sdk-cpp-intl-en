...
CoreInternalOutcome CreateConsoleMNPVersionCompileTaskResponse::Deserialize(const string &payload)
{
...
string CreateConsoleMNPVersionCompileTaskResponse::ToJsonString() const
{
...
CreateMNPVersionCompileTaskResp CreateConsoleMNPVersionCompileTaskResponse::GetData() const
{
    return m_data;
}

bool CreateConsoleMNPVersionCompileTaskResponse::DataHasBeenSet() const
{
