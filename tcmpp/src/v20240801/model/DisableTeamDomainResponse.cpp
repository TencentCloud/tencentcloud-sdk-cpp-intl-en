...
CoreInternalOutcome DisableTeamDomainResponse::Deserialize(const string &payload)
{
...
string DisableTeamDomainResponse::ToJsonString() const
{
...
DisableEnterpriseDomainResp DisableTeamDomainResponse::GetData() const
{
    return m_data;
}

bool DisableTeamDomainResponse::DataHasBeenSet() const
{
