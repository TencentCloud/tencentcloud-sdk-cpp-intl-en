...
string DescribeUserRequest::GetPlatformId() const
{
    return m_platformId;
}

void DescribeUserRequest::SetPlatformId(const string& _platformId)
{
    m_platformId = _platformId;
    m_platformIdHasBeenSet = true;
}

bool DescribeUserRequest::PlatformIdHasBeenSet() const
{
