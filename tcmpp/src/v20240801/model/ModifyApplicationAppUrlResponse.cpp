...
CoreInternalOutcome ModifyApplicationAppUrlResponse::Deserialize(const string &payload)
{
...
string ModifyApplicationAppUrlResponse::ToJsonString() const
{
...
BooleanInfo ModifyApplicationAppUrlResponse::GetData() const
{
    return m_data;
}

bool ModifyApplicationAppUrlResponse::DataHasBeenSet() const
{
