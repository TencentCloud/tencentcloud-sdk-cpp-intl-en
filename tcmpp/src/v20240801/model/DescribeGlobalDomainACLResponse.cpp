...
CoreInternalOutcome DescribeGlobalDomainACLResponse::Deserialize(const string &payload)
{
...
string DescribeGlobalDomainACLResponse::ToJsonString() const
{
...
DescribeGlobalDomainsResp DescribeGlobalDomainACLResponse::GetData() const
{
    return m_data;
}

bool DescribeGlobalDomainACLResponse::DataHasBeenSet() const
{
