...
CoreInternalOutcome DescribeApplicationMNPVersionAuditListResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationMNPVersionAuditListResponse::ToJsonString() const
{
...
DescribeApplicationMNPVersionAuditListPageResp DescribeApplicationMNPVersionAuditListResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationMNPVersionAuditListResponse::DataHasBeenSet() const
{
