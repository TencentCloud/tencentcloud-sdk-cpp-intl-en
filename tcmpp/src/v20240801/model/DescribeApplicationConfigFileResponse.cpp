...
CoreInternalOutcome DescribeApplicationConfigFileResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationConfigFileResponse::ToJsonString() const
{
...
DownloadApplicationConfigResp DescribeApplicationConfigFileResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationConfigFileResponse::DataHasBeenSet() const
{
