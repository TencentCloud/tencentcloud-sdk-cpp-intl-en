...
CoreInternalOutcome DescribeMNPReleasedVersionHistoryResponse::Deserialize(const string &payload)
{
...
string DescribeMNPReleasedVersionHistoryResponse::ToJsonString() const
{
...
DescribeRevertOnlineVersionPageResp DescribeMNPReleasedVersionHistoryResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPReleasedVersionHistoryResponse::DataHasBeenSet() const
{
