...
CoreInternalOutcome DescribeApplicationConfigResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationConfigResponse::ToJsonString() const
{
...
DownloadApplicationConfigResp DescribeApplicationConfigResponse::GetData() const
{
    return m_data;
}

bool DescribeApplicationConfigResponse::DataHasBeenSet() const
{
