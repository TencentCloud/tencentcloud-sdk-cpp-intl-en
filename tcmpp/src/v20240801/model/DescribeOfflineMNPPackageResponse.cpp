...
CoreInternalOutcome DescribeOfflineMNPPackageResponse::Deserialize(const string &payload)
{
...
string DescribeOfflineMNPPackageResponse::ToJsonString() const
{
...
StringData DescribeOfflineMNPPackageResponse::GetData() const
{
    return m_data;
}

bool DescribeOfflineMNPPackageResponse::DataHasBeenSet() const
{
