...
CoreInternalOutcome CreatePlatformAuditResponse::Deserialize(const string &payload)
{
...
string CreatePlatformAuditResponse::ToJsonString() const
{
...
BooleanInfo CreatePlatformAuditResponse::GetData() const
{
    return m_data;
}

bool CreatePlatformAuditResponse::DataHasBeenSet() const
{
