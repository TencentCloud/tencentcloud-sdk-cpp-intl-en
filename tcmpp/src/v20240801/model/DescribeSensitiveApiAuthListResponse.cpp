...
CoreInternalOutcome DescribeSensitiveApiAuthListResponse::Deserialize(const string &payload)
{
...
string DescribeSensitiveApiAuthListResponse::ToJsonString() const
{
...
DescribeSensitiveApiAuthPageParam DescribeSensitiveApiAuthListResponse::GetData() const
{
    return m_data;
}

bool DescribeSensitiveApiAuthListResponse::DataHasBeenSet() const
{
