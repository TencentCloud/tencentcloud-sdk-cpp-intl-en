...
CoreInternalOutcome DescribeTeamDomainListResponse::Deserialize(const string &payload)
{
...
string DescribeTeamDomainListResponse::ToJsonString() const
{
...
DescribeTeamDomainListPageResp DescribeTeamDomainListResponse::GetData() const
{
    return m_data;
}

bool DescribeTeamDomainListResponse::DataHasBeenSet() const
{
