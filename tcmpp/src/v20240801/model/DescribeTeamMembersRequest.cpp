...
int64_t DescribeTeamMembersRequest::GetOffset() const
{
    return m_offset;
}

void DescribeTeamMembersRequest::SetOffset(const int64_t& _offset)
{
    m_offset = _offset;
...
int64_t DescribeTeamMembersRequest::GetLimit() const
{
    return m_limit;
}

void DescribeTeamMembersRequest::SetLimit(const int64_t& _limit)
{
    m_limit = _limit;
...
string DescribeTeamMembersRequest::GetPlatformId() const
{
    return m_platformId;
}

void DescribeTeamMembersRequest::SetPlatformId(const string& _platformId)
{
    m_platformId = _platformId;
    m_platformIdHasBeenSet = true;
}

bool DescribeTeamMembersRequest::PlatformIdHasBeenSet() const
{
