...
CoreInternalOutcome CreateSensitiveAPIResponse::Deserialize(const string &payload)
{
...
string CreateSensitiveAPIResponse::ToJsonString() const
{
...
BooleanInfo CreateSensitiveAPIResponse::GetData() const
{
    return m_data;
}

bool CreateSensitiveAPIResponse::DataHasBeenSet() const
{
