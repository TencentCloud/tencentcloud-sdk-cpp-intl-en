...
CoreInternalOutcome DescribeSensitiveAPIListResponse::Deserialize(const string &payload)
{
...
string DescribeSensitiveAPIListResponse::ToJsonString() const
{
...
SensitiveApiPageInfo DescribeSensitiveAPIListResponse::GetData() const
{
    return m_data;
}

bool DescribeSensitiveAPIListResponse::DataHasBeenSet() const
{
