...
CoreInternalOutcome DescribeDomainTeamListResponse::Deserialize(const string &payload)
{
...
string DescribeDomainTeamListResponse::ToJsonString() const
{
...
DescribeDomainTeamListPageResp DescribeDomainTeamListResponse::GetData() const
{
    return m_data;
}

bool DescribeDomainTeamListResponse::DataHasBeenSet() const
{
