...
CoreInternalOutcome RollbackMNPVersionResponse::Deserialize(const string &payload)
{
...
string RollbackMNPVersionResponse::ToJsonString() const
{
...
BooleanInfo RollbackMNPVersionResponse::GetData() const
{
    return m_data;
}

bool RollbackMNPVersionResponse::DataHasBeenSet() const
{
