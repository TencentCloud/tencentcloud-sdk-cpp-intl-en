...
string DescribeApplicationRequest::GetPlatformId() const
{
    return m_platformId;
}

void DescribeApplicationRequest::SetPlatformId(const string& _platformId)
{
    m_platformId = _platformId;
    m_platformIdHasBeenSet = true;
}

bool DescribeApplicationRequest::PlatformIdHasBeenSet() const
{
