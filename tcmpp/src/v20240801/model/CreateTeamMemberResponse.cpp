...
CoreInternalOutcome CreateTeamMemberResponse::Deserialize(const string &payload)
{
...
string CreateTeamMemberResponse::ToJsonString() const
{
...
CreateTeamMemberInfoResp CreateTeamMemberResponse::GetData() const
{
    return m_data;
}

bool CreateTeamMemberResponse::DataHasBeenSet() const
{
