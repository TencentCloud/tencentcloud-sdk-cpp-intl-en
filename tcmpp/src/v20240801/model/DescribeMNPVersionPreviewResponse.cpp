...
CoreInternalOutcome DescribeMNPVersionPreviewResponse::Deserialize(const string &payload)
{
...
string DescribeMNPVersionPreviewResponse::ToJsonString() const
{
...
DescribeShowCaseResp DescribeMNPVersionPreviewResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPVersionPreviewResponse::DataHasBeenSet() const
{
