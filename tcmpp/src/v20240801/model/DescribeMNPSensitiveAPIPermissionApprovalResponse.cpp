...
CoreInternalOutcome DescribeMNPSensitiveAPIPermissionApprovalResponse::Deserialize(const string &payload)
{
...
string DescribeMNPSensitiveAPIPermissionApprovalResponse::ToJsonString() const
{
...
DescribeMNPSensitiveAPIPermissionApprovalData DescribeMNPSensitiveAPIPermissionApprovalResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPSensitiveAPIPermissionApprovalResponse::DataHasBeenSet() const
{
