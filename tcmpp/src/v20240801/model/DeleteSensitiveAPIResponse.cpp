...
CoreInternalOutcome DeleteSensitiveAPIResponse::Deserialize(const string &payload)
{
...
string DeleteSensitiveAPIResponse::ToJsonString() const
{
...
BooleanInfo DeleteSensitiveAPIResponse::GetData() const
{
    return m_data;
}

bool DeleteSensitiveAPIResponse::DataHasBeenSet() const
{
