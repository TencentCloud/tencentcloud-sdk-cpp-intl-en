...
CoreInternalOutcome ConfigureMNPPreviewResponse::Deserialize(const string &payload)
{
...
string ConfigureMNPPreviewResponse::ToJsonString() const
{
...
BooleanInfo ConfigureMNPPreviewResponse::GetData() const
{
    return m_data;
}

bool ConfigureMNPPreviewResponse::DataHasBeenSet() const
{
