...
CoreInternalOutcome DescribeSensitiveApiApplyDetailResponse::Deserialize(const string &payload)
{
...
string DescribeSensitiveApiApplyDetailResponse::ToJsonString() const
{
...
DescribeSensitiveApiApplyDetail DescribeSensitiveApiApplyDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeSensitiveApiApplyDetailResponse::DataHasBeenSet() const
{
