...
CoreInternalOutcome CreateGlobalDomainACLResponse::Deserialize(const string &payload)
{
...
string CreateGlobalDomainACLResponse::ToJsonString() const
{
...
CreateGlobalDomainResp CreateGlobalDomainACLResponse::GetData() const
{
    return m_data;
}

bool CreateGlobalDomainACLResponse::DataHasBeenSet() const
{
