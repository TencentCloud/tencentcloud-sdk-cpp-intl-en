...
CoreInternalOutcome DescribeMNPResponse::Deserialize(const string &payload)
{
...
string DescribeMNPResponse::ToJsonString() const
{
...
DescribeMNPManagerDetailData DescribeMNPResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPResponse::DataHasBeenSet() const
{
