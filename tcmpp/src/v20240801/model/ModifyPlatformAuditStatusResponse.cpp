...
CoreInternalOutcome ModifyPlatformAuditStatusResponse::Deserialize(const string &payload)
{
...
string ModifyPlatformAuditStatusResponse::ToJsonString() const
{
...
BooleanInfo ModifyPlatformAuditStatusResponse::GetData() const
{
    return m_data;
}

bool ModifyPlatformAuditStatusResponse::DataHasBeenSet() const
{
