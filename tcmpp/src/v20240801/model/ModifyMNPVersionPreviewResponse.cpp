...
CoreInternalOutcome ModifyMNPVersionPreviewResponse::Deserialize(const string &payload)
{
...
string ModifyMNPVersionPreviewResponse::ToJsonString() const
{
...
BooleanInfo ModifyMNPVersionPreviewResponse::GetData() const
{
    return m_data;
}

bool ModifyMNPVersionPreviewResponse::DataHasBeenSet() const
{
