...
CoreInternalOutcome DescribeSimpleTeamListResponse::Deserialize(const string &payload)
{
...
string DescribeSimpleTeamListResponse::ToJsonString() const
{
...
DescribeSimpleTeamListResp DescribeSimpleTeamListResponse::GetData() const
{
    return m_data;
}

bool DescribeSimpleTeamListResponse::DataHasBeenSet() const
{
