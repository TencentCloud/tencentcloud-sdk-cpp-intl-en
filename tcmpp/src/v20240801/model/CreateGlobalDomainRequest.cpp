...
vector<string> CreateGlobalDomainRequest::GetDomainUrlList() const
{
    return m_domainUrlList;
}

void CreateGlobalDomainRequest::SetDomainUrlList(const vector<string>& _domainUrlList)
{
    m_domainUrlList = _domainUrlList;
    m_domainUrlListHasBeenSet = true;
}

bool CreateGlobalDomainRequest::DomainUrlListHasBeenSet() const
{
    return m_domainUrlListHasBeenSet;
}

int64_t CreateGlobalDomainRequest::GetDomainType() const
{
    return m_domainType;
}

void CreateGlobalDomainRequest::SetDomainType(const int64_t& _domainType)
{
    m_domainType = _domainType;
    m_domainTypeHasBeenSet = true;
}

bool CreateGlobalDomainRequest::DomainTypeHasBeenSet() const
{
    return m_domainTypeHasBeenSet;
}

string CreateGlobalDomainRequest::GetPlatformId() const
{
    return m_platformId;
}

void CreateGlobalDomainRequest::SetPlatformId(const string& _platformId)
{
    m_platformId = _platformId;
    m_platformIdHasBeenSet = true;
}

bool CreateGlobalDomainRequest::PlatformIdHasBeenSet() const
{
