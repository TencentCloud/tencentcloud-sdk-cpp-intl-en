...
CoreInternalOutcome DescribeMNPDetailResponse::Deserialize(const string &payload)
{
...
string DescribeMNPDetailResponse::ToJsonString() const
{
...
MNPDetail DescribeMNPDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPDetailResponse::DataHasBeenSet() const
{
