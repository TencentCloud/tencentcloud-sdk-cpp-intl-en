...
CoreInternalOutcome DescribeMNPManagerDetailResponse::Deserialize(const string &payload)
{
...
string DescribeMNPManagerDetailResponse::ToJsonString() const
{
...
DescribeMNPManagerDetailData DescribeMNPManagerDetailResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPManagerDetailResponse::DataHasBeenSet() const
{
