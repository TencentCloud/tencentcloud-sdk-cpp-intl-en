...
CoreInternalOutcome ReleaseMNPVersionResponse::Deserialize(const string &payload)
{
...
string ReleaseMNPVersionResponse::ToJsonString() const
{
...
BooleanInfo ReleaseMNPVersionResponse::GetData() const
{
    return m_data;
}

bool ReleaseMNPVersionResponse::DataHasBeenSet() const
{
