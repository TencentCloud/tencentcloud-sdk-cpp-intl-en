...
CoreInternalOutcome DescribeSensitiveAPIAuditListResponse::Deserialize(const string &payload)
{
...
string DescribeSensitiveAPIAuditListResponse::ToJsonString() const
{
...
SensitiveApiAuditInfoPageResp DescribeSensitiveAPIAuditListResponse::GetData() const
{
    return m_data;
}

bool DescribeSensitiveAPIAuditListResponse::DataHasBeenSet() const
{
