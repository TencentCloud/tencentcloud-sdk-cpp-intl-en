...
CoreInternalOutcome DescribeMNPApprovalListResponse::Deserialize(const string &payload)
{
...
string DescribeMNPApprovalListResponse::ToJsonString() const
{
...
DescribeMNPApprovalListResp DescribeMNPApprovalListResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPApprovalListResponse::DataHasBeenSet() const
{
