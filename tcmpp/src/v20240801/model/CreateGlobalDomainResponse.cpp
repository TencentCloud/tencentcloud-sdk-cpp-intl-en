...
CoreInternalOutcome CreateGlobalDomainResponse::Deserialize(const string &payload)
{
...
string CreateGlobalDomainResponse::ToJsonString() const
{
...
CreateGlobalDomainResp CreateGlobalDomainResponse::GetData() const
{
    return m_data;
}

bool CreateGlobalDomainResponse::DataHasBeenSet() const
{
