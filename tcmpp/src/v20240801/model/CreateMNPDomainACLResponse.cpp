...
CoreInternalOutcome CreateMNPDomainACLResponse::Deserialize(const string &payload)
{
...
string CreateMNPDomainACLResponse::ToJsonString() const
{
...
BooleanInfo CreateMNPDomainACLResponse::GetData() const
{
    return m_data;
}

bool CreateMNPDomainACLResponse::DataHasBeenSet() const
{
