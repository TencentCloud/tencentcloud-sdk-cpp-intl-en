...
CoreInternalOutcome DescribeMNPManagerListResponse::Deserialize(const string &payload)
{
...
string DescribeMNPManagerListResponse::ToJsonString() const
{
...
DescribeMNPManagerListResp DescribeMNPManagerListResponse::GetData() const
{
    return m_data;
}

bool DescribeMNPManagerListResponse::DataHasBeenSet() const
{
