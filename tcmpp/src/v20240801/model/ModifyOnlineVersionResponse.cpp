...
CoreInternalOutcome ModifyOnlineVersionResponse::Deserialize(const string &payload)
{
...
string ModifyOnlineVersionResponse::ToJsonString() const
{
...
BooleanInfo ModifyOnlineVersionResponse::GetData() const
{
    return m_data;
}

bool ModifyOnlineVersionResponse::DataHasBeenSet() const
{
