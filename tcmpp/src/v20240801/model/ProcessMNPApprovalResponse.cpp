...
CoreInternalOutcome ProcessMNPApprovalResponse::Deserialize(const string &payload)
{
...
string ProcessMNPApprovalResponse::ToJsonString() const
{
...
BooleanInfo ProcessMNPApprovalResponse::GetData() const
{
    return m_data;
}

bool ProcessMNPApprovalResponse::DataHasBeenSet() const
{
