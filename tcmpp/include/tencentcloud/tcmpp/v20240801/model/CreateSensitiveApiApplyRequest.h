...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_CREATESENSITIVEAPIAPPLYREQUEST_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_CREATESENSITIVEAPIAPPLYREQUEST_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class CreateSensitiveApiApplyRequest : public AbstractModel
                {
                public:
                    CreateSensitiveApiApplyRequest();
                    ~CreateSensitiveApiApplyRequest() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_CREATESENSITIVEAPIAPPLYREQUEST_H_
