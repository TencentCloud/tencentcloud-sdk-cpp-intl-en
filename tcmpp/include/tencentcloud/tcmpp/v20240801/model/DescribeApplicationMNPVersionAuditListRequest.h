...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEAPPLICATIONMNPVERSIONAUDITLISTREQUEST_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEAPPLICATIONMNPVERSIONAUDITLISTREQUEST_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class DescribeApplicationMNPVersionAuditListRequest : public AbstractModel
                {
                public:
                    DescribeApplicationMNPVersionAuditListRequest();
                    ~DescribeApplicationMNPVersionAuditListRequest() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEAPPLICATIONMNPVERSIONAUDITLISTREQUEST_H_
