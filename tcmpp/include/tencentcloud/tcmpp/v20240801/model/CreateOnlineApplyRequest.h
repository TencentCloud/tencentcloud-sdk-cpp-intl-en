...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_CREATEONLINEAPPLYREQUEST_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_CREATEONLINEAPPLYREQUEST_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class CreateOnlineApplyRequest : public AbstractModel
                {
                public:
                    CreateOnlineApplyRequest();
                    ~CreateOnlineApplyRequest() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_CREATEONLINEAPPLYREQUEST_H_
