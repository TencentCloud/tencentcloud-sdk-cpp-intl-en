...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_MODIFYMNPVERSIONPREVIEWREQUEST_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_MODIFYMNPVERSIONPREVIEWREQUEST_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class ModifyMNPVersionPreviewRequest : public AbstractModel
                {
                public:
                    ModifyMNPVersionPreviewRequest();
                    ~ModifyMNPVersionPreviewRequest() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_MODIFYMNPVERSIONPREVIEWREQUEST_H_
