...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBESENSITIVEAPILISTREQUEST_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBESENSITIVEAPILISTREQUEST_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class DescribeSensitiveAPIListRequest : public AbstractModel
                {
                public:
                    DescribeSensitiveAPIListRequest();
                    ~DescribeSensitiveAPIListRequest() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBESENSITIVEAPILISTREQUEST_H_
