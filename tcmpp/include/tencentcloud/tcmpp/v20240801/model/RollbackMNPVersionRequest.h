...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_ROLLBACKMNPVERSIONREQUEST_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_ROLLBACKMNPVERSIONREQUEST_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class RollbackMNPVersionRequest : public AbstractModel
                {
                public:
                    RollbackMNPVersionRequest();
                    ~RollbackMNPVersionRequest() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_ROLLBACKMNPVERSIONREQUEST_H_
