...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEROLELISTRESP_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEROLELISTRESP_H_
...
#include <tencentcloud/tcmpp/v20240801/model/DescribeRoleListData.h>
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class DescribeRoleListResp : public AbstractModel
                {
                public:
                    DescribeRoleListResp();
                    ~DescribeRoleListResp() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEROLELISTRESP_H_
