...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBESENSITIVEAPIAUTHLISTPARAM_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBESENSITIVEAPIAUTHLISTPARAM_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class DescribeSensitiveApiAuthListParam : public AbstractModel
                {
                public:
                    DescribeSensitiveApiAuthListParam();
                    ~DescribeSensitiveApiAuthListParam() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBESENSITIVEAPIAUTHLISTPARAM_H_
