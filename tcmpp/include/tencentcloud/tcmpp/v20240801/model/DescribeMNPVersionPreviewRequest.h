...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEMNPVERSIONPREVIEWREQUEST_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEMNPVERSIONPREVIEWREQUEST_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class DescribeMNPVersionPreviewRequest : public AbstractModel
                {
                public:
                    DescribeMNPVersionPreviewRequest();
                    ~DescribeMNPVersionPreviewRequest() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEMNPVERSIONPREVIEWREQUEST_H_
