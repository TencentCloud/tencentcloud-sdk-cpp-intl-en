...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEGLOBALDOMAINLISTREQUEST_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEGLOBALDOMAINLISTREQUEST_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class DescribeGlobalDomainListRequest : public AbstractModel
                {
                public:
                    DescribeGlobalDomainListRequest();
                    ~DescribeGlobalDomainListRequest() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_DESCRIBEGLOBALDOMAINLISTREQUEST_H_
