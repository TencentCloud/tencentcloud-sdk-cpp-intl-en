...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_APPLICATIONSIMPLEINFORESP_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_APPLICATIONSIMPLEINFORESP_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class ApplicationSimpleInfoResp : public AbstractModel
                {
                public:
                    ApplicationSimpleInfoResp();
                    ~ApplicationSimpleInfoResp() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_APPLICATIONSIMPLEINFORESP_H_
