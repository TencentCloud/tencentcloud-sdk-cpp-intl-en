...
#ifndef TENCENTCLOUD_TCMPP_V20240801_MODEL_MODIFYONLINEVERSIONREQUEST_H_
#define TENCENTCLOUD_TCMPP_V20240801_MODEL_MODIFYONLINEVERSIONREQUEST_H_
    ...
    namespace Tcmpp
    {
        namespace V20240801
        {
            namespace Model
            {
                ...
                */
                class ModifyOnlineVersionRequest : public AbstractModel
                {
                public:
                    ModifyOnlineVersionRequest();
                    ~ModifyOnlineVersionRequest() = default;
...
#endif // !TENCENTCLOUD_TCMPP_V20240801_MODEL_MODIFYONLINEVERSIONREQUEST_H_
