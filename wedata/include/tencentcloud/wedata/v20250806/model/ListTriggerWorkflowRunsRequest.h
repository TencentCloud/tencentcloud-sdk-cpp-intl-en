            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Filter parameters, workflow name or ID query name: Keyword, workflow ID query name: WorkflowId, folder query name: FolderId, person in charge query name: InChargeUin, workflow execution ID: ExecutionId.
                    ...
                    /**
                     * 设置Filter parameters, workflow name or ID query name: Keyword, workflow ID query name: WorkflowId, folder query name: FolderId, person in charge query name: InChargeUin, workflow execution ID: ExecutionId.
                     * @param _filters Filter parameters, workflow name or ID query name: Keyword, workflow ID query name: WorkflowId, folder query name: FolderId, person in charge query name: InChargeUin, workflow execution ID: ExecutionId.
                     * 
                     */
                    ...
                    /**
                     * 获取Sorting field. the sorting field name is as follows: start time - CreateTime, end time - EndTime.
                    ...
                    /**
                     * 设置Sorting field. the sorting field name is as follows: start time - CreateTime, end time - EndTime.
                     * @param _orderFields Sorting field. the sorting field name is as follows: start time - CreateTime, end time - EndTime.
                     * 
                     */
