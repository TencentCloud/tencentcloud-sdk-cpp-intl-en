            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Source data source ID, separated by semicolons, need to pass through DescribeDataSourceWithoutInfo to obtain.
                    ...
                    /**
                     * 设置Source data source ID, separated by semicolons, need to pass through DescribeDataSourceWithoutInfo to obtain.
                     * @param _sourceServiceId Source data source ID, separated by semicolons, need to pass through DescribeDataSourceWithoutInfo to obtain.
                     * 
                     */
                    ...
                    /**
                     * 获取Target data source ID, use ; to separate, need to pass through DescribeDataSourceWithoutInfo to obtain.
                    ...
                    /**
                     * 设置Target data source ID, use ; to separate, need to pass through DescribeDataSourceWithoutInfo to obtain.
                     * @param _targetServiceId Target data source ID, use ; to separate, need to pass through DescribeDataSourceWithoutInfo to obtain.
                     * 
                     */
