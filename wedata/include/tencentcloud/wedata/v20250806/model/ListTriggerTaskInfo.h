...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTRIGGERTASKINFO_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTRIGGERTASKINFO_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class ListTriggerTaskInfo : public AbstractModel
                {
                public:
                    ListTriggerTaskInfo();
                    ~ListTriggerTaskInfo() = default;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     * 
                     */
                    std::vector<TriggerTaskBaseAttribute> GetItems() const;
...
Note: This field may return null, indicating that no valid values can be obtained.
                     * 
                     */
                    void SetItems(const std::vector<TriggerTaskBaseAttribute>& _items);
...
Note: This field may return null, indicating that no valid values can be obtained.
                     */
                    std::vector<TriggerTaskBaseAttribute> m_items;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_LISTTRIGGERTASKINFO_H_
