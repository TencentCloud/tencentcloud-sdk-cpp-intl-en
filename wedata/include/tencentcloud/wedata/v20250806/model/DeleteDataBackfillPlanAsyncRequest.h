...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_DELETEDATABACKFILLPLANASYNCREQUEST_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_DELETEDATABACKFILLPLANASYNCREQUEST_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class DeleteDataBackfillPlanAsyncRequest : public AbstractModel
                {
                public:
                    DeleteDataBackfillPlanAsyncRequest();
                    ~DeleteDataBackfillPlanAsyncRequest() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_DELETEDATABACKFILLPLANASYNCREQUEST_H_
