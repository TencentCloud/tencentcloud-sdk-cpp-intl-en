...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETASKBASEATTRIBUTEPART_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETASKBASEATTRIBUTEPART_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class UpdateTaskBaseAttributePart : public AbstractModel
                {
                public:
                    UpdateTaskBaseAttributePart();
                    ~UpdateTaskBaseAttributePart() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_UPDATETASKBASEATTRIBUTEPART_H_
