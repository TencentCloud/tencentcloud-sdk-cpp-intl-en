            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Authorization permission type (CAN_VIEW/CAN_RUN/CAN_EDIT/CAN_MANAGE).
...
Note: This field may return null, indicating that no valid values can be obtained.
                    ...
                    /**
                     * 设置Authorization permission type (CAN_VIEW/CAN_RUN/CAN_EDIT/CAN_MANAGE).
Note: This field may return null, indicating that no valid values can be obtained.
                     * @param _permissionType Authorization permission type (CAN_VIEW/CAN_RUN/CAN_EDIT/CAN_MANAGE).
Note: This field may return null, indicating that no valid values can be obtained.
                     * 
                     */
