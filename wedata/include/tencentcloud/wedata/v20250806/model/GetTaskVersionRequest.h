            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Submit version ID. If not specified, the latest submit version will be used by default.
                     * @return VersionId Submit version ID. If not specified, the latest submit version will be used by default.
                     * 
                     */
                    std::string GetVersionId() const;

                    /**
                     * 设置Submit version ID. If not specified, the latest submit version will be used by default.
