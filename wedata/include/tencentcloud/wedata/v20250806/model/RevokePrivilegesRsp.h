...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_REVOKEPRIVILEGESRSP_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_REVOKEPRIVILEGESRSP_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class RevokePrivilegesRsp : public AbstractModel
                {
                public:
                    RevokePrivilegesRsp();
                    ~RevokePrivilegesRsp() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_REVOKEPRIVILEGESRSP_H_
