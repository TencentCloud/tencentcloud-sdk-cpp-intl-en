...
#ifndef TENCENTCLOUD_WEDATA_V20250806_MODEL_CREATETRIGGERWORKFLOWRUNRESULT_H_
#define TENCENTCLOUD_WEDATA_V20250806_MODEL_CREATETRIGGERWORKFLOWRUNRESULT_H_
    ...
    namespace Wedata
    {
        namespace V20250806
        {
            namespace Model
            {
                ...
                */
                class CreateTriggerWorkflowRunResult : public AbstractModel
                {
                public:
                    CreateTriggerWorkflowRunResult();
                    ~CreateTriggerWorkflowRunResult() = default;
...
#endif // !TENCENTCLOUD_WEDATA_V20250806_MODEL_CREATETRIGGERWORKFLOWRUNRESULT_H_
