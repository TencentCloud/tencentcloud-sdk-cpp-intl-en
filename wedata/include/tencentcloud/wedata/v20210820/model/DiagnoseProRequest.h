            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Query Conditions (TaskId and CurRunDate need to be filled in this field for diagnosis)
                    ...
                    /**
                     * 设置Query Conditions (TaskId and CurRunDate need to be filled in this field for diagnosis)
