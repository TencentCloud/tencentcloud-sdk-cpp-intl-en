...
string DescribeDatabaseMetasRequest::ToJsonString() const
{
...
vector<Filter> DescribeDatabaseMetasRequest::GetFilters() const
{
    return m_filters;
}

void DescribeDatabaseMetasRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
    m_filtersHasBeenSet = true;
}

bool DescribeDatabaseMetasRequest::FiltersHasBeenSet() const
{
    return m_filtersHasBeenSet;
}

vector<OrderField> DescribeDatabaseMetasRequest::GetOrderFields() const
{
    return m_orderFields;
}

void DescribeDatabaseMetasRequest::SetOrderFields(const vector<OrderField>& _orderFields)
{
