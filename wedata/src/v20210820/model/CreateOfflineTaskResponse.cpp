...
CoreInternalOutcome CreateOfflineTaskResponse::Deserialize(const string &payload)
{
...
string CreateOfflineTaskResponse::ToJsonString() const
{
...
bool CreateOfflineTaskResponse::DataHasBeenSet() const
{
