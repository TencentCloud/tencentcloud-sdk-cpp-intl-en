...
CoreInternalOutcome DescribeUserSAMLConfigResponse::Deserialize(const string &payload)
{
...
string DescribeUserSAMLConfigResponse::ToJsonString() const
{
...
string DescribeUserSAMLConfigResponse::GetSAMLMetadata() const
{
    return m_sAMLMetadata;
}

bool DescribeUserSAMLConfigResponse::SAMLMetadataHasBeenSet() const
{
    return m_sAMLMetadataHasBeenSet;
}

uint64_t DescribeUserSAMLConfigResponse::GetStatus() const
{
    return m_status;
}
