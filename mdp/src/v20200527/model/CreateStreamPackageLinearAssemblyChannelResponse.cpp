...
CoreInternalOutcome CreateStreamPackageLinearAssemblyChannelResponse::Deserialize(const string &payload)
{
...
string CreateStreamPackageLinearAssemblyChannelResponse::ToJsonString() const
{
...
LinearAssemblyChannelInfo CreateStreamPackageLinearAssemblyChannelResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamPackageLinearAssemblyChannelResponse::InfoHasBeenSet() const
{
