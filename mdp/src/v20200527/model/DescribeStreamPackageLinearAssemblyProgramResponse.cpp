...
CoreInternalOutcome DescribeStreamPackageLinearAssemblyProgramResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageLinearAssemblyProgramResponse::ToJsonString() const
{
...
LinearAssemblyProgramInfo DescribeStreamPackageLinearAssemblyProgramResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamPackageLinearAssemblyProgramResponse::InfoHasBeenSet() const
{
