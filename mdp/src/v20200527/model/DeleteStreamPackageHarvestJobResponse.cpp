...
CoreInternalOutcome DeleteStreamPackageHarvestJobResponse::Deserialize(const string &payload)
{
...
string DeleteStreamPackageHarvestJobResponse::ToJsonString() const
{
