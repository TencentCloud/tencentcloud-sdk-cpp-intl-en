...
CoreInternalOutcome DescribeStreamPackageChannelsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageChannelsResponse::ToJsonString() const
{
...
vector<ChannelInfo> DescribeStreamPackageChannelsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageChannelsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeStreamPackageChannelsResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamPackageChannelsResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeStreamPackageChannelsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamPackageChannelsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeStreamPackageChannelsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamPackageChannelsResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

uint64_t DescribeStreamPackageChannelsResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamPackageChannelsResponse::TotalPageHasBeenSet() const
{
