...
CoreInternalOutcome DescribeStreamPackageSourceAlertsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageSourceAlertsResponse::ToJsonString() const
{
...
vector<SourceAlert> DescribeStreamPackageSourceAlertsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageSourceAlertsResponse::InfosHasBeenSet() const
{
