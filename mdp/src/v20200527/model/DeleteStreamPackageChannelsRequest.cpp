...
string DeleteStreamPackageChannelsRequest::ToJsonString() const
{
...
vector<string> DeleteStreamPackageChannelsRequest::GetIds() const
{
    return m_ids;
}

void DeleteStreamPackageChannelsRequest::SetIds(const vector<string>& _ids)
{
    m_ids = _ids;
    m_idsHasBeenSet = true;
}

bool DeleteStreamPackageChannelsRequest::IdsHasBeenSet() const
{
