...
CoreInternalOutcome ModifyStreamPackageChannelEndpointResponse::Deserialize(const string &payload)
{
...
string ModifyStreamPackageChannelEndpointResponse::ToJsonString() const
{
