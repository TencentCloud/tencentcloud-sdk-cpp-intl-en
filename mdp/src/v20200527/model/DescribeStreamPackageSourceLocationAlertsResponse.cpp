...
CoreInternalOutcome DescribeStreamPackageSourceLocationAlertsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageSourceLocationAlertsResponse::ToJsonString() const
{
...
vector<LocationAlert> DescribeStreamPackageSourceLocationAlertsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageSourceLocationAlertsResponse::InfosHasBeenSet() const
{
