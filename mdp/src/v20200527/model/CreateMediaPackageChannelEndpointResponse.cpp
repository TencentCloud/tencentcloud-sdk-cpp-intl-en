...
CoreInternalOutcome CreateMediaPackageChannelEndpointResponse::Deserialize(const string &payload)
{
    Document d;
...
EndpointInfo CreateMediaPackageChannelEndpointResponse::GetInfo() const
{
    return m_info;
}

bool CreateMediaPackageChannelEndpointResponse::InfoHasBeenSet() const
{
