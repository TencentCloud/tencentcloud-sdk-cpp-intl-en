...
string BindSSAICDNDomainWithChannelRequest::ToJsonString() const
{
...
string BindSSAICDNDomainWithChannelRequest::GetChannelId() const
{
    return m_channelId;
}

void BindSSAICDNDomainWithChannelRequest::SetChannelId(const string& _channelId)
{
    m_channelId = _channelId;
    m_channelIdHasBeenSet = true;
}

bool BindSSAICDNDomainWithChannelRequest::ChannelIdHasBeenSet() const
{
    return m_channelIdHasBeenSet;
}

string BindSSAICDNDomainWithChannelRequest::GetCdnDomain() const
{
    return m_cdnDomain;
}

void BindSSAICDNDomainWithChannelRequest::SetCdnDomain(const string& _cdnDomain)
{
    m_cdnDomain = _cdnDomain;
    m_cdnDomainHasBeenSet = true;
}

bool BindSSAICDNDomainWithChannelRequest::CdnDomainHasBeenSet() const
{
