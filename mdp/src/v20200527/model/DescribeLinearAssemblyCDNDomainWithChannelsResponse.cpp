...
CoreInternalOutcome DescribeLinearAssemblyCDNDomainWithChannelsResponse::Deserialize(const string &payload)
{
...
string DescribeLinearAssemblyCDNDomainWithChannelsResponse::ToJsonString() const
{
...
CdnDomainInfo DescribeLinearAssemblyCDNDomainWithChannelsResponse::GetInfo() const
{
    return m_info;
}

bool DescribeLinearAssemblyCDNDomainWithChannelsResponse::InfoHasBeenSet() const
{
