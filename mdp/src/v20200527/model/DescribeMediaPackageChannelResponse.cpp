...
CoreInternalOutcome DescribeMediaPackageChannelResponse::Deserialize(const string &payload)
{
    Document d;
...
ChannelInfo DescribeMediaPackageChannelResponse::GetInfo() const
{
    return m_info;
}

bool DescribeMediaPackageChannelResponse::InfoHasBeenSet() const
{
