...
CoreInternalOutcome ModifyStreamPackageSourceLocationResponse::Deserialize(const string &payload)
{
...
string ModifyStreamPackageSourceLocationResponse::ToJsonString() const
{
