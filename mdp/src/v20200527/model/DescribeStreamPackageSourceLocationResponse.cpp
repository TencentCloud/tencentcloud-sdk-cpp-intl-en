...
CoreInternalOutcome DescribeStreamPackageSourceLocationResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageSourceLocationResponse::ToJsonString() const
{
...
SourceLocationInfo DescribeStreamPackageSourceLocationResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamPackageSourceLocationResponse::InfoHasBeenSet() const
{
