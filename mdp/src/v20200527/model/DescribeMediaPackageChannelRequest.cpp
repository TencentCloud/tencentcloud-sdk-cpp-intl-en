...
string DescribeMediaPackageChannelRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
string DescribeMediaPackageChannelRequest::GetId() const
{
    return m_id;
}

void DescribeMediaPackageChannelRequest::SetId(const string& _id)
{
    m_id = _id;
    m_idHasBeenSet = true;
}

bool DescribeMediaPackageChannelRequest::IdHasBeenSet() const
{
