...
CoreInternalOutcome ModifyStreamPackageLinearAssemblyChannelResponse::Deserialize(const string &payload)
{
...
string ModifyStreamPackageLinearAssemblyChannelResponse::ToJsonString() const
{
