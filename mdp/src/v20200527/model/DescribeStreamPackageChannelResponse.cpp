...
CoreInternalOutcome DescribeStreamPackageChannelResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageChannelResponse::ToJsonString() const
{
...
ChannelInfo DescribeStreamPackageChannelResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamPackageChannelResponse::InfoHasBeenSet() const
{
