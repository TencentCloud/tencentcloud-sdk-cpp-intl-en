...
CoreInternalOutcome CreateStreamPackageVodRemuxTaskResponse::Deserialize(const string &payload)
{
...
string CreateStreamPackageVodRemuxTaskResponse::ToJsonString() const
{
...
VodRemuxTaskInfo CreateStreamPackageVodRemuxTaskResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamPackageVodRemuxTaskResponse::InfoHasBeenSet() const
{
