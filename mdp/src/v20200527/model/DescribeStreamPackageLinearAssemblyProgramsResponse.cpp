...
CoreInternalOutcome DescribeStreamPackageLinearAssemblyProgramsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageLinearAssemblyProgramsResponse::ToJsonString() const
{
...
vector<LinearAssemblyProgramInfo> DescribeStreamPackageLinearAssemblyProgramsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageLinearAssemblyProgramsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyProgramsResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamPackageLinearAssemblyProgramsResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyProgramsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamPackageLinearAssemblyProgramsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyProgramsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamPackageLinearAssemblyProgramsResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyProgramsResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamPackageLinearAssemblyProgramsResponse::TotalPageHasBeenSet() const
{
