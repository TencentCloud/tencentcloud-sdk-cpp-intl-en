...
CoreInternalOutcome CreateStreamPackageChannelResponse::Deserialize(const string &payload)
{
...
string CreateStreamPackageChannelResponse::ToJsonString() const
{
...
ChannelInfo CreateStreamPackageChannelResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamPackageChannelResponse::InfoHasBeenSet() const
{
