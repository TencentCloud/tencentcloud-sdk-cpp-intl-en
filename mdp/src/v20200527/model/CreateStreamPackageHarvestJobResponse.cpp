...
CoreInternalOutcome CreateStreamPackageHarvestJobResponse::Deserialize(const string &payload)
{
...
string CreateStreamPackageHarvestJobResponse::ToJsonString() const
{
...
HarvestJobResp CreateStreamPackageHarvestJobResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamPackageHarvestJobResponse::InfoHasBeenSet() const
{
