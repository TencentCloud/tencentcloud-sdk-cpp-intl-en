...
CoreInternalOutcome DescribeStreamPackageLinearAssemblyChannelsResponse::Deserialize(const string &payload)
{
    ...
    if (rsp.HasMember("Infos") && !rsp["Infos"].IsNull())
    {
        ...
        {
            LinearAssemblyChannelInfo item;
...
string DescribeStreamPackageLinearAssemblyChannelsResponse::ToJsonString() const
{
...
vector<LinearAssemblyChannelInfo> DescribeStreamPackageLinearAssemblyChannelsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageLinearAssemblyChannelsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyChannelsResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamPackageLinearAssemblyChannelsResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyChannelsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamPackageLinearAssemblyChannelsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyChannelsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamPackageLinearAssemblyChannelsResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

uint64_t DescribeStreamPackageLinearAssemblyChannelsResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamPackageLinearAssemblyChannelsResponse::TotalPageHasBeenSet() const
{
