...
CoreInternalOutcome DescribeStreamPackageSourceLocationsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageSourceLocationsResponse::ToJsonString() const
{
...
vector<SourceLocationInfo> DescribeStreamPackageSourceLocationsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageSourceLocationsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeStreamPackageSourceLocationsResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamPackageSourceLocationsResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeStreamPackageSourceLocationsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamPackageSourceLocationsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeStreamPackageSourceLocationsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamPackageSourceLocationsResponse::TotalNumHasBeenSet() const
{
    return m_totalNumHasBeenSet;
}

uint64_t DescribeStreamPackageSourceLocationsResponse::GetTotalPage() const
{
    return m_totalPage;
}

bool DescribeStreamPackageSourceLocationsResponse::TotalPageHasBeenSet() const
{
