...
CoreInternalOutcome DeleteStreamPackageHarvestJobsResponse::Deserialize(const string &payload)
{
...
string DeleteStreamPackageHarvestJobsResponse::ToJsonString() const
{
