...
CoreInternalOutcome CreateStreamPackageSourceLocationResponse::Deserialize(const string &payload)
{
...
string CreateStreamPackageSourceLocationResponse::ToJsonString() const
{
...
SourceLocationInfo CreateStreamPackageSourceLocationResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamPackageSourceLocationResponse::InfoHasBeenSet() const
{
