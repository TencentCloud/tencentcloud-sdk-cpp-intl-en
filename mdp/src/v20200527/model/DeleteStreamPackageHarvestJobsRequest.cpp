...
string DeleteStreamPackageHarvestJobsRequest::ToJsonString() const
{
...
vector<string> DeleteStreamPackageHarvestJobsRequest::GetIDs() const
{
    return m_iDs;
}

void DeleteStreamPackageHarvestJobsRequest::SetIDs(const vector<string>& _iDs)
{
    m_iDs = _iDs;
    m_iDsHasBeenSet = true;
}

bool DeleteStreamPackageHarvestJobsRequest::IDsHasBeenSet() const
{
