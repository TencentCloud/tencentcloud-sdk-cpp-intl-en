...
CoreInternalOutcome DescribeStreamPackageHarvestJobResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageHarvestJobResponse::ToJsonString() const
{
...
HarvestJobResp DescribeStreamPackageHarvestJobResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamPackageHarvestJobResponse::InfoHasBeenSet() const
{
