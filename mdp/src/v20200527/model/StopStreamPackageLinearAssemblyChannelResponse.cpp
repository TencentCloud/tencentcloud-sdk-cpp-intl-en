...
CoreInternalOutcome StopStreamPackageLinearAssemblyChannelResponse::Deserialize(const string &payload)
{
...
string StopStreamPackageLinearAssemblyChannelResponse::ToJsonString() const
{
