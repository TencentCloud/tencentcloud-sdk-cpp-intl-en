...
CoreInternalOutcome DescribeStreamPackageSSAIUsageResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageSSAIUsageResponse::ToJsonString() const
{
...
SSAIUsageInfo DescribeStreamPackageSSAIUsageResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamPackageSSAIUsageResponse::InfoHasBeenSet() const
{
