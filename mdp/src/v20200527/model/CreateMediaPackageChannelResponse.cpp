...
CoreInternalOutcome CreateMediaPackageChannelResponse::Deserialize(const string &payload)
{
    Document d;
...
ChannelInfo CreateMediaPackageChannelResponse::GetInfo() const
{
    return m_info;
}

bool CreateMediaPackageChannelResponse::InfoHasBeenSet() const
{
