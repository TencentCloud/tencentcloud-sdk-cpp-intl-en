...
CoreInternalOutcome DescribeStreamPackageVodRemuxTaskResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageVodRemuxTaskResponse::ToJsonString() const
{
...
VodRemuxTaskInfo DescribeStreamPackageVodRemuxTaskResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamPackageVodRemuxTaskResponse::InfoHasBeenSet() const
{
