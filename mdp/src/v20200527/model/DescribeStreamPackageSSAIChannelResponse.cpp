...
CoreInternalOutcome DescribeStreamPackageSSAIChannelResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageSSAIChannelResponse::ToJsonString() const
{
...
SSAIChannelInfo DescribeStreamPackageSSAIChannelResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamPackageSSAIChannelResponse::InfoHasBeenSet() const
{
