...
CoreInternalOutcome CreateStreamPackageChannelEndpointResponse::Deserialize(const string &payload)
{
...
string CreateStreamPackageChannelEndpointResponse::ToJsonString() const
{
...
EndpointInfo CreateStreamPackageChannelEndpointResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamPackageChannelEndpointResponse::InfoHasBeenSet() const
{
