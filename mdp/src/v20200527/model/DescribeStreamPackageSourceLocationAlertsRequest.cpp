...
string DescribeStreamPackageSourceLocationAlertsRequest::ToJsonString() const
{
...
string DescribeStreamPackageSourceLocationAlertsRequest::GetLocationId() const
{
    return m_locationId;
}

void DescribeStreamPackageSourceLocationAlertsRequest::SetLocationId(const string& _locationId)
{
    m_locationId = _locationId;
    m_locationIdHasBeenSet = true;
}

bool DescribeStreamPackageSourceLocationAlertsRequest::LocationIdHasBeenSet() const
{
