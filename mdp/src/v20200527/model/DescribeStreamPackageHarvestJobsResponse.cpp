...
CoreInternalOutcome DescribeStreamPackageHarvestJobsResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageHarvestJobsResponse::ToJsonString() const
{
...
vector<HarvestJobResp> DescribeStreamPackageHarvestJobsResponse::GetInfos() const
{
    return m_infos;
}

bool DescribeStreamPackageHarvestJobsResponse::InfosHasBeenSet() const
{
    return m_infosHasBeenSet;
}

uint64_t DescribeStreamPackageHarvestJobsResponse::GetPageNum() const
{
    return m_pageNum;
}

bool DescribeStreamPackageHarvestJobsResponse::PageNumHasBeenSet() const
{
    return m_pageNumHasBeenSet;
}

uint64_t DescribeStreamPackageHarvestJobsResponse::GetPageSize() const
{
    return m_pageSize;
}

bool DescribeStreamPackageHarvestJobsResponse::PageSizeHasBeenSet() const
{
    return m_pageSizeHasBeenSet;
}

uint64_t DescribeStreamPackageHarvestJobsResponse::GetTotalNum() const
{
    return m_totalNum;
}

bool DescribeStreamPackageHarvestJobsResponse::TotalNumHasBeenSet() const
{
