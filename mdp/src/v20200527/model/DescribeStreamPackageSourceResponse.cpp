...
CoreInternalOutcome DescribeStreamPackageSourceResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageSourceResponse::ToJsonString() const
{
...
SourceInfo DescribeStreamPackageSourceResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamPackageSourceResponse::InfoHasBeenSet() const
{
