...
CoreInternalOutcome DescribeLinearAssemblyCDNDomainWithChannelResponse::Deserialize(const string &payload)
{
...
string DescribeLinearAssemblyCDNDomainWithChannelResponse::ToJsonString() const
{
...
CdnDomainInfo DescribeLinearAssemblyCDNDomainWithChannelResponse::GetInfo() const
{
    return m_info;
}

bool DescribeLinearAssemblyCDNDomainWithChannelResponse::InfoHasBeenSet() const
{
