...
CoreInternalOutcome DescribeStreamPackageLinearAssemblyChannelResponse::Deserialize(const string &payload)
{
...
string DescribeStreamPackageLinearAssemblyChannelResponse::ToJsonString() const
{
...
LinearAssemblyChannelInfo DescribeStreamPackageLinearAssemblyChannelResponse::GetInfo() const
{
    return m_info;
}

bool DescribeStreamPackageLinearAssemblyChannelResponse::InfoHasBeenSet() const
{
