...
CoreInternalOutcome DeleteStreamPackageChannelEndpointsResponse::Deserialize(const string &payload)
{
...
string DeleteStreamPackageChannelEndpointsResponse::ToJsonString() const
{
