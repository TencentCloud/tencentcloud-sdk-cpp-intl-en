...
string DeleteMediaPackageChannelsRequest::ToJsonString() const
{
    Document d;
    d.SetObject();
...
vector<string> DeleteMediaPackageChannelsRequest::GetIds() const
{
    return m_ids;
}

void DeleteMediaPackageChannelsRequest::SetIds(const vector<string>& _ids)
{
    m_ids = _ids;
    m_idsHasBeenSet = true;
}

bool DeleteMediaPackageChannelsRequest::IdsHasBeenSet() const
{
