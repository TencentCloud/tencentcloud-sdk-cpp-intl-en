...
CoreInternalOutcome CreateStreamPackageSSAIChannelResponse::Deserialize(const string &payload)
{
...
string CreateStreamPackageSSAIChannelResponse::ToJsonString() const
{
...
SSAIChannelInfo CreateStreamPackageSSAIChannelResponse::GetInfo() const
{
    return m_info;
}

bool CreateStreamPackageSSAIChannelResponse::InfoHasBeenSet() const
{
