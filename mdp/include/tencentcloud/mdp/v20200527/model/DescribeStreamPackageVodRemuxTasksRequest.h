...
#ifndef TENCENTCLOUD_MDP_V20200527_MODEL_DESCRIBESTREAMPACKAGEVODREMUXTASKSREQUEST_H_
#define TENCENTCLOUD_MDP_V20200527_MODEL_DESCRIBESTREAMPACKAGEVODREMUXTASKSREQUEST_H_
    ...
    namespace Mdp
    {
        namespace V20200527
        {
            namespace Model
            {
                ...
                */
                class DescribeStreamPackageVodRemuxTasksRequest : public AbstractModel
                {
                public:
                    DescribeStreamPackageVodRemuxTasksRequest();
                    ~DescribeStreamPackageVodRemuxTasksRequest() = default;
...
#endif // !TENCENTCLOUD_MDP_V20200527_MODEL_DESCRIBESTREAMPACKAGEVODREMUXTASKSREQUEST_H_
