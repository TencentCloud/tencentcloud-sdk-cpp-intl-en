...
#ifndef TENCENTCLOUD_MDP_V20200527_MODEL_DESCRIBEMEDIAPACKAGECHANNELSRESPONSE_H_
#define TENCENTCLOUD_MDP_V20200527_MODEL_DESCRIBEMEDIAPACKAGECHANNELSRESPONSE_H_
    ...
    namespace Mdp
    {
        namespace V20200527
        {
            namespace Model
            {
                ...
                */
                class DescribeMediaPackageChannelsResponse : public AbstractModel
                {
                public:
                    DescribeMediaPackageChannelsResponse();
                    ~DescribeMediaPackageChannelsResponse() = default;
                    CoreInternalOutcome Deserialize(const std::string &payload);


                    /**
                     * 获取The list of channel outputs.
...
#endif // !TENCENTCLOUD_MDP_V20200527_MODEL_DESCRIBEMEDIAPACKAGECHANNELSRESPONSE_H_
