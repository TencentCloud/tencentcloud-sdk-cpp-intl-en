...
#ifndef TENCENTCLOUD_MDP_V20200527_MODEL_DELETESTREAMPACKAGECHANNELSRESPONSE_H_
#define TENCENTCLOUD_MDP_V20200527_MODEL_DELETESTREAMPACKAGECHANNELSRESPONSE_H_
    ...
    namespace Mdp
    {
        namespace V20200527
        {
            namespace Model
            {
                ...
                */
                class DeleteStreamPackageChannelsResponse : public AbstractModel
                {
                public:
                    DeleteStreamPackageChannelsResponse();
                    ~DeleteStreamPackageChannelsResponse() = default;
...
#endif // !TENCENTCLOUD_MDP_V20200527_MODEL_DELETESTREAMPACKAGECHANNELSRESPONSE_H_
