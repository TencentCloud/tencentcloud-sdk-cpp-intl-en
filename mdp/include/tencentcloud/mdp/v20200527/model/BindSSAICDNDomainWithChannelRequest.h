...
#ifndef TENCENTCLOUD_MDP_V20200527_MODEL_BINDSSAICDNDOMAINWITHCHANNELREQUEST_H_
#define TENCENTCLOUD_MDP_V20200527_MODEL_BINDSSAICDNDOMAINWITHCHANNELREQUEST_H_
    ...
    namespace Mdp
    {
        namespace V20200527
        {
            namespace Model
            {
                ...
                */
                class BindSSAICDNDomainWithChannelRequest : public AbstractModel
                {
                public:
                    BindSSAICDNDomainWithChannelRequest();
                    ~BindSSAICDNDomainWithChannelRequest() = default;
...
#endif // !TENCENTCLOUD_MDP_V20200527_MODEL_BINDSSAICDNDOMAINWITHCHANNELREQUEST_H_
