...
#ifndef TENCENTCLOUD_MDP_V20200527_MODEL_MODIFYMEDIAPACKAGECHANNELENDPOINTREQUEST_H_
#define TENCENTCLOUD_MDP_V20200527_MODEL_MODIFYMEDIAPACKAGECHANNELENDPOINTREQUEST_H_
    ...
    namespace Mdp
    {
        namespace V20200527
        {
            namespace Model
            {
                ...
                */
                class ModifyMediaPackageChannelEndpointRequest : public AbstractModel
                {
                public:
                    ModifyMediaPackageChannelEndpointRequest();
                    ~ModifyMediaPackageChannelEndpointRequest() = default;
...
#endif // !TENCENTCLOUD_MDP_V20200527_MODEL_MODIFYMEDIAPACKAGECHANNELENDPOINTREQUEST_H_
