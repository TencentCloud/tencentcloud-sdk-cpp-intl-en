...
#ifndef TENCENTCLOUD_MDP_V20200527_MODEL_DESCRIBESTREAMPACKAGELINEARASSEMBLYPROGRAMSRESPONSE_H_
#define TENCENTCLOUD_MDP_V20200527_MODEL_DESCRIBESTREAMPACKAGELINEARASSEMBLYPROGRAMSRESPONSE_H_
    ...
    namespace Mdp
    {
        namespace V20200527
        {
            namespace Model
            {
                ...
                */
                class DescribeStreamPackageLinearAssemblyProgramsResponse : public AbstractModel
                {
                public:
                    DescribeStreamPackageLinearAssemblyProgramsResponse();
                    ~DescribeStreamPackageLinearAssemblyProgramsResponse() = default;
...
#endif // !TENCENTCLOUD_MDP_V20200527_MODEL_DESCRIBESTREAMPACKAGELINEARASSEMBLYPROGRAMSRESPONSE_H_
