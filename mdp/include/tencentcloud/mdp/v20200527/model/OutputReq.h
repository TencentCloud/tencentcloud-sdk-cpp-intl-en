...
#ifndef TENCENTCLOUD_MDP_V20200527_MODEL_OUTPUTREQ_H_
#define TENCENTCLOUD_MDP_V20200527_MODEL_OUTPUTREQ_H_
    ...
    namespace Mdp
    {
        namespace V20200527
        {
            namespace Model
            {
                ...
                */
                class OutputReq : public AbstractModel
                {
                public:
                    OutputReq();
                    ~OutputReq() = default;
                    ...
                    /**
                     * 获取Output type, distinguish HLS DASH.
                    ...
                    /**
                     * 设置Output type, distinguish HLS DASH.
...
#endif // !TENCENTCLOUD_MDP_V20200527_MODEL_OUTPUTREQ_H_
