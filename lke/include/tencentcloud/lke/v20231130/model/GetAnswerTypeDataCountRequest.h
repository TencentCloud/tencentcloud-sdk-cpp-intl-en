            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Message source (1. shared from user end; 2. chat API; 3. chat test, 4. application evaluation).
                    ...
                    /**
                     * 设置Message source (1. shared from user end; 2. chat API; 3. chat test, 4. application evaluation).
