            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Log in to user's root sub-account (required in integrator mode).
                    ...
                    /**
                     * 设置Log in to user's root sub-account (required in integrator mode).
                    ...
                    /**
                     * 获取Filter sub-scenarios (used in document parsing scenarios).
                    ...
                    /**
                     * 设置Filter sub-scenarios (used in document parsing scenarios).
