...
string StopRiskCenterTaskRequest::ToJsonString() const
{
...
vector<TaskIdListKey> StopRiskCenterTaskRequest::GetTaskIdList() const
{
    return m_taskIdList;
}

void StopRiskCenterTaskRequest::SetTaskIdList(const vector<TaskIdListKey>& _taskIdList)
{
