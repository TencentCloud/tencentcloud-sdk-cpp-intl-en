...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDYNAMICASSETSREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDYNAMICASSETSREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeDynamicAssetsRequest : public AbstractModel
                {
                public:
                    DescribeDynamicAssetsRequest();
                    ~DescribeDynamicAssetsRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDYNAMICASSETSREQUEST_H_
