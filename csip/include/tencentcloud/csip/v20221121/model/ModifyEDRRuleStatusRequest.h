            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Enabled status: 0 - Enabled, 1 - Disabled</p>
                    ...
                    /**
                     * 设置<p>Enabled status: 0 - Enabled, 1 - Disabled</p>
                     * @param _status <p>Enabled status: 0 - Enabled, 1 - Disabled</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Policy type. 0: system; 1: custom</p>
                    ...
                    /**
                     * 设置<p>Policy type. 0: system; 1: custom</p>
                     * @param _ruleType <p>Policy type. 0: system; 1: custom</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>APPID of the modify policy</p>
                    ...
                    /**
                     * 设置<p>APPID of the modify policy</p>
                     * @param _targetAppIDs <p>APPID of the modify policy</p>
                     * 
                     */
