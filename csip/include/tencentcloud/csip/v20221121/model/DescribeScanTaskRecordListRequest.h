...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBESCANTASKRECORDLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBESCANTASKRECORDLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeScanTaskRecordListRequest : public AbstractModel
                {
                public:
                    DescribeScanTaskRecordListRequest();
                    ~DescribeScanTaskRecordListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBESCANTASKRECORDLISTREQUEST_H_
