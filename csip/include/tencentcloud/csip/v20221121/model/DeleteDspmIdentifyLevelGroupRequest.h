...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DELETEDSPMIDENTIFYLEVELGROUPREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DELETEDSPMIDENTIFYLEVELGROUPREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DeleteDspmIdentifyLevelGroupRequest : public AbstractModel
                {
                public:
                    DeleteDspmIdentifyLevelGroupRequest();
                    ~DeleteDspmIdentifyLevelGroupRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DELETEDSPMIDENTIFYLEVELGROUPREQUEST_H_
