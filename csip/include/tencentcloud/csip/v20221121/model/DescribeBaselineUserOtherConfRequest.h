...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBASELINEUSEROTHERCONFREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBASELINEUSEROTHERCONFREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeBaselineUserOtherConfRequest : public AbstractModel
                {
                public:
                    DescribeBaselineUserOtherConfRequest();
                    ~DescribeBaselineUserOtherConfRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBASELINEUSEROTHERCONFREQUEST_H_
