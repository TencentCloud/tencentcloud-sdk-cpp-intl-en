...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGESENSITIVEINFOLISTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGESENSITIVEINFOLISTEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateImageSensitiveInfoListExportJobRequest : public AbstractModel
                {
                public:
                    CreateImageSensitiveInfoListExportJobRequest();
                    ~CreateImageSensitiveInfoListExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGESENSITIVEINFOLISTEXPORTJOBREQUEST_H_
