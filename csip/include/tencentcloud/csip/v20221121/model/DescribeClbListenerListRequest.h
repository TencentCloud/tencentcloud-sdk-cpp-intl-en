...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECLBLISTENERLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECLBLISTENERLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeClbListenerListRequest : public AbstractModel
                {
                public:
                    DescribeClbListenerListRequest();
                    ~DescribeClbListenerListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBECLBLISTENERLISTREQUEST_H_
