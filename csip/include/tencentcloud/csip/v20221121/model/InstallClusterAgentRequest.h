...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_INSTALLCLUSTERAGENTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_INSTALLCLUSTERAGENTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class InstallClusterAgentRequest : public AbstractModel
                {
                public:
                    InstallClusterAgentRequest();
                    ~InstallClusterAgentRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_INSTALLCLUSTERAGENTREQUEST_H_
