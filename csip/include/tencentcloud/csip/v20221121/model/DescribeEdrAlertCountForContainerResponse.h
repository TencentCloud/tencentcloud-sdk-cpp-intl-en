            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Global mode returns (when both ID arrays are empty); null in grouping mode</p>
                    ...
                    /**
                     * 获取<p>Grouping mode return (when ContainerIds or ClusterIds is not empty); return [] if empty</p>
