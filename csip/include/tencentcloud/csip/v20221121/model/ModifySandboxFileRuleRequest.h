...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYSANDBOXFILERULEREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYSANDBOXFILERULEREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class ModifySandboxFileRuleRequest : public AbstractModel
                {
                public:
                    ModifySandboxFileRuleRequest();
                    ~ModifySandboxFileRuleRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYSANDBOXFILERULEREQUEST_H_
