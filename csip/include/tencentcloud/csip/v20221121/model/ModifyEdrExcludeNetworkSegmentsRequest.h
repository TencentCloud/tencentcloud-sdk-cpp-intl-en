            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Exception IP range list, supporting IP/IP range/CIDR formats, up to 100 entries</p>
                    ...
                    /**
                     * 设置<p>Exception IP range list, supporting IP/IP range/CIDR formats, up to 100 entries</p>
                     * @param _networkSegments <p>Exception IP range list, supporting IP/IP range/CIDR formats, up to 100 entries</p>
                     * 
                     */
