            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Filter parameters<br>Status: Binding progress status. 0: In progress. 1: Completed. 2: Failed.</p>
                    ...
                    /**
                     * 设置<p>Filter parameters<br>Status: Binding progress status. 0: In progress. 1: Completed. 2: Failed.</p>
                     * @param _filters <p>Filter parameters<br>Status: Binding progress status. 0: In progress. 1: Completed. 2: Failed.</p>
                     * 
                     */
