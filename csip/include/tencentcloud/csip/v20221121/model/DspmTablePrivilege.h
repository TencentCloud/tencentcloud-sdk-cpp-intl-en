...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMTABLEPRIVILEGE_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMTABLEPRIVILEGE_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                * Table permission
                */
                class DspmTablePrivilege : public AbstractModel
                {
                public:
                    DspmTablePrivilege();
                    ~DspmTablePrivilege() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMTABLEPRIVILEGE_H_
