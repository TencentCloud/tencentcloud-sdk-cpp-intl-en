...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DELETEDSPMIDENTIFYCOMPLIANCEGROUPREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DELETEDSPMIDENTIFYCOMPLIANCEGROUPREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DeleteDspmIdentifyComplianceGroupRequest : public AbstractModel
                {
                public:
                    DeleteDspmIdentifyComplianceGroupRequest();
                    ~DeleteDspmIdentifyComplianceGroupRequest() = default;
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>Identification template ID set</p>
                    ...
                    /**
                     * 设置<p>Identification template ID set</p>
                     * @param _ids <p>Identification template ID set</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DELETEDSPMIDENTIFYCOMPLIANCEGROUPREQUEST_H_
