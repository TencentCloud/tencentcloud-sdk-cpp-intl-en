...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBASELINESYNCCONFREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBASELINESYNCCONFREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeBaselineSyncConfRequest : public AbstractModel
                {
                public:
                    DescribeBaselineSyncConfRequest();
                    ~DescribeBaselineSyncConfRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBASELINESYNCCONFREQUEST_H_
