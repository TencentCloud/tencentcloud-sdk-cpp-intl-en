...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDYNAMICASSETSRESPONSE_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDYNAMICASSETSRESPONSE_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeDynamicAssetsResponse : public AbstractModel
                {
                public:
                    DescribeDynamicAssetsResponse();
                    ~DescribeDynamicAssetsResponse() = default;
                     ...
                     * 
                     */
                    std::vector<AssetHeaderItem> GetHeader() const;
                ...
                private:
                     ...
                     * Headers.
                     */
                    std::vector<AssetHeaderItem> m_header;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDYNAMICASSETSRESPONSE_H_
