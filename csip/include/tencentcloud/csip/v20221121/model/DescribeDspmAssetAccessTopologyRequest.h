            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取View type. Valid values: `ip` or `instance`.
                    ...
                    /**
                     * 设置View type. Valid values: `ip` or `instance`.
                     * @param _view View type. Valid values: `ip` or `instance`.
                     * 
                     */
...
Filter:{
	...
	},
	{
		...
		"Values":["root|%","test|%"]
                     ...
                     * @param _filter -View by source ip
View: "ip"
