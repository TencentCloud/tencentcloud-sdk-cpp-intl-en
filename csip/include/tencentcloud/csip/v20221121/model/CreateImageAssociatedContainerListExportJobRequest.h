...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEASSOCIATEDCONTAINERLISTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEASSOCIATEDCONTAINERLISTEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateImageAssociatedContainerListExportJobRequest : public AbstractModel
                {
                public:
                    CreateImageAssociatedContainerListExportJobRequest();
                    ~CreateImageAssociatedContainerListExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEASSOCIATEDCONTAINERLISTEXPORTJOBREQUEST_H_
