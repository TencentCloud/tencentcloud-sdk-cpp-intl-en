            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 设置<p>Trigger ID.</p>
                     * @param _triggerId <p>Trigger ID.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Trigger type. Value: 1 (Cron expression), 2 (fixed time).</p>
                    ...
                    /**
                     * 设置<p>Trigger type. Value: 1 (Cron expression), 2 (fixed time).</p>
                     * @param _triggerType <p>Trigger type. Value: 1 (Cron expression), 2 (fixed time).</p>
                     * 
                     */
