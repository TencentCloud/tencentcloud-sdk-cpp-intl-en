...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEREGISTRYLISTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEREGISTRYLISTEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateImageRegistryListExportJobRequest : public AbstractModel
                {
                public:
                    CreateImageRegistryListExportJobRequest();
                    ~CreateImageRegistryListExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEREGISTRYLISTEXPORTJOBREQUEST_H_
