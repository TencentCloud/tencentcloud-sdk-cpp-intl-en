            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Number of servers associated with the image</p>
                    ...
                    /**
                     * 设置<p>Number of servers associated with the image</p>
                     * @param _hostCount <p>Number of servers associated with the image</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Number of containers associated with the image</p>
                    ...
                    /**
                     * 设置<p>Number of containers associated with the image</p>
                     * @param _containerCount <p>Number of containers associated with the image</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Mirror associated account name</p>
                    ...
                    /**
                     * 设置<p>Mirror associated account name</p>
                     * @param _ownerAccountName <p>Mirror associated account name</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Account uin of the mirror</p>
                    ...
                    /**
                     * 设置<p>Account uin of the mirror</p>
                     * @param _ownerUin <p>Account uin of the mirror</p>
                     * 
                     */
