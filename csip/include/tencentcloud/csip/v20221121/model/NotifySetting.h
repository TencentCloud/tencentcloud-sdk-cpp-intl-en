            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Notification settings mode</p><p>Enumeration values:</p><ul><li>0: Standard mode</li><li>1: Advanced mode</li></ul>
                    ...
                    /**
                     * 设置<p>Notification settings mode</p><p>Enumeration values:</p><ul><li>0: Standard mode</li><li>1: Advanced mode</li></ul>
                     * @param _mode <p>Notification settings mode</p><p>Enumeration values:</p><ul><li>0: Standard mode</li><li>1: Advanced mode</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Notification status</p><p>Enumeration values:</p><ul><li>0: notification off</li><li>1: notification on</li></ul>
                    ...
                    /**
                     * 设置<p>Notification status</p><p>Enumeration values:</p><ul><li>0: notification off</li><li>1: notification on</li></ul>
                     * @param _status <p>Notification status</p><p>Enumeration values:</p><ul><li>0: notification off</li><li>1: notification on</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Asset scope</p><p>Enumeration values:</p><ul><li>1: All hosts</li><li>2: Selected hosts</li><li>3: Select by tag</li></ul>
                    ...
                    /**
                     * 设置<p>Asset scope</p><p>Enumeration values:</p><ul><li>1: All hosts</li><li>2: Selected hosts</li><li>3: Select by tag</li></ul>
                     * @param _assetRange <p>Asset scope</p><p>Enumeration values:</p><ul><li>1: All hosts</li><li>2: Selected hosts</li><li>3: Select by tag</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Notification module (secondary module)</p>
                    ...
                    /**
                     * 设置<p>Notification module (secondary module)</p>
                     * @param _subModule <p>Notification module (secondary module)</p>
                     * 
                     */
                    ...
                    /**
                     * 设置<p>Handling status</p>
                     * @param _item <p>Handling status</p>
                     * 
                     */
