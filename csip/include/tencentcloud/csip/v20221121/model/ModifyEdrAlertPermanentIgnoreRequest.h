            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Alarm locating list (cross-account supported), up to 500 entries</p>
                    ...
                    /**
                     * 设置<p>Alarm locating list (cross-account supported), up to 500 entries</p>
                     * @param _targets <p>Alarm locating list (cross-account supported), up to 500 entries</p>
                     * 
                     */
