...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDSPMIDENTIFYCATEGORYLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDSPMIDENTIFYCATEGORYLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeDspmIdentifyCategoryListRequest : public AbstractModel
                {
                public:
                    DescribeDspmIdentifyCategoryListRequest();
                    ~DescribeDspmIdentifyCategoryListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDSPMIDENTIFYCATEGORYLISTREQUEST_H_
