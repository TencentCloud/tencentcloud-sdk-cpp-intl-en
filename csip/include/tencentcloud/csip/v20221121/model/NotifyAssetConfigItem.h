            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 设置<p>Submodule</p>
                     * @param _subModule <p>Submodule</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Asset scope</p><p>Enumeration values:</p><ul><li>0: meaningless</li><li>1: all</li><li>2: selected</li><li>3: by tag</li></ul>
                    ...
                    /**
                     * 设置<p>Asset scope</p><p>Enumeration values:</p><ul><li>0: meaningless</li><li>1: all</li><li>2: selected</li><li>3: by tag</li></ul>
                     * @param _assetRange <p>Asset scope</p><p>Enumeration values:</p><ul><li>0: meaningless</li><li>1: all</li><li>2: selected</li><li>3: by tag</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>ID of selected instances</p>
                    ...
                    /**
                     * 设置<p>ID of selected instances</p>
                     * @param _instanceIds <p>ID of selected instances</p>
                     * 
                     */
                    ...
                    /**
                     * 设置<p>Removed instance ID</p>
                     * @param _excludedInstanceIds <p>Removed instance ID</p>
                     * 
                     */
                    ...
                    /**
                     * 设置<p>Cloud tag</p>
                     * @param _cloudTags <p>Cloud tag</p>
                     * 
                     */
