            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                     ...
                     * @param _policyID <p>Baseline policy ID.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Baseline parent category ID for filtering detection items under the specified parent category.</p>
                    ...
                    /**
                     * 设置<p>Baseline parent category ID for filtering detection items under the specified parent category.</p>
                     * @param _parentCategoryID <p>Baseline parent category ID for filtering detection items under the specified parent category.</p>
                     * 
                     */
