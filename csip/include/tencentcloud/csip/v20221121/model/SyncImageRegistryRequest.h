            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Whether to synchronize all repositories</p><p>Enumeration values:</p><ul><li>true: yes</li><li>false: no</li></ul>
                    ...
                    /**
                     * 设置<p>Whether to synchronize all repositories</p><p>Enumeration values:</p><ul><li>true: yes</li><li>false: no</li></ul>
                     * @param _all <p>Whether to synchronize all repositories</p><p>Enumeration values:</p><ul><li>true: yes</li><li>false: no</li></ul>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>List of mirror repository IDs to be synchronized</p>
                    ...
                    /**
                     * 设置<p>List of mirror repository IDs to be synchronized</p>
                     * @param _registryIds <p>List of mirror repository IDs to be synchronized</p>
                     * 
                     */
