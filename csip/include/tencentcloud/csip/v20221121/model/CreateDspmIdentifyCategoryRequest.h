...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYCATEGORYREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYCATEGORYREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateDspmIdentifyCategoryRequest : public AbstractModel
                {
                public:
                    CreateDspmIdentifyCategoryRequest();
                    ~CreateDspmIdentifyCategoryRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYCATEGORYREQUEST_H_
