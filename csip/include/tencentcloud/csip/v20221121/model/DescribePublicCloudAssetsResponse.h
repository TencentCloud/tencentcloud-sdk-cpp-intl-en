...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEPUBLICCLOUDASSETSRESPONSE_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEPUBLICCLOUDASSETSRESPONSE_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribePublicCloudAssetsResponse : public AbstractModel
                {
                public:
                    DescribePublicCloudAssetsResponse();
                    ~DescribePublicCloudAssetsResponse() = default;
                     ...
                     * 
                     */
                    std::vector<PublicAssetInfo> GetAssets() const;
                ...
                private:
                     ...
                     * Asset collection
                     */
                    std::vector<PublicAssetInfo> m_assets;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEPUBLICCLOUDASSETSRESPONSE_H_
