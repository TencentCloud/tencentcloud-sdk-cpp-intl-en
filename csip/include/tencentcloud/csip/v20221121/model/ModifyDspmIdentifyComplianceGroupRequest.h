...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYDSPMIDENTIFYCOMPLIANCEGROUPREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYDSPMIDENTIFYCOMPLIANCEGROUPREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class ModifyDspmIdentifyComplianceGroupRequest : public AbstractModel
                {
                public:
                    ModifyDspmIdentifyComplianceGroupRequest();
                    ~ModifyDspmIdentifyComplianceGroupRequest() = default;
                     ...
                     * @param _id <p>Identification template ID</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Identification template name</p>
                    ...
                    /**
                     * 设置<p>Identification template name</p>
                     * @param _name <p>Identification template name</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYDSPMIDENTIFYCOMPLIANCEGROUPREQUEST_H_
