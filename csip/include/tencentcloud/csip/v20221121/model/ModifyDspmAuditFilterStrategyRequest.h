...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYDSPMAUDITFILTERSTRATEGYREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYDSPMAUDITFILTERSTRATEGYREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class ModifyDspmAuditFilterStrategyRequest : public AbstractModel
                {
                public:
                    ModifyDspmAuditFilterStrategyRequest();
                    ~ModifyDspmAuditFilterStrategyRequest() = default;
                    ...
                    /**
                     * 设置<p>Policy rule content</p>
                     * @param _rule <p>Policy rule content</p>
                     * 
                     */
                     ...
                     * @param _isEnabled <p>Whether to enable</p><p>Enumeration values:</p><ul><li>0: disabled</li><li>1: enabled</li></ul>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYDSPMAUDITFILTERSTRATEGYREQUEST_H_
