            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Number of clusters with alarms (COUNT(DISTINCT cluster_id), excluding empty cluster_id)</p>
                    ...
                    /**
                     * 设置<p>Number of clusters with alarms (COUNT(DISTINCT cluster_id), excluding empty cluster_id)</p>
                     * @param _clustersCount <p>Number of clusters with alarms (COUNT(DISTINCT cluster_id), excluding empty cluster_id)</p>
                     * 
                     */
