...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEEXPOSUREAUTOTAGRULESREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEEXPOSUREAUTOTAGRULESREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeExposureAutoTagRulesRequest : public AbstractModel
                {
                public:
                    DescribeExposureAutoTagRulesRequest();
                    ~DescribeExposureAutoTagRulesRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEEXPOSUREAUTOTAGRULESREQUEST_H_
