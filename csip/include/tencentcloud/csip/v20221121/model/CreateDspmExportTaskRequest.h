            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Risk level (0-Safe, 1-Low risk, 2-Medium-risk, 3-High-risk, -1-All)</p>
                    ...
                    /**
                     * 设置<p>Risk level (0-Safe, 1-Low risk, 2-Medium-risk, 3-High-risk, -1-All)</p>
                     * @param _dangerLevel <p>Risk level (0-Safe, 1-Low risk, 2-Medium-risk, 3-High-risk, -1-All)</p>
                     * 
                     */
                     ...
                     * @param _clientSideIp <p>Client IP address</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Traffic source. Parameter value: Agent/Proxy/empty. If Agent is passed, agent logs will be returned. If Proxy is passed, proxy logs will be returned. If both or neither are passed, return all.</p>
                    ...
                    /**
                     * 设置<p>Traffic source. Parameter value: Agent/Proxy/empty. If Agent is passed, agent logs will be returned. If Proxy is passed, proxy logs will be returned. If both or neither are passed, return all.</p>
                     * @param _sourceTypes <p>Traffic source. Parameter value: Agent/Proxy/empty. If Agent is passed, agent logs will be returned. If Proxy is passed, proxy logs will be returned. If both or neither are passed, return all.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Table name, length limited to 64. For multiple table name queries, use space-separated.</p>
                    ...
                    /**
                     * 设置<p>Table name, length limited to 64. For multiple table name queries, use space-separated.</p>
                     * @param _tableName <p>Table name, length limited to 64. For multiple table name queries, use space-separated.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Field name, length limited to 64. For multiple field name queries, use space-separated.</p>
                    ...
                    /**
                     * 设置<p>Field name, length limited to 64. For multiple field name queries, use space-separated.</p>
                     * @param _fieldName <p>Field name, length limited to 64. For multiple field name queries, use space-separated.</p>
                     * 
                     */
                     ...
                     * @param _dbTypes <p>Database type</p>
                     * 
                     */
                    ...
                    /**
                     * 设置<p>Response code</p>
                     * @param _retNo <p>Response code</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Risk level array (0-secure, 1-low risk, 2-medium-risk, 3-high-risk). To select all, import all values. If empty, see the DangerLevel input parameter.</p>
                    ...
                    /**
                     * 设置<p>Risk level array (0-secure, 1-low risk, 2-medium-risk, 3-high-risk). To select all, import all values. If empty, see the DangerLevel input parameter.</p>
                     * @param _dangerLevels <p>Risk level array (0-secure, 1-low risk, 2-medium-risk, 3-high-risk). To select all, import all values. If empty, see the DangerLevel input parameter.</p>
                     * 
                     */
                     ...
                     * @param _trxId <p>Transaction Id.</p>
                     * 
                     */
