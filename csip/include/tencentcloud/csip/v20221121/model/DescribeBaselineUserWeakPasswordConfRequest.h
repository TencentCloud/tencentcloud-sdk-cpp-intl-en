...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBASELINEUSERWEAKPASSWORDCONFREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBASELINEUSERWEAKPASSWORDCONFREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeBaselineUserWeakPasswordConfRequest : public AbstractModel
                {
                public:
                    DescribeBaselineUserWeakPasswordConfRequest();
                    ~DescribeBaselineUserWeakPasswordConfRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEBASELINEUSERWEAKPASSWORDCONFREQUEST_H_
