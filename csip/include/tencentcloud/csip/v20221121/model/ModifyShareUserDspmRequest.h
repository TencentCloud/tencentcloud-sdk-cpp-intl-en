...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYSHAREUSERDSPMREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYSHAREUSERDSPMREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class ModifyShareUserDspmRequest : public AbstractModel
                {
                public:
                    ModifyShareUserDspmRequest();
                    ~ModifyShareUserDspmRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_MODIFYSHAREUSERDSPMREQUEST_H_
