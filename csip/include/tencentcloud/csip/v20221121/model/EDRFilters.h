...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_EDRFILTERS_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_EDRFILTERS_H_
...
If there are multiple Values in the same Filter, the logical relationship between the Values under the same Filter is OR.
                */
                class EDRFilters : public AbstractModel
                {
                public:
                    EDRFilters();
                    ~EDRFilters() = default;
                    ...
                    /**
                     * 获取<p>Whether to use fuzzy match. It will be handled by the front-end and can be ignored.</p>
                    ...
                    /**
                     * 设置<p>Whether to use fuzzy match. It will be handled by the front-end and can be ignored.</p>
                     * @param _exactMatch <p>Whether to use fuzzy match. It will be handled by the front-end and can be ignored.</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_EDRFILTERS_H_
