...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEASSOCIATEDHOSTLISTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEASSOCIATEDHOSTLISTEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateImageAssociatedHostListExportJobRequest : public AbstractModel
                {
                public:
                    CreateImageAssociatedHostListExportJobRequest();
                    ~CreateImageAssociatedHostListExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEIMAGEASSOCIATEDHOSTLISTEXPORTJOBREQUEST_H_
