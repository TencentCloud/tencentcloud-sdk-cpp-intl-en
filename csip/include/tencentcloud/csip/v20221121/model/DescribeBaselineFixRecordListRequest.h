            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Number of items per page for paging query. Maximum value: 100. If exceeded, the server will automatically roll back to the default value of 10.</p>
                    ...
                    /**
                     * 设置<p>Number of items per page for paging query. Maximum value: 100. If exceeded, the server will automatically roll back to the default value of 10.</p>
                     * @param _limit <p>Number of items per page for paging query. Maximum value: 100. If exceeded, the server will automatically roll back to the default value of 10.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Paging query starting offset amount, starting from 0.</p>
                    ...
                    /**
                     * 设置<p>Paging query starting offset amount, starting from 0.</p>
                     * @param _offset <p>Paging query starting offset amount, starting from 0.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Sorting order. Valid values: asc (in ascending order) or desc (in descending order). Default: desc.</p>
                    ...
                    /**
                     * 设置<p>Sorting order. Valid values: asc (in ascending order) or desc (in descending order). Default: desc.</p>
                     * @param _order <p>Sorting order. Valid values: asc (in ascending order) or desc (in descending order). Default: desc.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Sort field name. Values: FixTime (repair time), ID (record ID). Default: sort by ID in descending order.</p>
                    ...
                    /**
                     * 设置<p>Sort field name. Values: FixTime (repair time), ID (record ID). Default: sort by ID in descending order.</p>
                     * @param _by <p>Sort field name. Values: FixTime (repair time), ID (record ID). Default: sort by ID in descending order.</p>
                     * 
                     */
