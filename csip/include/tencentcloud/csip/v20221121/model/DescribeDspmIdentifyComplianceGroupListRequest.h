...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDSPMIDENTIFYCOMPLIANCEGROUPLISTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDSPMIDENTIFYCOMPLIANCEGROUPLISTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeDspmIdentifyComplianceGroupListRequest : public AbstractModel
                {
                public:
                    DescribeDspmIdentifyComplianceGroupListRequest();
                    ~DescribeDspmIdentifyComplianceGroupListRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEDSPMIDENTIFYCOMPLIANCEGROUPLISTREQUEST_H_
