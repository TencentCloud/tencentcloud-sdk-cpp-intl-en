            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Account name to which the pod belongs</p>
                    ...
                    /**
                     * 设置<p>Account name to which the pod belongs</p>
                     * @param _ownerAccountName <p>Account name to which the pod belongs</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>appid of the account associated with the pod</p>
                    ...
                    /**
                     * 设置<p>appid of the account associated with the pod</p>
                     * @param _ownerAppId <p>appid of the account associated with the pod</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>uin of the account to which the pod belongs</p>
                    ...
                    /**
                     * 设置<p>uin of the account to which the pod belongs</p>
                     * @param _ownerUin <p>uin of the account to which the pod belongs</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Cluster status.</p><p>Enumeration values: </p><ul><li>Running: Running, </li><li>Exception: Exception, </li><li>Unknown: Unknown, </li><li>Creating: Creating.</li></ul>
                    ...
                    /**
                     * 设置<p>Cluster status.</p><p>Enumeration values: </p><ul><li>Running: Running, </li><li>Exception: Exception, </li><li>Unknown: Unknown, </li><li>Creating: Creating.</li></ul>
                     * @param _clusterStatus <p>Cluster status.</p><p>Enumeration values: </p><ul><li>Running: Running, </li><li>Exception: Exception, </li><li>Unknown: Unknown, </li><li>Creating: Creating.</li></ul>
                     * 
                     */
                     ...
                     * @param _podId <p>Pod unique id</p>
                     * 
                     */
                    ...
                    /**
                     * 设置<p>Unique cluster Id.</p>
                     * @param _clusterCaMd5 <p>Unique cluster Id.</p>
                     * 
                     */
