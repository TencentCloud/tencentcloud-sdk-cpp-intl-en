...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEHIGHBASELINERISKSEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEHIGHBASELINERISKSEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateHighBaseLineRisksExportJobRequest : public AbstractModel
                {
                public:
                    CreateHighBaseLineRisksExportJobRequest();
                    ~CreateHighBaseLineRisksExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEHIGHBASELINERISKSEXPORTJOBREQUEST_H_
