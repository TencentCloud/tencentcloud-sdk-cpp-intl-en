...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYCOMPLIANCERULERELATIONREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYCOMPLIANCERULERELATIONREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateDspmIdentifyComplianceRuleRelationRequest : public AbstractModel
                {
                public:
                    CreateDspmIdentifyComplianceRuleRelationRequest();
                    ~CreateDspmIdentifyComplianceRuleRelationRequest() = default;
                     ...
                     * 
                     */
                    std::vector<DspmIdentifyCategoryRuleRelateItem> GetRules() const;

                    /**
                     * 设置<p>None</p>
                     * @param _rules <p>None</p>
                     * 
                     */
                    void SetRules(const std::vector<DspmIdentifyCategoryRuleRelateItem>& _rules);
                ...
                private:
                     ...
                     * <p>None</p>
                     */
                    std::vector<DspmIdentifyCategoryRuleRelateItem> m_rules;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYCOMPLIANCERULERELATIONREQUEST_H_
