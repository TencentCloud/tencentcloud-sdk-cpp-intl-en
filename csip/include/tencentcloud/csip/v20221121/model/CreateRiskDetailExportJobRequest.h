...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATERISKDETAILEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATERISKDETAILEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateRiskDetailExportJobRequest : public AbstractModel
                {
                public:
                    CreateRiskDetailExportJobRequest();
                    ~CreateRiskDetailExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATERISKDETAILEXPORTJOBREQUEST_H_
