...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEPROCESSDAEMONGLOBALCONFRESPONSE_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEPROCESSDAEMONGLOBALCONFRESPONSE_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeProcessDaemonGlobalConfResponse : public AbstractModel
                {
                public:
                    DescribeProcessDaemonGlobalConfResponse();
                    ~DescribeProcessDaemonGlobalConfResponse() = default;
                    CoreInternalOutcome Deserialize(const std::string &payload);
                    std::string ToJsonString() const;


                    /**
                     * 获取<p>Whether process protection is enabled. 0: No. 1: Yes. 9: Not set, same as 0, not enabled</p>
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEPROCESSDAEMONGLOBALCONFRESPONSE_H_
