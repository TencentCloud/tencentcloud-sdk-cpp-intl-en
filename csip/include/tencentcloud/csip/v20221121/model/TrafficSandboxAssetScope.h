            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Instance ID. Only for host assets.
                    ...
                    /**
                     * 设置Instance ID. Only for host assets.
                     * @param _instanceId Instance ID. Only for host assets.
                     * 
                     */
                    ...
                    /**
                     * 获取Container ID. This parameter is required only when the asset type is container.
                    ...
                    /**
                     * 设置Container ID. This parameter is required only when the asset type is container.
                     * @param _containerId Container ID. This parameter is required only when the asset type is container.
                     * 
                     */
