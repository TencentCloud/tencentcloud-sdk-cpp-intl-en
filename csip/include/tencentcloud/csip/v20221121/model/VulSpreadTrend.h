            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>Date<br>Parameter format: YYYY-MM-DD</p>
                    ...
                    /**
                     * 设置<p>Date<br>Parameter format: YYYY-MM-DD</p>
                     * @param _date <p>Date<br>Parameter format: YYYY-MM-DD</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Propagation trend numeric value of the date</p>
                    ...
                    /**
                     * 设置<p>Propagation trend numeric value of the date</p>
                     * @param _trend <p>Propagation trend numeric value of the date</p>
                     * 
                     */
