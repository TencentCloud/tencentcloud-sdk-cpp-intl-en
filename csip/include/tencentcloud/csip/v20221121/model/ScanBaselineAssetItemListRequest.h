            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取<p>List of detection item IDs to rescan. It is only applicable to this asset.</p>
                    ...
                    /**
                     * 设置<p>List of detection item IDs to rescan. It is only applicable to this asset.</p>
                     * @param _itemIDList <p>List of detection item IDs to rescan. It is only applicable to this asset.</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Target asset ID (Instance ID for AssetType=HOST; CLUSTER ID for AssetType=CLUSTER).</p>
                    ...
                    /**
                     * 设置<p>Target asset ID (Instance ID for AssetType=HOST; CLUSTER ID for AssetType=CLUSTER).</p>
                     * @param _assetID <p>Target asset ID (Instance ID for AssetType=HOST; CLUSTER ID for AssetType=CLUSTER).</p>
                     * 
                     */
                    ...
                    /**
                     * 获取<p>Asset type of the hit asset. Parameter Value:</p><ul><li>HOST: Host</li><li>CLUSTER: Cluster</li><li>POD: Pod</li><li>CONTAINER: Container</li><li>IMAGE: Mirror</li></ul>
                    ...
                    /**
                     * 设置<p>Asset type of the hit asset. Parameter Value:</p><ul><li>HOST: Host</li><li>CLUSTER: Cluster</li><li>POD: Pod</li><li>CONTAINER: Container</li><li>IMAGE: Mirror</li></ul>
                     * @param _assetType <p>Asset type of the hit asset. Parameter Value:</p><ul><li>HOST: Host</li><li>CLUSTER: Cluster</li><li>POD: Pod</li><li>CONTAINER: Container</li><li>IMAGE: Mirror</li></ul>
                     * 
                     */
