...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DELETEDSPMIDENTIFYCOMPLIANCECATEGORYRELATIONREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DELETEDSPMIDENTIFYCOMPLIANCECATEGORYRELATIONREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DeleteDspmIdentifyComplianceCategoryRelationRequest : public AbstractModel
                {
                public:
                    DeleteDspmIdentifyComplianceCategoryRelationRequest();
                    ~DeleteDspmIdentifyComplianceCategoryRelationRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DELETEDSPMIDENTIFYCOMPLIANCECATEGORYRELATIONREQUEST_H_
