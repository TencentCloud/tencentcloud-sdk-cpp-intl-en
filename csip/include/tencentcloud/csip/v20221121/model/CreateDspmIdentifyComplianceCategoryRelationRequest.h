...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYCOMPLIANCECATEGORYRELATIONREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYCOMPLIANCECATEGORYRELATIONREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateDspmIdentifyComplianceCategoryRelationRequest : public AbstractModel
                {
                public:
                    CreateDspmIdentifyComplianceCategoryRelationRequest();
                    ~CreateDspmIdentifyComplianceCategoryRelationRequest() = default;
                     ...
                     * @param _parentCategoryId <p>Parent category ID</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEDSPMIDENTIFYCOMPLIANCECATEGORYRELATIONREQUEST_H_
