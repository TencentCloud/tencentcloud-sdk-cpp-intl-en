...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEASSETCOMPONENTLISTEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEASSETCOMPONENTLISTEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateAssetComponentListExportJobRequest : public AbstractModel
                {
                public:
                    CreateAssetComponentListExportJobRequest();
                    ~CreateAssetComponentListExportJobRequest() = default;
                    ...
                    /**
                     * 设置<p>Save file name</p>
                     * @param _exportName <p>Save file name</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATEASSETCOMPONENTLISTEXPORTJOBREQUEST_H_
