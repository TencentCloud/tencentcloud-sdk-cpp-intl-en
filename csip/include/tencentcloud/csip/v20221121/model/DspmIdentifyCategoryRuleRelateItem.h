...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMIDENTIFYCATEGORYRULERELATEITEM_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMIDENTIFYCATEGORYRULERELATEITEM_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DspmIdentifyCategoryRuleRelateItem : public AbstractModel
                {
                public:
                    DspmIdentifyCategoryRuleRelateItem();
                    ~DspmIdentifyCategoryRuleRelateItem() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DSPMIDENTIFYCATEGORYRULERELATEITEM_H_
