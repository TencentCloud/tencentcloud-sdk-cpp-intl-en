...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEPROCESSDAEMONHOSTREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEPROCESSDAEMONHOSTREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class DescribeProcessDaemonHostRequest : public AbstractModel
                {
                public:
                    DescribeProcessDaemonHostRequest();
                    ~DescribeProcessDaemonHostRequest() = default;
                    ...
                    /**
                     * 获取<p>Name - string - Required: No - MachineName InstanceId - string - Required: No - instance ID PublicIp - string - Required: No - public IP address PrivateIp - string - Required: No - private IP address</p>
                    ...
                    /**
                     * 设置<p>Name - string - Required: No - MachineName InstanceId - string - Required: No - instance ID PublicIp - string - Required: No - public IP address PrivateIp - string - Required: No - private IP address</p>
                     * @param _filters <p>Name - string - Required: No - MachineName InstanceId - string - Required: No - instance ID PublicIp - string - Required: No - public IP address PrivateIp - string - Required: No - private IP address</p>
                     * 
                     */
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_DESCRIBEPROCESSDAEMONHOSTREQUEST_H_
