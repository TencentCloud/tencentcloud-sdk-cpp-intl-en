...
#ifndef TENCENTCLOUD_CSIP_V20221121_MODEL_CREATESCANSTATISTICEXPORTJOBREQUEST_H_
#define TENCENTCLOUD_CSIP_V20221121_MODEL_CREATESCANSTATISTICEXPORTJOBREQUEST_H_
    ...
    namespace Csip
    {
        namespace V20221121
        {
            namespace Model
            {
                ...
                */
                class CreateScanStatisticExportJobRequest : public AbstractModel
                {
                public:
                    CreateScanStatisticExportJobRequest();
                    ~CreateScanStatisticExportJobRequest() = default;
...
#endif // !TENCENTCLOUD_CSIP_V20221121_MODEL_CREATESCANSTATISTICEXPORTJOBREQUEST_H_
