...
#ifndef TENCENTCLOUD_CLOUDAUDIT_V20190319_MODEL_CREATEAUDITREQUEST_H_
#define TENCENTCLOUD_CLOUDAUDIT_V20190319_MODEL_CREATEAUDITREQUEST_H_
    ...
    namespace Cloudaudit
    {
        namespace V20190319
        {
            namespace Model
            {
                ...
                */
                class CreateAuditRequest : public AbstractModel
                {
                public:
                    CreateAuditRequest();
                    ...
                    /**
                     * 获取Tracking set name, which can contain 3-128 ASCII letters (a-z; A-Z), digits (0-9), and underscores (_).
                    ...
                    /**
                     * 设置Tracking set name, which can contain 3-128 ASCII letters (a-z; A-Z), digits (0-9), and underscores (_).
                    ...
                    /**
                     * 获取Prefix of a log file, which can only contain 3-40 ASCII letters (a-z; A-Z) and digits (0-9). It can be left empty and is the account ID by default.
                    ...
                    /**
                     * 设置Prefix of a log file, which can only contain 3-40 ASCII letters (a-z; A-Z) and digits (0-9). It can be left empty and is the account ID by default.
...
#endif // !TENCENTCLOUD_CLOUDAUDIT_V20190319_MODEL_CREATEAUDITREQUEST_H_
