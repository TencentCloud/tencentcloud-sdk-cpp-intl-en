...
CoreInternalOutcome CreateAuditResponse::Deserialize(const string &payload)
{
...
string CreateAuditResponse::ToJsonString() const
{
...
int64_t CreateAuditResponse::GetIsSuccess() const
{
    return m_isSuccess;
}

bool CreateAuditResponse::IsSuccessHasBeenSet() const
{
