...
string DescribeDiskOperationLogsRequest::ToJsonString() const
{
...
vector<Filter> DescribeDiskOperationLogsRequest::GetFilters() const
{
    return m_filters;
}

void DescribeDiskOperationLogsRequest::SetFilters(const vector<Filter>& _filters)
{
    m_filters = _filters;
