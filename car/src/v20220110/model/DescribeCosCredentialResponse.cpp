...
CoreInternalOutcome DescribeCosCredentialResponse::Deserialize(const string &payload)
{
...
string DescribeCosCredentialResponse::ToJsonString() const
{
...
string DescribeCosCredentialResponse::GetSecretID() const
{
    return m_secretID;
}

bool DescribeCosCredentialResponse::SecretIDHasBeenSet() const
{
    return m_secretIDHasBeenSet;
}

string DescribeCosCredentialResponse::GetSecretKey() const
{
    return m_secretKey;
}

bool DescribeCosCredentialResponse::SecretKeyHasBeenSet() const
{
    return m_secretKeyHasBeenSet;
}

string DescribeCosCredentialResponse::GetSessionToken() const
{
    return m_sessionToken;
}

bool DescribeCosCredentialResponse::SessionTokenHasBeenSet() const
{
    return m_sessionTokenHasBeenSet;
}

string DescribeCosCredentialResponse::GetCosBucket() const
{
    return m_cosBucket;
}

bool DescribeCosCredentialResponse::CosBucketHasBeenSet() const
{
    return m_cosBucketHasBeenSet;
}

string DescribeCosCredentialResponse::GetCosRegion() const
{
    return m_cosRegion;
}

bool DescribeCosCredentialResponse::CosRegionHasBeenSet() const
{
    return m_cosRegionHasBeenSet;
}

string DescribeCosCredentialResponse::GetPath() const
{
    return m_path;
}

bool DescribeCosCredentialResponse::PathHasBeenSet() const
{
    return m_pathHasBeenSet;
}

int64_t DescribeCosCredentialResponse::GetStartTime() const
{
    return m_startTime;
}

bool DescribeCosCredentialResponse::StartTimeHasBeenSet() const
{
    return m_startTimeHasBeenSet;
}

int64_t DescribeCosCredentialResponse::GetExpiredTime() const
{
    return m_expiredTime;
}

bool DescribeCosCredentialResponse::ExpiredTimeHasBeenSet() const
{
