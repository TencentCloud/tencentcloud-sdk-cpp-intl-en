...
string DescribeApplicationStatusRequest::ToJsonString() const
{
...
vector<string> DescribeApplicationStatusRequest::GetApplicationIdList() const
{
    return m_applicationIdList;
}

void DescribeApplicationStatusRequest::SetApplicationIdList(const vector<string>& _applicationIdList)
{
    m_applicationIdList = _applicationIdList;
    m_applicationIdListHasBeenSet = true;
}

bool DescribeApplicationStatusRequest::ApplicationIdListHasBeenSet() const
{
