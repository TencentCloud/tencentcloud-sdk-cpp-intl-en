...
string DescribeApplicationListRequest::GetApplicationCategory() const
{
    return m_applicationCategory;
}

void DescribeApplicationListRequest::SetApplicationCategory(const string& _applicationCategory)
{
    m_applicationCategory = _applicationCategory;
    m_applicationCategoryHasBeenSet = true;
}

bool DescribeApplicationListRequest::ApplicationCategoryHasBeenSet() const
{
