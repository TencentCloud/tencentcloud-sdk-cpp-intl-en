...
string DeleteApplicationVersionRequest::ToJsonString() const
{
...
string DeleteApplicationVersionRequest::GetApplicationId() const
{
    return m_applicationId;
}

void DeleteApplicationVersionRequest::SetApplicationId(const string& _applicationId)
{
    m_applicationId = _applicationId;
    m_applicationIdHasBeenSet = true;
}

bool DeleteApplicationVersionRequest::ApplicationIdHasBeenSet() const
{
    return m_applicationIdHasBeenSet;
}

string DeleteApplicationVersionRequest::GetApplicationVersionId() const
{
    return m_applicationVersionId;
}

void DeleteApplicationVersionRequest::SetApplicationVersionId(const string& _applicationVersionId)
{
    m_applicationVersionId = _applicationVersionId;
    m_applicationVersionIdHasBeenSet = true;
}

bool DeleteApplicationVersionRequest::ApplicationVersionIdHasBeenSet() const
{
