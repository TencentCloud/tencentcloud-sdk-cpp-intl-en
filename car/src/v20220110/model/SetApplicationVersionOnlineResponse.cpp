...
CoreInternalOutcome SetApplicationVersionOnlineResponse::Deserialize(const string &payload)
{
...
string SetApplicationVersionOnlineResponse::ToJsonString() const
{
...
vector<UserApplicationVersion> SetApplicationVersionOnlineResponse::GetVersions() const
{
    return m_versions;
}

bool SetApplicationVersionOnlineResponse::VersionsHasBeenSet() const
{
