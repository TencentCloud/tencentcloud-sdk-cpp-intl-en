...
CoreInternalOutcome BindConcurrentPackagesToProjectResponse::Deserialize(const string &payload)
{
...
string BindConcurrentPackagesToProjectResponse::ToJsonString() const
{
