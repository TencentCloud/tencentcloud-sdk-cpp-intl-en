...
CoreInternalOutcome CreateApplicationProjectResponse::Deserialize(const string &payload)
{
...
string CreateApplicationProjectResponse::ToJsonString() const
{
...
string CreateApplicationProjectResponse::GetProjectId() const
{
    return m_projectId;
}

bool CreateApplicationProjectResponse::ProjectIdHasBeenSet() const
{
