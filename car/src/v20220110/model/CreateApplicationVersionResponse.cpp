...
CoreInternalOutcome CreateApplicationVersionResponse::Deserialize(const string &payload)
{
...
string CreateApplicationVersionResponse::ToJsonString() const
{
...
UserApplicationVersion CreateApplicationVersionResponse::GetVersion() const
{
    return m_version;
}

bool CreateApplicationVersionResponse::VersionHasBeenSet() const
{
