...
CoreInternalOutcome DescribeApplicationVersionResponse::Deserialize(const string &payload)
{
...
string DescribeApplicationVersionResponse::ToJsonString() const
{
...
vector<UserApplicationVersion> DescribeApplicationVersionResponse::GetVersions() const
{
    return m_versions;
}

bool DescribeApplicationVersionResponse::VersionsHasBeenSet() const
{
