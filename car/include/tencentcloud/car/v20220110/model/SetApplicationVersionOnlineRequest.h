...
#ifndef TENCENTCLOUD_CAR_V20220110_MODEL_SETAPPLICATIONVERSIONONLINEREQUEST_H_
#define TENCENTCLOUD_CAR_V20220110_MODEL_SETAPPLICATIONVERSIONONLINEREQUEST_H_
    ...
    namespace Car
    {
        namespace V20220110
        {
            namespace Model
            {
                ...
                */
                class SetApplicationVersionOnlineRequest : public AbstractModel
                {
                public:
                    SetApplicationVersionOnlineRequest();
                    ~SetApplicationVersionOnlineRequest() = default;
...
#endif // !TENCENTCLOUD_CAR_V20220110_MODEL_SETAPPLICATIONVERSIONONLINEREQUEST_H_
