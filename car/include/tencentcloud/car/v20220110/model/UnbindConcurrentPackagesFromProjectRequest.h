...
#ifndef TENCENTCLOUD_CAR_V20220110_MODEL_UNBINDCONCURRENTPACKAGESFROMPROJECTREQUEST_H_
#define TENCENTCLOUD_CAR_V20220110_MODEL_UNBINDCONCURRENTPACKAGESFROMPROJECTREQUEST_H_
    ...
    namespace Car
    {
        namespace V20220110
        {
            namespace Model
            {
                ...
                */
                class UnbindConcurrentPackagesFromProjectRequest : public AbstractModel
                {
                public:
                    UnbindConcurrentPackagesFromProjectRequest();
                    ~UnbindConcurrentPackagesFromProjectRequest() = default;
...
#endif // !TENCENTCLOUD_CAR_V20220110_MODEL_UNBINDCONCURRENTPACKAGESFROMPROJECTREQUEST_H_
