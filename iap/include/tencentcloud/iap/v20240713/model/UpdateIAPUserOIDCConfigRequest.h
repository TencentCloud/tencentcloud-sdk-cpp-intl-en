            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取RSA signature public key in the JWKS format, which is used to verify the OpenID Connect IdP's ID token and must be Base64-encoded. For the security of your account, we recommend you rotate it regularly.
                    ...
                    /**
                     * 设置RSA signature public key in the JWKS format, which is used to verify the OpenID Connect IdP's ID token and must be Base64-encoded. For the security of your account, we recommend you rotate it regularly.
                    ...
                    /**
                     * 获取Description, with a length of 1 to 255 English or Chinese characters. It is empty by default.
                    ...
                    /**
                     * 设置Description, with a length of 1 to 255 English or Chinese characters. It is empty by default.
