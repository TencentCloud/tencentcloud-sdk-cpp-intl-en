            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取IdP type. 13: IAP user OIDC IdP.
                    ...
                    /**
                     * 获取The verification fingerprint of the HTTPS CA certificate. English letters and digits are allowed, and each fingerprint is 40 characters long, with a maximum of 5 fingerprints.
                    ...
                    /**
                     * 获取Whether to enable the automatic use of the OIDC signature public key. 1: Yes, 2: No (default).
