            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取AZ ID of the read-only group, which is the same as that of the primary instance.
                    ...
                    /**
                     * 获取Timeout threshold used after the delayed read-only instance removal feature is enabled.
