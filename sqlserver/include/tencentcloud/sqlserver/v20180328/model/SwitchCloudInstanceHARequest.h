            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Switch execution method. 0 - execute immediately; 1 - execute within the time window. The default value is 0.
                    ...
                    /**
                     * 设置Switch execution method. 0 - execute immediately; 1 - execute within the time window. The default value is 0.
