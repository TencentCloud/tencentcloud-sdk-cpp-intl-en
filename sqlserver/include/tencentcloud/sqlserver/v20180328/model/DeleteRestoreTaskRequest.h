            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Rollback task record ID set. Up to 10 records can be deleted once.
                    ...
                    /**
                     * 设置Rollback task record ID set. Up to 10 records can be deleted once.
                     * @param _restoreIds Rollback task record ID set. Up to 10 records can be deleted once.
                     * 
                     */
