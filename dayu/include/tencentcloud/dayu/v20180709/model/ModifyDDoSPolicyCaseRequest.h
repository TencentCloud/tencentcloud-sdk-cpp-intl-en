            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取End UDP business port. Value range: (0, 65535). It must be greater than or equal to the start UDP business port
                    ...
                    /**
                     * 设置End UDP business port. Value range: (0, 65535). It must be greater than or equal to the start UDP business port
                    ...
                    /**
                     * 获取Whether there are customers outside Mainland China. Valid values: [no, yes]
                    ...
                    /**
                     * 设置Whether there are customers outside Mainland China. Valid values: [no, yes]
                    ...
                    /**
                     * 获取Fixed feature code of TCP payload. String length limit: 512
                    ...
                    /**
                     * 设置Fixed feature code of TCP payload. String length limit: 512
                    ...
                    /**
                     * 获取Fixed feature code of UDP payload. String length limit: 512
                    ...
                    /**
                     * 设置Fixed feature code of UDP payload. String length limit: 512
                    ...
                    /**
                     * 获取Minimum length of TCP business packet. Value range: (0, 1500)
                    ...
                    /**
                     * 设置Minimum length of TCP business packet. Value range: (0, 1500)
                    ...
                    /**
                     * 获取Maximum length of TCP business packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of TCP business packet
                    ...
                    /**
                     * 设置Maximum length of TCP business packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of TCP business packet
                    ...
                    /**
                     * 获取Minimum length of UDP business packet. Value range: (0, 1500)
                    ...
                    /**
                     * 设置Minimum length of UDP business packet. Value range: (0, 1500)
                    ...
                    /**
                     * 获取Maximum length of UDP business packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of UDP business packet
                    ...
                    /**
                     * 设置Maximum length of UDP business packet. Value range: (0, 1500). It must be greater than or equal to the minimum length of UDP business packet
                    ...
                    /**
                     * 获取Whether there are VPN businesses. Valid values: [no, yes]
                    ...
                    /**
                     * 设置Whether there are VPN businesses. Valid values: [no, yes]
                    ...
                    /**
                     * 获取TCP business port list. Individual ports and port ranges are supported, which should be in string type, such as 80,443,700-800,53,1000-3000
                    ...
                    /**
                     * 设置TCP business port list. Individual ports and port ranges are supported, which should be in string type, such as 80,443,700-800,53,1000-3000
                    ...
                    /**
                     * 获取UDP business port list. Individual ports and port ranges are supported, which should be in string type, such as 80,443,700-800,53,1000-3000
                    ...
                    /**
                     * 设置UDP business port list. Individual ports and port ranges are supported, which should be in string type, such as 80,443,700-800,53,1000-3000
