...
uint64_t ModifySmsSignRequest::GetUsedMethod() const
{
    return m_usedMethod;
}

void ModifySmsSignRequest::SetUsedMethod(const uint64_t& _usedMethod)
{
    m_usedMethod = _usedMethod;
    m_usedMethodHasBeenSet = true;
}

bool ModifySmsSignRequest::UsedMethodHasBeenSet() const
{
