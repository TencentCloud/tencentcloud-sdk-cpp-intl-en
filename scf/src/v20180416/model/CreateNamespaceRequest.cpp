...
string CreateNamespaceRequest::GetNamespace() const
{
    return m_namespace;
}

void CreateNamespaceRequest::SetNamespace(const string& _namespace)
{
    m_namespace = _namespace;
    m_namespaceHasBeenSet = true;
}

bool CreateNamespaceRequest::NamespaceHasBeenSet() const
{
