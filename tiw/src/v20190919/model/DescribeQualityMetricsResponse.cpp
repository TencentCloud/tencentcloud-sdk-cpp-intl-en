...
CoreInternalOutcome DescribeQualityMetricsResponse::Deserialize(const string &payload)
{
...
string DescribeQualityMetricsResponse::ToJsonString() const
{
...
string DescribeQualityMetricsResponse::GetMetric() const
{
    return m_metric;
}

bool DescribeQualityMetricsResponse::MetricHasBeenSet() const
{
    return m_metricHasBeenSet;
}

vector<TimeValue> DescribeQualityMetricsResponse::GetContent() const
{
    return m_content;
}

bool DescribeQualityMetricsResponse::ContentHasBeenSet() const
{
