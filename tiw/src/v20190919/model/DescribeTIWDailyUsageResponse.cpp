...
CoreInternalOutcome DescribeTIWDailyUsageResponse::Deserialize(const string &payload)
{
...
string DescribeTIWDailyUsageResponse::ToJsonString() const
{
...
vector<UsageDataItem> DescribeTIWDailyUsageResponse::GetUsages() const
{
    return m_usages;
}

bool DescribeTIWDailyUsageResponse::UsagesHasBeenSet() const
{
