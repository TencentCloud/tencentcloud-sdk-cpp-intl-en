            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取The name of the route, unique at the instance level, does not need to be provided.
                    ...
                    /**
                     * 设置The name of the route, unique at the instance level, does not need to be provided.
                    ...
                    /**
                     * 获取Method of route. Available values:
- GET
- POST
- DELETE
- PUT
...
- UNLOCK
                    ...
                    /**
                     * 设置Method of route. Available values:
- GET
- POST
- DELETE
- PUT
...
- http
                    ...
                    /**
                     * 获取Whether to cache the response body. Default true
                    ...
                    /**
                     * 设置Whether to cache the response body. Default true
