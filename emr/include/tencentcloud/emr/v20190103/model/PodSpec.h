            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Purpose of the resource, i.e., node type, which currently can only be "TASK".
                     * @return NodeType Purpose of the resource, i.e., node type, which currently can only be "TASK".
                     */
                    std::string GetNodeType() const;

                    /**
                     * 设置Purpose of the resource, i.e., node type, which currently can only be "TASK".
                    ...
                    /**
                     * 获取Mount point of resources for the host. The specified mount point corresponds to the host path and is used as the data storage directory in the pod. (This parameter has been disused)
                    ...
                    /**
                     * 设置Mount point of resources for the host. The specified mount point corresponds to the host path and is used as the data storage directory in the pod. (This parameter has been disused)
                    ...
                    /**
                     * 获取EKS cluster - CPU type. Valid values: "intel", "amd"
                     * @return CpuType EKS cluster - CPU type. Valid values: "intel", "amd"
                     */
                    std::string GetCpuType() const;

                    /**
                     * 设置EKS cluster - CPU type. Valid values: "intel", "amd"
