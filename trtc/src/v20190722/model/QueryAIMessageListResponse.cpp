...
CoreInternalOutcome QueryAIMessageListResponse::Deserialize(const string &payload)
{
...
string QueryAIMessageListResponse::ToJsonString() const
{
...
uint64_t QueryAIMessageListResponse::GetTotal() const
{
    return m_total;
}

bool QueryAIMessageListResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<MessageInfo> QueryAIMessageListResponse::GetMessageList() const
{
    return m_messageList;
}

bool QueryAIMessageListResponse::MessageListHasBeenSet() const
{
