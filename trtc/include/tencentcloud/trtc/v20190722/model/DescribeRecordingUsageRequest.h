...
The period queried per request cannot be longer than 31 days.
                    ...
                    /**
                     * 获取Whether to query single-stream or mixed-stream recording. Valid values: `single`, `multi`.
                    ...
                    /**
                     * 设置Whether to query single-stream or mixed-stream recording. Valid values: `single`, `multi`.
