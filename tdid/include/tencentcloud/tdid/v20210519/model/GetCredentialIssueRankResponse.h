...
#ifndef TENCENTCLOUD_TDID_V20210519_MODEL_GETCREDENTIALISSUERANKRESPONSE_H_
#define TENCENTCLOUD_TDID_V20210519_MODEL_GETCREDENTIALISSUERANKRESPONSE_H_
    ...
    namespace Tdid
    {
        namespace V20210519
        {
            namespace Model
            {
                ...
                */
                class GetCredentialIssueRankResponse : public AbstractModel
                {
                public:
                    GetCredentialIssueRankResponse();
                    ~GetCredentialIssueRankResponse() = default;
...
#endif // !TENCENTCLOUD_TDID_V20210519_MODEL_GETCREDENTIALISSUERANKRESPONSE_H_
