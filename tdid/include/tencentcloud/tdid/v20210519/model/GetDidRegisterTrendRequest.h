...
#ifndef TENCENTCLOUD_TDID_V20210519_MODEL_GETDIDREGISTERTRENDREQUEST_H_
#define TENCENTCLOUD_TDID_V20210519_MODEL_GETDIDREGISTERTRENDREQUEST_H_
    ...
    namespace Tdid
    {
        namespace V20210519
        {
            namespace Model
            {
                ...
                */
                class GetDidRegisterTrendRequest : public AbstractModel
                {
                public:
                    GetDidRegisterTrendRequest();
                    ~GetDidRegisterTrendRequest() = default;
...
#endif // !TENCENTCLOUD_TDID_V20210519_MODEL_GETDIDREGISTERTRENDREQUEST_H_
