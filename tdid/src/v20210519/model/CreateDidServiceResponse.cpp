...
CoreInternalOutcome CreateDidServiceResponse::Deserialize(const string &payload)
{
...
string CreateDidServiceResponse::ToJsonString() const
{
...
Task CreateDidServiceResponse::GetTask() const
{
    return m_task;
}

bool CreateDidServiceResponse::TaskHasBeenSet() const
{
