...
CoreInternalOutcome GetConsortiumClusterListResponse::Deserialize(const string &payload)
{
...
string GetConsortiumClusterListResponse::ToJsonString() const
{
...
vector<BcosClusterItem> GetConsortiumClusterListResponse::GetClusterList() const
{
    return m_clusterList;
}

bool GetConsortiumClusterListResponse::ClusterListHasBeenSet() const
{
