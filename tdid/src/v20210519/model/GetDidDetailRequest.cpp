...
string GetDidDetailRequest::ToJsonString() const
{
...
string GetDidDetailRequest::GetDid() const
{
    return m_did;
}

void GetDidDetailRequest::SetDid(const string& _did)
{
    m_did = _did;
    m_didHasBeenSet = true;
}

bool GetDidDetailRequest::DidHasBeenSet() const
{
