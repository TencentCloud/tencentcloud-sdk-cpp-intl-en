...
CoreInternalOutcome GetDidListResponse::Deserialize(const string &payload)
{
...
string GetDidListResponse::ToJsonString() const
{
...
vector<DidData> GetDidListResponse::GetDataList() const
{
    return m_dataList;
}

bool GetDidListResponse::DataListHasBeenSet() const
{
    return m_dataListHasBeenSet;
}

int64_t GetDidListResponse::GetAllCount() const
{
    return m_allCount;
}

bool GetDidListResponse::AllCountHasBeenSet() const
{
