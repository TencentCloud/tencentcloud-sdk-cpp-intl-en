...
CoreInternalOutcome CreateTDidResponse::Deserialize(const string &payload)
{
...
string CreateTDidResponse::ToJsonString() const
{
...
string CreateTDidResponse::GetDid() const
{
    return m_did;
}

bool CreateTDidResponse::DidHasBeenSet() const
{
