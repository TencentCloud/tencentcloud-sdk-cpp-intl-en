...
CoreInternalOutcome CreateTDidByPublicKeyResponse::Deserialize(const string &payload)
{
...
string CreateTDidByPublicKeyResponse::ToJsonString() const
{
...
string CreateTDidByPublicKeyResponse::GetDid() const
{
    return m_did;
}

bool CreateTDidByPublicKeyResponse::DidHasBeenSet() const
{
