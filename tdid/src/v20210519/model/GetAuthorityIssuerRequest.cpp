...
string GetAuthorityIssuerRequest::ToJsonString() const
{
...
string GetAuthorityIssuerRequest::GetDid() const
{
    return m_did;
}

void GetAuthorityIssuerRequest::SetDid(const string& _did)
{
    m_did = _did;
    m_didHasBeenSet = true;
}

bool GetAuthorityIssuerRequest::DidHasBeenSet() const
{
