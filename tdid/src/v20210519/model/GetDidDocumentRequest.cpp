...
string GetDidDocumentRequest::ToJsonString() const
{
...
string GetDidDocumentRequest::GetDid() const
{
    return m_did;
}

void GetDidDocumentRequest::SetDid(const string& _did)
{
    m_did = _did;
    m_didHasBeenSet = true;
}

bool GetDidDocumentRequest::DidHasBeenSet() const
{
