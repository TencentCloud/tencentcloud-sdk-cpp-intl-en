...
string GetCptInfoRequest::ToJsonString() const
{
...
uint64_t GetCptInfoRequest::GetCptIndex() const
{
    return m_cptIndex;
}

void GetCptInfoRequest::SetCptIndex(const uint64_t& _cptIndex)
{
    m_cptIndex = _cptIndex;
    m_cptIndexHasBeenSet = true;
}

bool GetCptInfoRequest::CptIndexHasBeenSet() const
{
