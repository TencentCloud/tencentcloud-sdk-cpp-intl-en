...
string CancelAuthorityIssuerRequest::ToJsonString() const
{
...
string CancelAuthorityIssuerRequest::GetDid() const
{
    return m_did;
}

void CancelAuthorityIssuerRequest::SetDid(const string& _did)
{
    m_did = _did;
    m_didHasBeenSet = true;
}

bool CancelAuthorityIssuerRequest::DidHasBeenSet() const
{
