...
string RemoveHashRequest::ToJsonString() const
{
...
string RemoveHashRequest::GetHash() const
{
    return m_hash;
}

void RemoveHashRequest::SetHash(const string& _hash)
{
    m_hash = _hash;
    m_hashHasBeenSet = true;
}

bool RemoveHashRequest::HashHasBeenSet() const
{
