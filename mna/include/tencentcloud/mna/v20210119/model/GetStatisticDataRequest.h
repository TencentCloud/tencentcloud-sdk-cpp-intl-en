            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Device ID. If not specified, pass "-1".
                    ...
                    /**
                     * 设置Device ID. If not specified, pass "-1".
...
2: Daily statistics
                    ...
                    /**
                     * 获取Device ID list. Up to 10 devices. Used when downloading total traffic of multiple devices. At this point, DeviceId can be "-1".
                    ...
                    /**
                     * 设置Device ID list. Up to 10 devices. Used when downloading total traffic of multiple devices. At this point, DeviceId can be "-1".
