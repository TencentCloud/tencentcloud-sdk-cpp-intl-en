...
#ifndef TENCENTCLOUD_MNA_V20210119_MODEL_ADDAPPLICATIONRESPONSE_H_
#define TENCENTCLOUD_MNA_V20210119_MODEL_ADDAPPLICATIONRESPONSE_H_
    ...
    namespace Mna
    {
        namespace V20210119
        {
            namespace Model
            {
                ...
                */
                class AddApplicationResponse : public AbstractModel
                {
                public:
                    AddApplicationResponse();
                    ~AddApplicationResponse() = default;
...
#endif // !TENCENTCLOUD_MNA_V20210119_MODEL_ADDAPPLICATIONRESPONSE_H_
