...
#ifndef TENCENTCLOUD_MNA_V20210119_MODEL_GETNETMONITORBYNAMERESPONSE_H_
#define TENCENTCLOUD_MNA_V20210119_MODEL_GETNETMONITORBYNAMERESPONSE_H_
    ...
    namespace Mna
    {
        namespace V20210119
        {
            namespace Model
            {
                ...
                */
                class GetNetMonitorByNameResponse : public AbstractModel
                {
                public:
                    GetNetMonitorByNameResponse();
                    ~GetNetMonitorByNameResponse() = default;
...
#endif // !TENCENTCLOUD_MNA_V20210119_MODEL_GETNETMONITORBYNAMERESPONSE_H_
