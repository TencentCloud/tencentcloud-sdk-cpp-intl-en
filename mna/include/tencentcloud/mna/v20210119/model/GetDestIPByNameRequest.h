...
#ifndef TENCENTCLOUD_MNA_V20210119_MODEL_GETDESTIPBYNAMEREQUEST_H_
#define TENCENTCLOUD_MNA_V20210119_MODEL_GETDESTIPBYNAMEREQUEST_H_
    ...
    namespace Mna
    {
        namespace V20210119
        {
            namespace Model
            {
                ...
                */
                class GetDestIPByNameRequest : public AbstractModel
                {
                public:
                    GetDestIPByNameRequest();
                    ~GetDestIPByNameRequest() = default;
...
#endif // !TENCENTCLOUD_MNA_V20210119_MODEL_GETDESTIPBYNAMEREQUEST_H_
