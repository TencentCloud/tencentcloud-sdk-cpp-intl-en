...
CoreInternalOutcome DescribeCustomerBillSummaryResponse::Deserialize(const string &payload)
{
...
string DescribeCustomerBillSummaryResponse::ToJsonString() const
{
...
double DescribeCustomerBillSummaryResponse::GetTotalCost() const
{
    return m_totalCost;
}

bool DescribeCustomerBillSummaryResponse::TotalCostHasBeenSet() const
{
