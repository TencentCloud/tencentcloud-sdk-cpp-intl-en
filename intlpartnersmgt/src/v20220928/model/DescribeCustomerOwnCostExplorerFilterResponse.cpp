...
CoreInternalOutcome DescribeCustomerOwnCostExplorerFilterResponse::Deserialize(const string &payload)
{
...
string DescribeCustomerOwnCostExplorerFilterResponse::ToJsonString() const
{
...
CostAnalyzeFilterDetail DescribeCustomerOwnCostExplorerFilterResponse::GetData() const
{
    return m_data;
}

bool DescribeCustomerOwnCostExplorerFilterResponse::DataHasBeenSet() const
{
