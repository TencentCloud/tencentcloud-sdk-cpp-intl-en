...
CoreInternalOutcome DescribeCustomerOwnVoucherUsageDetailsResponse::Deserialize(const string &payload)
{
...
string DescribeCustomerOwnVoucherUsageDetailsResponse::ToJsonString() const
{
...
vector<UsageDetail> DescribeCustomerOwnVoucherUsageDetailsResponse::GetData() const
{
    return m_data;
}

bool DescribeCustomerOwnVoucherUsageDetailsResponse::DataHasBeenSet() const
{
    return m_dataHasBeenSet;
}

int64_t DescribeCustomerOwnVoucherUsageDetailsResponse::GetVoucherId() const
{
    return m_voucherId;
}

bool DescribeCustomerOwnVoucherUsageDetailsResponse::VoucherIdHasBeenSet() const
{
    return m_voucherIdHasBeenSet;
}

double DescribeCustomerOwnVoucherUsageDetailsResponse::GetTotalAmount() const
{
    return m_totalAmount;
}

bool DescribeCustomerOwnVoucherUsageDetailsResponse::TotalAmountHasBeenSet() const
{
    return m_totalAmountHasBeenSet;
}

double DescribeCustomerOwnVoucherUsageDetailsResponse::GetRemainAmount() const
{
    return m_remainAmount;
}

bool DescribeCustomerOwnVoucherUsageDetailsResponse::RemainAmountHasBeenSet() const
{
    return m_remainAmountHasBeenSet;
}

int64_t DescribeCustomerOwnVoucherUsageDetailsResponse::GetTotalRecordsCount() const
{
    return m_totalRecordsCount;
}

bool DescribeCustomerOwnVoucherUsageDetailsResponse::TotalRecordsCountHasBeenSet() const
{
    return m_totalRecordsCountHasBeenSet;
}

string DescribeCustomerOwnVoucherUsageDetailsResponse::GetMonth() const
{
    return m_month;
}

bool DescribeCustomerOwnVoucherUsageDetailsResponse::MonthHasBeenSet() const
{
    return m_monthHasBeenSet;
}

int64_t DescribeCustomerOwnVoucherUsageDetailsResponse::GetRecordsCountByMonth() const
{
    return m_recordsCountByMonth;
}

bool DescribeCustomerOwnVoucherUsageDetailsResponse::RecordsCountByMonthHasBeenSet() const
{
