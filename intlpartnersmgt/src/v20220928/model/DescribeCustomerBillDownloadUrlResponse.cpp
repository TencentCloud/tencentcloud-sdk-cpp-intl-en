...
CoreInternalOutcome DescribeCustomerBillDownloadUrlResponse::Deserialize(const string &payload)
{
...
string DescribeCustomerBillDownloadUrlResponse::ToJsonString() const
{
...
string DescribeCustomerBillDownloadUrlResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeCustomerBillDownloadUrlResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

int64_t DescribeCustomerBillDownloadUrlResponse::GetReady() const
{
    return m_ready;
}

bool DescribeCustomerBillDownloadUrlResponse::ReadyHasBeenSet() const
{
