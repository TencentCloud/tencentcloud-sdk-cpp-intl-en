...
CoreInternalOutcome DescribeRebateDownloadUrlResponse::Deserialize(const string &payload)
{
...
string DescribeRebateDownloadUrlResponse::ToJsonString() const
{
...
string DescribeRebateDownloadUrlResponse::GetDownloadUrl() const
{
    return m_downloadUrl;
}

bool DescribeRebateDownloadUrlResponse::DownloadUrlHasBeenSet() const
{
    return m_downloadUrlHasBeenSet;
}

int64_t DescribeRebateDownloadUrlResponse::GetReady() const
{
    return m_ready;
}

bool DescribeRebateDownloadUrlResponse::ReadyHasBeenSet() const
{
