...
CoreInternalOutcome QueryCustomerBillingQuotaResponse::Deserialize(const string &payload)
{
...
string QueryCustomerBillingQuotaResponse::ToJsonString() const
{
...
QueryCustomerBillingQuotaData QueryCustomerBillingQuotaResponse::GetData() const
{
    return m_data;
}

bool QueryCustomerBillingQuotaResponse::DataHasBeenSet() const
{
