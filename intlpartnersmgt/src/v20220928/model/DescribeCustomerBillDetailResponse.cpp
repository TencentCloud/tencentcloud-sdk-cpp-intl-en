...
CoreInternalOutcome DescribeCustomerBillDetailResponse::Deserialize(const string &payload)
{
...
string DescribeCustomerBillDetailResponse::ToJsonString() const
{
...
int64_t DescribeCustomerBillDetailResponse::GetTotal() const
{
    return m_total;
}

bool DescribeCustomerBillDetailResponse::TotalHasBeenSet() const
{
    return m_totalHasBeenSet;
}

vector<BillDetailData> DescribeCustomerBillDetailResponse::GetDetailSet() const
{
    return m_detailSet;
}

bool DescribeCustomerBillDetailResponse::DetailSetHasBeenSet() const
{
