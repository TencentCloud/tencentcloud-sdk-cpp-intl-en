...
string QueryAccountVerificationStatusRequest::ToJsonString() const
{
...
int64_t QueryAccountVerificationStatusRequest::GetClientUin() const
{
    return m_clientUin;
}

void QueryAccountVerificationStatusRequest::SetClientUin(const int64_t& _clientUin)
{
    m_clientUin = _clientUin;
    m_clientUinHasBeenSet = true;
}

bool QueryAccountVerificationStatusRequest::ClientUinHasBeenSet() const
{
