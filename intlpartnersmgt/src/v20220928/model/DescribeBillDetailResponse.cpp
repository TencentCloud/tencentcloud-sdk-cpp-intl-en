...
CoreInternalOutcome DescribeBillDetailResponse::Deserialize(const string &payload)
{
...
string DescribeBillDetailResponse::ToJsonString() const
{
...
vector<CustomerBillDetailData> DescribeBillDetailResponse::GetDetailSet() const
{
    return m_detailSet;
}
...
int64_t DescribeBillDetailResponse::GetTotal() const
{
    return m_total;
}
