...
#ifndef TENCENTCLOUD_INTLPARTNERSMGT_V20220928_MODEL_DESCRIBECUSTOMEROWNVOUCHERUSAGEDETAILSRESPONSE_H_
#define TENCENTCLOUD_INTLPARTNERSMGT_V20220928_MODEL_DESCRIBECUSTOMEROWNVOUCHERUSAGEDETAILSRESPONSE_H_
    ...
    namespace Intlpartnersmgt
    {
        namespace V20220928
        {
            namespace Model
            {
                ...
                */
                class DescribeCustomerOwnVoucherUsageDetailsResponse : public AbstractModel
                {
                public:
                    DescribeCustomerOwnVoucherUsageDetailsResponse();
                    ~DescribeCustomerOwnVoucherUsageDetailsResponse() = default;
...
#endif // !TENCENTCLOUD_INTLPARTNERSMGT_V20220928_MODEL_DESCRIBECUSTOMEROWNVOUCHERUSAGEDETAILSRESPONSE_H_
