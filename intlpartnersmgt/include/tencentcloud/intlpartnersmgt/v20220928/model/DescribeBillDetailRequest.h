            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Billing mode. Valid values: prePay (Monthly subscription) and postPay (Pay-As-You-Go resources)
                    ...
                    /**
                     * 设置Billing mode. Valid values: prePay (Monthly subscription) and postPay (Pay-As-You-Go resources)
