...
#ifndef TENCENTCLOUD_INTLPARTNERSMGT_V20220928_MODEL_DESCRIBEREBATEDOWNLOADURLRESPONSE_H_
#define TENCENTCLOUD_INTLPARTNERSMGT_V20220928_MODEL_DESCRIBEREBATEDOWNLOADURLRESPONSE_H_
    ...
    namespace Intlpartnersmgt
    {
        namespace V20220928
        {
            namespace Model
            {
                ...
                */
                class DescribeRebateDownloadUrlResponse : public AbstractModel
                {
                public:
                    DescribeRebateDownloadUrlResponse();
                    ~DescribeRebateDownloadUrlResponse() = default;
...
#endif // !TENCENTCLOUD_INTLPARTNERSMGT_V20220928_MODEL_DESCRIBEREBATEDOWNLOADURLRESPONSE_H_
