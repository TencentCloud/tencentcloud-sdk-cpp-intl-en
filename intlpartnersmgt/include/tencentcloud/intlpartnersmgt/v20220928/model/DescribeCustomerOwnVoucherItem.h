...
#ifndef TENCENTCLOUD_INTLPARTNERSMGT_V20220928_MODEL_DESCRIBECUSTOMEROWNVOUCHERITEM_H_
#define TENCENTCLOUD_INTLPARTNERSMGT_V20220928_MODEL_DESCRIBECUSTOMEROWNVOUCHERITEM_H_
    ...
    namespace Intlpartnersmgt
    {
        namespace V20220928
        {
            namespace Model
            {
                ...
                * Voucher data.
                */
                class DescribeCustomerOwnVoucherItem : public AbstractModel
                {
                public:
                    DescribeCustomerOwnVoucherItem();
                    ~DescribeCustomerOwnVoucherItem() = default;
...
#endif // !TENCENTCLOUD_INTLPARTNERSMGT_V20220928_MODEL_DESCRIBECUSTOMEROWNVOUCHERITEM_H_
