            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc.
                     * @return InstanceId ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc.
                     */
                    std::string GetInstanceId() const;

                    /**
                     * 设置ID of an instance for which to modify the sync mode. The ID is in the format of tdsql-ow728lmc.
