            ...
            namespace Model
            {
                ...
                */
                ...
                public:
                    ...
                    /**
                     * 获取Specific name of database to be queried
                     * @return Db Specific name of database to be queried
                     */
                    std::string GetDb() const;

                    /**
                     * 设置Specific name of database to be queried
                    ...
                    /**
                     * 获取Sort by metric. Valid values: query_time_sum, query_count
                     * @return OrderBy Sort by metric. Valid values: query_time_sum, query_count
                     */
                    std::string GetOrderBy() const;

                    /**
                     * 设置Sort by metric. Valid values: query_time_sum, query_count
